...
TL;DR: The paper proposes that quantum probability, similar to energy in general relativity, becomes quasilocal in curved spacetime. It demonstrates that gravitational boundaries and horizons convert global probability conservation into a flux balance law, leading to effective non-Hermiticity for local observers while preserving global unitarity. This is shown in Schwarzschild, Kerr, and FLRW spacetimes, with implications for black hole ringdown observations.


<details>
  <summary>Details</summary>
Motivation: The motivation is to reconcile quantum probabilities with curved spacetime geometry, akin to how energy is treated in general relativity, addressing how probability conservation becomes quasilocal under gravitational effects.

Method: Interpreting Hermiticity as inner-product conservation symmetry, the authors analyze how gravitational boundaries and horizons alter probability conservation into a flux balance law. They derive quasilocal probability effects in specific spacetime models (Schwarzschild, Kerr, FLRW) and link these to observational signatures in black hole ringdowns.

Result: The key result is the demonstration of quasilocal probability conservation induced by spacetime curvature, leading to effective non-Hermitian dynamics for restricted observers while maintaining global unitarity. Observable effects are identified in gravitational wave signals during black hole ringdowns.

Conclusion: The conclusion is that probability conservation in quantum field theory on curved spacetimes is inherently geometric, mirroring energy's quasilocal behavior, requiring a rethinking of quantum observables in strong gravitational fields.
...
TL;DR: This paper explores how κ-deformed non-commutative geometry affects the thermodynamics of Schwarzschild-AdS black holes, revealing critical behavior and phase transitions with a Van der Waals-like critical ratio.


<details>
  <summary>Details</summary>
Motivation: To investigate the impact of κ-deformation on black hole thermodynamics, particularly in an uncharged Schwarzschild-AdS system, and understand deviations from standard phase transition behaviors.

Method: Constructed a κ-deformed Schwarzschild-AdS metric using a κ-deformed Newtonian potential. Derived modified first law and Smarr relation treating κ as a thermodynamic variable with its conjugate potential.

Result: Found κ-deformation induces critical behavior and phase transitions with critical ratio P_c v_c/T_c ≈ 0.370 (similar to Van der Waals). Observed a unique double-loop G-T curve instead of standard swallow-tail patterns.

Conclusion: κ-deformation significantly alters black hole thermodynamics, introducing novel phase structures that differ from classical results, highlighting the importance of non-commutative geometry effects in gravitational systems.
...
TL;DR: This paper provides a comprehensive overview of Love numbers in compact binary systems, focusing on their theoretical foundations, computation methods for black holes and neutron stars, and extensions to 'new physics' scenarios, while also exploring hidden symmetries in general relativity.


<details>
  <summary>Details</summary>
Motivation: To understand tidal effects in gravitational waves, measurable by future observatories, by reviewing Love numbers' role in compact objects like black holes and neutron stars.

Method: Uses effective field theory, post-Newtonian frameworks, and perturbation theory to analyze Love numbers across static, dynamical, and nonlinear scenarios, including extensions to charged black holes, higher dimensions, and modified theories.

Result: Comprehensive analysis of tidal responses in compact objects, including static Love numbers of black holes, and symmetry explanations for their vanishing. Surveys computational methods and new physics applications.

Conclusion: Love numbers are crucial for testing general relativity and probing new physics via gravitational wave observations, with ongoing exploration of theoretical symmetries and astrophysical implications.
...
TL;DR: The paper investigates the loss of hyperbolicity in perturbation equations for black holes in scalar Gauss-Bonnet gravity, showing that the minimum mass for physical solutions can be made arbitrarily small with proper coupling function choices, though observable deviations from general relativity remain bounded.


<details>
  <summary>Details</summary>
Motivation: To understand the validity limits of scalar Gauss-Bonnet gravity as an effective field theory by studying when perturbations become unphysical (elliptic), which indicates EFT breakdown.

Method: Analyzes a class of coupling functions allowing small-mass black holes, determines how the minimum mass threshold depends on theory parameters, and examines the relationship between mass and observable quantities like scalar charge.

Result: The minimum mass can be made arbitrarily small via appropriate coupling functions, but observable deviations (e.g., scalar charge) are bounded, meaning EFT remains valid despite very low mass cutoffs.

Conclusion: The theory's predictive power is maintained for observable quantities even as the lower mass limit is pushed to extremes, suggesting compatibility with general relativity observations within the effective field theory framework.
...
TL;DR: The authors refute previous claims that quantum damping of cosmological shear is not generic in mLQC-I by showing that the previous analysis used unphysical initial conditions. They demonstrate that under physically valid collapsing Bianchi I scenarios, quantum damping leads to isotropy post-bounce, supporting classicalization.


<details>
  <summary>Details</summary>
Motivation: To address the validity of arguments presented in arXiv:2603.18175 which questioned the generality of quantum damping in mLQC-I models, ensuring that the analysis uses physically admissible initial conditions for a collapsing universe.

Method: Examined the initial conditions and assumptions in previous studies, restricted analysis to three-dimensional contraction scenarios, performed numerical simulations and perturbative analysis to observe shear behavior post-bounce.

Result: Quantum damping of shear is robust under valid initial conditions, anisotropies decay exponentially regardless of matter content (with weak energy condition), leading to an isotropic attractor state post-bounce.

Conclusion: Quantum damping in mLQC-I is a generic feature that drives classicalization via isotropization, countering prior objections by highlighting use of unphysical scenarios in earlier work.
...
TL;DR: The paper explores solutions in $d$-dimensional Einstein gravity with a massless scalar field, utilizing generalized Weyl metrics, $SO(2)$ symmetry, and Harrison-type transformations to generate multipolar scalar fields and solutions with magnetic/scalar counterparts of known spacetimes.


<details>
  <summary>Details</summary>
Motivation: The motivation is to extend known solutions in general relativity to include scalar fields and higher dimensions, enabling the study of more complex spacetime structures and their properties under symmetries and transformations.

Method: The method involves using generalized Weyl metrics with $d-2$ Killing vectors, applying $SO(2)$ symmetry to generate multipolar fields, and employing Harrison-type transformations to introduce magnetic fields. This leads to solutions unifying scalar and magnetic counterparts of Schwarzschild-Melvin and Fisher-Janis-Newman-Winicour solutions.

Result: The result is a novel solution containing both scalar and magnetic field components, with particular limits recovering well-known spacetimes. This unifies previously separate solutions under a common framework.

Conclusion: This work demonstrates the versatility of combining symmetry-based techniques and transformations to construct multipolar solutions in higher-dimensional gravity with scalar fields, offering new avenues for exploring interacting fields in curved spacetime.
...
TL;DR: The paper demonstrates that applying a generalized uncertainty principle (GUP) with minimal length and maximal momentum to the Schwarzschild black hole's phase space results in a discrete mass spectrum, mass upper limit, bounded entropy, and regulated Hawking temperature. A GUP-deformed lapse function is introduced to maintain ADM mass and horizon radius while matching the temperature via surface gravity. Analysis of supermassive BH data yields a stringent constraint on the GUP parameter (β ≤ 10^-98), indicating astrophysical observations already limit quantum gravity parameters.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address divergences and singularities in classical black hole physics by incorporating quantum gravity effects through GUP. This aims to resolve issues like infinite entropy and unregulated Hawking temperatures while connecting theoretical predictions with observable astrophysical data.

Method: The authors apply the GUP framework directly to the Schwarzschild black hole's reduced phase space, deriving equations that incorporate minimal length and maximal momentum. They construct a GUP-modified lapse function to preserve key spacetime parameters (ADM mass, horizon radius) and calculate thermodynamic quantities (temperature, entropy). Observational data from supermassive black holes are used to constrain the GUP parameter β.

Result: Key results include a finite discrete mass spectrum for black holes, an upper mass bound, entropy bounded by Bekenstein-Hawking formula modifications, and a regulated Hawking temperature. The derived constraint β ≤ 10^-98 provides the first astrophysical bound on GUP parameters using observed supermassive black holes.

Conclusion: The study shows that GUP-based quantum gravity effects naturally regularize black hole properties without altering classical geometry. The strict bound on β demonstrates that current astrophysical observations can constrain quantum gravity models, bridging theoretical physics with empirical data.
...
### [14] [Relative Magnification Factor of Point Sources on Accretion Disks](https://arxiv.org/abs/2604.09046)
*Qing-Hua Zhu*

Main category: gr-qc

TL;DR: The paper introduces a relative magnification factor to study the effects of source motion on images of accretion disks around supermassive black holes, revealing that moving sources create significant distortions in magnification patterns, which could provide new insights into the dynamics of accretion flows and spacetime geometry.


<details>
  <summary>Details</summary>
Motivation: To address the need for understanding dynamic small-scale structures near supermassive black holes in preparation for imaging by the Event Horizon Telescope and future VLBI arrays.

Method: Compares static and corotating accretion disk sources using the relative magnification factor, analyzing distortions in magnification distributions and caustic structures under gravitational lensing effects.

Result: Corotating sources cause substantial modulations in caustic structures and magnification factor distributions on image/source planes, unlike static sources. Time-delayed images encode accretion flow kinematics.

Conclusion: The magnification factor patterns from moving sources offer a novel observational probe to study the interplay between spacetime geometry and accretion flow properties near black holes.
...
### [15] [Probing the Kinematic Dipole with LISA: an analytical treatment](https://arxiv.org/abs/2604.08968)
*Jacopo Fumagalli,Giulia Cusin,Cyril Pitrou,Gianmassimo Tasinato*

Main category: gr-qc

TL;DR: This paper proposes a method to detect a kinematic dipole in the gravitational-wave background via the LISA interferometer, allowing for an independent measurement of the Solar System's peculiar velocity and probing cosmic anisotropies.


<details>
  <summary>Details</summary>
Motivation: The goal is to detect the kinematic dipole induced by the Solar System's motion, thereby providing a new way to measure its peculiar velocity and investigate cosmic anisotropies through gravitational waves.

Method: The authors derive an analytic response of LISA to the dipole, develop an optimal estimator, and use Fisher forecasts to assess detectability thresholds for different LISA configurations, considering varying noise levels and signal characteristics.

Result: Fisher analysis shows that fiducial LISA requires h²Ω_GW ≥ 5×10⁻⁸, while an improved detector needs ≥5×10⁻¹⁰. Signals with complex frequency profiles offer better detection prospects. The dipole can also help break degeneracies in noisy scenarios.

Conclusion: The method provides a viable path for detecting the kinematic dipole, enhancing our understanding of cosmic anisotropies and improving GW detection in challenging environments with foregrounds or noise.
...
TL;DR: This paper develops a simplified relativistic kinetic theory using a BGK-type collision term, formulates the Boltzmann equation in tetrad form, derives thermal coefficients via Chapman-Enskog expansion for general spacetimes, and constructs a self-consistent Einstein-Boltzmann system for spatially homogeneous models with viscosity and heat flow.


<details>
  <summary>Details</summary>
Motivation: To simplify the complex relativistic kinetic theory framework while maintaining accuracy for systems with internal degrees of freedom, and to enable analysis of viscous effects and heat flow in curved spacetime without full computational demands of the Boltzmann equation.

Method: 1. Reformulate relativistic Boltzmann equation in tetrad formalism.
2. Apply Chapman-Enskog expansion to calculate thermal coefficients to first order.
3. Derive a self-consistent system of first-order differential equations equivalent to Einstein-Boltzmann system for specific homogeneous spacetime models.

Result: Constructed a reduced-order model that captures key features of relativistic gases with viscosity and heat flow in homogeneous cosmological settings. Provides computationally efficient framework for studying relativistic dissipative processes in curved spacetime.

Conclusion: The developed method successfully unifies relativistic kinetic theory with gravitational dynamics through simplified equations, offering a practical tool for cosmological modeling involving dissipative effects without full kinetic complexity.
...
TL;DR: The study calculates gravitational-wave memory in scalar-Gauss-Bonnet gravity using numerical relativity waveforms, finding that indirect modifications during black hole mergers alter memory by up to 4%, with potential for improving gravity tests in future detectors.


<details>
  <summary>Details</summary>
Motivation: To probe strong-field gravity beyond general relativity (GR) using gravitational-wave memory, a key observable that remains undetected and offers insights into nonlinear dynamics.

Method: Derive memory expressions in scalar-Gauss-Bonnet gravity within Horndeski framework, compute memory from numerical waveforms of binary black holes, compare with GR predictions.

Result: Indirect effects (dynamics changes) dominate over direct scalar contributions; memory differences reach ~4% vs GR templates. Including memory increases waveform mismatches by >10x, enhancing detection capabilities for modified gravity effects.

Conclusion: Gravitational-wave memory offers a unique probe for testing gravity theories, particularly with third-generation detectors analyzing low-mass binaries where effects are most pronounced.
...
TL;DR: The paper explores static spherically symmetric vacuum solutions in a generalized bumblebee gravity model with non-minimal couplings B²R and B^μB^νR_{μν}, finding a diverse range of solutions including black holes, wormholes, and naked singularities, with some black holes exhibiting zero entropy.


<details>
  <summary>Details</summary>
Motivation: The motivation is to extend the understanding of bumblebee gravity models by investigating non-minimal couplings to curvature terms, which could provide a richer theoretical framework for describing gravitational phenomena.

Method: The authors derive solutions by varying the action with non-minimal couplings and imposing the vacuum expectation value (VEV) constraint, showing that these operations do not commute, leading to a broader solution space than previous models.

Result: Ten exact solutions are obtained, including black holes, wormholes, and naked singularities. Some black hole solutions have zero entropy, suggesting unique thermodynamic properties.

Conclusion: The study supports bumblebee-type theories with non-minimal vector-tensor couplings as potential fundamental descriptions of the universe, emphasizing the importance of considering non-commutativity in action variation and VEV constraints.
...
TL;DR: The paper derives scattering observables up to 5PN order using the worldline action, incorporating radiation-reaction and hereditary effects. It introduces an isotropic framework to analyze conservative dynamics, resolves prescription discrepancies, and validates Effective One Body coefficients.


<details>
  <summary>Details</summary>
Motivation: To accurately model the two-body problem in general relativity at the fifth post-Newtonian order, including non-local effects like tails and memory contributions, and reconcile different prescriptions for loop integrals.

Method: The authors use the worldline action formalism from a prior work to compute impulse, scattering angle, and time delay. They apply Feynman's $i0^+$ prescription to isolate conservative components, handle non-local memory effects with double Principal-Value integrals, and compare with the γ-3 prescription. The method ensures consistency with local-in-time dynamics and Effective One Body formalism.

Result: Established a systematic procedure for handling memory-like contributions under Feynman's prescription, determined universal conservative Hamiltonian terms, validated specific Effective One Body coefficients ({\bar d}_{5{\rm loc}}, a_{6{\rm loc}}), and showed discrepancies between Feynman and γ-3 prescriptions regarding memory signs and π² term origins.

Conclusion: The isotropic framework provides a clear path to characterize two-body dynamics through scattering data. Feynman's prescription is preferred for preserving expected π² term origins, while the γ-3 approach may not. This work strengthens the connection between worldline and Effective One Body methods in gravitational physics.
...
### [20] [How well can the QCD axion hide?](https://arxiv.org/abs/2604.08657)
*Sung Mook Lee,Maria Ramos,Fuensanta Vilches*

Main category: hep-ph

TL;DR: Multi-axion frameworks relax the theoretical bound on the QCD axion's photon coupling and allow it to be a subdominant dark matter component, complicating detection. However, next-gen experiments can still detect axion-like particles in most evasion regions, with some parameters remaining probeable.


<details>
  <summary>Details</summary>
Motivation: Investigate how multiple axion fields' collective phenomena (level crossings, string bundles) modify the QCD axion's properties and domain wall constraints.

Method: Analyze the domain wall number's dependence on the full anomaly structure in multi-axion setups, comparing to single-axion constraints (E/N ≥ 8/3).

Result: The E/N bound is relaxed in multi-axion scenarios; QCD axion can be subdominant DM. Even when QCD axion evades detection, axion-like particles often remain detectable. Some parameter regions remain probeable with two-axion models.

Conclusion: Multi-axion models challenge traditional QCD axion detection but offer alternative avenues via axion-like particles. Future experiments can still test most parameter spaces despite observational complexities.
...
### [21] [On Exclusive Coherent Production of Bosons in Electron-Proton Collisions](https://arxiv.org/abs/2604.08667)
*Reuven Balkin,Ta'el Coren,Alexander Jentsch,Hongkai Liu,Maksym Ovchynnikov,Yotam Soreq,Sokratis Trifinopoulos*

Main category: hep-ph

TL;DR: The paper introduces a unified framework for analyzing exclusive electroproduction processes in high-energy physics experiments, particularly for the future Electron-Ion Collider (EIC). It addresses various particle productions and evaluates its predictions against existing models, emphasizing the importance of considering finite-Q² effects in multi-differential observables and informing experimental setups.


<details>
  <summary>Details</summary>
Motivation: To develop a comprehensive and flexible framework for exclusive electroproduction processes that can handle diverse particles (pseudoscalars, vectors, axion-like particles, etc.) and accurately model high-energy EIC kinematics, while addressing limitations of current flux-factorized methods.

Method: A unified 2→3 scattering amplitude framework was developed using phenomenological amplitudes constrained by experimental data. The model incorporates finite-Q² correlations and was validated by comparing with flux-factorized approaches in both total rates and differential distributions, with a focus on the missing-proton-energy signature.

Result: The framework shows good agreement with flux-factorized models in the near-real photon regime but reveals significant effects from finite-Q² correlations at higher virtualities. Detailed kinematic analysis provides critical insights for optimizing EIC's forward-proton detector acceptance and signal selection strategies.

Conclusion: The proposed 2→3 framework is a reliable tool for EIC physics analyses, offering systematic refinement with new data and enabling precise predictions for exclusive processes. It underscores the necessity of full quantum mechanical treatments to accurately interpret multi-differential observables in future experiments.
...
### [22] [Probing Higgs and Top Interactions through the Muon Lens at multi-TeV Muon Colliders](https://arxiv.org/abs/2604.08688)
*Tisa Biswas,Anindya Datta,Barbara Mele*

Main category: hep-ph

TL;DR: The paper assesses the capability of a future 10 TeV muon collider to probe dimension-6 SMEFT operators influencing Higgs and top quark processes, demonstrating it could significantly outperform LHC and FCC-ee constraints.


<details>
  <summary>Details</summary>
Motivation: To explore new physics beyond the Standard Model by testing SMEFT operators in regimes with limited LHC sensitivity, particularly for muon-Higgs-gauge and muon-top interactions.

Method: Simulation-based analysis of specific $μ^+μ^-$ collision processes (Zh, μμh, t̄t, t̄t h) at 10 TeV, incorporating differential data and angular distributions to project bounds on Wilson coefficients.

Result: Muon collider can improve limits on relevant Wilson coefficients by up to a factor of 10 compared to existing limits and FCC-ee projections, enabling stronger constraints on UV models like vector-like leptons and leptoquarks.

Conclusion: A 10 TeV muon collider offers unprecedented sensitivity to new physics effects at multi-TeV scales, surpassing LHC limitations and providing unique insights into beyond-Standard-Model scenarios.
...
### [23] [Axion Quality in Warped Extra-Dimension](https://arxiv.org/abs/2604.08700)
*Kiwoon Choi,Chang Hyeon Lee,Chang Sub Shin*

Main category: hep-ph

TL;DR: The paper addresses the axion quality problem in warped extra-dimensional models by analyzing nonlocal effects from U(1)-charged fields, showing how warped geometry and branes suppress non-QCD contributions to the axion potential.


<details>
  <summary>Details</summary>
Motivation: To resolve the axion quality problem in models where the QCD axion is a Wilson-line mode of a 5D U(1) gauge field, since traditional local symmetry-breaking terms are highly constrained.

Method: Systematically calculate nonlocal contributions to the axion potential from fields propagating along the compact dimension, considering effects of warped geometry and orbifold fixed points.

Result: Identifies parametric suppression mechanisms where warped geometry and branes reduce non-QCD contributions, allowing the axion to achieve sufficiently high quality under specific conditions.

Conclusion: Warped extra-dimensional models can provide viable high-quality axions if parameters satisfy the derived suppression conditions, offering a potential solution to the axion quality problem.
...
### [24] [A numerical implementation of the NLO DIS structure functions in the dipole picture](https://arxiv.org/abs/2604.09071)
*Henri Hänninen,Heikki Mäntysaari,Jani Penttala*

Main category: hep-ph

TL;DR: The paper presents a numerical program for evaluating deep inelastic scattering (DIS) structure functions at next-to-leading order (NLO) accuracy using the dipole picture, ensuring stable numerical evaluation with massive quarks.


<details>
  <summary>Details</summary>
Motivation: To develop a robust numerical tool that accurately computes DIS cross sections at NLO accuracy, addressing numerical stability issues when incorporating massive quarks in the dipole framework.

Method: The method involves implementing NLO DIS impact factors with massive quarks in a numerically stable form within the dipole picture. This likely includes mathematical techniques to handle potential instabilities arising from massive quark contributions in the cross-section calculations.

Result: The program successfully achieves stable evaluation of NLO DIS cross sections, overcoming previous numerical challenges associated with massive quarks, thereby providing reliable results for DIS structure function calculations.

Conclusion: The developed numerical program offers a reliable and stable method for evaluating DIS structure functions at NLO accuracy in the dipole picture, particularly when dealing with massive quarks, advancing precision in high-energy physics computations.
...
### [25] [Probing High-Quality Axions with Gravitational Waves](https://arxiv.org/abs/2604.09081)
*Ruiyu Zhou,Jin-Wei Wang,Ligong Bian*

Main category: hep-ph

TL;DR: This paper studies gravitational wave signals from phase transitions and topological defects in a high-quality axion framework, showing that GW alone can't distinguish between different axion models, necessitating complementary probes.


<details>
  <summary>Details</summary>
Motivation: To systematically analyze GW signals from phase transitions and topological defects in axion models, particularly focusing on their detectability and differentiation between scenarios.

Method: Uses a gauged U(1)_g symmetry to prevent vacuum degeneracy lifting, imposes constraints based on axion dark matter abundance and high-quality conditions, calculates GW spectra for QCD axion and axion-like particles.

Result: Identifies a constrained gauge scale (1.6e11 GeV to 1e16 GeV) for the QCD axion, predicts two-step phase transitions with high-frequency GW peaks, finds GW spectra nearly identical between QCD axion and axion-like models.

Conclusion: GW signals alone cannot differentiate between axion scenarios, emphasizing the need for additional observational or experimental probes beyond GW detection.
...
### [26] [Classical and spin polarizabilities of singly heavy baryons within heavy baryon chiral perturbation theory](https://arxiv.org/abs/2604.09149)
*Zi-Jun Li,Zhan-Wei Liu,Ping Chen*

Main category: hep-ph

TL;DR: The study examines electromagnetic and spin polarizabilities of singly charmed baryons using chiral perturbation theory, finding smaller electric but larger magnetic polarizability corrections compared to nucleons, and larger polarizabilities in singly bottom baryons.


<details>
  <summary>Details</summary>
Motivation: To systematically analyze electromagnetic and spin polarizabilities of spin-1/2 singly charmed baryons at higher order precision (p^4) and compare their properties with nucleons and singly bottom baryons.

Method: Heavy baryon chiral perturbation theory at O(p^4) framework, calculating polarizabilities considering mass splittings and transition magnetic moments.

Result: Higher-order corrections reduced electric polarizability slightly, but increased magnetic polarizability significantly due to small mass splitting. Spin polarizabilities (except γ_{M1M1}) are smaller than nucleons. Singly bottom baryons showed even larger polarizabilities.

Conclusion: The findings highlight the role of chiral dynamics in polarizability behavior of heavy baryons and suggest bottom baryons as more sensitive probes due to larger polarizabilities.
...
### [27] [Hadronic form factors in QCD and the incompleteness problem in the time-like region](https://arxiv.org/abs/2604.09185)
*Enrique Ruiz Arriola,Pablo Sanchez-Puertas,Wojciech Broniowski*

Main category: hep-ph

TL;DR: The paper addresses the violation of dispersion relations and superconvergence sum rules in hadronic form factors due to insufficient data in the intermediate energy region between known resonances and perturbative QCD. It proposes using radial Regge trajectories to fill this gap, leading to improved consistency of these theoretical constraints.


<details>
  <summary>Details</summary>
Motivation: To resolve the discrepancies in QCD spectral sum rules caused by missing data between resonance peaks and the perturbative regime, ensuring theoretical consistency for analyses involving hadronic form factors.

Method: Propose a minimal hadronic spectral ansatz using radial Regge trajectories to model the intermediate energy region not covered by known resonances or perturbative calculations. Apply this model to examine dispersion relations and superconvergence sum rules.

Result: The proposed Regge-based ansatz demonstrates the necessity of including this intermediate region to satisfy QCD sum rules, showing how existing violations are resolved when incorporating Regge physics.

Conclusion: Radial Regge trajectories provide a valid framework to bridge gaps in experimental data, enabling accurate dispersion relation tests and reinforcing QCD's role as the theory governing hadronic form factors.
...
### [28] [A Levinson's theorem for particle form factors](https://arxiv.org/abs/2604.09207)
...
### [29] [Constraining new physics in charm quark associated Higgs boson production events using the Standard Model effective field theory approach](https://arxiv.org/abs/2604.09225)
...
### [30] [Probing Solar Symmetrons with Direct Detection](https://arxiv.org/abs/2604.09283)
...
### [31] [A General Prescription for Spurion Analysis of Non-Invertible Selection Rules](https://arxiv.org/abs/2604.09345)
*Ling-Xiao Xu*
...
### [32] [CMB signatures of gravity-mediated dark radiation in $\mathbf{ΔN_{\rm eff}}$](https://arxiv.org/abs/2604.09356)
...
### [33] [Threshold Top-Quark Pair-Production: Cross Sections and Key Uncertainties](https://arxiv.org/abs/2604.09485)
...
### [34] [The four-loop non-singlet splitting functions in QCD](https://arxiv.org/abs/2604.09534)
*Thomas Gehrmann,Andreas von Manteuffel,Vasily Sotnikov,Tongzhi Yang*

Main category: hep-ph

TL;DR: This paper presents the first fully analytic computation of the four-loop splitting functions for quark non-singlet distributions in perturbative QCD, enabling precise parton evolution and resummation techniques.


<details>
  <summary>Details</summary>
Motivation: To advance precision in particle physics calculations by extending perturbative QCD predictions through accurate determination of higher-order splitting functions, which are essential for evolving parton distributions and improving collider phenomenology.

Method: The authors performed an analytic calculation of four-loop splitting functions using methods from perturbative quantum field theory, confirmed existing partial results, and derived numerical representations for practical applications.

Result: Fully analytic expressions for all four-loop non-singlet splitting functions, extraction of four-loop virtual and rapidity anomalous dimensions, and numerical tables suitable for parton distribution function evolution codes.

Conclusion: The results provide essential ingredients for higher-order calculations in collider physics, enhancing precision in measurements and predictions within the Standard Model.
...
### [35] [Choice of optical transformation for photonic circuit wavefront sensors](https://arxiv.org/abs/2604.08665)
*Jonathan Lin*

Main category: astro-ph.IM

TL;DR: The paper explores optimizing photonic integrated circuits for high-contrast imaging by configuring them to maximize sensitivity to phase aberrations, evaluating two coupling methods (direct electric field and optical mode sorter) and deriving a unitary matrix for optimal wavefront sensing and correction.


<details>
  <summary>Details</summary>
Motivation: To enhance exoplanet detection efficiency in future missions by improving photonic coronagraph designs, enabling simultaneous high throughput for off-axis signals and effective wavefront sensing to correct aberrations.

Method: The authors analyze two coupling configurations for photonic circuits: direct piecewise electric field coupling and coupling via an optical mode sorter. They derive a unitary matrix applicable for both scenarios to maximize sensitivity to phase aberrations, crucial for effective wavefront correction.

Result: Derivation of a universal unitary matrix configuration that maximizes phase aberration sensitivity across both coupling methods, supporting simultaneous high-contrast imaging and wavefront sensing in photonic circuits.

Conclusion: Photonic integrated circuits configured with the derived unitary matrix can achieve optimal sensitivity to phase errors, significantly advancing their effectiveness in exoplanet detection and adaptive optics systems.
...
### [36] [Development of the New Optical Sensor for IceCube-Gen2](https://arxiv.org/abs/2604.08785)
*Delaney Butterfield,Chris Wendt*

Main category: astro-ph.IM

TL;DR: The Gen2-DOM, a new digital optical module for the IceCube-Gen2 detector, offers 4 times the photon sensitivity compared to existing IceCube DOMs, featuring 18 4" PMTs arranged in a 4π coverage, optimized for reduced borehole size and high-energy event sensitivity. It includes dedicated readout boards and internal storage for efficient data handling, with 12 prototypes to be deployed in 2025-2026.


<details>
  <summary>Details</summary>
Motivation: The motivation behind developing the Gen2-DOM is to enhance the sensitivity and reduce costs for the IceCube-Gen2 expansion, enabling better detection of high-energy neutrinos and aligning with the scientific goals of the project.

Method: The Gen2-DOM utilizes 18 4" PMTs arranged in a uniform 4π angular distribution within a borosilicate glass pressure vessel. Each PMT has a dedicated readout board to optimize sensitivity. The mechanical design is optimized for a smaller borehole diameter to reduce drilling costs. Internal storage allows multi-level triggering to manage data flow efficiently.

Result: Twelve Gen2-DOM prototypes are scheduled for deployment in the 2025-2026 austral summer. The paper discusses the current design development status and preliminary performance test results.

Conclusion: The Gen2-DOM represents a significant advancement in optical detection technology for IceCube-Gen2, balancing improved sensitivity, cost reduction, and efficient data handling, setting the stage for future neutrino physics research.
...
### [37] [cTreeBalls: a fast 3-point correlation function code for clustering measurements](https://arxiv.org/abs/2604.08855)
*Mario A. Rodriguez-Meza,Eladio Moreno,Alejandro Aviles,Gustavo Niz*

Main category: astro-ph.IM

TL;DR: cTreeBalls (cBalls) is a Python/C package that efficiently computes (2,3)-point clustering statistics for large datasets, such as LSST data, using octree and kd-tree algorithms with user-friendly features.


<details>
  <summary>Details</summary>
Motivation: Enable feasible analysis of massive datasets like those from LSST by providing a fast and flexible tool to compute clustering statistics necessary for cosmological studies.

Method: Implements octree and kd-tree algorithms to efficiently process over 200 million HEALPix pixels in under 10 minutes on a single HPC node. Includes user-friendly interface, configurable parameters via external files, logging, and support for two-point statistics in periodic boxes.

Result: Successfully handles large-scale simulations (e.g., Nside=4096 full sky) quickly, with robust I/O and configurability tailored for DESC/LSST collaborations.

Conclusion: cTreeBalls offers a scalable solution for cosmological data analysis, meeting the demands of upcoming surveys like LSST through optimized algorithms and user-centric design.
...
### [38] [Recent development in high-precision high-fidelity spectrographs for exoplanet research and characterization](https://arxiv.org/abs/2604.09020)
*François Bouchy,Francesco Pepe,Xavier Dumusque,Tobias Schmidt,Christophe Lovis,Stéphane Udry*

Main category: astro-ph.IM

TL;DR: The paper discusses the development and operation of high-precision spectrographs (ESPRESSO, NIRPS, ANDES, RISTRETTO) supported by PlanetS, aimed at achieving sub-m/s radial-velocity precision for detecting Earth-mass exoplanets by addressing instrumental and stellar instabilities.


<details>
  <summary>Details</summary>
Motivation: To detect and characterize Earth-mass exoplanets, which requires high-precision spectrographs capable of sub-m/s radial-velocity measurements, necessitating the mitigation of all sources of instrumental and stellar instabilities.

Method: Design, development, and operation of advanced spectrographs (ESPRESSO, NIRPS, ANDES, RISTRETTO) with enhanced stability and precision, likely involving innovative technologies to minimize instrumental drifts and account for stellar activity.

Result: The created spectrographs achieve the required sub-m/s radial-velocity precision, enabling improved detection and characterization of low-mass exoplanets by effectively tackling key sources of instability.

Conclusion: The successful implementation of these spectrographs represents a significant advancement in exoplanet research, paving the way for future detections of Earth-like planets and deeper understanding of planetary systems.
...
### [39] [Fast and Scalable Production of Stacked Prism X-ray Lenses for Astrophysics Using Two-Photon Polymerization](https://arxiv.org/abs/2604.09182)
*Filip af Malmborg,Chloé Delmotte,Kian Shaker,Mark Pearce*

Main category: astro-ph.IM

TL;DR: The paper introduces stacked prism lenses (SPLs) manufactured via two-photon polymerization (2PP), demonstrating faster production and higher precision than prior methods. Preliminary tests show improved efficiency and optical performance, suggesting SPLs could advance X-ray telescope technology if scalability and assembly challenges are resolved.


<details>
  <summary>Details</summary>
Motivation: To address limitations of current X-ray telescope optics in focal length, resolution, efficiency, and scalability by developing SPLs with superior manufacturing through 2PP.

Method: Manufactured SPLs using two-photon polymerization, conducted laboratory tests on efficiency and optical performance, and analyzed challenges in printing time and assembly.

Result: 2PP produced SPLs with higher geometric fidelity and faster production times. Preliminary tests showed improved efficiency over existing methods, validating optical capabilities.

Conclusion: 2PP is a reliable method for SPL fabrication. With further optimization of printing time and assembly, SPL-based X-ray telescopes could become feasible.
...
### [40] [Unseen Astronomy](https://arxiv.org/abs/2604.09250)
*Dr James W. Trayford*
...
### [41] [Enhancing event reconstruction for $γ$-ray particle detector arrays using transformers](https://arxiv.org/abs/2604.09402)
...
### [42] [Large or bright satellite constellations: Effects on observations, including on the background sky brightness](https://arxiv.org/abs/2604.09427)
*Olivier R. Hainaut*
...
### [43] [IFS spectrograph designs for the Wide-field Spectroscopic Telescope: Architecture and performance gains from curved sensors](https://arxiv.org/abs/2604.09488)
...
### [44] [High-dimensional inference for the $γ$-ray sky with differentiable programming](https://arxiv.org/abs/2604.08648)
*Siddharth Mishra-Sharma,Tracy R. Slatyer,Yitian Sun,Yuqing Wu*

Main category: astro-ph.HE

TL;DR: The paper proposes using differentiable probabilistic programming to efficiently analyze the Galactic Center γ-ray Excess (GCE) by enabling probabilistic exploration of large model spaces with GPU acceleration. It demonstrates this approach on γ-ray data and highlights its broader applicability in astrophysics.


<details>
  <summary>Details</summary>
Motivation: To address the GCE puzzle and demonstrate the utility of differentiable probabilistic programming for handling large model spaces in astrophysical analyses.

Method: Developed a differentiable forward model and likelihood function leveraging GPU acceleration and vectorization to probabilistically explore continuous spatial morphologies of the GCE emission. Used variational inference for efficient model space exploration.

Result: Showcased the method's capability to handle the complex GCE analysis while emphasizing its potential for flexible application to other astrophysical datasets.

Conclusion: Differentiable probabilistic programming offers a powerful tool for astrophysical analysis, particularly in managing high-dimensional model spaces, and this work provides a framework for future such studies.
...
### [45] [Ghosts of eruptions past: Searching for historical Galactic supernovae using variable thermal dust echoes and machine learning](https://arxiv.org/abs/2604.08686)
*Justin Vega,Kishalay De,Ashish Mahabal,Jacob E. Jencson,Viraj R. Karambelkar,Armin Rest,Megan Masterson*

Main category: astro-ph.HE

TL;DR: The paper presents a novel method to detect dust echoes from core-collapse supernovae in the Milky Way using 12 years of NEOWISE data. Despite searching millions of candidates, only Cas A showed significant dust echoes, highlighting its unique properties. The findings set the stage for future surveys with Roman telescope to detect obscured Galactic supernovae.


<details>
  <summary>Details</summary>
Motivation: To identify long-overlooked core-collapse supernovae hidden by dust in the Galactic plane, given the historical gap in optically visible discoveries despite an expected rate of 1-3 per century. Dust echoes offer a non-optical detection method.

Method: Untargeted all-sky search using NEOWISE difference imaging, machine learning classification (CNN trained on Cas A echoes), and statistical analysis of transient candidates to find dust echo over-densities.

Result: Identified Cas A as the sole region with detectable dust echoes at current WISE sensitivity. Created the largest Cas A echo catalog (20,477 points) and demonstrated method's ~94% classification accuracy.

Conclusion: Current observational limits miss most dusty supernovae, but upcoming Roman telescope surveys will vastly improve detection capabilities, enabling discovery of obscured events consistent with the Galactic supernova rate.
...
### [46] [Chasing Gamma-Ray Signals from Binary Neutron Star Coalescences with the Cherenkov Telescope Array: Prospects and Observing Strategies](https://arxiv.org/abs/2604.08748)
...
TL;DR: This paper evaluates CTAO's GeV-TeV follow-up strategies for gravitational wave events, finding that ~5% of GW-associated short GRBs could be detectable with optimized methods, emphasizing jet and viewing angles' roles.


<details>
  <summary>Details</summary>
Motivation: The detection of GW170817 and GRB 170817A highlights the potential of multi-messenger astronomy. The paper seeks to assess CTAO's capability in detecting TeV emission from GW follow-ups, leveraging its advanced sensitivity and survey capabilities.

Method: A multi-step simulation pipeline is used, simulating BNS systems with GW signals and modeling gamma-ray emission using observed short GRB data, including off-axis jets. CTAO's observational parameters like sky tiling, integration times, and conditions are simulated to test different strategies.

Result: Optimized strategies enable ~5% detection rate of GeV-TeV radiation from simulated GW-associated GRBs. Detectability is highly dependent on jet opening and viewing angles, suggesting improved targeting with preliminary angle estimates.

Conclusion: CTAO's optimized follow-up methods enhance multi-messenger studies, especially for neutron star-black hole mergers. Future strategies should incorporate galaxy distributions and synergies with detectors like the Einstein Telescope.
...
### [47] [The Northern High Time Resolution Universe pulsar survey: III. Single-pulse search continuation, follow-up observations, and initial results](https://arxiv.org/abs/2604.09080)
*L. J. M. Houben,H. Falcke,L. G. Spitler,E. D. Barr,M. Berezina,D. J. Champion,R. Karuppusamy,M. Kramer*

Main category: astro-ph.HE

TL;DR: This paper reports the first discovery of a fast radio burst (FRB20110220A) and a new rotating radio transient (RRAT) using the Effelsberg Telescope, along with analysis of single pulse candidates revealing a Galactic origin for faint radio transients.


<details>
  <summary>Details</summary>
Motivation: To continue the High Time Resolution Universe (HTRU) survey for pulsars and radio transients, focusing on detecting rare events like FRBs and RRATs while understanding their spatial distribution in the galaxy.

Method: Single pulse searches were conducted with the 100m Effelsberg Radio Telescope in the northern HTRU survey. Detected candidates were analyzed for dispersion measures, fluences, and spatial distribution patterns relative to Galactic coordinates.

Result: Discovered first FRB (FRB20110220A) with specific parameters (DM=501 pc/cm³, width=11.9 ms, fluence=0.6 Jy ms). Detected a new RRAT (J0404+53) and confirmed another (J2028+28) with improved positional data. Found 8 SP trains, 272 faint SP candidates showing Galactic-latitude/longitude-dependent detection rates.

Conclusion: Demonstrates the HTRU survey's effectiveness in detecting rare transients and suggests a population of faint Galactic single pulses. Highlights need for continued surveys to better understand transient populations and their distributions.
...
### [48] [Radio Monitoring Campaign of Active Repeater FRB 20220912A with CHIME](https://arxiv.org/abs/2604.09098)
...
### [49] [A New Measurement of the Extragalactic Background Light using 15\,yr of {\it Fermi}-Large Area Telescope Data](https://arxiv.org/abs/2604.09139)
...
### [50] [The evolution of the mid-infrared spectrum of SN 1987A observed with the JWST/MIRI-MRS](https://arxiv.org/abs/2604.09211)
...
### [51] [A TeV-based Determination of the Local Extragalactic Background Light and its Consistency with Galaxy Counts and Direct Measurements](https://arxiv.org/abs/2604.09397)
...
### [52] [Blueshifted lines from the inner accretion disc's rotation can explain quasar absorption "forests''](https://arxiv.org/abs/2604.09433)
