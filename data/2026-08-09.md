...
### [13] [Baryogenesis via the CKM Matrix with Minimal Flavor Violation](https://arxiv.org/abs/2608.05269)
...
### [14] [Axion-driven spontaneous leptogenesis, precisely](https://arxiv.org/abs/2608.05279)
...
### [15] [First-principles upper bounds on dark matter-electron scattering rates from condensed matter sum rules](https://arxiv.org/abs/2608.05282)
...
### [16] [Novel Signatures of Matter-Induced Dark Matter Decay in Large-Volume Neutrino Telescopes](https://arxiv.org/abs/2608.05284)
...
### [17] [GOOFy-compatible 3HDMs and beyond](https://arxiv.org/abs/2608.05304)
...
### [18] [Beyond Borel Windows: A Systematic Optimization Framework for QCD Sum Rules](https://arxiv.org/abs/2608.05322)
...
### [19] [Photon-nucleon entanglement in Compton scattering at low and high energies](https://arxiv.org/abs/2608.05330)
...
### [20] [HiggsTools for LHC Run 3 and Beyond](https://arxiv.org/abs/2608.05401)
...
### [21] [Spinor tunnelling amplitudes from all-order Feynman diagram summation](https://arxiv.org/abs/2608.05511)
...
### [22] [Coherent and Stochastic Axion Dark Matter from Thermal Relaxation](https://arxiv.org/abs/2608.05538)
...
### [23] [Revisiting the $Λ_c^+ \to nπ^+η$ decay in light of the BESIII measurement](https://arxiv.org/abs/2608.05629)
...
### [24] [Net electron spin rotation in a plane-wave pulse: Holonomy set by the anomalous magnetic moment](https://arxiv.org/abs/2608.05698)
...
### [25] [Machine Learning is Good for Physics - and Vice Versa](https://arxiv.org/abs/2608.05812)
...
### [26] [Descoped and Upscoped FCC-ee Running Scenarios in the SMEFT](https://arxiv.org/abs/2608.05874)
...
### [27] [QCD analytic coupling](https://arxiv.org/abs/2608.05894)
...
### [28] [Impact of dimension-8 SMEFT operators on baryogenesis via sphaleron decoupling](https://arxiv.org/abs/2608.05950)
...
### [29] [Infrared singularities and the collinear limits of multi-leg scattering amplitudes](https://arxiv.org/abs/2608.06157)
...
### [30] [AT2025agpz in Rubin commissioning data: distinguishing a luminous interacting supernova from nuclear transients in compact galaxies](https://arxiv.org/abs/2608.05318)
...
### [31] [Reconstructing Core-Collapse Supernova Gravitational-Wave Signals with Transdimensional Bayesian Inference](https://arxiv.org/abs/2608.05456)
...
### [32] [A Roadmap for Transient Hunters: Mapping Stellar Mass and Star Formation Rate Anisotropies in the Local Universe](https://arxiv.org/abs/2608.05531)
...
### [33] [No evidence for a supermassive black hole binary in GSN 069](https://arxiv.org/abs/2608.05534)
...
### [34] [Influence of effective mass of the relativistic mean field theory on core collapse supernovae and compact objects](https://arxiv.org/abs/2608.05582)
...
### [35] [Kinematically Resolving the Fe K Complex in Her X-1: The Accretion Disk and Ionized Wind Across X-ray Eclipses](https://arxiv.org/abs/2608.05719)
...
### [36] [GeV γ-ray emission in the star-forming region S140](https://arxiv.org/abs/2608.05809)
...
### [37] [Prospects for characterizing Population III remnants with next-generation gravitational-wave observatories](https://arxiv.org/abs/2608.05846)
...
### [38] [A broadband outburst of the compact steep-spectrum quasar 3C 138 in 2024-2026](https://arxiv.org/abs/2608.05852)
...
### [39] [Phase-resolved QPO Analysis of GX 339-4: Improved Technique and Consistent Behaviors between QPOs and Broadband Noise](https://arxiv.org/abs/2608.05916)
...
### [40] [The impact of nuclear equations of state on the dynamics and multi-messenger emission of magnetorotational stellar explosions](https://arxiv.org/abs/2608.06017)
...
### [41] [Search for an all-sky and a Galactic Ridge diffuse neutrino emission with the first 2 years of KM3NeT/ARCA data](https://arxiv.org/abs/2608.06163)
...
### [42] [An "inside-out" approach to modeling supermassive black hole binary inspiral](https://arxiv.org/abs/2608.06269)
*Laura Blecha*
...
### [43] [The plunging region of thin accretion discs across the black hole spin range](https://arxiv.org/abs/2608.06278)
...
### [44] [A unified modeling of X-ray and gamma-ray spectro-polarimetric data: the case of Cygnus X-1](https://arxiv.org/abs/2608.06328)
...
### [45] [Living on the Edge of Effective Field Theory: Near-Extremal Black Holes in Quadratic Gravity](https://arxiv.org/abs/2608.05268)
...
### [46] [The glow of eternal black holes](https://arxiv.org/abs/2608.05270)
*Vladimir Strokov*
...
### [47] [Absorption spectrum and greybody factors of charged black holes in loop quantum gravity](https://arxiv.org/abs/2608.05292)
...
### [48] [Charged Penrose Extraction in RN--AdS Black Holes with Dark Energy: Ergosphere Geometry and Rigorous Efficiency Bounds](https://arxiv.org/abs/2608.05641)
...
### [49] [Kinematic Bounds on Charged Energy Extraction in the Purely Electric Branch of Euler--Heisenberg Type f(R,T) Black Holes](https://arxiv.org/abs/2608.05644)
*Anirudh Pradhan,K. Ghaderi,M. Zeyauddin*
...
### [50] [Constructing the canonical harmonic coordinates of Kerr metric to the fourth post-Minkowskian order](https://arxiv.org/abs/2608.05713)
...
### [51] [How Loud Must a Neutron-Star Merger Be to Reveal Its Equation of State?](https://arxiv.org/abs/2608.05794)
*Sk Md Adil Imam*
...
### [52] [Asymmetric Quantum Oppenheimer-Snyder Collapse](https://arxiv.org/abs/2608.05818)
...
### [53] [A Novel Kerr-like Black Hole in a General Double Power Law Dark Matter Environment: Geometry, Spectroscopy, and Energy Extraction](https://arxiv.org/abs/2608.05861)
...
### [54] [A Scale-Invariant Theory of the Universe](https://arxiv.org/abs/2608.05929)
...
### [55] [Coherent End-to-End Search for Generic Extreme-Mass-Ratio Inspirals](https://arxiv.org/abs/2608.05974)
...
### [56] [Radial spectra and dynamical signatures of excited boson stars](https://arxiv.org/abs/2608.06067)
...
### [57] [Quasinormal Modes of Gauss--Bonnet Black Holes via the Spectral Method: Scalar, Vector, and Tensor Perturbations](https://arxiv.org/abs/2608.06083)
...
### [58] [Spinning Particle Dynamics and Observational Redshift around an Asymptotically Flat Symmergent Black Hole](https://arxiv.org/abs/2608.06114)
...
### [59] [A Neutron Star Hidden Inside a Black Hole](https://arxiv.org/abs/2608.06224)
