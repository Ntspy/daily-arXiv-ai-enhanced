...
### [17] [Searching for charged Higgs bosons in top decays via the $t^*b$ channel](https://arxiv.org/abs/2607.05499)
...
### [18] [Constant Scaling Fails for Global Monopole Networks](https://arxiv.org/abs/2607.05517)
...
### [19] [Precision Study of Semileptonic and Non-Leptonic $B_c$ Decays to $η_c$ and P Wave Charmonia](https://arxiv.org/abs/2607.05527)
...
### [20] [Linear Breit-Wheeler pair production in the search for axion-like particles](https://arxiv.org/abs/2607.05572)
...
### [21] [Can blind spots save neutralino dark matter in natural supersymmetry models?](https://arxiv.org/abs/2607.05648)
...
### [22] [Compactness, mass spectra, and strong stability of singly heavy tetraquarks](https://arxiv.org/abs/2607.05793)
...
### [23] [Separating energy scales in hadron scattering](https://arxiv.org/abs/2607.05990)
...
### [24] [Anisotropic electron scattering and Migdal effect in semiconductor detectors](https://arxiv.org/abs/2607.06005)
...
### [25] [Radiative decays of $X(3872)$ within $D{\bar D}^*$ molecular framework](https://arxiv.org/abs/2607.06046)
...
### [26] [A resonance-aware MC@NLO QCD+EW-matched calculation of lepton-pair production](https://arxiv.org/abs/2607.06059)
...
### [27] [A Quantitative Framework of Nonperturbative QCD from Topological Vacuum with Application to Parton Structures](https://arxiv.org/abs/2607.06060)
*Wei-Yang Liu*
...
### [28] [ggxy: Fast and flexible NLO QCD corrections to gluon-initiated processes](https://arxiv.org/abs/2607.06099)
*Daniel Stremmer*
...
### [29] [Radiative Breaking of Two-Zero Neutrino Mass Minors: Revisiting the $\mathrm{U}(1)_{L_μ-L_τ}$ Model](https://arxiv.org/abs/2607.06102)
...
### [30] [Non-Unitarity Effects and Fake CP Violation in Neutrino Oscillation Experiments](https://arxiv.org/abs/2607.06108)
...
### [31] [Quantum decoherence: a study applied to quarkonium-like bound states in strongly interacting matter](https://arxiv.org/abs/2607.06137)
...
### [32] [Vector-Meson Spin Alignment from Anisotropic Quark or Hadron Coalescence](https://arxiv.org/abs/2607.06138)
...
### [34] [Polyakov Loops Tame Phase Transitions](https://arxiv.org/abs/2607.06203)
...
### [35] [Flux-integrated inclusive and pionless cross sections for charged-current neutrino scattering off ${}^{40}\text{Ar}$ at energies available in the MicroBooNE experiment](https://arxiv.org/abs/2607.06241)
...
### [36] [Role of the $Σ(1430)(1/2^-)$ in the $J/ψ\to Λ\barΛ π^0$ reaction](https://arxiv.org/abs/2607.06255)
...
### [37] [$KX(3872)$ interaction and correlation function](https://arxiv.org/abs/2607.06317)
...
### [38] [Dispersive estimation of the LO hadronic contribution to the muon ${g-2}$: fitting incompatible ${e^+e^-}$ data](https://arxiv.org/abs/2607.06352)
...
### [39] [Interplay of CPT-Violating and CPT-Conserving Lorentz Invariance Violation at DUNE](https://arxiv.org/abs/2607.06513)
...
### [40] [Predictions for $b$-baryon lifetimes at NNLO-QCD](https://arxiv.org/abs/2607.06538)
...
### [41] [Understanding Pulsar Magnetospheres with the SKAO](https://arxiv.org/abs/2607.05432)
...
### [42] [Formation of rotating supergiants via stellar mergers in dense clusters: Implications for black hole natal spins](https://arxiv.org/abs/2607.05495)
...
### [43] [Radio and X-ray Observations of the Transitional Supernova 2019yvr: Insights into the Progenitor Mass-Loss History](https://arxiv.org/abs/2607.05500)
...
### [44] [Radiation-hydrodynamics of star-disc collisions: From system parameters to outflows and lightcurves](https://arxiv.org/abs/2607.05508)
...
### [45] [Analyzing Cosmic Ray Spectral Features: A Numerical Investigation](https://arxiv.org/abs/2607.05606)
...
### [46] [Dependence of Particle Acceleration Efficiency on Shock Velocity in Weakly Magnetized Electron-Ion Shocks](https://arxiv.org/abs/2607.05778)
...
### [47] [Multi-messenger View of White Dwarf Tidal Disruption Events by Intermediate-Mass Black Holes: I. Gravitational Waves and Disk Photon and Neutrino Emissions](https://arxiv.org/abs/2607.05899)
...
### [48] [Unveiling the Local Environment of FRB 20220912A: Sub-arcsecond $4-26$ GHz Radio Continuum Mapping](https://arxiv.org/abs/2607.05950)
...
### [49] [Identifying a circum-jet southern ring counterpart to the northern jet of the Crab Nebula](https://arxiv.org/abs/2607.05963)
*Noam Soker*
...
### [50] [Two fluid CFL strange quark stars with scalar dark matter: critical mass and mass gap implications](https://arxiv.org/abs/2607.05972)
...
### [51] [The problem of escape: a missing bit in the theory of the origin of cosmic rays](https://arxiv.org/abs/2607.06024)
*P. Blasi,E. Amato*
...
### [52] [A Possible Triple Formation Scenario of Binary Black Hole Merge With One In Pair-instability Supernova Mass Gap](https://arxiv.org/abs/2607.06067)
...
### [53] [Exploring the Galactic plasma with pulsars in the SKA Era](https://arxiv.org/abs/2607.06096)
...
### [54] [Pulsars in Globular Clusters With the SKAO](https://arxiv.org/abs/2607.06154)
...
### [55] [The X-ray Variability of the Ultraluminous X-ray Sources in the NGC 4631 galaxy](https://arxiv.org/abs/2607.06156)
...
### [56] [An intrinsic decline of accretion activity in GRS 1915+105](https://arxiv.org/abs/2607.06200)
...
### [57] [Chandra X-Ray Imaging and Spatially Resolved Spectroscopy of SN 1987A: Energy-Dependent Morphology of the Equatorial Ring](https://arxiv.org/abs/2607.06302)
...
### [58] [SN 2022erq: A Superluminous Thermonuclear Supernova with Escalating Pre-Explosion Mass Loss](https://arxiv.org/abs/2607.06338)
...
### [59] [Unravelling Turbulence and Magnetic Fields in Galaxy Clusters with SKA and XRISM](https://arxiv.org/abs/2607.06346)
...
### [60] [Extreme particle acceleration in X-ray binaries is linked to their jets](https://arxiv.org/abs/2607.06360)
...
### [61] [Finite-Field QED Corrections to Vacuum Birefringence and Magnetar Polarization Transport](https://arxiv.org/abs/2607.06422)
...
### [62] [Minimum Energies and Magnetic Field Strengths of Edge-brightened Compact Symmetric Objects](https://arxiv.org/abs/2607.06562)
...
### [63] [The Impact of Space Debris on Optical Astronomy](https://arxiv.org/abs/2607.05480)
...
### [64] [The role of sound and auditory displays in telescope control rooms: a pilot study](https://arxiv.org/abs/2607.05520)
...
### [65] [The Wide-field Spectroscopic Telescope: optical designs for the low-resolution multi-object spectrographs](https://arxiv.org/abs/2607.05601)
...
### [66] [Detection of Organics in Water Ice by Optical-PhotoThermal Infrared Spectroscopy](https://arxiv.org/abs/2607.05629)
...
### [67] [Exploring Image-Text Alignment for Radio Galaxy Morphologies](https://arxiv.org/abs/2607.06305)
...
### [68] [Instrument response generation using high-resolution 3D voxelization of GRBAlpha and VZLUSAT-2 satellites with MEGAlib](https://arxiv.org/abs/2607.06311)
...
### [69] [Long-term performance of SiPMs in space environment measured by GRBAlpha, GRBBeta, and VZLUSAT-2 CubeSats](https://arxiv.org/abs/2607.06318)
...
### [70] [slicersim: A python package to simulate image slicer spectroscopic observations -- application to the Lazuli Spectrograph](https://arxiv.org/abs/2607.06391)
...
### [71] [LUnar-based Survey for Time-domain Exploration and Research network (LUSTER-net)](https://arxiv.org/abs/2607.06548)
