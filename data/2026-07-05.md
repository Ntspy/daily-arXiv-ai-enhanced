...
### [27] [Inflation from Covariant Signature Change: A Geometric Mechanism](https://arxiv.org/abs/2607.01274)
...
### [28] [Hypersurface Anchored Variational Principle for General Relativity](https://arxiv.org/abs/2607.01285)
*Prasanta Sahoo*
...
### [29] [Impact of Spacecraft Orbit Uncertainties and Velocity Mismodeling on the LISA Gravitational-Wave Response](https://arxiv.org/abs/2607.01318)
...
### [30] [Vacuum Cherenkov radiation in supercritical magnetic fields](https://arxiv.org/abs/2607.01419)
...
### [31] [Stability regions of glued wormholes with massless Kim-Lee backreacted spacetimes as interior](https://arxiv.org/abs/2607.01687)
...
### [32] [Particle dynamics and quasi-periodic oscillations of a Reissner--Nordström-like black hole in Kalb--Ramond gravity under an external magnetic test field](https://arxiv.org/abs/2607.01723)
...
### [33] [Classical and Loop Quantum Cosmology of Interacting Dark Energy: A Dynamical System Analysis with Superfluid Dark Matter and Dust Matter](https://arxiv.org/abs/2607.01724)
...
### [34] [Rotating Black Holes and the Kerr/CFT Correspondence in Einstein-Bumblebee Gravity](https://arxiv.org/abs/2607.01884)
...
### [35] [Chaotic behaviors of particles around the black hole with an anisotropic matter immersed in a magnetic field](https://arxiv.org/abs/2607.01910)
...
### [36] [Phase Transitions with Lyapunov Exponents under Einstein and String Frames in Dilatonic Reissner--Nordström--AdS Black Holes](https://arxiv.org/abs/2607.01912)
...
### [37] [Neutron stars with primary scalar hair](https://arxiv.org/abs/2607.01937)
...
### [38] [Boson Stars in Teleparallel Gravity with a Nonminimally Coupled Field: The Violation of Energy Conditions and Gravitational Waveforms from EMRIs](https://arxiv.org/abs/2607.02017)
...
### [39] [Nonlocal correlations of fermionic entanglement in the spacetime of Einstein-Gauss-Bonnet black hole](https://arxiv.org/abs/2607.02039)
...
### [40] [The Direct Wave is Not a Meaningful Test of Horizon Properties](https://arxiv.org/abs/2607.02380)
...
### [41] [Black Hole Persistence in Scalar Tensor Theories](https://arxiv.org/abs/2607.02409)
...
### [42] [Can Primordial Black Holes Be Seeds for Early Galaxies in Models Satisfying the Covariant Entropy Bound?](https://arxiv.org/abs/2607.01292)
...
### [43] [No Evidence for Superradiant Axions in LIGO-Virgo-KAGRA GWTC-5 Binary Black Hole Spins](https://arxiv.org/abs/2607.01317)
...
### [44] [Axion Misalignment Across First-Order Phase Transitions](https://arxiv.org/abs/2607.01333)
...
### [45] [Electron stability constrains neutrino time delays](https://arxiv.org/abs/2607.01339)
...
### [46] [Local Conformal Predictions for Calibrated Surrogates](https://arxiv.org/abs/2607.01354)
...
### [47] [Neutron stars as thermometers for reheating induced dipole dark matter](https://arxiv.org/abs/2607.01390)
*Sahabub Jahedi*
...
### [48] [One-loop matching of QCD currents to power-suppressed two-jet operators](https://arxiv.org/abs/2607.01413)
...
### [49] [The theory of electric dipole moments: the view from below](https://arxiv.org/abs/2607.01443)
*Jordy de Vries*
...
### [50] [An introduction to Hammer v2: Helicity Amplitude Module for Matrix Element Reweighting](https://arxiv.org/abs/2607.01459)
...
### [51] [Hadronization of $Λ_c^+$ baryons from recombination model in Pb+Pb collisions at the Large Hadron Collider](https://arxiv.org/abs/2607.01637)
...
### [52] [Gravitational Waves from Multiple First-Order Phase Transitions in a Scenario with Early Matter Domination](https://arxiv.org/abs/2607.01697)
...
### [53] [Subensemble Acceptance Method 3.0: General Corrections to Cumulants from Exact Conservation Constraints](https://arxiv.org/abs/2607.01783)
...
### [54] [Hybrid Residual Correction of VMC Charmonium Masses with a Screened Funnel Interaction](https://arxiv.org/abs/2607.01797)
...
### [55] [Phenomenology of genuine twist-three distributions from a global QCD analysis](https://arxiv.org/abs/2607.01866)
...
### [56] [Refined Sensitivity Estimates for Single-Molecule Magnet Dark Matter Detectors](https://arxiv.org/abs/2607.01868)
...
### [57] [Dynamics of Self-Interacting Dark Sectors](https://arxiv.org/abs/2607.01920)
*Esau Cervantes*
...
### [58] [One-loop proton decay from Peccei-Quinn symmetry](https://arxiv.org/abs/2607.02026)
*H. B. Câmara*
...
### [59] [$Λ$ hyperons in core-collapse supernovae: Equilibration and neutrino opacities](https://arxiv.org/abs/2607.02086)
...
### [60] [Light tetraquark states with $J^{PC}=1^{--}$ from QCD sum rules](https://arxiv.org/abs/2607.02109)
...
### [61] [Searching for single production of a vector-like $Y$ quark decaying into $bW$ at the FCC-eh](https://arxiv.org/abs/2607.02177)
...
### [62] [Sideband Structure of Axion Electrodynamics](https://arxiv.org/abs/2607.02232)
...
### [63] [A Comprehensive Analysis of $B_s \to D_s^{**}\ellν_\ell$ Decays Within and Beyond the Standard Model](https://arxiv.org/abs/2607.02276)
...
### [64] [A Maximum-Entropy Method for Zero-Skewness Valence GPDs Constrained by Nucleon Electromagnetic Form Factors](https://arxiv.org/abs/2607.02302)
*Seung-il Nam*
...
### [65] [New constraints on non-unitary neutrino mixing from 8 years of IceCube DeepCore atmospheric neutrino data](https://arxiv.org/abs/2607.02355)
...
### [66] [Symmetry Analysis of Compact Tetraquark States and Implications for the Level Ordering of the Fully Charmed Candidates $X(6600)$, $X(6900)$, and $X(7100)$](https://arxiv.org/abs/2607.02382)
...
### [67] [Chebyshev Approximations of Feynman Integrals for Collider Physics](https://arxiv.org/abs/2607.02411)
...
### [68] [Event-axis TMD measurements in $e^+e^-$ and SIDIS](https://arxiv.org/abs/2607.02438)
...
### [69] [Transverse-spin dependent energy-energy correlators in proton-proton collisions within the dihadron fragmentation framework](https://arxiv.org/abs/2607.02441)
...
### [70] [The $D_{s1}(2460)$ and other open-charm $1^+$ states in relativistic chiral effective field theory](https://arxiv.org/abs/2607.02452)
...
### [71] [Identifying $Σ(1380)$ and $Σ(1430)$ in the $J/ψ\to Λπ\barΣ$ reaction](https://arxiv.org/abs/2607.02485)
...
### [72] [A critical look at low-scale cosmological phase transitions in the PTA era](https://arxiv.org/abs/2607.02505)
