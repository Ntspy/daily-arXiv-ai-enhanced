...
TL;DR: The paper calculates the electron EDM induced by CP-violating SU(2)_L multiplet Yukawa interactions at full three-loop level, finding a 3x larger contribution than the electroweak-Weinberg operator alone due to combined effects of Weinberg and dipole operators.


<details>
  <summary>Details</summary>
Motivation: To explore testable beyond-Standard-Model physics at three-loop order, specifically evaluating the full impact of CP-violating interactions contributing to electron EDM predictions.

Method: Direct three-loop calculation of electron EDM using CP-violating SU(2)_L multiplet Yukawa interactions, combining contributions from the electroweak-Weinberg (two-loop) and CP-odd dipole (three-loop) operators within SMEFT framework.

Result: Full three-loop calculation yields an electron EDM contribution 3 times larger than the Weinberg operator alone. The CP-odd dipole operator's effect is comparable to the Weinberg term, with logarithmic enhancements playing a significant role.

Conclusion: Future electron EDM experiments can probe these three-loop effects, with the dipole operator contributing significantly, requiring full higher-order calculations for accurate predictions.
