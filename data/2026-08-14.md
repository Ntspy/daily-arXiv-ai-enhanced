...
### [24] [Don't Cut Corners: How Training Outside the Prior Makes Simulation-Based Inference More Robust](https://arxiv.org/abs/2608.12470)
...
### [25] [Laser-micromachined silicon-platelet feedhorns for large-scale submillimeter and millimeter-wave focal planes](https://arxiv.org/abs/2608.12577)
...
### [26] [Tropospheric Ducting Prediction based on GFS Model Data at Inyarrimanha Ilgari Bundara, the CSIRO Murchison Radio-astronomy Observatory](https://arxiv.org/abs/2608.12861)
...
### [27] [SNIFFLES I: Intended Emission, Unwanted Emission, and Unintended Radiation from Low-Earth Orbiting Satellites Impacting Radio Astronomy from 1-26 GHz](https://arxiv.org/abs/2608.12999)
...
### [28] [FOSSIL's preliminary thermal architecture](https://arxiv.org/abs/2608.13185)
...
### [29] [Optical development of the BISOU breadboard](https://arxiv.org/abs/2608.13225)
...
### [30] [Optical concept model of the future cosmology project BISOU](https://arxiv.org/abs/2608.13257)
...
### [31] [JWST MIRI Medium Resolution Spectrometer Point Fixed Pattern Corrections: Cleaner and Higher Signal-to-Noise Spectra of Point Sources](https://arxiv.org/abs/2608.13464)
...
### [32] [Numerical Model Simulation of the Carruthers GCI Images](https://arxiv.org/abs/2608.13516)
...
### [33] [Dark matter in scale-invariant gravity with hidden-sector condensation](https://arxiv.org/abs/2608.12456)
...
### [34] [Probing CP-violating top-quark dipole moments with tomographic observables](https://arxiv.org/abs/2608.12463)
...
### [35] [Soft Collinear Effective Theory for Heavy QCD Axions](https://arxiv.org/abs/2608.12467)
...
### [36] [Defect-Mediated Conversion: Dark Matter from Cosmological Domain-Wall Scattering](https://arxiv.org/abs/2608.12468)
...
### [37] [Singlet-doublet dark matter beyond freeze-out](https://arxiv.org/abs/2608.12480)
...
### [38] [Singlet-Doublet fermion origin of dark matter, neutrino mass and inverse first-order electroweak phase transition](https://arxiv.org/abs/2608.12483)
...
### [39] [Spontaneous Scoto-leptogenesis](https://arxiv.org/abs/2608.12497)
...
### [40] [N$^3$LO soft-gluon corrections for $Zγ$ production](https://arxiv.org/abs/2608.12556)
...
### [41] [A Novel One-loop Model for Majorana Neutrino Mass and Dark Matter](https://arxiv.org/abs/2608.12646)
...
### [42] [Massive cold hybrid stars in a modified Polyakov-Nambu-Jona-Lasinio model](https://arxiv.org/abs/2608.12653)
...
### [43] [Scalar induced gravitational waves as probes of dark QCD](https://arxiv.org/abs/2608.12706)
...
### [44] [Topological diagrams of $Ω^0_c$ decays in the $SU(3)_F$ limit](https://arxiv.org/abs/2608.12742)
...
### [45] [In-medium properties of $D$ and $D^*$ mesons in magnetized isospin asymmetric nuclear matter](https://arxiv.org/abs/2608.12834)
...
### [46] [Entropy from inclusive scattering](https://arxiv.org/abs/2608.12923)
*M. A. Braun*
...
### [47] [Newtrinos.jl: A Julia Package for Global Analysis of Neutrino Data](https://arxiv.org/abs/2608.12940)
...
### [48] [Decay widths of radially excited vector mesons of the $U(3)$ nonet with production of three pseudoscalar mesons in the extended NJL model](https://arxiv.org/abs/2608.13140)
...
### [49] [Magnetization and Magnetic Field-Induced Correction: Implications for QGP Thermal Photon Production in Magnetohydrodynamic](https://arxiv.org/abs/2608.13364)
...
### [50] [Non-perturbative quark production and transport in the evolving glasma: the WAGASHI event generator](https://arxiv.org/abs/2608.13393)
...
### [51] [Critical behavior and critical exponents of rotating QCD matter](https://arxiv.org/abs/2608.13469)
...
### [52] [A pion-driven near-threshold enhancement in the $π\,T_{cc}$ system](https://arxiv.org/abs/2608.13525)
...
### [53] [Kinematic Fingerprints of a Nucleon-Triggered $V_{\mathcal{B}}$ in Rare $η^{(\prime)}\toπ^0(η)γγ$ Decays on Nucleon Targets](https://arxiv.org/abs/2608.13537)
*Yaroslav Balytskyi*
