...
### [42] [The First Measurement of Jet Collimation Profiles in an X-ray Binary: the Case of SS 433](https://arxiv.org/abs/2607.28122)
...
### [43] [Multiwavelength study of supernova remnants in the Circinus constellation with SRG/eROSITA](https://arxiv.org/abs/2607.28188)
...
### [44] [Estimating amplitude of matter density fluctuations in solar and supernova models using neutrino flavor evolution](https://arxiv.org/abs/2607.28398)
...
### [45] [Binary neutron stars in the next-generation era: Multi-messenger detection prospects and constraints on the equation of state, mass distribution, and cosmology](https://arxiv.org/abs/2607.28438)
...
### [46] [Uncertainty-Aware Tidal Disruption Event Classification : A Host-Agnostic Probabilistic Random Forest Approach](https://arxiv.org/abs/2607.28510)
...
### [51] [Co-design of ground-based gravitational wave detector networks](https://arxiv.org/abs/2607.27254)
...
### [52] [Assessing the Impact of Instrumental Requirements on the Scientific Performance of the Einstein Telescope](https://arxiv.org/abs/2607.27311)
...
### [53] [Emulating Cosmic Structure Formation with a Lagrangian Neural Cellular Automaton](https://arxiv.org/abs/2607.27320)
...
### [54] [The Calibration System of the iLocater Spectrograph](https://arxiv.org/abs/2607.27330)
...
### [55] [Commissioning and on-sky performance verification of iLocater](https://arxiv.org/abs/2607.27332)
...
### [56] [Laboratory characterization of iLocater](https://arxiv.org/abs/2607.27356)
...
### [57] [PhoPS: An automated photometric pipeline for survey-era astronomy](https://arxiv.org/abs/2607.27414)
...
### [58] [Tiny Observatory for Telescope Optimization (TOTO): testing algorithms for autonomous on-orbit alignment for space-based telescope systems](https://arxiv.org/abs/2607.27457)
...
### [59] [Testing of machine learning wavefront sensing algorithms on the Tiny Observatory for Telescope Optimization (TOTO) testbed](https://arxiv.org/abs/2607.27458)
...
### [60] [Compton Polarimeter Prototype for the CUbesat Solar Polarimeter (CUSP) mission](https://arxiv.org/abs/2607.27460)
...
### [61] [Design and testing progress towards the first flight of the rocket experiment demonstration of a Soft X-ray Polarimeter (REDSoX)](https://arxiv.org/abs/2607.27639)
...
### [62] [Proof of Concept Measurements of Laterally Graded Multilayers for Soft X-ray Spectropolarimetry](https://arxiv.org/abs/2607.27664)
...
### [67] [Segment-level thermal sensitivity analysis for exo-Earth coronagraphy with segmented space telescopes](https://arxiv.org/abs/2607.28393)
...
### [68] [Statistical treatment of searches for counterparts of positionally-uncertain astrophysical sources: from flux upper limits to detection](https://arxiv.org/abs/2607.28473)
...
### [69] [DB-Bench: Benchmarking Deblenders for LSST DESC Using the Blending ToolKit](https://arxiv.org/abs/2607.28475)
...
### [70] [Upgrading LBTI/NOMIC with a quadruple annular groove phase mask and GeoSnap detector for imaging nearby, habitable-zone exoplanets](https://arxiv.org/abs/2607.28562)
...
### [71] [Laboratory demonstration of low order wavefront control using light reflected off the vortex coronagraph](https://arxiv.org/abs/2607.28603)
...
### [72] [Hubble tension problem encompassed by phase-space quantum cosmology](https://arxiv.org/abs/2607.27285)
*Alex E. Bernardini*
...
### [73] [Nonlinear Dynamics near the Threshold of Gravitational Collapse](https://arxiv.org/abs/2607.27343)
...
### [74] [Inflation in unimodular loop quantum cosmology](https://arxiv.org/abs/2607.27344)
...
### [75] [Gauge vs (hidden) physical symmetries of FLRW cosmologies](https://arxiv.org/abs/2607.27351)
...
### [76] [Quark Stars in $f(T,\mathcal{T}) $ Gravity: Structure, Stability, and Observational Constraints](https://arxiv.org/abs/2607.27365)
...
### [77] [Structural morphology and the gravitational arrow of time](https://arxiv.org/abs/2607.27526)
...
### [78] [Tidal Love numbers of multi-state Boson stars](https://arxiv.org/abs/2607.27587)
...
### [79] [Constrained thermodynamics and geodesic observables of an effective non-commutative Kerr-like black hole](https://arxiv.org/abs/2607.27707)
...
### [80] [Degenerate Limits of Scalar-Tensor Gravity](https://arxiv.org/abs/2607.27801)
...
### [81] [Foldy--Wouthuysen Transformation of the Generalized Dirac Equation in Symmetric Teleparallel Gravity](https://arxiv.org/abs/2607.27889)
...
### [82] [Towards long and accurate numerical relativity waveforms of binary black holes beyond general relativity](https://arxiv.org/abs/2607.27991)
...
### [83] [High-accuracy drivers to simulate black hole binaries beyond general relativity with the fixing-the-equations approach](https://arxiv.org/abs/2607.28003)
*Guillermo Lara,Harald P. Pfeiffer,Nils Deppe,Lawrence E. Kidder,Geoffrey Lovelace,Sizheng Ma,Alexandra Macedo,Jordan Moxon,Kyle C. Nelli,Mark A. Scheel,William Throwe,Nils L. Vu*
...
### [84] [Quartic Scalar Clouds on Fixed Kerr Backgrounds](https://arxiv.org/abs/2607.28044)
*Hendrik Mennenga*
...
### [85] [Signatures of kinetic gravity braiding in cosmological probes of the gravitational field](https://arxiv.org/abs/2607.28207)
...
### [86] [Homogeneous and Isotropic Linearized Gravity as a Caldeira--Leggett System](https://arxiv.org/abs/2607.28209)
...
### [87] [Logarithmic corrections to black hole entropy from minimum-assumptions discretization](https://arxiv.org/abs/2607.28249)
...
### [88] [Ab Initio Real-Time Gravitational-Wave Parameter Estimation](https://arxiv.org/abs/2607.28265)
...
### [89] [Post-Newtonian Roche-Lobe-Overflow Prescription for Compact Binary Mass Transfer and the Corresponding Gravitational Waveforms](https://arxiv.org/abs/2607.28315)
...
### [90] [The BGV Theorem and the Null Convergence Condition](https://arxiv.org/abs/2607.28412)
*William H. Kinney*
...
### [91] [Dynamics of compact binary systems in massive scalar Gauss-Bonnet gravity](https://arxiv.org/abs/2607.28448)
