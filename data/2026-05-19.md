...
- [astro-ph.HE](#astro-ph.HE) [Total: 37]
...
### [10] [Extending the model of rotating acoustic geometries to include non-vanishing solid-body rotation: quasibound spectra](https://arxiv.org/abs/2605.16621)
*H. S. Vieira*
...
### [11] [The impact of seasonality over the sensitivity of Einstein Telescope and the SNR of CBC signals at the Sardinia candidate site](https://arxiv.org/abs/2605.18135)
...
### [31] [The Case for Astrons](https://arxiv.org/abs/2605.18186)
...
### [32] [Natural modification of quantum uncertainty, modified gravity, and cosmology](https://arxiv.org/abs/2605.18203)
...
### [33] [Kerr-like black holes shadow surrounded by dark matter halos: Comparison between various dark matter profiles](https://arxiv.org/abs/2605.18205)
...
### [34] [Short-Range Tests of the Gravitational Inverse-Square Law](https://arxiv.org/abs/2605.18212)
...
### [44] [Freeze-in Warm Dark Matter via Dimension-6 Operators in 3-3-1 Models](https://arxiv.org/abs/2605.16465)
*Fuwei Liu,Fujun Liu*
...
### [45] [ULYSSES the Third: An Odyssey Towards a Unified Python Toolkit for Leptogenesis](https://arxiv.org/abs/2605.16540)
...
### [46] [Towards Measuring the CP-Violating Phase with Atmospheric Neutrinos](https://arxiv.org/abs/2605.16721)
...
### [47] [Higgs Physics with the XFEL Compton $\boldsymbol{γγ}$ Collider Concept at $\boldsymbol{\sqrt{s}=125}$ GeV](https://arxiv.org/abs/2605.16756)
...
### [48] [3D Initial-State Dynamics across scales: A Comparative Study of saturation and string-based descriptions](https://arxiv.org/abs/2605.16914)
...
### [49] [An EFT Map of Axion Dark Radiation from Reheating](https://arxiv.org/abs/2605.17178)
*Yong Xu*
...
### [50] [Systematic analysis of fermionic masses and flavor mixings: a model-independent approach](https://arxiv.org/abs/2605.17202)
...
### [51] [\textsc{RooAgent}: An LLM Agent for \textsc{Root}-Based High Energy Physics Analysis](https://arxiv.org/abs/2605.17318)
*Aman Desai*
...
### [52] [Investigating the mass spectra of $1F$-wave singly heavy $Σ_{Q}$, $Ξ^{\prime}_{Q}$, and $Ω_{Q}$ baryons](https://arxiv.org/abs/2605.17322)
...
### [53] [An Analysis on the Parton Distribution Functions of Heavy Mesons](https://arxiv.org/abs/2605.17389)
*Satyajit Puhan*
...
### [54] [Collective response and noise of a levitated ferromagnet lattice for ultralight dark matter detection](https://arxiv.org/abs/2605.17417)
...
### [55] [Entanglement Maximization and Symmetry Selection in Composite Higgs Models](https://arxiv.org/abs/2605.17434)
...
### [56] [Comprehensive investigation of nucleon decays into one lepton plus two mesons](https://arxiv.org/abs/2605.17525)
...
### [57] [Higher excited charmed and charmed-strange mesons in an unquenched quark model](https://arxiv.org/abs/2605.17832)
...
### [58] [MAGE-HEP: Monte Carlo Analysis and Graphical Environment for High-Energy Physics](https://arxiv.org/abs/2605.17871)
...
### [59] [Branching ratios and CP violations of $B \toρ(ω) γ$ decays in the modified perturbative QCD approach and the relevant dark photonic decays of $B\to ρ(ω) γ^\prime $](https://arxiv.org/abs/2605.17943)
...
### [60] [Helicity effects in the dynamically assisted Schwinger mechanism](https://arxiv.org/abs/2605.18027)
...
### [61] [Compact $cs\bar{s}\bar{s}$ Tetraquarks in the Charm--Strange Sector: Mass Spectra, Rearrangement Decays and Regge Trajectories with $D_s$ Threshold Inputs](https://arxiv.org/abs/2605.18075)
...
### [62] [The Triadic Texture: Neutrino Predictions, Viable Vacuum, and Phenomenological Constraints](https://arxiv.org/abs/2605.18154)
...
### [63] [Positivity of the effective range for finite range attractive potentials with a repulsive core](https://arxiv.org/abs/2605.18207)
*Davide Germani*
...
### [64] [Two-body decays of radially excited $η(1295)$ and $η(1475)$ mesons in the extended NJL model](https://arxiv.org/abs/2605.18270)
...
### [65] [Gravitational form factors of light mesons from Basis Light-Front Quantization](https://arxiv.org/abs/2605.18350)
...
### [66] [Nested-GPT for variable-multiplicity parton showers: A case study in the resummation of non-global logarithms](https://arxiv.org/abs/2605.18360)
...
### [67] [Probing SMEFT Operators through $t\bar{t}t\bar{t}$ Production with Hyper-Graph Neural Networks at the LHC](https://arxiv.org/abs/2605.18382)
...
### [68] [Quantum enhanced identification of boosted jets with quantum graph neural networks](https://arxiv.org/abs/2605.18416)
...
### [69] [Quark and gluon tomography of the helium-4 nucleus](https://arxiv.org/abs/2605.18519)
...
### [70] [Final-state rescattering in $\bar{B}^{0}_{(s)}\to Λ^{+}_{c}\barΛ^{-}_{c}$ decays](https://arxiv.org/abs/2605.18574)
...
### [71] [Markov chain Monte Carlo (MCMC) based Likelihood Extraction of Chiral-Odd Compton Form Factors from Deeply Virtual Exclusive Experiments](https://arxiv.org/abs/2605.18589)
...
### [72] [NLO EW and QCD dimension-6 SMEFT results for Higgs and gauge boson decays in POPxf format](https://arxiv.org/abs/2605.18679)
...
### [73] [Sensitivity of MAGIX@MESA to BSM effects via Bethe-Heitler pair production](https://arxiv.org/abs/2605.18718)
...
### [74] [Polarization Birefringence and Waveform Systematics in GW231123](https://arxiv.org/abs/2605.16425)
...
### [75] [The pair-instability origin of supernova 2023vbw](https://arxiv.org/abs/2605.16487)
...
### [76] [The interaction phase of engine-driven explosions and high-energy winds](https://arxiv.org/abs/2605.16490)
...
### [77] [A 14-year-old Mystery: The Peculiar Case of the Engine-driven SN 2012ap](https://arxiv.org/abs/2605.16495)
...
### [78] [Neutrino Flavor Conversion Shapes the Rate of Failed Core-collapse Supernovae](https://arxiv.org/abs/2605.16504)
...
### [79] [Is the Binary Black Hole Population Inference from Gravitational-Wave Data Robust?](https://arxiv.org/abs/2605.16510)
...
### [80] [Probing the Mass-loss Histories of Type IIn and II-L Supernovae with Late-time Radio Observations](https://arxiv.org/abs/2605.16546)
...
### [81] [The Torques Acting on Accreting Millisecond X-Ray Pulsars in the Outburst and Quiescent States, and During the Long-Term Evolution](https://arxiv.org/abs/2605.16670)
...
### [82] [Multiwavelength Probes of Cosmic Ray Transport in Molecular Cloud Structures](https://arxiv.org/abs/2605.16698)
...
### [83] [XRISM detection of the 6.4 keV Fe K$α$ line in the radio galaxy Cygnus A](https://arxiv.org/abs/2605.16766)
...
### [84] [Simulation study of the cosmic ray Sun shadow with a time-dependent solar magnetic field model](https://arxiv.org/abs/2605.16898)
...
### [85] [SN 2023dbc in M108: Optical and Near-Infrared Observations of a Highly-Obscured, Moderately Energetic Stripped-Envelope Supernova](https://arxiv.org/abs/2605.16916)
...
### [86] [Nonlinear electrodynamics in magnetars: systematic effects on radius constraints and timing analysis](https://arxiv.org/abs/2605.17048)
...
### [87] [Jet-Structure Imprint on the Curvature Tail of Gamma-Ray Burst Prompt Emission](https://arxiv.org/abs/2605.17060)
...
### [88] [Identifying observable MeV lines from the decays of weak and main $r$-process isotopes in mergers](https://arxiv.org/abs/2605.17213)
...
### [89] [Radio Emission from Fast Blue Optical Transients Powered by Trans-relativistic Shocks in Confined Circumstellar Material](https://arxiv.org/abs/2605.17280)
...
### [90] [Understanding corona and disk evolution in black hole X-ray binaries through a comprehensive study of their broadband variability and QPO characteristics](https://arxiv.org/abs/2605.17344)
...
### [91] [Precise and Rapid Parameter Inference of Kilonova with Conditional Variational Autoencoder](https://arxiv.org/abs/2605.17377)
...
### [93] [Accretion geometry and spectral evolution in 1A 1118-61: a comparison of the 2009 and 2026 outbursts](https://arxiv.org/abs/2605.17455)
...
### [94] [GRMHD Simulations of Magnetized Accretion Disk/Jet: Variabilities of Black Holes and Spectral Energy Distributions in Magnetic States](https://arxiv.org/abs/2605.17460)
...
### [95] [Population synthesis of active galactic nuclei based on the radiation-regulated unification model](https://arxiv.org/abs/2605.17547)
...
### [96] [Charged-current neutrino opacity within the relativistic Hartree-Fock framework for astrophysical simulations of core-collapse supernovae and binary neutron star mergers](https://arxiv.org/abs/2605.17563)
...
### [97] [Diffuse gamma-ray emission in the vicinity of open cluster Berkeley 87](https://arxiv.org/abs/2605.17636)
...
### [98] [Classification of IGR J20084+3221 as an Intermediate Polar using X-ray and Optical Observations](https://arxiv.org/abs/2605.17735)
...
### [99] [The First Insights into an Ultraluminous X-ray Pulsar with XRISM: Phase-Resolved High-Resolution Spectroscopy of the Fe K-shell Band of M82 X-2](https://arxiv.org/abs/2605.17786)
...
### [100] [Higher-order statistics of the stochastic gravitational wave background from supermassive black hole binaries](https://arxiv.org/abs/2605.17983)
...
### [101] [Search for the Highest-energy Quasiperiodic Oscillation in the Black Hole X-Ray Binary Candidate Swift J1727.8-1613](https://arxiv.org/abs/2605.18050)
...
### [102] [Spectral energy-loss bump and $γ$-ray pulsar halos](https://arxiv.org/abs/2605.18122)
*Kun Fang*
...
### [103] [Anisotropic Ejecta from Binary Neutron Star Mergers: Self-Consistent Main Thermal and Late-Time Radio Emission of NS-Powered Kilonovae](https://arxiv.org/abs/2605.18129)
...
### [104] [Sub-stellar Strange Quark Matter Objects: Predicting a New Class of Highly-Compact Candidates](https://arxiv.org/abs/2605.18260)
...
### [105] [Two kinds of Galactic source populations could explain the cosmic-ray observation up to the "knee" region](https://arxiv.org/abs/2605.18266)
...
### [106] [A Three-Dimensional Exploration of Magnetic Fields, Rotation, and Shock Revival in a $39 M_\odot$ Core-Collapse Supernova Progenitor](https://arxiv.org/abs/2605.18347)
...
### [107] [Iron line diagnostics of the stellar wind in X1908+075](https://arxiv.org/abs/2605.18427)
...
### [108] [A 4200-hour HyperFlash and ÉCLAT campaign on the hyperactive FRB 20240114A: constraining energetics with the most brilliant bursts](https://arxiv.org/abs/2605.18513)
...
### [109] [Pulse profile modelling of the 2024 outburst of the accreting millisecond pulsar SRGA J144459.2-604207](https://arxiv.org/abs/2605.18731)
...
### [110] [A universal framework to identify eccentric binary mergers: GW200105 case study](https://arxiv.org/abs/2605.18742)
...
### [111] [Mosaic: Area-Closed Spherical Surface Mosaics Induced by Cartesian Grids](https://arxiv.org/abs/2605.16422)
...
### [112] [The EDGES Analysis Pipeline: Description and Validation](https://arxiv.org/abs/2605.16643)
...
### [113] [Extracting redshifts from 2D slitless spectroscopic images using deep learning for the CSST galaxy survey](https://arxiv.org/abs/2605.16762)
...
### [114] [Stellar Density Classification and Regression for CSST Multi-color Imaging Using Deep Learning](https://arxiv.org/abs/2605.17445)
...
### [115] [Accelerating Redshift-Conditioned Galaxy Image Synthesis with One-step Generative Modeling](https://arxiv.org/abs/2605.17546)
...
### [116] ['Unacceptable to our people': Diverse cultural beliefs, Indigenous rights, and the future of human activities on the Moon](https://arxiv.org/abs/2605.17706)
*John C. Barentine*
...
### [117] [Impact of Satellite Constellations on Observations with the 80-cm Telescope and the Mini-SiTian at the Xinglong Observatory, NAOC](https://arxiv.org/abs/2605.17948)
...
### [118] [Photometric classification of quasars from DES and photo-$z$ estimation with Machine Learning](https://arxiv.org/abs/2605.18218)
...
### [119] [Datacubes of H$α$, CaII K, CaII H and H$ε$ line profiles of the full solar disk recorded daily at Meudon observatory since 2017 and some typical profiles of solar features](https://arxiv.org/abs/2605.18499)
*Jean-Marie Malherbe*
...
### [120] [Towards the Deployment of the First NectarCAM, a Medium-Sized-Telescope Camera for the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2605.18596)
...
### [121] [The Wide Field Imager (WFI) Instruments for the Polarimeter to Unify the Corona and Helliosphere (PUNCH)](https://arxiv.org/abs/2605.18706)
...
### [122] [WaveDriver: a Laser Guide Star AO System for HWO](https://arxiv.org/abs/2605.18723)
