...
### [1] [Extreme Sensitivity of Standard Model Vacuum Stability to Enhanced Scalar Couplings: Implications from Renormalization Group Equations and Radiatively Broken Electroweak Symmetry Scenario](https://arxiv.org/abs/2511.09601)
*Farrukh A. Chishtie,Sirous Homayouni*

Main category: hep-ph

TL;DR: The paper examines how the Higgs quartic coupling's slight changes affect the Standard Model's vacuum stability, finding a critical threshold at 3% where stability transitions occur, with implications for beyond-Standard-Model physics.


<details>
  <summary>Details</summary>
Motivation: To explore the extreme sensitivity of the Standard Model vacuum stability to the Higgs quartic coupling and its implications for understanding the electroweak scale and beyond-Standard-Model physics.

Method: The authors use three-loop renormalization group equations to analyze Higgs quartic coupling enhancement factors (k) from 1.0 to 7.2. They track how these enhancements affect vacuum stability and the emergence of UV Landau poles.

Result: A critical enhancement factor k_criter=1.03 is identified where vacuum stability transitions occur. For k>1.03, absolute stability exists with UV poles indicating EFT breakdown, linking radiative symmetry breaking to strong dynamics near the GUT scale.

Conclusion: The proximity of the observed Higgs mass to the metastability boundary makes the scalar sector a sensitive probe for beyond-Standard-Model physics, emphasizing its role in uncovering new physics at high energies.
...
### [2] [Cosmological Limits on Strong Dark Forces](https://arxiv.org/abs/2511.09614)
*Peter W. Graham,Harikrishnan Ramani,Olivier Simon,Erwin H. Tanin*

Main category: hep-ph

TL;DR: The paper explores how cosmological observations can constrain long-range interactions between dark matter particles, focusing on a model where dark matter is a fermion interacting via a light scalar. By analyzing both background and perturbation dynamics, it identifies regions of parameter space where deviations from standard cold dark matter predictions are significant. Using existing cosmological constraints, the study sets the tightest limits yet on dark matter self-interactions below 100 kpc scales and also examines repulsive forces, yielding stricter constraints than previous work.


<details>
  <summary>Details</summary>
Motivation: To investigate the viability of long-range dark matter self-interactions that have not yet been constrained by existing experiments and observations, aiming to uncover new physics beyond standard cosmological models.

Method: The authors model a fermionic dark matter coupled via a Yukawa potential to a light scalar field. They simulate both background cosmological evolution and matter perturbations across parameter regions where dark forces exceed gravity's strength. Analysis of the attractor mechanism in the background dynamics and comparison with observables like the equation of state and small-scale perturbations enable exclusion of certain parameter spaces.

Result: Key findings include the discovery of an attractor mechanism that unifies diverse initial conditions into a unique evolutionary path for specific parameters. Significant deviations from cold dark matter are found in observable epochs across large parameter regions, which are excluded using existing constraints. The constraints on short-range (<100 kpc) self-interactions are the most stringent to date. Repulsive forces also yield tighter limits than previous studies.

Conclusion: Cosmological observations provide potent constraints on dark matter self-interactions beyond current experimental bounds. The study demonstrates the necessity of considering dynamical interactions in dark matter models and highlights the potential of cosmological probes to uncover beyond-standard physics in the dark sector.
...
### [3] [$L_μ-L_τ$ gauge bosons in beam dumps and supernovae](https://arxiv.org/abs/2511.09619)
*Nikita Blinov,Patrick J. Fox,Kevin J. Kelly,Ryan Plestid,Tao Zhou*

Main category: hep-ph

TL;DR: The paper examines a sub-GeV Lμ-Lτ gauge boson, addressing discrepancies in SHiP experiment projections and supernovae cooling constraints. It evaluates beam dump production modes and re-examines SN1987A-based bounds along with other supernova-related probes.


<details>
  <summary>Details</summary>
Motivation: To correct inconsistencies in previous studies regarding the sensitivity of the SHiP experiment and supernova cooling constraints, and to explore additional observational probes for the Lμ-Lτ boson.

Method: Quantitative analysis of beam dump production modes, re-evaluation of SN1987A cooling bounds, and examination of diffusive cooling, low-energy supernovae existence, and high-energy neutrino signal absence from SN1987A.

Result: Identified discrepancies in prior SHiP sensitivity projections and supernovae constraints; provided refined analyses of production mechanisms and supernova-based observational limits.

Conclusion: The study enhances understanding of sub-GeV Lμ-Lτ boson phenomenology by clarifying experimental and astrophysical constraints, offering improved frameworks for future searches and interpretations.
...
### [4] [Ultralight Dark Matter from the Edge of Field Space](https://arxiv.org/abs/2511.09622)
*Mathias Becker,Francesco D'Eramo,Ville Vaskonen*

Main category: hep-ph

TL;DR: The paper introduces wallions, a new bosonic dark matter candidate with field-space boundaries, which have exponentially suppressed mass and radiative stability. They explore their cosmological evolution and experimental detection via instanton effects.


<details>
  <summary>Details</summary>
Motivation: To propose a novel dark matter candidate that addresses limitations of existing models by incorporating field-space boundaries, ensuring mass suppression and stability against self-interactions.

Method: The study examines the properties of wallions, including mass suppression mechanisms and radiative stability. It analyzes early-universe evolution and cosmological signatures. Instanton effects are explored as a means to generate field-space boundaries, and potential experimental probes are discussed.

Result: Wallions demonstrate viable cosmological behavior with stable mass properties and possible observable manifestations through their interactions with Standard Model fields.

Conclusion: Wallions represent a promising dark matter model with unique features, offering testable predictions for future experiments and cosmological observations.
...
### [5] [Entanglement, Yang-Mills, and the Scattering Matrix as an SU(N)-equivariant Kernel](https://arxiv.org/abs/2511.09623)
*Kun-Feng Lyu,Rahul Muraleedharan,Kuver Sinha*

Main category: hep-ph

TL;DR: The paper explores the entanglement generated in two-body scattering processes within SU(N) symmetry using representation theory, linking color dynamics to operator algebras and demonstrating that Yang-Mills theories exhibit universal maximum entanglement values independent of kinematics. Entanglement properties are shown to constrain effective field theory operators and uniquely identify Yang-Mills couplings through entanglement preservation.


<details>
  <summary>Details</summary>
Motivation: To understand how scattering processes in SU(N)-equivariant systems generate entanglement, separate group structure from dynamics, and identify universal features in entanglement measures across different representations and higher-dimensional operators.

Method: Analyzing scattering as SU(N)-equivariant maps between tensor-product representations, decomposing operator algebras to quantify entangling power. Applying representation theory to track invariant subspaces in fundamental vs. adjoint representations, employing color-kinematics duality in Yang-Mills to determine color kernel behavior, and analyzing dimension-six/eight operators' impact on entanglement universality.

Result: Fundamental representation scattering only preserves separability in identity/swap directions; adjoint scattering is inherently entangling with larger invariant algebra. Yang-Mills scattering at right angles yields universal max entanglement (0.75 for SU(2), ~0.91 for SU(3)), independent of kinematics. Higher-dimension operators break universality by populating new color sectors. Helicity entanglement constraints uniquely select Yang-Mills couplings through color Jacobi identity enforcement.

Conclusion: Entanglement in color/helicity spaces provides a unifying framework to study algebraic/dynamical aspects of scattering, offering tomographic insights into effective field theory and revealing information-theoretic principles underlying gauge theories.
...
### [6] [A new approach to determine the thermodynamics of deconfined matter to high accuracy](https://arxiv.org/abs/2511.09627)
*Tyler Gorda,Pablo Navarrete,Risto Paatelainen,Leon Sandbote,Kaapo Seppänen*

Main category: hep-ph

TL;DR: The paper proposes a new method combining phase-quenched lattice simulations and perturbation theory to accurately determine QCD thermodynamics at finite density and high temperatures, achieving precision beyond current standards by including nonperturbative gluonic contributions.


<details>
  <summary>Details</summary>
Motivation: To address the challenges in calculating QCD thermodynamics in regions where α_s is small but nonperturbative effects are present, providing a precise approach across a wide phase diagram arc.

Method: Phase-quenched (PQ) lattice simulations combined with perturbation theory up to O(α_s^{7/2}), using electrostatic QCD and a novel numerical method for four-loop sum-integrals to compute pressure differences between PQ and full QCD.

Result: The method successfully suppresses nonperturbative PQ pairing effects, allowing the perturbative QCD pressure to be determined with higher precision, incorporating nonperturbative gluonic contributions from lattice data.

Conclusion: This approach offers a powerful tool for exploring QCD thermodynamics in a wide parameter range, surpassing previous precision limits and integrating both perturbative and nonperturbative elements effectively.
...
### [7] [Freezing-in the Axiverse](https://arxiv.org/abs/2511.09631)
*Christopher Dessert,Soubhik Kumar,Joshua T. Ruderman*

Main category: hep-ph

TL;DR: The paper examines scenarios with multiple light axions in the Standard Model (SM) and their impact on $N_{\rm eff}$, the number of relativistic degrees of freedom. Using an effective field theory (EFT) approach with dimension-six operators, including a newly identified charge radius operator, it explores how different flavor structures (anarchy, textures, minimal flavor violation) affect the detectability of these axions via cosmic microwave background (CMB) experiments like Simons Observatory and CMB-HD.


<details>
  <summary>Details</summary>
Motivation: Many UV scenarios predict multiple (~10-100) light axions weakly interacting with the SM. However, their collective presence challenges the stringent constraints on $N_{\rm eff}$. The goal is to understand how these axions can evade such constraints without committing to a specific UV completion, while assessing detectability by current/future experiments.

Method: An EFT framework is used to parametrize axion-SM interactions considering operators up to dimension six. A novel charge radius operator is identified. The study systematically addresses different flavor structures (anarchy, textures, minimal flavor violation), calculating their contributions to $N_{\rm eff}$ and evaluating discovery potential through CMB data analysis.

Result: The discovery potential for axion scenarios via CMB experiments is highly dependent on the flavor structure assumed. Specific EFT scenarios (e.g., anarchy) allow observable signals in upcoming surveys, while others may remain undetectable. Terrestrial and astrophysical probes complement CMB measurements to constrain these models.

Conclusion: The presence of multiple light axions can potentially reconcile theoretical UV scenarios with $N_{\rm eff}$ constraints, but detection critically depends on their flavor coupling structures. Future CMB surveys combined with other probes offer a robust path to explore these scenarios and distinguish between different flavor models.
...
### [8] [Octet scalars shaping LHC distributions in 4-jet final states](https://arxiv.org/abs/2511.09632)
...
### [9] [The Unresolved Behaviour of Polarized Scattering Matrix Elements at NNLO in QCD](https://arxiv.org/abs/2511.09691)
...
### [10] [CP violation](https://arxiv.org/abs/2511.09739)
*Alexey A Petrov*

Main category: hep-ph

TL;DR: The article provides an introduction to CP violation, its role in explaining matter-antimatter asymmetry, and its insufficiency within the Standard Model for baryogenesis, highlighting the need for new physics beyond the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To explain the observed matter-antimatter asymmetry in the universe, which cannot be fully accounted for by the Standard Model's predicted level of CP violation, and to introduce foundational concepts for further exploration of new physics.

Method: Pedagogical exposition of C, P, T, and CP symmetries; discussion of CP violation sources in the Standard Model (complex CKM matrix phases); and examination of its implications for baryogenesis and potential new physics contributions.

Result: CP violation in the Standard Model is insufficient for baryogenesis, necessitating exploration of additional CP violation sources beyond the Standard Model.

Conclusion: CP violation remains a critical area for probing new physics beyond the Standard Model to resolve discrepancies in matter-antimatter asymmetry explanations.
...
### [11] [Searching for screened scalar forces with long-baseline atom interferometers](https://arxiv.org/abs/2511.09750)
*Hannah Banks,John Carlton,Benjamin Elder,Thomas Hird,Christopher McCabe*

Main category: hep-ph

TL;DR: The paper proposes a novel method using a 10-meter-long atom interferometer with an annular planar source mass to detect screened fifth forces from dark-sector models, addressing key challenges through the Q-flip protocol and in-situ calibration, potentially improving bounds on chameleon and symmetron models by 1-1.5 orders of magnitude.


<details>
  <summary>Details</summary>
Motivation: Screened scaler particles in dark-sector models evade experimental detection via density-dependent screening but predict detectable fifth forces. Current experiments are limited, necessitating a new approach to access previously unconstrained parameter spaces.

Method: The method involves constructing a 10-meter atom interferometer with an annular source mass to create a spatially varying density environment. The Q-flip protocol alternates interferometry sequences to tag the static fifth force signal, while an in-situ calibration maps gravity effects from the plate, isolating the fifth force signal.

Result: Simulations and analysis show the proposed setup could surpass existing bounds on chameleon and symmetron models by 1-1.5 orders of magnitude, achieving shot-noise-limited sensitivity through effective noise rejection.

Conclusion: This approach significantly enhances sensitivity to screened fifth forces, being applicable to next-gen experiments like AION-10/VLBAI and adaptable to other models/baseline lengths, providing a path to testing fundamental physics predictions in dark-sector theories.
...
### [12] [Semi-visible higgs decay as a probe for new invisible particles](https://arxiv.org/abs/2511.09778)
*Sally Dawson,Arnab Roy,German Valencia*

Main category: hep-ph

TL;DR: The paper analyzes the HL-LHC's sensitivity to new invisible particles (scalars and fermions) via semi-visible Higgs decays, focusing on masses below 50 GeV. Using a dark-SMEFT framework with dimension-six operators and a Z2 symmetry, it compares results with Z-boson width constraints and unitarity limits, while proposing kinematic LHC strategies to distinguish particle interactions.


<details>
  <summary>Details</summary>
Motivation: To explore the discovery potential of the HL-LHC for low-mass invisible particles (≲50 GeV) inaccessible via standard collision channels, leveraging Higgs decays where only one visible particle exists, and to evaluate the superiority of this approach over existing methods like Z-boson width measurements and unitarity bounds.

Method: The analysis employs a dark-SMEFT effective theory with dimension-six operators and Z2 symmetry, simulating semi-visible Higgs decays. It compares constraints derived from this method against those from invisible Z-boson decays and perturbative unitarity arguments. LHC kinematic strategies are outlined to differentiate operator structures.

Result: HL-LHC can probe new invisible particle masses below 50 GeV effectively via semi-visible Higgs decays, offering sensitivity beyond Z-width and unitarity-based limits. Distinct kinematic signatures allow discrimination of different operator contributions.

Conclusion: Semi-visible Higgs decays provide a powerful probe for low-mass invisible particles at HL-LHC. Future experiments should prioritize these decay channels and employ specified kinematic techniques to distinguish interaction types, enhancing prospects for beyond-Standard-Model physics discoveries.
...
### [13] [Beam polarization precision requirements for future $e^+e^-$ Higgs factories](https://arxiv.org/abs/2511.09851)
*Brendon Madison*

Main category: hep-ph

TL;DR: The paper evaluates the minimum polarization precision needed for future $e^+e^-$ Higgs factories, highlighting the critical role of positron polarization. Depending on measurement type, higher positron polarization either reduces or increases required precision. Key experiments like Higgsstrahlung and electron asymmetry require polarization precisions of 0.1% and 0.02%, respectively, or higher polarization values.


<details>
  <summary>Details</summary>
Motivation: Determine the necessary beam polarization precision levels for future Higgs factories to ensure accurate measurements of critical observables like $σ_{ZH}$, $A_{m e}$, and $σ_{γγ}$, considering both electron and positron polarization effects.

Method: Analysis of polarization dependencies on measurements scaling with effective polarization ($P_	ext{eff}$) versus product of polarizations ($P_-P_+$). Calculate precision thresholds for specific experiments, assessing scenarios where polarization values approach 100%.

Result: Positron polarization significantly impacts required precision: for $P_	ext{eff}$-dependent measurements, higher $P_+$ reduces precision needs (e.g., 0.1% for off-Z pole experiments). For $P_-P_+$-related observables like $A_{m e}$, stricter precision (0.02%) or higher polarization (>98%) is needed. Thresholds validated for $σ_{ZH}$ (1e-3), $A_{m e}$ (1e-4), $σ_{γγ}$ (1e-4).

Conclusion: Future colliders must prioritize achieving positron polarization close to 100% or exceptional polarization precision (<0.02%) to satisfy demanding experimental requirements, particularly for Z-pole asymmetry measurements. Strategies balancing beam optimization and precision are essential.
...
### [14] [Sifting out the neutral and charged components of $X(3872)$ from a spin observable](https://arxiv.org/abs/2511.09981)
...
### [15] [Masses of Purely Top-Quark Bound States: Toponium and the Triply-Top Baryon](https://arxiv.org/abs/2511.10053)
*Z. Rajabi Najjar,K. Azizi*

Main category: hep-ph

TL;DR: The study examines top quark-related particle states using QCD sum rules, confirming possible bound states and guiding future experiments.


<details>
  <summary>Details</summary>
Motivation: To analyze recent CMS and ATLAS observations of a pseudoscalar enhancement near the t-tbar threshold, which suggests the existence of bound states requiring theoretical validation.

Method: QCD sum-rule method considering both perturbative and nonperturbative (up to dimension 8 operators) contributions to calculate properties of η_t, ψ_t, and Ω_{ttt} states.

Result: Pseudoscalar η_t results align with CMS predictions within uncertainties; both η_t and ψ_t show negative binding energies indicating strong t-tbar correlations, confirming them as potential bound states.

Conclusion: These findings provide essential theoretical groundwork for experimental searches at LHC and future colliders like FCC, emphasizing importance of top quark systems in particle physics research.
...
TL;DR: The paper explores how axion-trapped misalignment models with finite-temperature potential barriers generate gravitational waves (GWs) through a resonant instability as the universe cools. The study finds that this mechanism enhances GW signals by up to two orders of magnitude compared to standard models, though such strong signals coincide with correct dark matter abundance in limited parameter ranges.


<details>
  <summary>Details</summary>
Motivation: To understand novel GW production mechanisms in early universe scenarios involving axion dynamics, specifically addressing how finite-temperature effects influence axion fragmentation and its observational signatures.

Method: The authors analyze the evolution of axion field dynamics in a temperature-dependent potential, focusing on the instability-driven fragmentation process as the universe cools. They derive equations of motion for inhomogeneities, compute the induced GW spectra through gravitational coupling, and compare spectral features with standard scenarios.

Result: The model predicts an enhanced GW amplitude (up to 100x increase) with distinct spectral shapes compared to zero-temperature fragmentation. The peak frequency and amplitude of the GW signal are directly tied to the temperature-dependent potential parameters.

Conclusion: While finite-temperature axion fragmentation offers a significant GW signal boost, the required parameter space that matches both dark matter density and detectable GWs is constrained. This suggests potential testable predictions for future gravitational wave observatories.
...
TL;DR: The paper evaluates the potential of the μTRISTAN experiment in probing LLPs from Higgs boson decays, showing its capability to set stronger bounds on exotic Higgs branching ratios compared to HL-LHC but not surpassing future LHC far detectors.


<details>
  <summary>Details</summary>
Motivation: To assess the effectiveness of the μTRISTAN experiment's asymmetric μ+ e− collider configurations in detecting LLPs from Higgs decays, leveraging their boosted production to improve detection efficiency and set tighter constraints on beyond-Standard-Model physics.

Method: Analyzed proposed μTRISTAN runs at energy configurations {1 TeV, 30 GeV} and {3 TeV, 50 GeV}, calculating LLP signal sensitivities using far detector placement along the beamline to capture decay products from long-lived particles, comparing projected bounds to HL-LHC and existing LHC far detector proposals like CODEX-b, ANUBIS, and MATHUSLA.

Result: μTRISTAN's boosted events allow collecting a large LLP flux, enabling stronger constraints on Higgs branching ratios for certain LLP decay modes in the large proper decay length regime than HL-LHC. However, it cannot exceed the sensitivity of upcoming LHC-based far detectors.

Conclusion: While μTRISTAN offers notable improvements over HL-LHC in probing specific LLP scenarios, its reach is limited compared to dedicated LHC far detector experiments, highlighting the complementary roles of different experimental approaches in exploring BSM physics.
...
TL;DR: The paper explores the one-pion exchange interaction between the kaon and vector antikaon, identifying new bound states and resonance states in the K K̄* system, and extends this method to the D D̄* system, suggesting spin and parity properties of certain charmonium candidates.


<details>
  <summary>Details</summary>
Motivation: To investigate the existence of bound and resonance states in meson-meson systems (K K̄*, D D̄*) through Schrödinger equation solutions, potentially explaining particle data group entries and charmonium states.

Method: Solving the Schrödinger equation in S-wave approximation for K K̄* and D D̄* systems, using one-pion exchange potential to calculate binding energies and resonance states under outgoing wave conditions.

Result: Found a new bound state f₁(1378) in K K̄*, potential identification of f₁(1420) as two resonance states, and in D D̄* system, predicted states corresponding to χ_{c1}(3872), T_{c̄c1}(3900), T_{c̄c}(4020), and X(3940) with J^P=1⁺.

Conclusion: The method confirms the presence of multiple resonances and bound states in both systems, supporting their identification with known particles and proposing spin/parity assignments for charmonium candidates via Schrödinger solutions under specific potentials.
...
TL;DR: The discovery of a substructure in ψ(3686) decays indicates di-pion correlations, confirmed via chiral unitary model analysis.


<details>
  <summary>Details</summary>
Motivation: To explain the unexpected substructure observed in π+π- mass spectrum from ψ(3686) decay and challenge previous understanding.

Method: Applying chiral unitary approach to model di-pion interactions and reproduce the observed anomaly.

Result: Successful reproduction of the π+π- mass threshold substructure, confirming di-pion correlations exist in heavy quarkonium decays.

Conclusion: Di-pion correlations are a significant factor in quarkonium decay dynamics, requiring revision of prior theoretical models.
...
TL;DR: The paper presents an updated analysis of two-body charm decays D → PV using the factorization-assisted topological-amplitude (FAT) approach, incorporating SU(3) symmetry breaking. New high-precision data allows quantification of nonfactorizable contributions in T, C, E, and A diagrams, leading to improved parameters and CP asymmetry predictions for future experiments.


<details>
  <summary>Details</summary>
Motivation: To leverage new high-precision experimental data to refine the FAT approach analysis of D → PV decays, better quantify nonfactorizable effects, and improve predictions for branching ratios and CP asymmetries in charm sector decays.

Method: Extended FAT framework with SU(3) symmetry breaking incorporated into topological amplitudes; global fit to experimental data determines universal parameters for diagrams. Focus on nonfactorizable contributions of T, C, E, and A diagrams, resulting in updated parameters with improved precision.

Result: Quantified nonfactorizable T diagram contributions critical for branching ratios. Updated C, E, A parameters show significantly different strong phases vs prior FAT analysis. Predictions match current data, with CP asymmetries at O(10^-3) for select modes. Provides testable predictions for unobserved decays (BR ~ 10^-4-10^-3).

Conclusion: Enhanced precision in charm sector analysis enables accurate predictions for future experiments like LHCb, BESIII, and Belle II. Highlights CP asymmetry observables as key targets, emphasizing updated parameters' role in resolving discrepancies and guiding experimental pursuits.
...
TL;DR: The paper explores the implications of $SU(2)_F$ bosons in a $U(2)_F$ flavor model, analyzing both PNGBs and light gauge bosons with unsuppressed flavor-violating interactions. It derives constraints on flavor symmetry breaking scales using meson and lepton decays, showing that low-energy experiments can probe scales beyond astrophysical limits.


<details>
  <summary>Details</summary>
Motivation: The motivation is to study unexplored $SU(2)_F$ boson states in a flavor model that combines a QCD axion-like $U(1)_F$ PNGB with either PNGBs from a global symmetry or light gauge bosons from a gauge symmetry. Previous studies have not addressed the unique flavor-violating properties of the $SU(2)_F$ degrees of freedom, which naturally allow unsuppressed couplings to SM fermions.

Method: The method involves analyzing two scenarios: (1) $SU(2)_F$ as a global symmetry producing PNGBs, (2) $SU(2)_F$ as a gauge symmetry with weak coupling yielding light triplet gauge bosons. The authors calculate predictions for flavor-changing neutral currents (FCNC) and lepton flavor violation (LFV), focusing on decays like $K → πX$, $μ → eX$, and constraints from $K-\bar{K}$ mixing and $μ → eγ$. The theoretical framework includes deriving interactions, decay rates, and symmetry breaking scale bounds.

Result: Key results are stringent constraints on the flavor symmetry breaking scale $v_φ$ up to $10^{11}-10^{12}$ GeV from light boson scenarios (via $K$ and μ decays), while heavier bosons are probed via $B/τ$ decays. The work demonstrates that low-energy flavor experiments surpass astrophysical limits in testing ultra-high energy symmetry breaking scales.

Conclusion: The conclusion highlights that low-energy flavor experiments provide a critical and powerful probe of $U(2)_F$ models, capable of exploring symmetry breaking scales beyond what astrophysics allows. This underscores the importance of upcoming flavor experiments in testing fundamental flavor symmetries and their associated boson sectors.
...
TL;DR: The paper introduces a comprehensive framework for analyzing flavored dark matter models, integrating relic density, detection limits, collider data, and flavor physics. It applies to scalar/fermionic DM, testing two scenarios with Majorana DM coupled to leptons/quarks. Results show that lepton-coupled DM has less constrained parameter space, while quark-coupled DM requires hierarchical couplings. Public tools are provided.


<details>
  <summary>Details</summary>
Motivation: To systematically study flavored dark matter models by unifying multiple experimental and observational constraints, ensuring a consistent analysis across particle physics frontiers.

Method: Combining relic density calculations, direct/indirect detection limits, collider constraints, and a global SMEFT analysis with RG evolution to assess flavor observables. Focus on Majorana DM interacting via right-handed leptons or down-type quarks, assuming thermal freeze-out.

Result: In leptophobic DM, flavor-violating decays like μ→eγ set primary limits but LHC allows significant parameter space. For quark-coupled DM, direct detection and meson mixing require hierarchical couplings. Public toolchain enables further research.

Conclusion: Flavored dark matter models must satisfy diverse constraints across particle physics. Hierarchical couplings are favored for quark interactions. The framework offers a robust platform to evaluate future experimental possibilities.
...
TL;DR: A new mechanism dissipates axion kinetic energy via interactions with dark magnetic monopoles, leading to the QCD axion and monopoles explaining dark matter and baryon asymmetry. The axion decay constant is predicted to be under 1e9 GeV.


<details>
  <summary>Details</summary>
Motivation: To explain dark matter abundance and baryon asymmetry within a unified framework using axions and dark monopoles.

Method: The mechanism involves monopoles acquiring mass from the axion field and transitioning between dyonic states when interacting with a rotating axion field, dissipating axion kinetic energy and reducing axion abundance.

Result: The model predicts an axion decay constant <1e9 GeV to match observed dark matter and baryon densities.

Conclusion: This mechanism offers a consistent explanation for both dark matter and baryogenesis, linking axion dynamics with monopole interactions.
...
### [30] [Changing-Look AGN Powered By Disk Tearing](https://arxiv.org/abs/2511.09626)
*Nicholas Kaaz,Matthew Liska,Charlotte Ward,Jordy Davelaar*

Main category: astro-ph.HE

TL;DR: The study explores whether the tearing of accretion disks around rotating black holes can explain the dramatic luminosity changes observed in changing-look active galactic nuclei (CLAGN). Using high-resolution simulations and synthetic observations, the research shows that disk tearing events cause significant variability in both continuum and broad line emissions on timescales matching CLAGN, with unique asymmetries in emission lines that could serve as evidence for this mechanism. Predictions for future detection via upcoming observatories are also made.


<details>
  <summary>Details</summary>
Motivation: To address the mystery behind the extreme luminosity variations in CLAGN, which current models struggle to explain, by investigating if disk-tearing events—a phenomenon from simulations of tilted accretion disks around rotating black holes—can reproduce the observed behaviors.

Method: The team ran a 3D general-relativistic magnetohydrodynamic simulation of a tilted, geometrically thin accretion disk around a rapidly rotating 10^8 solar mass black hole. They used ray-tracing to model light captured by a line-of-sight camera and a torus-like broad line region (BLR). The BLR's photoionization was computed to generate spectra, analyzing both continuum and emission line variability over different timescales.

Result: Simulations revealed order-of-magnitude swings in continuum and line luminosities over months-years, plus shorter weekly variations from inner disk precession and intraday oscillations from radial disk breathing. Disk precession asymmetrically illuminated the BLR, causing red-to-blue line asymmetries—a potential signature of disk tearing. Predictions were made for upcoming observatories like ULTRASAT and Vera Rubin to detect such events.

Conclusion: Disk tearing around rotating black holes is a viable mechanism for CLAGN-like variability, offering explanations for observed luminosity swings and characteristic emission line asymmetries. Future observations with high time-resolution instruments could confirm this mechanism, reshaping our understanding of AGN accretion dynamics.
...
### [31] [Searching for Long-Period Radio Transients in ASKAP EMU Data with 10-Second Imaging](https://arxiv.org/abs/2511.09770)
...
TL;DR: The study conducted a large-scale search for long-period radio transients (LPTs) using ASKAP data but found none, instead identifying new stellar flares and establishing detection limits. This assesses the viability of current methods for LPT discovery.


<details>
  <summary>Details</summary>
Motivation: LPTs exist in a timescale gap between existing radio search methods, making them hard to detect. Increasing the known sample of LPTs can advance understanding of compact objects and emission mechanisms.

Method: Analyzed 200 hours of ASKAP archival data across 750 deg² with 10-second time resolution—the first large-scale LPT search using this setup. Used second-scale imaging to probe LPT timescales.

Result: No LPTs detected but discovered six stellar flares (one new to radio observations). Derived a transient surface density lower limit of 2.21×10⁻⁶ deg⁻² and sensitivity of 16.9 mJy at 10-second timescales.

Conclusion: Current ASKAP 10-second imaging has limited LPT detection capability. Results highlight needs for improved detection pipelines, longer integration times, and optimized observational strategies to better probe this poorly understood transient category.
...
### [32] [Simulating the Diffuse Neutrino Emission from the Milky Way with GALPROP](https://arxiv.org/abs/2511.09777)
*P. D. Marinos,T. A. Porter,G. P. Rowell,I. V. Moskalenko,G. Jóhannesson*

Main category: astro-ph.HE

TL;DR: The paper uses the GALPROP framework to model Galactic diffuse neutrino and gamma-ray emissions, showing consistency with IceCube and LHAASO data, and provides new models for future neutrino searches.


<details>
  <summary>Details</summary>
Motivation: To understand Galactic diffuse neutrino and gamma-ray emissions and validate models against observational data from IceCube and LHAASO up to PeV energies.

Method: The GALPROP cosmic ray propagation framework was used to create realistic bounding models. Predictions for neutrino and gamma-ray signals were compared with IceCube and LHAASO data, considering gamma-ray point source contamination.

Result: All GALPROP models are consistent with neutrino data within uncertainties and align with gamma-ray-derived neutrino expectations when accounting for contamination. The new models offer state-of-the-art predictions for VHE neutrino emissions.

Conclusion: The developed models are reliable for interpreting current data and guiding future neutrino detection experiments.
...
### [33] [A precessing magnetic jet as the engine of GRB 250702B](https://arxiv.org/abs/2511.09850)
*Tao An*

Main category: astro-ph.HE

TL;DR: GRB 250702B's ultra-long, episodic prompt emission and X-ray flare are explained by a black hole accreting from a misaligned debris disk, launching a precessing, structured jet with emission tied to disk precession and magnetic dissipation.


<details>
  <summary>Details</summary>
Motivation: To understand the unusual duration and episodic nature of GRB 250702B, which challenges standard models, by proposing a unified scenario involving black hole accretion and jet precession.

Method: Interpreting observational data through a model where Lense-Thirring precession of an inner torus drives the jet's episodic emission, with hard gamma-ray episodes from magnetic reconnection in the jet's spine and X-ray flare from the outer disk. Off-axis viewing and nutation explain missing pulses and apparent opening angle inconsistencies.

Result: The model accounts for the observed emission episodes (spaced ~2825s), the preceding X-ray flare, and resolves the 'missing pulses' issue via precession-induced beaming fluctuations, offering testable predictions.

Conclusion: The proposed mechanism provides a self-consistent explanation for GRB 250702B's anomalies, emphasizing the role of accretion physics and relativistic jet dynamics in extreme astrophysical events.
...
### [34] [Synchrotron radiation from NGC 470 HLX1 - a hidden hyperluminous accreting neutron star?](https://arxiv.org/abs/2511.10183)
*Tanuman Ghosh,Shiv Sethi,Gulab Chand Dewangan,Matteo Bachetti,Vikram Rana,Ranjeev Misra*

Main category: astro-ph.HE

TL;DR: The paper investigates the broadband spectrum of NGC 470 HLX-1, a hyperluminous X-ray source, and explores the possibility that its emission arises from synchrotron radiation from a magnetized neutron star under super-Eddington accretion. The presence of a blackbody-like component hints at disk or outflow processes near the corotation radius.


<details>
  <summary>Details</summary>
Motivation: To determine if synchrotron radiation from a neutron star magnetosphere can explain the observed variability and spectral features of HLX-1, and to understand particle acceleration and electron Lorentz factors under extreme accretion conditions.

Method: Broadband spectral modeling of NGC 470 HLX-1, analyzing synchrotron emission from a neutron star with varying magnetic field latitudes. The study also examines particle acceleration mechanisms and the role of blackbody components potentially linked to disks or outflows under super-Eddington accretion.

Result: The detected blackbody-like component suggests disk or outflow activity near the corotation radius. The viability of neutron star synchrotron emission as the primary mechanism opens new interpretations for HLX systems' energetics.

Conclusion: HLX-1's spectrum is consistent with a neutron star powering the emission via synchrotron radiation under super-Eddington conditions. This challenges the assumption that all HLXs are black holes, urging further studies to see if more HLXs might host neutron stars.
...
### [35] [Probing AGN Disks Density Profiles through Gravitational Wave Observations](https://arxiv.org/abs/2511.10204)
*Xiangyu Lyu,En-Kun Li,Changfu Shi,Yi-Ming Hu*

Main category: astro-ph.HE

TL;DR: The paper proposes using inspiralling stellar mass binary black holes with eccentric orbits in AGN disks to measure disk density profiles via space-borne gravitational wave detectors, achieving high precision (~2e-11 g/cm³) and opening a new method to study galactic center gas distributions.


<details>
  <summary>Details</summary>
Motivation: Current telescopes cannot directly and precisely measure AGN disk density profiles, so the paper seeks an alternative method leveraging gravitational waves from binary black holes in these disks.

Method: Track gravitational wave evolution from a binary black hole system embedded in an AGN disk with an eccentric orbit. Use multi-year space-borne detector observations to infer disk density by analyzing time-dependent environmental imprints in the waveform.

Result: Demonstrates that the density profile error can be constrained below 2e-11 g/cm³, enabling precise measurements of ρ(r) distributions in AGN disks.

Conclusion: Introduces a novel method to investigate galactic centers by recovering gas density profiles through gravitational wave analysis, offering unprecedented access to previously unmeasurable parameters in AGN environments.
...
### [36] [Curious Case of CGRaBS J0211+1051: Observational Evidence of Lepto-Hadronic Origin of High-Energy Emission?](https://arxiv.org/abs/2511.10329)
...
### [37] [Using the Cherenkov Telescope onboard EUSO-SPB2 for Target of Opportunity searches of very high energy neutrino sources](https://arxiv.org/abs/2511.10332)
*Tobias Heibges,Claire Guépin,Diksha Garg,Luke Kupari,Mary Hall Reno,Tonia M. Venters,Lawrence Wiencke*

Main category: astro-ph.HE

TL;DR: The EUSO-SPB2 mission aimed to detect VHE neutrinos via upward-moving air showers but lost its payload due to a balloon leak. The team developed a scheduling tool and calculated upper limits on neutrino fluences from observed sources, showing promise for future balloon-based follow-up observations.


<details>
  <summary>Details</summary>
Motivation: To search for optical signals of very-high energy (VHE) neutrinos, which could reveal astrophysical sources capable of accelerating particles to ultra-high energies.

Method: Used the Cherenkov Telescope (CT) pointed below Earth's limb to detect upward-moving air showers from tau-lepton decays. Implemented the Neutrino Target Scheduler for ToO observations.

Result: Payload loss limited data, but upper limits on neutrino fluences were calculated. Demonstrated feasibility of ToO campaigns in near-space via balloon missions.

Conclusion: Results highlight the potential of future missions like POEMMA-Balloon for effective VHE neutrino detection through coordinated follow-up observations.
...
### [38] [Disk warping and black hole X-ray binaries I. Tentative unification of low-frequency quasi-periodic oscillations](https://arxiv.org/abs/2511.10474)
...
TL;DR: This paper explores how frame-dragging effects from Lense-Thirring torques influence accretion disk dynamics and X-ray binary variability, proposing that geometric warps in the disk explain transitions between QPO types and BBN properties during outbursts, particularly in Cyg X-1.


<details>
  <summary>Details</summary>
Motivation: To address the lack of consensus on the origins of broad-band noise (BBN) and quasi-periodic oscillations (QPOs) in X-ray binaries, and to explore whether frame-dragging effects cause disk warps that drive these variability patterns during state transitions.

Method: Analytical estimates are used to model the impact of geometric warps in the inner accretion disk on spectral-timing properties, focusing on how warp dynamics during state transitions could explain observed QPO type transitions and BBN changes.

Result: The study shows that disk warps induced by frame-dragging can modify spectral-timing properties to match observed QPO transitions during outbursts, and suggests warps drive hard-to-soft state transitions in systems like Cyg X-1, unifying BBN and QPO variability explanations.

Conclusion: The proposed warp mechanism provides a coherent framework linking accretion disk dynamics via frame-dragging to observed X-ray binary variability, offering a path toward unifying the spectral-timing behavior of black hole X-ray binaries during state transitions.
...
### [39] [Shapiro Delay Measurements from Fifteen Years of PSR J1231$-$1411 Radio Observations](https://arxiv.org/abs/2511.10529)
...
### [40] [Constraining the nature of the most extreme Galactic particle accelerator. H.E.S.S. observations of the microquasar V4641 Sgr](https://arxiv.org/abs/2511.10537)
...
TL;DR: The study of V4641~Sgr using H.E.S.S. data reveals multi-TeV gamma-ray emission with a power-law spectrum peaking at 100 TeV, suggesting it as a cosmic-ray accelerator beyond the knee. Leptonic origin favored due to low magnetic field and lack of dense gas, though hadronic scenarios remain possible with hard proton spectra.


<details>
  <summary>Details</summary>
Motivation: To investigate V4641~Sgr as a potential cosmic-ray accelerator capable of producing petaelectronvolt energies, particularly addressing whether its spectrum peaks beyond the 'knee' in the cosmic-ray flux and determining the emission mechanism between hadronic and leptonic origins.

Method: Analysis of ~100 hours of H.E.S.S. gamma-ray data, combined with HI/CO observations for target material assessment. Spectral and morphological studies were conducted to characterize emission properties and test hadronic vs. leptonic models.

Result: Detection of significant multi-TeV emission with a ~1.8 power-law spectrum, forming an elongated region. Indication of a two-component morphology without energy-dependent spatial variation. No dense gas detected, leading to magnetic field constraints (<3 μG) and implications for emission scenarios.

Conclusion: Leptonic origin is favored due to low magnetic field requirements and lack of dense target gas. Hadronic models require unusually hard proton spectra. The 100 TeV spectral peak positions V4641~Sgr as a candidate beyond the cosmic-ray knee, but definitive emission mechanism remains unresolved.
...
### [41] [UHECRs Propagation and their Multimessengers: Upper limits and the Impact of the Extragalactic Magnetic Field](https://arxiv.org/abs/2511.10581)
*Rodrigo Sasse,Rubens Costa,Adriel G. B Mocellin,Carlos H. Coimbra Araújo,Rita de Cássia dos Anjos*

Main category: astro-ph.HE

TL;DR: This study analyzes high-energy gamma rays and neutrinos from UHECRs in starburst galaxies like NGC 1068, using observations and simulations to constrain cosmic-ray luminosity and magnetic fields.


<details>
  <summary>Details</summary>
Motivation: To establish links between UHECRs, their sources, and multimessenger signals, while addressing uncertainties in cosmic-ray propagation and source properties.

Method: Simulates UHECR propagation in starburst galaxies, calculates gamma/neutrino fluxes using H.E.S.S./MAGIC limits, and models effects of magnetic fields on particle trajectories.

Result: Sets cosmic-ray luminosity upper limits, constrains EGMF to ≤1e-14 G for >90% UHECR survival, and predicts detectability by the Cherenkov Telescope Array.

Conclusion: Multimessenger observations are critical for understanding UHECR acceleration and propagation, with NGC 1068 as a key testbed for future high-energy astronomy experiments.
...
### [42] [A new regularization scheme for the wave function of the Universe in the Lorentzian path integral](https://arxiv.org/abs/2511.09621)
*Masaki Yamada*

Main category: gr-qc

TL;DR: The paper proposes a new regularization method for the lapse integral in cosmological path integrals, ensuring convergence and suppressing perturbations without requiring excursion into the ${\rm Im}N>0$ region. This approach uses a narrow Gaussian regulator to enforce initial universe size constraints and maintains a physically interpretable framework.


<details>
  <summary>Details</summary>
Motivation: The Lorentzian path integral for the wave function of the universe is conditionally convergent and requires a well-defined prescription. Previous methods like Picard-Lefschetz contor deformation lead to unsuppressed perturbations due to saddle points in ${\rm Im}N>0$.

Method: A regulator in minisuperspace via a narrow Gaussian delta function of width $σ$ is imposed on the lapse integral. The limit $σ→0$ is taken post-functional integration. Perturbation initial conditions are incorporated into the path integral formalism.

Result: The lapse integral converges absolutely along the real axis for fixed $σ>0$, avoiding ${\rm Im}N>0$. This yields a tunneling wave function with properly suppressed scalar and tensor perturbations. The Hartle-Hawking wave function is also reproducible with an appropriately chosen contour.

Conclusion: The proposed regularization provides a physically meaningful resolution to convergence issues, ensuring perturbations are appropriately suppressed while maintaining consistency with established wave function formulations.
...
### [43] [Dark matter by design: $Q$-balls, neural networks and galaxy rotation curves](https://arxiv.org/abs/2511.09634)
*Alexandre M. Pombo,Lorenzo Pizzuti,Alessandra di Giacomo*

Main category: gr-qc

TL;DR: This paper investigates if rotating Q-balls, a type of non-topological soliton, can model dark matter halos in disk galaxies by reproducing their rotation curves. Using a hybrid numerical method, the authors find Q-balls with toroidal structures match observed rotation curves well and constrain the scalar particle mass to ~10^-27 eV.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore if Q-balls, which naturally form toroidal structures with central density voids when rotating, can serve as viable dark matter halo candidates by mimicking the observed rotation curves of disk galaxies.

Method: The authors employed a hybrid numerical framework combining pseudo-spectral methods and physics-informed neural networks to model static and rotating Q-balls. They then fitted these models to rotation curve data from SPARC catalog galaxies to assess their compatibility.

Result: The model showed good agreement with observational data, allowing the authors to constrain the scalar field particle mass to approximately 10^-27 eV, consistent with previous constraints on galactic-scale soliton solutions.

Conclusion: Rotating Q-balls could potentially explain galactic rotation curves without dark matter, providing an alternative astrophysical model where these scalar field configurations act as self-interacting dark matter halos.
...
### [44] [Hybrid model for inspiral-merger-ringdown gravitational waveforms from comparable-mass, nonspinning binary black holes](https://arxiv.org/abs/2511.09646)
*Nur E. M. Rifat,David A. Nichols,Kent Yagi*

Main category: gr-qc

TL;DR: The paper presents an improved hybrid method combining post-Newtonian theory and perturbation theory, using the effective-one-body approach and modified potentials to better model gravitational waveforms from binary black hole mergers, achieving high accuracy with relative errors below 0.1% for mass ratios up to 8.


<details>
  <summary>Details</summary>
Motivation: The merger phase of binary black hole systems is difficult to model analytically, with existing hybrid methods showing inaccuracies during late inspiral and mismatched quasinormal-mode frequencies in ringdown. The goal is to improve the hybrid method to achieve better agreement with numerical relativity simulations.

Method: The hybrid method was enhanced by incorporating the effective-one-body (EOB) formalism to model the boundary trajectory between spatial regions. A modified Regge-Wheeler-Zerilli equation with a Poschl-Teller potential was used for the perturbation analysis, with tunable parameters to match the remnant black hole's quasinormal mode frequency. Boundary conditions were optimized through parameter adjustment.

Result: The modified hybrid approach successfully achieves a relative error of ~0.1% compared to numerical relativity simulations for nonspinning binaries with mass ratios from 1 to 8, improving accuracy in both inspiral dynamics and ringdown frequency matching.

Conclusion: The enhanced hybrid method bridges analytical and numerical approaches effectively, offering a computationally efficient tool for modeling gravitational waves from binary black hole mergers, particularly valuable for systems where full NR simulations are resource-intensive.
...
### [45] [Photon counting readout for detection and inference of gravitational waves from neutron star merger remnants](https://arxiv.org/abs/2511.09656)
...
### [46] [Finite Populations & Finite Time: The Non-Gaussianity of a Gravitational Wave Background](https://arxiv.org/abs/2511.09659)
...
TL;DR: The paper addresses the simplifying assumptions in current pulsar timing array (PTA) analyses by developing models that account for SMBHB signal interference without assuming Gaussianity or frequency quantization, revealing non-Gaussianities in PTA signals.


<details>
  <summary>Details</summary>
Motivation: To improve the accuracy of astrophysical inference of gravitational wave backgrounds by addressing limitations in existing PTA analysis methods, such as Gaussian approximations and neglecting interference between SMBHB signals.

Method: The authors developed analytical and numerical models of an astrophysical gravitational wave background (GWB) without assuming Gaussianity, frequency quantization, or ignoring interference between supermassive black hole binary signals. They compared statistical properties of PTA signals from their models with those from Gaussian GWB models.

Result: Interference between SMBHB signals introduces non-Gaussian statistical features in PTA signals, which current analyses fail to model, potentially leading to inaccuracies in interpreting GWB observations.

Conclusion: Current PTA analyses may underestimate the complexity of GWB signals by neglecting interference-induced non-Gaussianities, suggesting the need for more sophisticated models to accurately interpret observational data.
...
### [47] [Ladder Symmetry: The Necessary and Sufficient Condition for Vanishing Love Numbers](https://arxiv.org/abs/2511.09670)
...
### [48] [Periodic orbits and observational accretion disk around a Schwarzschild-like black hole surrounded by dark matter halo](https://arxiv.org/abs/2511.10043)
...
### [49] [Veiled Singularities in Einstein-Weyl Gravity: Stability and Physical Interpretation of Horizonless Solutions](https://arxiv.org/abs/2511.10151)
*Alfio M. Bonanno,Samuele Silveravalle,Andrea Spina*

Main category: gr-qc

TL;DR: The paper demonstrates the linear stability of attractive naked singularities in Einstein-Weyl gravity against tensor perturbations, showing they decay with oscillatory tails. These 'veiled singularities' are observationally similar to black holes, suggesting they could be viable horizonless alternatives in higher-derivative gravity theories.


<details>
  <summary>Details</summary>
Motivation: To explore the stability of horizonless solutions in Einstein-Weyl gravity, addressing the cosmic censorship conjecture which typically prohibits naked singularities in General Relativity. The aim is to determine if such singularities can persist as stable configurations.

Method: Numerical evolution of perturbation equations in the time domain to analyze mode behavior, comparing with massive field dynamics in quadratic gravity.

Result: All tensor perturbation modes decay with characteristic oscillatory tails, confirming linear stability. The singularities are dynamically stable and observationally concealed ('veiled'), behaving like black holes.

Conclusion: Attractive naked singularities in Einstein-Weyl gravity are stable and could serve as horizonless substitutes to black holes in higher-derivative gravity, challenging cosmic censorship and offering new insights into singularity resolution and effective field theories.
...
### [50] [Black-hole scattering with numerical relativity: Self-force extraction and post-Minkowskian validation](https://arxiv.org/abs/2511.10196)
...
### [51] [Confronting dark energy in Harada's Conformal Killing Gravity with observational data](https://arxiv.org/abs/2511.10263)
...
### [52] [Gravitational Atoms from Topological Stars](https://arxiv.org/abs/2511.10307)
*Ibrahima Bah,Emanuele Berti,Bogdan Ganchev,David Pereñiguez,Nicholas Speeney*

Main category: gr-qc

TL;DR: The paper investigates bound states of a massive scalar field around a topological star, demonstrating they form normal modes that create a gravitational atom, distinguishing horizonless objects from black holes. The behavior of these modes depends on the ratio of the field's Compton wavelength to the star's size, with distinct regimes leading to hydrogen-like clouds, localization, or complex spectra when scales are comparable, extending analysis to charged fields and Kaluza-Klein momentum.


<details>
  <summary>Details</summary>
Motivation: To explore the nature of horizonless objects like topological stars by analyzing their bound states, thereby distinguishing them from black holes through the discovery of genuine gravitational atoms formed via scalar field interactions.

Method: The study examines the relationship between the scalar field's Compton wavelength and the star's size. Three regimes are analyzed: long wavelength (hydrogen-like spectrum), short wavelength (localization along trajectories), and intermediate scales (complex spectrum with charged fields and Kaluza-Klein momentum considered).

Result: Bound states exhibit normal mode behaviors without horizons, showing spectral differences based on wavelength-to-star size ratios. When scales are comparable, richer spectra emerge, especially with electric charge and extra-dimensional momentum included.

Conclusion: Topological stars hosting scalar fields act as gravitational atoms, offering a clear distinction from black holes. The interplay between field wavelength and stellar scale provides a framework to study quantum-gravitational effects in horizonless systems.
...
### [53] [Generating optimal Gravitational-Wave template banks with metric-preserving autoencoders](https://arxiv.org/abs/2511.10466)
*Giovanni Cabass,Digvijay Wadekar,Matias Zaldarriaga,Zihan Zhou*

Main category: gr-qc

TL;DR: This paper introduces a geometric placement algorithm for gravitational wave template banks using autoencoders with SVD and normalizing flows, achieving better effectualness than previous methods.


<details>
  <summary>Details</summary>
Motivation: To improve the efficiency and accuracy of gravitational wave searches by addressing challenges in template placement and dimensionality reduction.

Method: The method involves SVD decomposition of waveforms, autoencoder-based non-linear compression to preserve distances in latent space, and geometric placement via uniform grids with normalizing flows for rejecting unphysical points.

Result: The algorithm results in templates with slightly fewer numbers than random forest methods but better performance, especially for high-mass binaries. It also discusses potential cosmological applications and challenges with periodic manifolds.

Conclusion: The proposed method effectively balances template count and detection performance, showing promise for gravitational wave searches and indicating potential for cosmological analyses despite periodic manifold complexities.
...
TL;DR: The paper analytically explores the quasi-resonances in a Reissner-Nordström black hole-massive scalar field system under the large-mass regime (Mμ ≫ 1), identifying critical mass spectra for long-lived resonances based on the black hole's dimensionless charge parameter Q̄.


<details>
  <summary>Details</summary>
Motivation: To understand the physical and mathematical properties of the system, particularly the existence of quasi-resonances with long lifetimes via analytical methods.

Method: Used analytical techniques to determine the critical mass spectrum {Mμ_crit(Q̄)} that characterizes long-lived resonances, focusing on the dimensionless charge parameter of the black hole.

Result: Proved the presence of quasi-resonances and derived the critical mass spectrum Mμ_crit(Q̄) for the system, specifying how the black hole's charge influences long-lived perturbation modes.

Conclusion: The study establishes that quasi-resonances with arbitrarily long lifetimes exist in the system, dependent on the black hole's charge, providing a foundational framework for further analysis of black hole-scalar field interactions.
...
### [55] [Learning Post-Newtonian Corrections from Numerical Relativity](https://arxiv.org/abs/2511.10522)
...
### [57] [Straight and Wiggly Cosmic Strings in Horndeski Theory](https://arxiv.org/abs/2511.10578)
...
### [58] [Analysis of the TAIGA-HiSCORE Data Using the Latent Space of Autoencoders](https://arxiv.org/abs/2511.09655)
*Yu. Yu. Dubenskaya,S. P. Polyakov,A. P. Kryukov,A. P. Demichev,E. O. Gres,E. B. Postnikov,A. Yu. Razumov,P. A. Volchugov,D. P. Zhurov*

Main category: astro-ph.IM

TL;DR: The paper proposes using autoencoders (AE) to analyze data from the TAIGA experiment's hybrid detectors, replacing conventional auxiliary parameters with AE latent space parameters for EAS primary particle energy reconstruction. This method enhances accuracy and facilitates data integration.


<details>
  <summary>Details</summary>
Motivation: Direct data merging between different TAIGA detector types is challenging due to differing signal natures. Current empirical auxiliary parameters may not optimally retain essential information, necessitating a more efficient and information-preserving approach.

Method: The authors employ autoencoders to process experimental data, replacing traditional parameters with AE latent space parameters. A separate ANN is used to reconstruct primary particle energy from the latent space. Monte Carlo simulations are utilized for TAIGA-HiSCORE data analysis.

Result: The AE method achieves satisfactory energy reconstruction accuracy. The study analyzes how latent space dimensionality affects accuracy and compares results favorably to conventional techniques.

Conclusion: Using AE latent space parameters offers a robust, assumption-free method for multimodal data integration and improves EAS primary particle parameter reconstruction accuracy compared to traditional approaches.
...
### [59] [Analyzing Exoplanet Transits Observed with the WFC3/UVIS G280 Grism](https://arxiv.org/abs/2511.09694)
...
### [60] [Mock Observations for the CSST Mission: CPI-C -- Targets for High Contrast Imaging](https://arxiv.org/abs/2511.09862)
*Yi-Ming Zhu,Gang Zhao,Jiang-Pei Dou,Zhong-Hua Lv,Yi-Li Chen,Bo Ma,Zhao-Jun Yan,Jing Tang,Ran Li*

Main category: astro-ph.IM

TL;DR: CPISM is a simulation tool for the CPI-C coronagraph on the CSST, aiding high-contrast exoplanet imaging by modeling observational effects and optimizing targets/strategies.


<details>
  <summary>Details</summary>
Motivation: To enable optimized observation planning and data analysis for the CPI-C mission by accurately simulating challenging exoplanet detection conditions.

Method: Modular software architecture with components for target modeling, imaging simulation, instrumental effects (noise, cosmic rays), detector response, and data products. Validated via comparison with theoretical models for bright stars.

Result: Demonstrated accuracy matching theoretical expectations, flexibility in adapating to various stellar/planetary models, and capability to simulate real-world observational challenges.

Conclusion: CPISM will improve CSST observation efficiency, enhance exoplanet detection potential, and provide essential data for analyzing planetary systems through its realistic simulation capabilities.
...
### [61] [Topmetal-L: A Low Noise Charge-Sensitive Pixel Sensor for POLAR2/LPD](https://arxiv.org/abs/2511.09863)
...
### [62] [fiDrizzle-MU: A Fast Iterative Drizzle with Multiplicative Updates](https://arxiv.org/abs/2511.09881)
*Shen Zhang,Lei Wang,Huanyuan Shan,Ran Li,Xiaoyue Cao,Yunhao Gao*

Main category: astro-ph.IM

TL;DR: The paper introduces fiDrizzleMU, an iterative multiplicative algorithm for co-adding exposures that improves anti-aliasing and noise reduction in stacked images. Applied to JWST data, it successfully reconstructs a gravitationally lensed candidate blurred by standard resampling, enabling better recovery of faint/extended structures.


<details>
  <summary>Details</summary>
Motivation: To address limitations of existing additive correction frameworks in image stacking, which fail to adequately preserve fine details and suppress noise, especially for faint/extended structures in high-res astronomical images.

Method: fiDrizzleMU uses iterative multiplicative updates instead of additive corrections. This approach better preserves spatial frequencies and reduces aliasing artifacts during image co-addition.

Result: When applied to James Webb Space Telescope data, fiDrizzleMU reconstructed a gravitational lensing candidate that was heavily blurred by standard pipeline processing. It demonstrated superior noise reduction and anti-aliasing compared to conventional methods.

Conclusion: fiDrizzleMU improves the fidelity of astronomical image stacking, particularly for challenging faint/extended features. It represents a valuable enhancement for high-resolution telescope data processing, offering clearer reconstructions of cosmic phenomena like gravitational lensing.
...
### [63] [Ginnungagap -- a massively parallel cosmological initial conditions generator](https://arxiv.org/abs/2511.10353)
*Sergey Pilipenko,Gustavo Yepes,Stefan Gottlöber,Steffen Knollmann*

Main category: astro-ph.IM

TL;DR: Ginnungagap is a parallelized code for generating cosmological initial conditions, supporting large-scale simulations with variable resolution and modularity.


<details>
  <summary>Details</summary>
Motivation: To create a flexible and efficient tool for generating cosmological initial conditions that can handle very large numbers of particles and diverse simulation requirements, including zoom-in regions and structure preservation.

Method: Uses MPI+OpenMP for full parallelism, allows uniform or spatially varying resolution, extends existing initial conditions while preserving large-scale structures, and is composed of modular, independent tools.

Result: Successfully tested across different simulation types, demonstrating effectiveness in generating initial conditions with desired resolutions and scalability for large-scale simulations.

Conclusion: Ginnungagap offers a robust, open-source solution for cosmological simulation initialization, enabling researchers to efficiently model complex structures with high resolution where needed.
...
### [64] [A scalable and accurate framework for self-calibrating null depth retrieval using neural posterior estimation](https://arxiv.org/abs/2511.10455)
