...
### [7] [QuickGWecc: Fast Bayesian pipeline for searching eccentric binaries in pulsar timing array data](https://arxiv.org/abs/2607.26051)
...
### [14] [Sum-Rule-Preserving Non-Factorized Transition-GPD Tomography of $N\toΔ(1232)$ Multipole Structure](https://arxiv.org/abs/2607.24864)
*R. M. Marinaro*
...
### [15] [Probing long-range $L_e-L_μ$ forces with supernova neutronization burst neutrinos](https://arxiv.org/abs/2607.24918)
...
### [18] [Gravitational waves decay in vacuum: a low energy effect of quantized gravitation](https://arxiv.org/abs/2607.24930)
...
### [19] [Multi-component Dark Matter in a Novel Three-Loop Inverse Scotogenic Seesaw Model](https://arxiv.org/abs/2607.24932)
...
### [20] [Coherence from interference: a solvable model of sub-GeV dark matter-nucleus scattering](https://arxiv.org/abs/2607.24933)
...
### [21] [Top-quark mass interpretation from simulation of top-flavoured mesons](https://arxiv.org/abs/2607.24935)
...
### [22] [Beyond leading-logarithm photon production from two-loop diagrams in a hot QCD medium](https://arxiv.org/abs/2607.24950)
...
### [23] [NNLO Determination of Polarized Parton Distribution Functions with Higher-Twist and Target-Mass Corrections](https://arxiv.org/abs/2607.25001)
...
### [24] [Regarding the Rotational Unruh Effect](https://arxiv.org/abs/2607.25004)
...
### [25] [Searches for heavy neutral lepton decays at spallation neutron sources](https://arxiv.org/abs/2607.25008)
...
### [26] [Few-gluon interactions and multipole radiation in high energy nuclear collisions](https://arxiv.org/abs/2607.25017)
*Thomas A. Trainor*
...
### [27] [Quantum detection of CP violation in the $t\bar{t}$ system: production](https://arxiv.org/abs/2607.25029)
...
### [28] [Quantum detection of CP violation in the $t\bar{t}$ system: tomography](https://arxiv.org/abs/2607.25034)
*Priyanka Lamba,Fabio Maltoni,Olimpia Miniati,Eleni Vryonidou*
...
### [30] [One-loop HDL thermodynamics of a strongly magnetized isospin asymmetric cold quark matter](https://arxiv.org/abs/2607.25167)
...
### [31] [Beyond a symmetry-restricted VEV ansatz: transverse stability of an $SU(5)$ special-subgroup vacuum](https://arxiv.org/abs/2607.25171)
*Hidetoshi Kawase*
...
### [32] [A quark-diquark model for parity doublet structure of baryons](https://arxiv.org/abs/2607.25178)
...
### [33] [Heavy Jet Mass in Hadronic Higgs Decays](https://arxiv.org/abs/2607.25187)
...
### [34] [Isolating Scheme Dependence of Quasi-PDFs in the RI/MOM Scheme](https://arxiv.org/abs/2607.25231)
*Junegone Chay*
...
### [35] [Spatial Guidance Field Theory: From Gradient Postulates and Charge Conservation to Gauge Group Structure](https://arxiv.org/abs/2607.25336)
*Xinqiao Li*
...
### [36] [Pseudoscalar Yukawa Coupling Induced Helical Asymmetry in Fermionic Preheating](https://arxiv.org/abs/2607.25521)
...
### [37] [Singly heavy tetraquarks](https://arxiv.org/abs/2607.25401)
...
### [39] [Photon Gas Thermodynamics in Doubly Special Relativity at the Planck Scale](https://arxiv.org/abs/2607.25473)
...
### [40] [Virtual state and two-pole structure: $Ξ(1690)$ and $Ξ(1820)$ from BESIII data on $ψ(3686)\to K^-Λ\barΞ^+$](https://arxiv.org/abs/2607.25606)
*Jun He*
...
### [41] [Constraining axion quadratic couplings with the Hulse-Taylor binary system](https://arxiv.org/abs/2607.25631)
...
### [42] [The 95 GeV Excess in Models with Two Higgs Doublets plus One Singlet: Model Distinction via Four-top Final States and Triple Higgs Couplings](https://arxiv.org/abs/2607.25670)
...
### [43] [Compositeness relations for near-threshold p-wave bound states](https://arxiv.org/abs/2607.25744)
*Guo-Ying Chen*
...
### [44] [Heavy and heavy-light mesons with arbitrary spin and parity in the Covariant Spectator Theory](https://arxiv.org/abs/2607.25747)
...
### [45] [A dispersive method to study CP asymmetries in hadronic multi-body $B$ decays](https://arxiv.org/abs/2607.25764)
...
### [46] [Form factors of the $ρ$-meson in chiral perturbation theory](https://arxiv.org/abs/2607.25844)
...
### [47] [Probing the limits on anomalous quartic gauge couplings via $ZZγ$ production in the $\ell\ellννγ$ channel at FCC-hh](https://arxiv.org/abs/2607.25935)
...
### [48] [Probing Lepton-Flavor-Violating Four-Lepton Operators at a Muon Collider](https://arxiv.org/abs/2607.26020)
...
### [49] [Tidal deformation of an accreting compact object](https://arxiv.org/abs/2607.24938)
...
### [50] [Fast, accurate, and differentiable: a neural-network surrogate for NRSur7dq4 precessing binary black hole waveforms](https://arxiv.org/abs/2607.24960)
...
### [51] [Coupled Gravitoelectromagnetic Response of a Magnetically Supported Generalized Hayward Black Hole in Nonlinear Electrodynamics](https://arxiv.org/abs/2607.24982)
...
### [52] [Fixing IR tail of gravitational waves from domain walls](https://arxiv.org/abs/2607.25073)
...
### [53] [GSpyNetTree-O4: an event validation tool used in the fourth LIGO-Virgo-KAGRA observing run](https://arxiv.org/abs/2607.25208)
...
### [54] [Parametrized beyond-Teukolsky framework in the time domain](https://arxiv.org/abs/2607.25311)
...
### [55] [Extracting Energy from a Non-Kerr Rotating Spacetime with an Anomalous Quadrupole Moment via Magnetic Reconnection](https://arxiv.org/abs/2607.25315)
...
### [56] [Memory Effect for deformed gravitational waves](https://arxiv.org/abs/2607.25452)
...
### [57] [Gravitational Baryogenesis in Rainbow Gauss-Bonnet gravity](https://arxiv.org/abs/2607.25491)
...
### [58] [Gravitational wave constraints on corrections to Bekenstein-Hawking Area Formula in classical F(R) gravity and quantum GR : implications for theory parameters](https://arxiv.org/abs/2607.25513)
...
### [59] [Spin precession in the strong deflection limit](https://arxiv.org/abs/2607.25617)
...
### [60] [Conserved Gravitational Charges as Curvature Fluxes](https://arxiv.org/abs/2607.25646)
...
### [61] [Taub-NUT as gravitational dyon with torsion](https://arxiv.org/abs/2607.25654)
...
### [62] [Echoes and quasinormal modes for static loop quantum black bounces](https://arxiv.org/abs/2607.25738)
...
### [63] [Late-Time Cosmological Tests of a Minisuperspace Generalized-Uncertainty-Principle Deformation](https://arxiv.org/abs/2607.25745)
*G. G. L. Nashed*
...
### [64] [General Relativistic Entropic Acceleration at the perturbation level: a CLASS implementation and first Boltzmann-code constraints](https://arxiv.org/abs/2607.25841)
...
### [65] [Analytic backreaction of a scalar wig on a Schwarzschild black hole](https://arxiv.org/abs/2607.25932)
...
### [66] [Causal Green function decomposition for quantum black hole seismology](https://arxiv.org/abs/2607.26010)
...
### [67] [Quantum Gravity from Fractal Entanglement Geometry](https://arxiv.org/abs/2607.26035)
*Jaume Gine*
...
### [68] [LiteBIRD Mission Overview after Mission Reformation](https://arxiv.org/abs/2607.25285)
...
### [69] [AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology I: Literature Review](https://arxiv.org/abs/2607.25672)
...
### [70] [RAISE: A Low-Frequency Space-Based Payload for Solar Radio and RFI Measurements on the SMiLE Mission](https://arxiv.org/abs/2607.25755)
...
### [71] [The Lunar Farside Transients and Technology Telescope (LFT3) Mission](https://arxiv.org/abs/2607.25762)
...
### [72] [CNN-Based Reanalysis of Optical Turbulence at the Canary Islands Observatories (OCAN)](https://arxiv.org/abs/2607.25940)
...
### [73] [Advancing X-Ray Camera Front-End Electronics Architecture through the AXIS-TAP Technology Platform](https://arxiv.org/abs/2607.26002)
...
### [74] [The IMF package: a toolkit implementing mass functions and statistical tools to analyze them](https://arxiv.org/abs/2607.26007)
