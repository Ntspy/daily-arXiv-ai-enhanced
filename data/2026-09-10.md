...
### [23] [Clock-noise propagation and calibration for phase-locking configurations in space-based gravitational-wave detectors](https://arxiv.org/abs/2609.09820)
...
### [24] [From driven oscillations to free ringdown: a particle plunging into Kerr](https://arxiv.org/abs/2609.09531)
...
### [25] [A Differentiable Parametric Model of Binary-Black-Hole Initial Data: I. Conformally flat Bowen-York punctures](https://arxiv.org/abs/2609.10173)
...
### [26] [Probing quantum chaos near a wormhole throat with a circular string](https://arxiv.org/abs/2609.09613)
...
### [27] [Ovcharenko-Podolsky Einstein-Maxwell gravitational instantons](https://arxiv.org/abs/2609.09694)
*Hari K. Kunduri*
...
### [28] [Analytic motions of spinning particles in Schwarzschild-(anti-)de Sitter spacetime](https://arxiv.org/abs/2609.09755)
...
### [29] [Thermodynamics of Kerr-Newman-Bertotti-Robinson black holes](https://arxiv.org/abs/2609.09816)
...
### [34] [Testing Source Dependence in Gravitational-Wave Tests of General Relativity with Mutual Information](https://arxiv.org/abs/2609.10220)
*Yi-Fan Wang*
...
### [35] [Long-lived resonances of massive scalar fields in the Reissner-Nordström black-hole spacetime: Analytic treatment in the large-mass regime](https://arxiv.org/abs/2511.10521)
*Shahar Hod*
...
### [44] [Feasibility of a collider-based detector search for upward-going fermions produced from gravitationally-bound dark matter within the Earth](https://arxiv.org/abs/2609.09194)
...
### [45] [The Masses of Bosons and Usual Fermions on Supersymmetric $SU(3)_{C}\times SU(4)_{L}\times U(1)_{X}$ Model](https://arxiv.org/abs/2609.09199)
*M. C. Rodriguez*
...
### [46] [On the analytic continuation and matching of threshold singularities from Vacuum Amplitudes](https://arxiv.org/abs/2609.09202)
...
### [47] [Nuclear interference versus dark sector excitation in the 248 keV LUX-ZEPLIN recoil candidate](https://arxiv.org/abs/2609.09230)
...
### [48] [Level-Four Modular Symmetry Selected by the Harmonic Pattern of Quark and Lepton Masses](https://arxiv.org/abs/2609.09262)
*Vernon Barger*
...
### [49] [Nucleon Stron-Interactions Size From Charmonium Photoproduction](https://arxiv.org/abs/2609.09318)
...
### [50] [Constraints on Neutron-Electron Quantum Dark Forces](https://arxiv.org/abs/2609.09336)
...
### [51] [Heavy Higgsino Interpretation of the LZ Event](https://arxiv.org/abs/2609.09385)
*Kevin Langhoff*
...
### [52] [Cutoff Scales in the Type-I 2HDM with Strongly First-Order Electroweak Phase Transitions: One-Step versus Multistep](https://arxiv.org/abs/2609.09444)
...
### [53] [Inclusive productions of $J/ψ+η_c$ in $e^{+}e^{-}$ annihilation at Belle](https://arxiv.org/abs/2609.09590)
...
### [54] [Next-to-Leading-Order Calculation of the Light Tensor $(J^P=2^+)$ Hybrid Correlation Function](https://arxiv.org/abs/2609.09669)
...
### [55] [More QCD Masterclass Lectures on Jet Physics and Machine Learning](https://arxiv.org/abs/2609.09785)
*Andrew J. Larkoski*
...
### [56] [Charmed baryon semileptonic decays in a relativistic three-quark model](https://arxiv.org/abs/2609.09802)
...
### [57] [Radiative Corrections to the Direct Detection of Inelastic Scattering of Higgsino-like Neutralino Dark Matter](https://arxiv.org/abs/2609.09830)
...
### [58] [On the universality of soft emission beyond the next-to-soft order](https://arxiv.org/abs/2609.10069)
...
### [59] [Probing the Electromagnetic Structure of Heavy-Light Hybrid Mesons with Vector and Axial-Vector Quantum Numbers](https://arxiv.org/abs/2609.10070)
...
### [60] [Zero-locus diagnostic of the direct contact term in $φ\toπ^+π^-π^0$](https://arxiv.org/abs/2609.10094)
...
### [61] [Decoding Heavy Top-Philic Resonances at the HL-LHC: From Parton Kinematics to Deep Learning Signatures](https://arxiv.org/abs/2609.10130)
...
### [62] [An improved partial-wave projection of the one-particle exchange in relativistic three-body scattering](https://arxiv.org/abs/2609.10306)
...
### [63] [Towards new D meson fragmentation functions](https://arxiv.org/abs/2609.10327)
...
### [64] [Searching for New Physics with Reinforcement Learning](https://arxiv.org/abs/2609.10382)
...
### [65] [Quantifying Information Hierarchy for Neutrino Oscillation Parameters at JUNO](https://arxiv.org/abs/2609.10383)
...
### [66] [Transition magnetic-dipole dark matter and the LZ230616 high-recoil candidate](https://arxiv.org/abs/2609.10453)
*Yuxuan He*
...
### [67] [Anomalies at the End of the Universe?](https://arxiv.org/abs/2609.10459)
...
### [68] [Inelastic Dark Matter and High-Energy Recoil Signatures in LZ](https://arxiv.org/abs/2609.10491)
...
### [69] [Can Elastic Neutrino Scattering Account for the LZ230616 Event?](https://arxiv.org/abs/2609.10504)
...
### [70] [Decoding the Imprints of Energy-Momentum Squared Gravity in Neutron Stars with Machine Learning Analysis](https://arxiv.org/abs/2609.09248)
...
### [71] [Dispersion Measure Variability in Fast Radio Bursts from Photoionization](https://arxiv.org/abs/2609.09285)
*Brian D. Metzger*
...
### [72] [Free Neutron Decay in Kilonova Ejecta: X-ray/UV Flashes with Non-Thermal Effects](https://arxiv.org/abs/2609.09311)
...
### [73] [Electromagnetic Emission and Orbital Evolution of Eccentric Supermassive Black Hole Binaries in Retrograde Disks](https://arxiv.org/abs/2609.09314)
...
### [74] [cuDART: a GPU-accelerated ray tracing code for generating synthetic observations of relativistic astrophysical sources](https://arxiv.org/abs/2609.09322)
...
### [75] [Evolution of Main Sequence Stars Transferring Mass to a Supermassive Black Hole](https://arxiv.org/abs/2609.09447)
...
### [76] [Multi-Wavelength Identification of a Luminous Mid-Infrared Supernova Powered by Circumstellar Interaction with Binary-Driven Pre-supernova Mass Loss](https://arxiv.org/abs/2609.09520)
...
### [77] [First Detection of Radio Polarization During Jet Formation in the Changing-Look AGN 1ES 1927+654](https://arxiv.org/abs/2609.09539)
...
### [78] [Pulse Signal Simulation of Pulsars](https://arxiv.org/abs/2609.09655)
...
### [79] [Searching for Type Ia Supernovae in the Dark Energy Spectroscopic Instrument](https://arxiv.org/abs/2609.09661)
...
### [80] [The Evolution of Thermal and Non-thermal Emission Components in GRB 250920C](https://arxiv.org/abs/2609.09710)
...
### [81] [Aarmed with Data: Bumps, Outflows, and Disk-like Emission in TDE 2025aarm](https://arxiv.org/abs/2609.09725)
...
### [82] [1LHAASO J1852+0050u: GeV-100TeV Gamma-ray emission Powered by Star-forming Region?](https://arxiv.org/abs/2609.09763)
...
### [83] [Time-Correlated Profile Variability in the MeerKAT Pulsar Timing Array](https://arxiv.org/abs/2609.09919)
...
### [84] [Evidence of a Low-Energy Cutoff in the Injected Spectrum of a Pulsar Wind Nebula](https://arxiv.org/abs/2609.10041)
...
### [85] [Orthogonal polarization modes of nonbirefringent origin in a geometric radio pulsar signal model](https://arxiv.org/abs/2609.10073)
...
### [86] [Search for refractive substructure in active galactic nuclei using ground-based VLBI observations](https://arxiv.org/abs/2609.10093)
...
### [87] [Hadronic origin of gamma rays and neutrinos from blazars: Multi-messenger implications and observational constraints](https://arxiv.org/abs/2609.10128)
...
### [88] [Extended gamma-ray emission in the vicinity of the Westerlund 1 massive star cluster and Kes 41 supernova remnant seen by the Fermi Large Area Telescope](https://arxiv.org/abs/2609.10176)
...
### [89] [The first MeerKAT S-band globular cluster pulsar survey](https://arxiv.org/abs/2609.10184)
...
### [90] [Anisotropic wind in tidal disruption events](https://arxiv.org/abs/2609.10213)
...
### [91] [Associating binary black holes with galactic centres using lensed gravitational waves](https://arxiv.org/abs/2609.10285)
