...
### [2] [Gravitational Waves from Dimension-6 Assisted Peccei - Quinn Phase Transitions](https://arxiv.org/abs/2608.13692)
...
### [3] [Beyond $Δm^2$: Absolute Mass Sensitivity in Neutrino Oscillations](https://arxiv.org/abs/2608.13736)
...
### [4] [Strong $\mathcal{CP}$ and Quark Mass Hierarchies from Modular Invariance](https://arxiv.org/abs/2608.13796)
...
### [5] [Systematic study of fully heavy-flavored tetraquarks $Q_1Q_2\bar{Q}_1\bar{Q}_2\,(Q_{1;2} \in \left\{b;c\right\})$: Mass spectra, threshold analysis, and confrontation with LHC data](https://arxiv.org/abs/2608.14154)
...
### [6] [Exploring the chiral magnetic effect in Au+Au collisions at $\sqrt{s_{NN}}=7.7-200$ GeV through Chiral Anomaly Transport](https://arxiv.org/abs/2608.14188)
...
### [7] [Probing the Single Production of First-Generation Singlet Vector-like Leptons at Future $e^+e^-$ Colliders](https://arxiv.org/abs/2608.14195)
...
### [8] [Simultaneous production of a $W$ boson and a charmed hadron at the LHC in general-mass variable-flavour-number scheme](https://arxiv.org/abs/2608.14268)
...
### [9] [Nonstandard Solution for Anomaly Cancellation as Seesaw Neutrino Origin in the SM](https://arxiv.org/abs/2608.14269)
...
### [10] [Pairton: Iterative Reconstruction of Short-Lived Particles](https://arxiv.org/abs/2608.14278)
...
### [11] [Enhanced Three-Particle Contribution to Electroweak Penguin $B$-Meson Decays](https://arxiv.org/abs/2608.14341)
...
### [12] [Pion and kaon D terms from holographic QCD and coupled-channel dispersion relations](https://arxiv.org/abs/2608.14347)
*Zhibo Liu*
...
### [13] [Jet functions for next-to-leading power factorization](https://arxiv.org/abs/2608.14382)
...
### [14] [NNLO QCD corrections to $WWγ$ production at the LHC](https://arxiv.org/abs/2608.14419)
...
### [15] [Understanding the enhanced $φη^{\prime}$ decay mode of the $φ(2170)$ through strange-meson loops](https://arxiv.org/abs/2608.14440)
...
### [19] [Regular Black Holes from Collapsing Dust in a Dark Energy Background](https://arxiv.org/abs/2608.13619)
*Qazi Abdul Ghafoor*
...
### [20] [Radiative Matching Across a Projector Bridge](https://arxiv.org/abs/2608.13634)
...
### [21] [Asymptotic flatness beyond General Relativity](https://arxiv.org/abs/2608.14204)
*David Maibach*
...
### [22] [C-infinity Compact-Support Wormholes with Exact Schwarzschild Exterior in Trace-Coupled Gravity](https://arxiv.org/abs/2608.14259)
...
### [23] [Explosions from Rotating Very Massive Star Collapses to Black Holes: Effects of Nuclear Burning](https://arxiv.org/abs/2608.13642)
...
### [24] [Observational Constraints on Horizonless Compact Objects from Thermal Emission in AGNs](https://arxiv.org/abs/2608.13645)
...
### [25] [A binary black hole merger rate comparison within the same metallicity - star formation rate framework](https://arxiv.org/abs/2608.13648)
...
### [26] [No Evidence for Nearby Circumstellar Material in the Type Ia Supernova 2025rbs](https://arxiv.org/abs/2608.13655)
...
### [27] [High-Energy Neutrinos from Supernova Shock Breakouts in Circumstellar Media: Light Curves, Spectra, and Contribution to the Extragalactic Neutrino Background](https://arxiv.org/abs/2608.13680)
...
### [28] [The second Arcminute Microkelvin Imager -- Large Array Gamma-ray burst radio afterglow catalog](https://arxiv.org/abs/2608.13697)
...
### [29] [Time-dependent multi-energy neutrino emission from symbiotic recurrent novae: the role of accretion disks](https://arxiv.org/abs/2608.13814)
...
### [30] [X-ray Activity of the RS CVn-type Star σ Gem with the First-Year Observations of Einstein Probe](https://arxiv.org/abs/2608.14009)
...
### [31] [The Evolution of the ACIS Contamination Layer on the Chandra X-ray Observatory from 2010 to 2026](https://arxiv.org/abs/2608.14363)
...
### [32] [Detection of possible burst oscillation in the neutron star low-mass X-ray binary 4U 1323-62](https://arxiv.org/abs/2608.14010)
...
### [33] [Launching Jets in Tidal Disruption Events: Magnetic Flux Advection and Plasma Loading](https://arxiv.org/abs/2608.14258)
...
### [34] [Optical Spectroscopy of TeV-emitting BL Lac Candidates](https://arxiv.org/abs/2608.14412)
...
### [35] [XRISM reveals sloshing-driven gas motions in the core of Abell 2029](https://arxiv.org/abs/2608.14415)
...
### [36] [Cosmic Ray Diffusion and the Origin of Very High Energy Gamma-Ray Emission in Young Massive Stellar Clusters](https://arxiv.org/abs/2608.14547)
...
### [37] [Laser Metrology for Precision Alignment of Transmission Gratings in the REDSoX Soft X-ray Polarimeter](https://arxiv.org/abs/2608.13640)
...
### [38] [MORFEO control strategy](https://arxiv.org/abs/2608.13728)
...
### [39] [Performance Analysis of the Asgard/NOTT Nulling Interferometer: Optimizing Observing Modes for High-contrast Detection](https://arxiv.org/abs/2608.13737)
...
### [40] [CCAT: a two-octave 1.024 GHz KID readout featuring an overlap-channel polyphase synthesis filter bank on RFSoC](https://arxiv.org/abs/2608.13852)
...
### [41] [Enhancing the performance and capabilities of the MIRI instrument on JWST](https://arxiv.org/abs/2608.13873)
...
### [42] [On the Acceleration of Pulsar Timing computations using Normalising Flows and Parallelisation](https://arxiv.org/abs/2608.13991)
...
### [43] [Aether.jl : A High-Performance 3D MHD and Multifluid Dust Code Written in a Dynamic Language with an Interactive Human-AI Development Framework](https://arxiv.org/abs/2608.14048)
*Ka Wai Ho*
