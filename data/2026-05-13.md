...
### [1] [A Nearly Constant Compton y-parameter for Mildly Relativistic Slab Coronae in AGN](https://arxiv.org/abs/2605.11446)
*Haichao Xu*
...
### [2] [Black Hole Ringdown Seen in Photon Polarization Swings](https://arxiv.org/abs/2605.11499)
...
### [3] [Are Single-Zone Emission models Sufficient to Explain GRB 220426A and GRB 230812B?](https://arxiv.org/abs/2605.11543)
...
### [4] [Interacting Binary Stars as Progenitors for Interacting Supernovae](https://arxiv.org/abs/2605.11635)
...
### [5] [Evidence for Multiple Orbiting Hotspots in the 340 GHz Variability of Sgr A*](https://arxiv.org/abs/2605.11698)
...
### [6] [Catching UHE Neutrinos with HERON](https://arxiv.org/abs/2605.12081)
*Andrew Zeolla*
...
### [7] [Synergy between the Cherenkov Telescope Array Observatory and the Vera C. Rubin Observatory](https://arxiv.org/abs/2605.11709)
...
### [14] [Periodic Emission Frequency Modulation in a Hyperactive Fast Radio Burst](https://arxiv.org/abs/2605.12098)
...
### [15] [Simulating the jittering-jets explosion mechanism: Supernova remnant G11.2-0.3](https://arxiv.org/abs/2605.12356)
...
### [16] [Precessing Black Hole Jets and Galactic Fossils](https://arxiv.org/abs/2605.12448)
*Maria J. Rodriguez*
...
### [18] [Tripartite Entanglement as a Probe of Neutrino Mass Hierarchy, CP Violation, and Non-Standard Interactions](https://arxiv.org/abs/2605.10972)
...
### [19] [Neutrino mixing and gravitational production via inflation](https://arxiv.org/abs/2605.11062)
...
### [20] [An approximate formula for the entropy of the negative binomial distribution](https://arxiv.org/abs/2605.11147)
*Sándor Lökös*
...
### [21] [Gluon Entanglement Entropy inside a Nucleon: A Toy Model](https://arxiv.org/abs/2605.11171)
...
### [22] [Detection of Gravitons: Graviton Absorption and Excess of Photon Luminosity from Interstellar Hydrogen](https://arxiv.org/abs/2605.11278)
...
### [23] [Reviving primordial black hole formation in slow first-order phase transitions](https://arxiv.org/abs/2605.11332)
...
### [24] [Long-lived sterile neutrinos from axionlike particles at the Super Tau-Charm Facility](https://arxiv.org/abs/2605.11630)
...
### [25] [SMEFT everywhere: a NLO study of $\boldsymbol{pp \to t\bar{t}H}$ with decaying tops](https://arxiv.org/abs/2605.11747)
...
### [26] [In-medium Y(1S,2S,3S) suppression in Pb-Pb collisions at sqrt(s_NN)=5.02 TeV](https://arxiv.org/abs/2605.11765)
...
### [27] [Formulation of parton shower evolution beyond leading order for electron-positron annihilation](https://arxiv.org/abs/2605.11792)
...
### [28] [Trace anomaly, effective degrees of freedom, and chemical potential effects near the QCD crossover](https://arxiv.org/abs/2605.11952)
...
### [29] [Probing the small-scale primordial power spectrum via relic neutrinos and acoustic reheating](https://arxiv.org/abs/2605.11956)
...
### [30] [Quantumness of top quark pairs produced at LHC within SMEFT framework](https://arxiv.org/abs/2605.12033)
*Amir Subba,Yu Shi*
...
### [31] [Explicit Conditions for Diagnosing Tree-Level Unitarity](https://arxiv.org/abs/2605.12057)
...
### [32] [A Phenomenological Study of Semileptonic $B^+$ and $B_s^0$ Decays into Axial-Vector Mesons $\big(D_1(2420),\, D_1^\prime(2430),\, D_{s1}(2460),\, \text{and } D_{s1}^\prime(2536)\big)$ within the Standard Model](https://arxiv.org/abs/2605.12065)
...
### [33] [Photoproduction of $J/Ψ$ in peripheral Oxygen-Oxygen collisions](https://arxiv.org/abs/2605.12123)
...
### [34] [Comparison of the hadronic vacuum polarization between hadronic $τ$-decay data and lattice QCD](https://arxiv.org/abs/2605.12205)
...
### [35] [Open LHC Monte Carlo Event Generation](https://arxiv.org/abs/2605.12229)
...
### [36] [Toward Charge-Dependent Tests of the Equivalence Principle: A Phenomenological Parameter and an Unexplored Frontier](https://arxiv.org/abs/2605.12246)
...
### [37] [A New Look at the X Compositeness from its Lineshape](https://arxiv.org/abs/2605.12274)
...
### [38] [Quasi Parton Distribution Functions in Covariant Quark Models](https://arxiv.org/abs/2605.12373)
...
### [39] [Optical Design of OPTICAM-ARG: A Three-Channel High-Time-Resolution Camera for the Jorge Sahade Telescope](https://arxiv.org/abs/2605.11329)
...
### [40] [Real-time detection of solar flares from ground-based VLF data](https://arxiv.org/abs/2605.11822)
...
### [41] [Marginal multi-object multi-frame blind deconvolution](https://arxiv.org/abs/2605.11980)
*A. Asensio Ramos*
...
### [42] [An agentic framework for gravitational-wave counterpart association in the multi-messenger era](https://arxiv.org/abs/2605.10584)
...
### [43] [Gauge-covariant Raychaudhuri dynamics for spin-nondegenerate Lorentz-violating congruences](https://arxiv.org/abs/2605.11050)
...
### [44] [Metric Reconstruction for Generic Black-Hole Perturbations](https://arxiv.org/abs/2605.11080)
...
### [45] [gwBenchmarks: Stress-Testing LLM Agents on High-Precision Gravitational Wave Astronomy](https://arxiv.org/abs/2605.11269)
...
### [46] [End-to-End Population Inference from Gravitational-Wave Strain using Transformers](https://arxiv.org/abs/2605.11274)
...
### [47] [GW240925 and GW250207: Astrophysical Calibration of Gravitational-wave Detectors](https://arxiv.org/abs/2605.11703)
...
### [48] [Discovery of Interpretable Surrogates via Agentic AI: Application to Gravitational Waves](https://arxiv.org/abs/2605.11280)
...
### [49] [Closing the Cosmographic Hierarchy: Dynamical Attractors from Inflation to Reheating](https://arxiv.org/abs/2605.11292)
...
### [50] [Periodic cosmic evolution in Hybrid and Logarithmic Teleparallel Gravity](https://arxiv.org/abs/2605.11338)
...
### [51] [Bardeen spacetime as quantum corrected black hole: Grey-body factors and quasinormal modes of gravitational perturbations](https://arxiv.org/abs/2605.11364)
...
### [52] [Dynamics of a relativistic discrete body: rigidity conditions, and covariant equations of motion](https://arxiv.org/abs/2605.11411)
*Alexei A. Deriglazov*
...
### [53] [Stability and quasi-normal ringing in analogue black-white holes in SNAIL-based traveling-wave parametric amplifiers](https://arxiv.org/abs/2605.11565)
...
### [54] [Cosmology of f(Q,L_m) gravity with Holographic Ricci Dark Energy: Early-Time Inflation and Late-Time Acceleration and RGUP Corrected Observables](https://arxiv.org/abs/2605.11623)
...
### [55] [Thermodynamic formulation of Cotton gravity in the Codazzi parametrization](https://arxiv.org/abs/2605.11821)
...
### [56] [A cosmology-to-ringdown EFT consistency map for scalar-tensor gravity](https://arxiv.org/abs/2605.11890)
...
### [57] [The choice of variables in cosmological dynamical systems](https://arxiv.org/abs/2605.11971)
...
### [58] [Generalized Mass-to-Horizon Entropy and Horizon Thermodynamics](https://arxiv.org/abs/2605.12003)
...
### [59] [Causality Violating Solutions in Curvature-Squared Gravity](https://arxiv.org/abs/2605.12076)
...
### [60] [Quasinormal Spectra of Fields of Various Spin in Asymptotically de Sitter Black Holes within Generalized Proca Theory](https://arxiv.org/abs/2605.12113)
*Milena Skvortsova*
...
### [61] [Chaos and epoch structure in the deformed Mixmaster universe](https://arxiv.org/abs/2605.12173)
*Babak Vakili*
...
### [62] [Impact of coalescence signals on the search for continuous gravitational waves with Einstein Telescope](https://arxiv.org/abs/2605.12249)
...
### [63] [On the Geometry of Cotton Gravity](https://arxiv.org/abs/2605.12392)
