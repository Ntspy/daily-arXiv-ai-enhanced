...
### [2] [Self-Supervised ConvLSTM for Fermi Large Area Telescope Transient Detection](https://arxiv.org/abs/2605.22112)
...
### [3] [Gravitational wave detectability range informed by external messengers](https://arxiv.org/abs/2605.21578)
...
### [5] [Massquerade: Impacts of Mass Ratio Reversals on Binary Black Hole Merger Rates and Mass Distributions](https://arxiv.org/abs/2605.21580)
...
### [6] [A Generalized Template Matching Algorithm for Correcting Jitter Noise in Pulsar Timing](https://arxiv.org/abs/2605.21750)
...
### [7] [The powerful shocks in RS Oph: NuSTAR X-ray data and a complete review](https://arxiv.org/abs/2605.21837)
...
### [8] [Discovery of a Featureless Tidal Disruption Event at z~1 with the Wide Field Survey Telescope](https://arxiv.org/abs/2605.21950)
...
### [9] [There and back again: Mysterious optical pulse profile behavior of the transitional millisecond pulsar PSR J1023+0038](https://arxiv.org/abs/2605.22136)
...
### [14] [A Weak Fe K$β$ Emission Line in the Broad-Line Radio Galaxy 3C 111 Observed with XRISM: An Ionized Wind Absorption Feature?](https://arxiv.org/abs/2605.22388)
...
### [19] [Fisher Information Velocity: A New Geometric Channel for Precision Glitch Identification in Gravitational-Wave Detectors](https://arxiv.org/abs/2605.21531)
...
### [20] [Spectra as Language: Large Language Models for Scalable Stellar Parameter and Abundance Inference](https://arxiv.org/abs/2605.22162)
...
### [21] [STARFIRE-2: Can we detect the global redshifted 21-cm signal from the cosmic dawn in Earth orbit?](https://arxiv.org/abs/2605.22400)
...
### [22] [Hostless extragalactic transients in Fink: Results from the ELEPHANT pipeline](https://arxiv.org/abs/2605.22407)
...
### [23] [Long-lived quasinormal modes of Asymptotically de Sitter Black Holes in Generalized Proca Theory](https://arxiv.org/abs/2605.21533)
*S. V. Bolokhov*
...
### [24] [The Relativistic Gravitational Field of a Spherically Symmetric Extended Body](https://arxiv.org/abs/2605.21551)
...
### [25] [Astrophysical Objects in Modified Theories of Gravity](https://arxiv.org/abs/2605.21564)
*Sneha Pradhan*
...
### [26] [Astrophysical Signature and Optical Appearance of Weyl--Corrected Einstein--Maxwell Black Holes](https://arxiv.org/abs/2605.21571)
...
### [27] [Wave-optics gravitational wave lensing in modified gravity](https://arxiv.org/abs/2605.21584)
...
### [28] [Gravitational Wave Hyperbolic Catalog: Reanalyzing High-Mass Gravitational Wave Signals Using Hyperbolic Waveforms](https://arxiv.org/abs/2605.21640)
...
### [29] [Relativity for Retired Engineers](https://arxiv.org/abs/2605.21660)
*David Garfinkle*
...
### [30] [Maximal extension of Schwarzschild-like spacetimes in Lorentz gauge theory](https://arxiv.org/abs/2605.21823)
*Mohsen Fathi*
...
### [31] [Quantitative Black Hole Imaging Laboratory with the Black Hole Vision App: I. Schwarzschild Spacetime](https://arxiv.org/abs/2605.21887)
*Lior M. Burko*
...
### [32] [Vacuum breakdown in a misaligned magnetized Kerr spacetime](https://arxiv.org/abs/2605.21910)
...
### [33] [On the Presence of a Tertiary Compact Object in GW190814](https://arxiv.org/abs/2605.21955)
...
### [34] [Thermodynamic acceptability of spherically symmetric perfect-fluid solutions in general relativity](https://arxiv.org/abs/2605.21990)
...
### [35] [Classical Renormalization Group Equations for General Relativity](https://arxiv.org/abs/2605.22037)
...
### [36] [Holographic Dark Energy with Hubble Radius as an Infrared Cutoff in Einstein-Cartan Gravity](https://arxiv.org/abs/2605.22143)
...
### [37] [Landauer entropy of spacetime](https://arxiv.org/abs/2605.22172)
...
### [38] [Analytical solutions for timelike orbits around Damour-Solodukhin wormholes](https://arxiv.org/abs/2605.22187)
...
### [43] [Black Hole Entropy Beyond the Wald Term in Nonminimally Coupled Gravity: A Covariant Phase Space Decomposition](https://arxiv.org/abs/2605.22429)
...
### [44] [Dynamics of Binary System around a Supermassive Black Hole :Binary Scattering and Eccentric vZLK Oscillations](https://arxiv.org/abs/2605.22525)
...
### [45] [Entropic route to Brown-York tensor: A unified framework for null and timelike hypersurfaces](https://arxiv.org/abs/2605.22434)
...
### [46] [Black hole dark monopole system](https://arxiv.org/abs/2605.22495)
*Marek Rogatko*
...
### [47] [Cosmological Singularities and Quantum Particles](https://arxiv.org/abs/2605.22623)
...
### [48] [Topological Thermodynamics of Generalized Bardeen Black Hole](https://arxiv.org/abs/2605.22686)
...
### [49] [Charged multi-sheet wormhole solutions](https://arxiv.org/abs/2605.22799)
...
### [50] [Another Look at the Weak-Field Limit of Generalized Hybrid Metric-Palatini Gravity](https://arxiv.org/abs/2605.22801)
...
### [51] [Prompt photon production in a bremsstrahlung in proton-proton collisions at $\sqrt{\mathbf{s}}$=10 GeV NICA energies](https://arxiv.org/abs/2605.21511)
...
### [52] [The Mass Gap Approach to QCD. II. The non-perturbative renormalization program for the massive gluon fields](https://arxiv.org/abs/2605.21547)
...
### [59] [Symmetry Breaking as Quantum Gate: Entropy and Weak Mixing Angle](https://arxiv.org/abs/2605.22070)
...
### [60] [$b\to c \bar u q$ decay and CP violating observables in the presence of new physics contributions](https://arxiv.org/abs/2605.22088)
...
### [61] [MAcNLOPS for ZZ Pair Production at the LHC](https://arxiv.org/abs/2605.22108)
...
### [62] [Equation of State at High Baryon Densities from a Thermodynamically Informed Neural Network](https://arxiv.org/abs/2605.22199)
...
### [63] [Probing freeze-in dark matter using Bose-Einstein condensate in neutron star](https://arxiv.org/abs/2605.22245)
...
### [64] [Symbolic Classification-Enabled LHC Limits Online BSM Global Fits](https://arxiv.org/abs/2605.22330)
*Shehu AbdusSalam*
...
### [68] [Rare kaon decays $K^- \to \ell^- \barν_\ell \ell'^{+} \ell'^{-}$: Standard Model predictions from lattice QCD](https://arxiv.org/abs/2605.22727)
