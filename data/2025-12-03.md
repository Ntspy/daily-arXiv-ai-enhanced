...
TL;DR: The paper evaluates the suitability of different telescopes for cyclic deconvolution in pulsar observations, finding low-frequency instruments like uGMRT and LOFAR optimal, with SKA-Low as a future successor. It highlights the Crab Pulsar's potential and recommends real-time spectroscopy backends.


<details>
  <summary>Details</summary>
Motivation: To determine the best observing frequencies and telescopes for achieving cyclic deconvolution in pulsar timing, focusing on pulsars with sub-40 ms spin periods.

Method: Used the cyclic figure of merit to analyze 312 pulsars across 14 telescope-frequency combinations, assessing the likelihood of successful cyclic deconvolution at various frequencies.

Result: Optimal frequency range for cyclic deconvolution is 80-300 MHz; uGMRT performs best among current telescopes, followed by LOFAR, with SKA-Low as a future option. The Crab Pulsar shows promise for faster-spinning pulsars.

Conclusion: Advocates for integrating real-time cyclic spectroscopy backends in low-frequency telescopes to enhance technique accessibility and encourages further study on non-recycled pulsars.
...
### [3] [Emergent Grand Unified Structure in a 4 x 4 Nilpotent Matrix Algebra](https://arxiv.org/abs/2512.02059)
*M. Adeel Ajaib*

Main category: hep-ph

TL;DR: The paper explores how nilpotent matrices related to the Schrödinger equation reveal structures linked to grand unified theories, uncovering group patterns that mirror particle physics families and suggest connections to SO(10) unification.


<details>
  <summary>Details</summary>
Motivation: To understand the underlying mathematical structures in physics by analyzing nilpotent matrices that connect the first-order Schrödinger equation to grand unified theories, potentially explaining the origin of fermion families and symmetry groups.

Method: A systematic search for all nilpotent matrices deriving the Schrödinger equation. The matrices are categorized into antisymmetric and symmetric-zero-diagonal sectors, analyzed for group structures, and compared with particle models like Pati-Salam.

Result: Antisymmetric matrices form three groups of 16 (splitting into 12+4 subgroups) showing unique scattering properties; symmetric matrices mirror quark-lepton families. These structures align with SO(10) embedding and suggest a link to fermion generations.

Conclusion: The 4x4 matrix framework provides a compact representation of grand unified theories, hinting at why three fermion families exist and how SO(10) symmetries manifest in simpler algebraic forms.
...
### [4] [Modified Entanglement Patterns in Two-Flavor Neutrinos from Quantum-Gravity Interactions](https://arxiv.org/abs/2512.02068)
*Bipin Singh Koranga,Parnav Kumar,Baktiar Wasir Farooq*

Main category: hep-ph

TL;DR: The paper examines how quantum gravity effects modify the entanglement entropy of neutrino oscillations, finding it can be a sensitive probe for Planck scale physics.


<details>
  <summary>Details</summary>
Motivation: To explore the influence of quantum gravity-induced corrections on neutrino oscillations and entanglement entropy, providing a potential method to test Planck scale physics through quantum correlations.

Method: Uses Von Neumann entropy to measure quantum correlations, applies quantum gravity-motivated modifications to neutrino dispersion relations, and conducts a statistical analysis over various oscillation lengths and neutrino energies.

Result: Identifies characteristic deviations in entropy profiles caused by quantum gravity effects, showing entanglement entropy is sensitive to minute departures from standard oscillation dynamics.

Conclusion: Entanglement entropy serves as a promising tool for detecting quantum gravity effects in neutrino phenomenology, offering a new avenue for testing Planck scale physics.
...
### [5] [QCD in Language Models: What do they really know about QCD?](https://arxiv.org/abs/2512.02072)
*Antonin Sulc,Patrick L. S. Connor*

Main category: hep-ph

TL;DR: This paper evaluates how well modern open-source LLMs like Llama, Qwen, and Gemma understand Quantum Chromodynamics (QCD) concepts through reverse engineering their internal representations and identifies current limitations.


<details>
  <summary>Details</summary>
Motivation: To assess LLMs' ability to assist in physics research by analyzing their encoded knowledge of QCD and pinpointing areas needing improvement in future models.

Method: The authors used targeted probing techniques and knowledge extraction protocols to examine how QCD principles such as color confinement and asymptotic freedom are represented in the models' parameter spaces.

Result: The study reveals idiosyncratic patterns in how each model encodes QCD concepts, showing both capabilities and significant limitations in representing advanced quantum field theory ideas.

Conclusion: While LLMs can assist in physics research, their current representations of complex QCD concepts are insufficient, indicating a need for future model development to address these gaps.
...
### [6] [Unitarizing non-relativistic scattering](https://arxiv.org/abs/2512.02097)
*Marcos M. Flores,Kalliopi Petraki*

Main category: hep-ph

TL;DR: The paper develops a unitary framework for non-relativistic scattering problems by incorporating both elastic and inelastic channels through anti-Hermitian kernels, addressing convergence issues via renormalization with Hermitian counterterms, applicable to dark matter studies.


<details>
  <summary>Details</summary>
Motivation: To ensure unitarity in scattering amplitudes requiring consistent treatment of inelastic channels and resolution of non-convergent behaviors in the complex momentum plane without violating physical constraints.

Method: 1. Derive anti-Hermitian contributions from unitarity using optical theorem, continuity equation, and inelastic channel integration. 2. Construct non-local separable potentials for unitarization. 3. Renormalize non-convergent amplitudes by introducing Hermitian counterterms paired with anti-Hermitian kernels.

Result: Established a renormalizable unitarization scheme valid for both convergent and non-convergent cases, ensuring finite cross sections while preserving unitarity. Demonstrated applicability to dark matter phenomenology.

Conclusion: The framework provides a robust tool for non-relativistic scattering problems, especially useful for accurately modeling dark matter interactions where inelastic effects and unitarity are critical.
...
### [7] [Do neutrinos dream in 5D? Towards a comprehensive extra-dimensional neutrino phenomenology](https://arxiv.org/abs/2512.02101)
*Arturo de Giorgi,Dhruv Pasari,Jessica Turner*

Main category: hep-ph

TL;DR: The paper explores neutrino masses and mixing in Large Extra Dimension models by examining a 5D bulk fermion's effects, considering four mass generation scenarios (Dirac/Majorana masses from bulk/brane), analyzing their implications on neutrino oscillations and experimental constraints.


<details>
  <summary>Details</summary>
Motivation: To understand the phenomenological impact of large extra dimensions on neutrino properties, particularly through the lens of a 5D bulk fermion's Kaluza-Klein tower and its role in mass/mixing phenomena.

Method: Systematic analysis of four mass generation scenarios (bulk/brane Dirac and Majorana masses) in an S¹/Z₂ compactified orbifold. Derived mass spectra and mixing patterns for neutrinos in vacuum/matter, compared with experimental data.

Result: Theoretical predictions for neutrino oscillation parameters under different scenarios, along with constraints on extra dimension parameters based on experimental data.

Conclusion: The study reveals how Large Extra Dimension models with bulk fermions can explain neutrino masses/mixing, and identifies viable parameter regions consistent with observations.
...
### [8] [Momentum entanglement at colliders: the $H \to WW,ZZ$ case](https://arxiv.org/abs/2512.02104)
*J. A. Aguilar-Saavedra*

Main category: hep-ph

TL;DR: The paper explores momentum entanglement in Higgs boson decays to WW or ZZ pairs using a discretized momentum space approach. It calculates entanglement measures for H→ZZ decays in four-lepton final states and assesses their detectability at the LHC and future colliders. The method provides a new framework for studying momentum entanglement in high-energy physics.


<details>
  <summary>Details</summary>
Motivation: To investigate quantum entanglement in particle momenta during Higgs decays, which could provide new insights into quantum correlations in high-energy processes and improve sensitivity in detecting such phenomena at particle colliders.

Method: Discretization of momentum space to analyze entanglement in Higgs decay products (WW or ZZ pairs). Specifically for H→ZZ→4 leptons, statistical sensitivity of entanglement measures is estimated for LHC and future collider settings.

Result: The method successfully quantifies momentum and spin entanglement in Higgs decays. Estimates show viable statistical sensitivity for detecting these effects at the LHC and upgraded facilities, demonstrating the method's broad applicability for studying momentum entanglement in high-energy experiments.

Conclusion: The discretisation approach offers a robust framework for momentum entanglement studies, enabling novel investigations into quantum correlations in particle collisions. It paves the way for future high-precision experiments to explore fundamental quantum properties in energy-intensive physics regimes.
...
### [9] [Assessing uncertainties in the determination of the trilinear Higgs self-coupling from single-Higgs observables](https://arxiv.org/abs/2512.02111)
*Henning Bahl,Philip Bechtle,Johannes Braathen,Sven Heinemeyer,Jenny List,Murillo Vellasco,Georg Weiglein*

Main category: hep-ph

TL;DR: The study examines the impact of theoretical uncertainties on indirect determinations of the trilinear Higgs coupling (λ₃₄) using a global EFT fit, showing that neglecting such uncertainties overestimates precision.


<details>
  <summary>Details</summary>
Motivation: To assess how theoretical uncertainties from loop contributions and EFT truncation affect the accuracy of extracting λ₃₄ via single Higgs production and electroweak observables at low-energy circular colliders.

Method: Uses an inert doublet model as a BSM scenario to simulate EFT fits, incorporating both standard and uncertainty-inclusive approaches to compare the impact on λ₃₄ sensitivity.

Result: Ignoring theoretical uncertainties leads to overly optimistic precision claims for λ₃₄, with actual achievable precision significantly lower when uncertainties are properly accounted for.

Conclusion: Future precision studies must include theoretical uncertainties in EFT analyses to avoid misinterpretations of collider data regarding Higgs couplings and electroweak symmetry breaking mechanisms.
...
### [10] [Vacuum Structure of the BNT Model of Neutrino Mass Generation](https://arxiv.org/abs/2512.02128)
*Saiyad Ashanujjaman,Siddharth P. Maharathy*

Main category: hep-ph

TL;DR: The paper analyzes the vacuum stability of the BNT model, showing that the electroweak vacuum may not always be the global minimum and proposes criteria for its stability.


<details>
  <summary>Details</summary>
Motivation: The motivation is to ensure the theoretical validity of the BNT model by investigating vacuum stability conditions, crucial for the model's consistency with electroweak symmetry breaking and avoiding problematic charge-breaking vacua.

Method: The method involves analyzing the scalar potential's boundedness, perturbative unitarity, and vacuum stability. The authors examine potential stationary points, compare vacuum depths, and derive mass inequalities for stability conditions.

Result: They find that the electroweak vacuum isn't always the global minimum, with charge-breaking vacua possibly existing. For specific cases (zero quadruplet VEV), stability reduces to mass inequalities. General cases require case-by-case analysis, but a combined criterion determines stability reliably.

Conclusion: The BNT model's vacuum stability depends on specific parameter choices. Simple analytical conditions apply only in restricted scenarios, necessitating thorough checks of scalar couplings for general cases to ensure the electroweak vacuum's global stability without charge-breaking issues.
...
### [11] [Linearly Polarized Gravitational Waves from Bubble Collisions](https://arxiv.org/abs/2512.02137)
*Katarina Trailović*

Main category: hep-ph

TL;DR: The paper explores how gravitational waves from a first-order phase transition, induced by beyond-Standard-Model physics and involving the nucleation and collision of two vacuum bubbles, could be detected and polarized-analyzed by interferometers like LISA and the Einstein Telescope, offering insights into early universe physics.


<details>
  <summary>Details</summary>
Motivation: To determine if current and future interferometers can detect and characterize linearly polarized gravitational waves from a slow first-order phase transition, thereby probing physics beyond the Standard Model and understanding the early universe.

Method: Analyzes the conditions under which a first-order phase transition produces linearly polarized gravitational waves from two-bubble collisions, then simulates or calculates the detectability and polarization measurement capability of interferometers like LISA and the Einstein Telescope.

Result: Shows that these interferometers can measure both the magnitude of the gravitational wave signal and its linear polarization state, which could uniquely identify the signal's origin related to a slow first-order phase transition.

Conclusion: Detection and polarization analysis of such gravitational waves could provide a novel observational handle on early universe phase transitions and the underlying physics beyond the Standard Model.
...
### [12] [Gravitational waves from flavoured SU(2) early-universe phase transitions](https://arxiv.org/abs/2512.02148)
*Anna Chrysostomou,Alan S. Cornell,Luc Darmé,Aldo Deandrea,Thibault Demartini*

Main category: hep-ph

TL;DR: The paper explores how the breaking of a SU(2) flavor symmetry at high energy scales (up to 10^7 GeV) could create gravitational-wave signals detectable by future observatories like the Einstein Telescope. Using dimensional reduction and hydrodynamical methods, they show that first-order phase transitions require strong couplings and that including leptoquarks expands the observable parameter space.


<details>
  <summary>Details</summary>
Motivation: To provide a method for probing high-energy flavor symmetries beyond direct collider reach by linking their breaking to observable gravitational-wave signals.

Method: 1. Applied dimensional reduction to compute finite-temperature effective potentials for SU(2) flavor symmetry breaking. 2. Analyzed conditions for first-order phase transitions. 3. Used hydrodynamical models to calculate gravitational-wave spectra from these transitions. 4. Included leptoquarks in the analysis to extend testable scenarios.

Result: Observed that first-order transitions require O(1) gauge couplings. Leptoquarks significantly increase the detectable parameter space. The Einstein Telescope has excellent potential to detect these signals.

Conclusion: Gravitational-wave observations offer a promising indirect probe of high-scale flavor symmetries, with leptoquarks enhancing detectability. This approach provides an alternative pathway to studying physics beyond the Standard Model beyond collider limits.
...
### [13] [SE+BSF4DM - A micrOMEGAs package for Sommerfeld Effect and Bound State Formation in colored Dark Sectors](https://arxiv.org/abs/2512.02155)
*Mathias Becker,Emanuele Copello,Martin Napetschnig*

Main category: hep-ph

TL;DR: SE+BSF4DM is a new add-on for micrOMEGAs that incorporates Sommerfeld effects and bound state formation to accurately calculate dark matter relic densities in QCD-colored models, offering seamless integration and broad applicability.


<details>
  <summary>Details</summary>
Motivation: Accurate relic density calculations require considering non-perturbative effects like Sommerfeld enhancement and bound state formation, which are often overlooked in standard tools.

Method: Integration of Sommerfeld effect and bound state formation into micrOMEGAs workflow through a modular package compatible with t-channel simplified models, minimizing user adjustments.

Result: The package provides precise predictions across a wide range of models, demonstrated through implementation details and validation examples, with applicability confirmed for QCD-colored dark sectors.

Conclusion: SE+BSF4DM enhances micrOMEGAs' capabilities, enabling reliable relic density computations without extensive user intervention, and serves as a valuable resource for dark matter model analysis.
...
### [14] [Non-perturbaitve effects in Higgs boson decays to electroweak vector bosons and photons](https://arxiv.org/abs/2512.02165)
*Alexander Khodjamirian,Kirill Melnikov,Arkady Vainshtein*

Main category: hep-ph

TL;DR: The paper calculates non-perturbative QCD corrections to Higgs decays into $γZ$ and $γγ$, finding they're suppressed by light quark Yukawa couplings but not quark masses, leading to $O(10^{-5})$ corrections—too small to affect high-precision collider experiments.


<details>
  <summary>Details</summary>
Motivation: To assess non-perturbative QCD effects in Higgs decays crucial for high-precision measurements at colliders like HL-LHC and future facilities.

Method: Computed leading non-perturbative corrections to $H\toγZ/γγ$ from light quarks, contrasting with perturbative methods that include quark mass suppression. Evaluated corrections' magnitude against experimental precision limits.

Result: Non-perturbative effects cause $O(10^{-5})$ changes in decay rates, which are below measurable thresholds at current and future colliders.

Conclusion: Such corrections are negligible for foreseeable collider experiments, confirming perturbative calculations suffice for precision analyses.
...
### [15] [Muon magnetic anomaly: experimental status and prospects](https://arxiv.org/abs/2512.02209)
*Dinko Pocanic*

Main category: hep-ph

TL;DR: Recent studies show a discrepancy between experimental and theoretical predictions of the muon's magnetic moment (a_μ), driven by uncertainties in the hadronic vacuum polarization (HVP) contribution. The MUonE experiment at CERN aims to reduce this uncertainty through direct measurement of muonic Bhabha scattering.


<details>
  <summary>Details</summary>
Motivation: Address the tension between experimental results and the Standard Model predictions for the muon magnetic anomaly, and resolve discrepancies between lattice QCD calculations and previous theoretical estimates.

Method: MUonE will directly measure the hadronic vacuum polarization contribution by studying muonic Bhabha scattering using a novel experimental setup at CERN.

Result: Expected to provide precise values for the HVP contribution, potentially validating or refining the Standard Model and explaining the observed muon g-2 discrepancy.

Conclusion: Successful execution of MUonE could resolve longstanding tensions in particle physics, offering insights into possible beyond-Standard-Model physics or confirming existing theoretical frameworks.
...
### [16] [Impact of Higgs-boson measurements on SMEFT fits](https://arxiv.org/abs/2512.02256)
...
### [17] [Non-diagonal DVCS with spinless hadron-to-two-hadron transition $γ^* π\to γππ$](https://arxiv.org/abs/2512.02407)
*Sangyeong Son*

Main category: hep-ph

TL;DR: The paper introduces and analyzes transition generalized parton distributions (GPDs) for π→ππ processes, focusing on the ρ(770) resonance. It derives angular distributions, develops a partial-wave expansion, and models GPDs using Omnès representation with ππ scattering data.


<details>
  <summary>Details</summary>
Motivation: To advance understanding of hadron structure through transition GPDs, explore ρ(770) resonance polarization effects, and connect QCD dynamics with low-energy scattering phases.

Method: Formalism derivation for π→ππ twist-2 GPDs, angular distribution analysis of e^-π→e^-γππ cross sections (considering Bethe-Heitler and DVCS), and double partial-wave expansion using Omnès representation constrained by ππ phase shifts.

Result: Distinct angular distributions sensitive to ρ(770) polarization states; model for transition GPDs linking to ππ scattering phases.

Conclusion: This work provides tools to probe hadron transitions via GPDs and connects high-energy GPD formalism with low-energy QCD observables, facilitating future experimental studies (e.g., with electron-pion scattering).
...
### [18] [Properties of Stable Massive Quark Stars in Holography](https://arxiv.org/abs/2512.02484)
*Kazem Bitaghsir Fadafan,Jesús Cruz Rojas,Jonas Mager*

Main category: hep-ph

TL;DR: The paper explores a holographic D3/D7 model with an adjusted dilaton profile to describe a deconfined, massive quark phase in QCD at finite density. It concludes that this phase's equation of state can support 2 solar mass exotic stars. Nucleons are modeled using Hebeler et al.'s EFT, and while holographic baryons (D5-branes) are discarded due to unrealistic pressures, hybrid stars with quark cores show promise for explaining dense compact objects.


<details>
  <summary>Details</summary>
Motivation: To investigate whether holographic models can account for the presence of quark matter in the cores of heavy compact stars, addressing limitations in previous holographic approaches that couldn't support sufficiently stiff equations of state for massive stars.

Method: The study uses a holographic D3/D7 system with a phenomenologically adjusted dilaton profile in the IR region. It compares EFT-based baryonic phases (Hebeler model) with holographic baryons (D5-branes), calculates equation of state parameters, and derives mass-radius relations & tidal deformabilities for hybrid stars.

Result: The model demonstrates a stiff enough equation of state to allow 2 solar mass stars with stable quark cores. Holographic baryons are invalidated due to inconsistent pressures, but hybrid stars with phenomenological baryonic matter and quark phases show viability. This challenges prior holographic models' conclusions.

Conclusion: This holographic framework supports quark matter's existence in compact star cores, offering a testable scenario for astrophysical observations. Future work should address limitations in holographic baryon modeling and validate predictions against gravitational wave data on tidal deformabilities.
...
### [19] [Relativistic correction to the binding energies of two-body hadronic molecular states](https://arxiv.org/abs/2512.02524)
*Lin-Qing Song,Hai-Qing Zhou*

Main category: hep-ph

TL;DR: The study analyzes relativistic corrections to binding energies of hadronic molecular states using different equations, finding unexpectedly large corrections when using relativistic methods, casting doubt on non-relativistic approaches.


<details>
  <summary>Details</summary>
Motivation: To investigate the magnitude of relativistic corrections in hadronic molecular states with MeV-scale binding energies, challenging the assumption that heavier exchanged masses reduce relativistic effects.

Method: Comparison of 3D Schrödinger, 3D Salpeter, and 4D Bethe-Salpeter equation solutions using the same interaction model (Wick-Cutkosky with OBE and physical D̄D system).

Result: Relativistic corrections are substantial (-90% to -70% of non-relativistic values) for binding energies between 1-50 MeV, contradicting expectations based on exchanged boson mass.

Conclusion: Analyses relying solely on non-relativistic or 3D relativistic equations may be unreliable for hadronic molecular states; fully relativistic treatments are necessary.
...
### [20] [Unified Functional-Holographic Theory of the QCD Critical End Point](https://arxiv.org/abs/2512.02635)
...
### [21] [Probing fully coherent radiation and parton densities using (virtual) photons at the LHC](https://arxiv.org/abs/2512.02640)
*François Arleo,Djessy Bourgeais,Maxime Guilbaud,Greg Jackson,Víctor Valencia Torres*

Main category: hep-ph

TL;DR: The study investigates how fully coherent radiation, caused by parton multiple scattering, affects prompt photon production in pPb collisions at the LHC. It finds that backward and forward rapidity photons are influenced by FCEL and FCEG respectively, while virtual photon production (Drell-Yan) is less affected, highlighting Drell-Yan's suitability for probing nuclear PDFs.


<details>
  <summary>Details</summary>
Motivation: To understand cold nuclear matter effects, specifically fully coherent radiation, on prompt photon production and evaluate its impact on interpreting nuclear parton distribution functions (nPDFs).

Method: Computed medium-induced radiation effects in leading-order direct and fragmentation photon processes for pPb collisions. Analyzed photon production at different rapidities and compared with Drell-Yan processes using pseudo-data for nPDF reweighting.

Result: At backward rapidity, FCEL significantly affects prompt photons; forward rapidity photons are dominated by FCEG via $qg→qγ$ scattering. Drell-Yan shows minimal coherent radiation effects, confirming its robustness for probing nPDFs.

Conclusion: Fully coherent radiation impacts prompt photon production differently at various rapidities, but Drell-Yan remains an optimal probe for nPDFs due to minimal coherent effects, validated through nPDF reweighting with LHC Run 3 pseudo-data.
...
### [22] [Reevaluating the $a_1(1420)$ enhancement and its molecular partners in the low-lying axial-vector meson spectrum](https://arxiv.org/abs/2512.02655)
...
### [23] [Exploring Leptogenesis, WIMP Dark Matter, and Gravitational Waves in an extended Scalar Framework](https://arxiv.org/abs/2512.02672)
...
### [24] [Chen Ning Yang Retrospective](https://arxiv.org/abs/2512.02673)
*Stephen L. Adler*

Main category: hep-ph

TL;DR: Chen-Ning Yang's key contributions include advancements in statistical mechanics models, parity violation in weak interactions, and the foundation for non-Abelian gauge theories in the Standard Model.


<details>
  <summary>Details</summary>
Motivation: To explore solvable models in statistical mechanics and understand fundamental particle interactions, particularly parity violation and the structure of weak forces.

Method: Developed theoretical frameworks like the Bethe Ansatz generalizations, Lee-Yang theorem, Yang-Baxter equation, and non-Abelian gauge theories with Mills.

Result: Established parity violation in weak decays, introduced left-handed currents, and laid groundwork for the Standard Model via non-Abelian gauge bosons.

Conclusion: Yang's work revolutionized particle physics by shaping the Standard Model and deepening insights into statistical mechanics and symmetry violations.
...
### [25] [Nucleon decays into three leptons: noncontact contributions](https://arxiv.org/abs/2512.02692)
...
### [26] [Lepton Flavor Physics in the flipped 3-3-1-1 Model: Non-Universality and Violation](https://arxiv.org/abs/2512.02703)
*D. T. Huong,V. H. Binh,N. T. Huong,H. T. Hung,Duong Van Loi,D. T. Binh*

Main category: hep-ph

TL;DR: This paper analyzes Z decays and lepton flavor violation processes in the F3311 model, determining constraints on Z'-Z mixing angle (sinφ ~ 10^-3) and setting lower bounds on Z' mass (~3.2 TeV). It also addresses B decay anomalies via loop contributions, achieving consistency with experimental data. Mass ranges for model particles (E: 6.5-9 TeV, Q:6-11 TeV, dark matter ξ:1.5-2 TeV) are derived using LUX-ZEPLIN data.


<details>
  <summary>Details</summary>
Motivation: To address discrepancies between Standard Model predictions and experimental observations in Z decays, lepton flavor violating processes, and lepton non-universality in B decays. The F3311 model provides a framework for explaining these anomalies through new gauge bosons (Z') and particles.

Method: The study employs theoretical calculations of decay processes (Z→leptons, l_i→l_jγ, three-body leptonic decays, B decays) within the F3311 model. Constraints on sinφ and Z' mass are derived from experimental bounds (e.g., μ→eγ, LUX-ZEPLIN dark matter data). One-loop contributions to B decays are calculated to explain lepton non-universality, validated through d→u and s→u transitions.

Result:  stringent constraints on sinφ < 10^-3; Z' mass ≥3.2 TeV. B-decay ratios R_D, R_{D(*)}, R(Xc) match experimental 3.3σ deviations. Derived particle mass ranges: E (6.5-9 TeV), Q (6-11 TeV), dark matter ξ (1.5-2 TeV).

Conclusion: The F3311 model successfully accounts for observed flavor anomalies with predicted particle masses within measurable ranges, offering a compelling extension beyond the Standard Model. Experimental validation of these mass predictions could confirm the model's validity.
...
### [27] [Heavy sterile neutrinos in $B$ decays and new QCD corrections to their semi-hadronic decay rates](https://arxiv.org/abs/2512.02733)
*Tim Kretz*
...
### [28] [Leptophilic Gauge Interactions in the SMEFT Era](https://arxiv.org/abs/2512.02773)
*Seyit Okan Kara*

Main category: hep-ph

TL;DR: The paper presents a precision-ready, model-independent Effective Field Theory (EFT) framework linking leptophilic gauge interactions to low-energy manifestations in the Standard Model Effective Field Theory (SMEFT) and Lepton EFT (LEFT).


<details>
  <summary>Details</summary>
Motivation: To create a unified framework that connects general leptophilic gauge interactions with their low-energy effects, ensuring quantum consistency and facilitating analysis across various precision experiments and collider studies.

Method: Develops a U(1)'_ell extension with family-dependent lepton charges, includes vectorlike leptons and singlet scalars for symmetry breaking. Derives SMEFT Wilson coefficients for four-lepton operators and Higgs-current structures, incorporates hypercharge-U(1)'_ell kinetic mixing. Performs renormalization-group evolution to LEFT and provides closed-form expressions applicable to multiple observables.

Result: Derives a single parameter Λ_eff = M_Zell/(g_ell*sqrt(|qq'|)) governing all leading EFT signatures, enabling unified mapping of UV charges onto observables. Validates EFT domain and outlines application as a 'plug-and-play' tool for global fits and collider analyses.

Conclusion: The framework offers a versatile interface for probing beyond SM physics in precision experiments and future colliders, emphasizing predictive power and model-independence for comprehensive studies.
...
### [29] [Models for differential cross section in neutron-proton scattering and their implications](https://arxiv.org/abs/2512.02801)
*Muhammad Saad Ashraf,Nosheen Akbar*

Main category: hep-ph

TL;DR: The paper proposes and tests several exponential models to describe elastic differential cross sections for various particle scattering processes, achieving accurate fits to np scattering data and predicting other observables consistent with theoretical expectations.


<details>
  <summary>Details</summary>
Motivation: To develop phenomenological models that accurately describe the dip-bump structure and other features of elastic scattering data across different energies and particle types, providing a comprehensive framework for predicting observables like total cross sections and slope parameters.

Method: Energy-dependent exponential models with power-law prefactors, Gaussian modifications for the dip region, and additive exponential contributions to account for charge and isospin effects. Parameters are determined via χ² minimization using np scattering data from 3.36 to 26.02 GeV. Predictions are made for other observables and compared with theoretical expectations.

Result: Models reproduce experimental data accurately, with parameters within expected bounds. Predictions for total cross sections, slopes, interaction radii, and cross-section ratios align with Regge phenomenology and high-energy scattering constraints.

Conclusion: The models successfully capture the complex features of elastic scattering data and provide reliable predictions for related observables, demonstrating their utility in particle physics analysis.
...
### [30] [From Dark Sectors to the Axion-Neutrino Connection](https://arxiv.org/abs/2512.02854)
*H. B. Câmara*
...
### [31] [All planar three-loop Feynman integrals for the production of two vector bosons at hadron colliders](https://arxiv.org/abs/2512.02999)
*Dhimiter Canko,Mattia Pozzoli*

Main category: hep-ph

TL;DR: The paper computes planar three-loop master integrals for leading colour N3LO QCD corrections to the production of two massive or off-shell vector bosons at hadron colliders using canonical differential equations and finite field techniques.


<details>
  <summary>Details</summary>
Motivation: To enable precise predictions for processes involving two massive or off-shell vector bosons at hadron colliders, which are crucial for testing the Standard Model and searching for new physics at the LHC.

Method: Organized nine four-point integral families with massless propagators and two massive legs. Constructed a basis of pure master integrals, applied canonical differential equations via finite field techniques, and solved using generalized power series expansions.

Result: All required planar three-loop master integrals have been computed, providing the necessary ingredients for N3LO QCD calculations in vector boson production processes.

Conclusion: The results significantly advance the theoretical framework for high-precision calculations in particle physics, enhancing the accuracy of LHC experimental analyses through improved QCD predictions.
...
### [32] [The role of the top Yukawa coupling in triple Higgs production at the LHC](https://arxiv.org/abs/2512.03003)
*Luca Panizzi*

Main category: hep-ph

TL;DR: The paper examines how changing the top Yukawa coupling affects the production of three Higgs bosons at the LHC, finding significant impacts on total cross-section but minimal effects on invariant mass distributions and other observables.


<details>
  <summary>Details</summary>
Motivation: To understand the sensitivity of triply rare Higgs production processes to variations in the top Yukawa coupling within experimentally allowed ranges.

Method: Quantitative analysis of cross-section changes and distribution impacts when varying the top Yukawa coupling parameter across permissible values.

Result: Modifying the coupling significantly alters total cross-sections but leaves key distributions (three-Higgs invariant mass, global observables) relatively unaffected.

Conclusion: While total production rates are sensitive to top Yukawa variations, certain discriminating observables remain robust, suggesting alternative experimental strategies might be needed to probe these couplings effectively.
...
### [33] [Modeling dark matter halos with self-interacting fermions](https://arxiv.org/abs/2512.03006)
*Fabian Hernandez-Gutierrez,Juan Barranco*

Main category: hep-ph

TL;DR: This paper explores modeling dark matter in galaxies using a core-halo structure with self-interacting fermions. The core is degenerate fermions, while the halo uses thermalized fluid or NFW profile. Parameter fits via χ² analysis match galaxy rotation curves, yielding fermion masses and interaction strengths. The model aligns with Milky Way and SPARC data with minimal parameters but shows halo model-dependent discrepancies.


<details>
  <summary>Details</summary>
Motivation: To determine if a core-halo model with self-interacting fermions can explain dark matter distribution in galaxies, addressing discrepancies between cold dark matter predictions and observed rotation curves.

Method: Solve Tolman-Oppenheimer-Volkoff equations for core; model halo as thermalized ideal gas or NFW profile. Use χ² analysis on LSB galaxies' rotation curves to constrain fermion mass (m_f) and interaction strength (y). Test with Milky Way and SPARC data.

Result: For thermalized halo: m_f 38.73-42.11 eV, y 269.69-348.48; For NFW halo: m_f 41.54-49.87 eV, y 5606.06-17484.84. Model fits multiple galaxies with only central density as free parameter. Halo properties depend significantly on halo model choice.

Conclusion: Self-interacting fermions in a core-halo structure can fit galactic rotation curves with minimal parameters. However, halo model selection impacts derived properties, highlighting need for further observational constraints.
...
### [34] [Radiative decays of the $Σ_c$, $Ξ'_c$ and $Ω_c$ charmed baryons](https://arxiv.org/abs/2512.03008)
...
### [35] [Flexible Gravitational-Wave Parameter Estimation with Transformers](https://arxiv.org/abs/2512.02968)
...
TL;DR: The paper introduces Dingo-T1, a transformer-based deep learning model for gravitational-wave data analysis. It efficiently handles diverse analysis configurations, enabling systematic studies and consistency tests while improving sample efficiency.


<details>
  <summary>Details</summary>
Motivation: Address the growing challenges in gravitational-wave data analysis due to increasing observational complexity and the need for flexible models adaptable to varying analysis settings, such as detector configurations and frequency ranges.

Method: A transformer-based architecture paired with a training strategy that allows adaptation at inference time. This enables handling different analysis configurations, missing data, and specialized tests.

Result: Dingo-T1 successfully analyzed 48 events from the third LIGO-Virgo-KAGRA run under various settings, allowed systematic studies of configuration impacts on posteriors, performed merger-ringdown consistency tests, and improved sample efficiency from 1.4% to 4.2%.

Conclusion: Flexible, scalable neural inference frameworks like Dingo-T1 are critical for current and future gravitational-wave observatories, providing efficient and adaptable analysis capabilities for complex data scenarios.
...
### [36] [Exceptional Points and Resonance in Black Hole Ringdown](https://arxiv.org/abs/2512.02110)
...
### [37] [Revisiting the gravitational "arrow of time"](https://arxiv.org/abs/2512.02238)
*Roberto A. Sussman,Sebastián Nájera,Fernando A. Pizaña,Juan Carlos Hidalgo*

Main category: gr-qc

TL;DR: The paper challenges Penrose's Weyl-curvature hypothesis regarding the gravitational 'arrow of time' by revisiting Bonnor's counterexample. It demonstrates that the hypothesis holds in physically viable scenarios near FLRW models, where heat conduction is treated as a peculiar velocity field. The authors also compare this hypothesis with the gravitational entropy framework by Clifton, Ellis, and Tavakol.


<details>
  <summary>Details</summary>
Motivation: To address the long-standing debate around Penrose's proposal linking structure formation to the dominance of Weyl over Ricci curvature, and to clarify the validity of Bonnor's counterexample under realistic cosmological conditions.

Method: Analysis of Bonnor's exact solutions for heat-conducting collapsing spheres in a Vaidya background, reinterpretation of heat conduction as peculiar velocity fields in FLRW-like cosmologies, and comparative study with gravitational entropy formalisms.

Result: Bonnor's counterexample does not invalidate Penrose's hypothesis when considering physically viable solutions near FLRW models. The gravitational 'arrow of time' aligns more consistently with entropy-based approaches.

Conclusion: Penrose's hypothesis remains valid in realistic cosmological settings, provided heat conduction is correctly modeled. The study underscores the importance of distinguishing physically viable solutions and clarifies connections between different temporal arrow frameworks.
...
### [38] [Gravitational radiation from hyperbolic orbits: comparison between self-force, post-Minkowskian, post-Newtonian, and numerical relativity results](https://arxiv.org/abs/2512.02274)
*Niels Warburton*

Main category: gr-qc

TL;DR: The paper uses a frequency-domain approach to calculate gravitational wave energy from compact objects on hyperbolic/parabolic orbits around a Schwarzschild black hole, validating against PM/ PN theories and comparing with self-force/numerical relativity results.


<details>
  <summary>Details</summary>
Motivation: To bridge the gap between analytical post-Minkowskian/post-Newtonian frameworks and numerical methods like self-force calculations, ensuring consistency across different regimes of gravitational wave physics.

Method: Frequency-domain Regge-Wheeler-Zerilli formalism applied to hyperbolic/parabolic geodesics. Compared results with PM/PN theories and introduced a PN-PM hybrid model.

Result: Agreement with PM theory for large impact parameters (v∞/c up to 0.7) and leading-order PM absorption. Hybrid model showed effectiveness. Initial comparison with self-force/numerical relativity established foundational consistency.

Conclusion: Demonstrated the validity of frequency-domain methods for extreme orbits and highlighted the utility of hybrid models in connecting analytical and numerical approaches for gravitational wave studies.
...
### [39] [Leading effective field theory corrections to the Kerr metric at all spins](https://arxiv.org/abs/2512.02338)
*Pedro G. S. Fernandes*

Main category: gr-qc

TL;DR: The paper examines higher-derivative corrections to the Kerr metric using pseudospectral methods, finding that near-extremal black holes are most affected, thus serving as sensitive probes of new physics.


<details>
  <summary>Details</summary>
Motivation: To explore leading corrections to General Relativity through higher-derivative terms in a low-energy effective field theory, independent of specific UV gravity completions.

Method: Pseudospectral methods were employed to compute leading-order corrections to the Kerr metric across all sub-extremal spin values.

Result: Near-extremal black holes show the most significant impact from higher-derivative corrections, making them ideal for probing new physics. Public datasets and code are provided.

Conclusion: Near-extremal black holes are particularly sensitive to higher-derivative corrections, offering a pathway to test gravity theories beyond General Relativity.
...
### [40] [Structure and Mass-Radius Stability of Charged Compact Objects in Symmetric Teleparallel Euler-Heisenberg Gravity](https://arxiv.org/abs/2512.02439)
*Allah Ditta,M. Yousaf,G. Mustafa,S. K. Maurya,Farruh Atamurotov,Orhan Donmez,Sardor Murodov*

Main category: gr-qc

TL;DR: The paper presents a relativistic model for charged anisotropic compact stars using $f(Q)$-Euler-Heisenberg gravity combined with the MIT bag model. The model satisfies physical viability conditions, exhibits mechanical equilibrium via balanced forces, and shows dynamical stability through Γ > 4/3.


<details>
  <summary>Details</summary>
Motivation: To explore compact star structures in modified gravity and electromagnetism, addressing gaps in understanding anisotropic fluid distributions and charged configurations within $f(Q)$ theories.

Method: Used $f(Q)$-Euler-Heisenberg gravity with MIT bag EoS; solved field equations for anisotropic fluid and nonlinear electromagnetic source. Applied Darmois-Israel conditions for smooth exterior matching. Tested regularity, energy, and causality conditions.

Result: Validated model compliance with all physical conditions, demonstrated interplay between anisotropy, sound speeds, and TOV balance. Mass-radius curves and redshift plots confirm regular behavior.

Conclusion: The model successfully describes stable charged compact stars in modified teleparallel gravity, showing viability of $f(Q)$-Euler-Heisenberg framework for astrophysical objects under extreme conditions.
...
### [41] [Non-vanishing non-linear Static Love Number of a Class of Extremal Reissner-Nordstrom Black Holes](https://arxiv.org/abs/2512.02506)
*L. R. Gounis,A. Kehagias,G. Panagopoulos,A. Riotto*

Main category: gr-qc

TL;DR: The paper calculates tidal Love numbers for extremal Reissner-Nordström black holes with axial symmetry, finding that the static tidal Love number is finite and non-zero when embedded in specific configurations, unlike isolated cases which remain zero.


<details>
  <summary>Details</summary>
Motivation: To explore tidal interactions of extremal black holes and validate theoretical frameworks by comparing exact solutions with effective field theory approaches.

Method: Exact solution of non-linear Einstein equations for axially symmetric extremal Reissner-Nordström geometry; computation of Zerilli-Moncrief master functions and comparison with effective field theory.

Result: Static tidal Love number remains finite in specific configurations, while isolated cases show zero Love number as expected. Master functions matched successfully with EFT predictions.

Conclusion: Axially symmetric configurations allow non-zero tidal deformations in extremal Reissner-Nordström black holes, highlighting differences between isolated and structured spacetime scenarios.
...
### [42] [Quasinormal modes of a static black hole in nonlinear electrodynamics](https://arxiv.org/abs/2512.02714)
...
### [43] [Universality and Falsifiability of Quantum Spacetime Decoherence: A Gauge-Invariant Framework for Gravitational-Wave Phase Diffusion](https://arxiv.org/abs/2512.02782)
*Hu Cang,Yuan Wang*
...
### [44] [A New Application of the Gibbons-Werner Method: Bound Orbits of Massive Particles in Stationary Spacetimes](https://arxiv.org/abs/2512.02806)
*Yang Huang*
...
### [45] [Inflationary assessment of $F(\mathcal{R},\tilde{\mathcal{R}})$ Einstein-Cartan models](https://arxiv.org/abs/2512.02847)
*Theodoros Katsoulas,Kyriakos Tamvakis*

Main category: gr-qc

TL;DR: This paper explores cubic terms in F(R, R̃) Einstein-Cartan gravity's action and their impact on inflationary models, showing they can improve consistency with observational data where quadratic models fall short.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the limitations of quadratic models in F(R, R̃) gravity which fail to align with observational data by introducing cubic terms to enhance model accuracy.

Method: The method involves analyzing inflationary behavior in Einstein-Cartan gravity models with an action that includes cubic terms of the Holst-invariant curvature alongside the Ricci scalar, varying parameter values to assess effects.

Result: The results indicate that cubic terms significantly influence observational compatibility, either positively or negatively depending on parameters, and can rescue parameter regions where quadratic models fail.

Conclusion: The conclusion is that incorporating cubic terms in the action provides a viable path to achieving inflationary models compatible with observational data, offering advantages over purely quadratic models in certain parameter ranges.
...
### [46] [Interacting Generalized Chaplygin-Jacobi gas: Thermodynamics approach](https://arxiv.org/abs/2512.02900)
*Gilberto Aguilar-Pérez,Miguel Cruz,Mohsen Fathi,J. R. Villanueva*

Main category: gr-qc

TL;DR: The paper examines a cosmological model with interacting dark energy (GCJG) and dark matter, showing stability through thermodynamic analysis and a phantom phase transition in dark energy.


<details>
  <summary>Details</summary>
Motivation: To explore the interaction between dark energy and dark matter using the GCJG model, addressing observational interests in phantom regimes and ensuring thermodynamic consistency.

Method: A linear interaction term Q ∝ ρ_x is applied between GCJG and pressureless dark matter. Conservation equations are solved analytically, and thermodynamic properties like temperature, entropy production, and specific heats are analyzed.

Result: Both components maintain positive temperatures for stability. Dark energy transitions to a phantom regime in the past without thermodynamic violation. Total entropy agrees with the second law, and dark energy undergoes a late-time phase transition.

Conclusion: The model provides a thermodynamically viable framework for interacting dark sectors, explaining observed phantom behavior and phase transitions in dark energy through entropy production and heat analysis.
...
### [47] [Gravitational-wave imprints of Kerr--Bertotti--Robinson black holes: frequency blue-shift and waveform dephasing](https://arxiv.org/abs/2512.02921)
*Xiang-Qian Li,Hao-Peng Yan,Xiao-Jun Yue*

Main category: gr-qc

TL;DR: The paper studies EMRIs in Kerr--BR spacetime with an external magnetic field, finding that the field increases ISCO radius and gravitational-wave frequency, affecting EMRI waveform dephasing which could impact parameter estimation for future detectors.


<details>
  <summary>Details</summary>
Motivation: The motivation is to explore how large-scale magnetic fields around Kerr black holes influence EMRI orbital dynamics and gravitational-wave signatures, which is crucial for accurate waveform modeling and parameter estimation in future space-based detectors.

Method: Analyzes geodesics in Kerr--BR spacetime, computes ISCO properties, compares with Kerr--Melvin metric, uses semi-analytic adiabatic evolution with exact geodesics and quadrupole flux to model inspiral waveforms.

Result: External magnetic fields push ISCO to larger radii but increase ISCO frequency, causing gravitational-wave frequency 'blue-shift'. Retrograde orbits are more sensitive to magnetic fields, with frequency crossover inverting spin-frequency hierarchy. Magnetic fields induce significant waveform dephasing.

Conclusion: Magnetic environments can leave observable imprints in EMRI signals, necessitating inclusion in waveform models to avoid biases in estimating black-hole spin and other parameters for detectors like LISA.
...
### [48] [Constraining Zero-Point Length from Gravitational Baryogenesis](https://arxiv.org/abs/2512.03009)
...
### [49] [Neutron stars in $f(\mathbb{Q})$ gravity](https://arxiv.org/abs/2512.03037)
*Lavinia Heisenberg,Carlos Pastor-Marcos*

Main category: gr-qc

TL;DR: The paper examines the challenges in constructing neutron star solutions in $f(\mathbb{Q})$ gravity, emphasizing the role of the affine connection's dynamical behavior. It finds that standard approximations lead to GR dynamics even in non-trivial models, suggesting beyond-GR effects require more complex structures. The authors establish a framework for future numerical studies.


<details>
  <summary>Details</summary>
Motivation: To address the theoretical inconsistencies arising from applying GR-like assumptions in $f(\mathbb{Q})$ gravity for neutron stars, ensuring physically meaningful solutions by properly accounting for the affine connection's dynamic role.

Method: Adapting BH spacetime formalisms to NS non-vacuum configurations, analyzing models $f(\mathbb{Q}) = \mathbb{Q} + α\mathbb{Q}^2$ and $f(\mathbb{Q}) = \mathbb{Q}^β$. Using Maclaurin/Laurent series expansions, they frame the problem as a BVP and identify numerical challenges.

Result: Standard regularity assumptions with series expansions yield GR-like behavior, indicating that beyond-GR effects necessitate more intricate solutions. Numerical pathologies and mitigation strategies are outlined.

Conclusion: A framework for future studies is provided, stressing the necessity of considering the connection's dynamics and rigorous BVP setup to explore truly beyond-GR neutron star solutions in $f(\mathbb{Q})$ gravity.
...
### [50] [Possible $ν$ Source Class: 3-sigma Detection of High-Energy Neutrinos from Supermassive Black Hole Binary Candidates](https://arxiv.org/abs/2512.02099)
...
### [51] [Slow-Light Effect in the Jet-Launching Region of M87](https://arxiv.org/abs/2512.02113)
*Yuh Tsunetoe,Dominic W. Pesce,Ramesh Narayan*

Main category: astro-ph.HE

TL;DR: The study investigates how 'slow-light' radiative transfer affects GRMHD models of the M87 jet, showing that slow-light images better match observations by smoothing helical features and revealing spin-dependent jet dynamics.


<details>
  <summary>Details</summary>
Motivation: Accurately model M87's jet observations considering relativistic effects since the jet is nearly aligned with the line of sight and plasma reaches relativistic speeds during propagation.

Method: Compare GRRT (slow-light) and fast-light radiative transfer simulations in GRMHD models of M87's jet, analyzing images and jet dynamics influenced by black hole spin.

Result: Slow-light images show cone-like structures consistent with observations, lessening helical features seen in fast-light models. Spin influences jet stability (more wobbling for low spin) and the transition from loop-dominated to edge-dominated morphology.

Conclusion: Slow-light treatment is critical for capturing relativistic effects in jet morphology and dynamics, particularly spin-dependent behavior, highlighting its necessity for accurate observational modeling.
...
### [52] [Dynamo and Jet interconnections in GRMHD simulations of black hole accretion disks](https://arxiv.org/abs/2512.02129)
*P. S. Santhiya,Pallavi Bhat,Prayush Kumar,Tushar Mondal,Indu K. Dihingia*

Main category: astro-ph.HE

TL;DR: This paper investigates how MRI-driven dynamo action in black hole accretion disks, using sub-SANE initial conditions with small-scale magnetic loops, influences jet formation and evolution. The study shows that dynamo cycles generate large-scale magnetic fields that drive correlated jet activity, but jets eventually shut down when horizon magnetic field coherence drops below a critical threshold.


<details>
  <summary>Details</summary>
Motivation: To explore how magnetic field configurations and dynamo processes affect jet longevity in black hole accretion disks beyond standard SANE/MAD models.

Method: Performs global 3D GRMHD simulations with sub-SANE initial conditions (multiple small-scale magnetic loops) compared to conventional SANE setups, varying BH spin (a=0.5, 0.9375). Analyzes dynamo cycles, magnetic field evolution, and jet behavior over time.

Result: Sub-SANE disks exhibit regular dynamo cycles (~10 orbits), sustained large-scale field generation via turbulent dynamo terms balancing advection. Jet activity correlates with dynamo peaks but shuts down when horizon flux coherence (C_BH < ~0.6) diminishes. SANE models maintain jets due to persistent initial fields.

Conclusion: Jet longevity depends on both dynamo-driven magnetic field evolution in the disk and magnetic coherence at the BH horizon, establishing a direct link between dynamo action and jet maintenance in GRMHD disks.
...
### [53] [AT2022zod: An Unusual Tidal Disruption Event in an Elliptical Galaxy at Redshift 0.11](https://arxiv.org/abs/2512.02136)
...
TL;DR: AT2022zod is an unusual short-lived optical flare in an elliptical galaxy, likely caused by a star being torn apart by an intermediate-mass black hole in a nearby ultra-compact dwarf galaxy. This event aids in understanding black hole demographics and improving detection methods for such objects.


<details>
  <summary>Details</summary>
Motivation: To investigate the origins of extreme Tidal Disruption Events (TDEs) and their potential link to intermediate-mass black holes (IMBHs), especially in environments like ultra-compact dwarf galaxies (UCDs), which are important for studying black hole demographics.

Method: Analysis of the optical flare's luminosity (~30-day duration), host galaxy properties (elliptical, z=0.11, central SMBH of ~1e8 solar masses), and orbital mechanics of possible tidal disruption scenarios (IMBH vs. SMBH non-parabolic orbit).

Result: The flare's characteristics rule out origin from the host's central SMBH due to rapid evolution and off-center position. Two plausible scenarios are proposed: disruption by an IMBH (1e4-1e6 solar masses) in a UCD companion or a star on a highly eccentric orbit around the SMBH. The former is favored.

Conclusion: AT2022zod provides evidence supporting intermediate-mass black holes in UCDs and highlights the need for refined survey strategies (e.g., Rubin Observatory's LSST) to better detect and characterize such events, advancing IMBH demographics studies.
...
### [54] [Inefficient Circularization, Delayed Stream-Disk Interaction and Reprocessing: A Five-Stage Model for the Intermediate-Mass Black Hole Tidal Disruption Event EP240222a](https://arxiv.org/abs/2512.02147)
*Wenkai Li,Ning Jiang,Tinggui Wang,Rongfeng Shen,Erlin Qiao,Lixin Dai,Di Luo,Dongyue Li,Chichuan Jin,Jiazheng Zhu*

Main category: astro-ph.HE

TL;DR: EP240222a is the first IMBH TDE observed in real-time with multi-wavelength data, showing unexpected light curves. A new five-stage model explains its evolution through distinct phases, including inefficient circularization, a faint X-ray precursor, delayed stream-disk interaction, super-Eddington accretion, and subsequent decline.


<details>
  <summary>Details</summary>
Motivation: To explain the deviation of EP240222a light curves from theoretical predictions by developing a model incorporating key TDE processes.

Method: Constructed a novel five-stage model detailing physical processes during the disruption event, validated against observational data through parameter fitting (star mass ~0.4 M☉, penetration factor ~1.0).

Result: Model accurately reproduces EP240222a's light curve evolution, identifying IMBH-TDE signature features like X-ray slow rise/UV plateau, and distinguishes scenarios involving white dwarfs.

Conclusion: Establishes the observed light curve patterns as characteristic of IMBH-TDEs, providing a framework for future TDE analysis and classification.
...
### [55] [Impact of Nuclear Reaction Rate Uncertainties on Type I X-ray Burst Nucleosynthesis: A Monte Carlo Study](https://arxiv.org/abs/2512.02167)
...
### [56] [High-Energy Extractions from Horizonless Compact Objects](https://arxiv.org/abs/2512.02171)
*Parth Bambhaniya,Elisabete M. de Gouveia Dal Pino*

Main category: astro-ph.HE

TL;DR: The paper explores how naked singularities, as alternatives to black holes, might allow more efficient energy extraction through Penrose and magnetic Penrose processes by utilizing negative energy orbits and ergoregions, offering potential for understanding high-energy astrophysical phenomena.


<details>
  <summary>Details</summary>
Motivation: To investigate if naked singularities could provide a more efficient mechanism for energy extraction than black holes, given their lack of event horizons allows unique dynamics in strong gravity regimes.

Method: Review of recent theoretical studies on energy extraction in naked singularity spacetimes, focusing on rotation, electromagnetic fields, particle interactions, and comparison with black hole processes.

Result: Naked singularities enable higher energy extraction efficiencies via Penrose-type mechanisms due to accessible ergoregions and negative energy orbits; these could impact particle acceleration and astrophysical phenomena.

Conclusion: Naked singularities may be viable alternatives to black holes as energy sources, providing insights into strong-field gravity physics and multi-messenger astrophysical observations.
...
### [57] [Observing binary neutron star subpopulations with the Einstein Telescope](https://arxiv.org/abs/2512.02296)
...
### [58] [Padé Approximants for Fast Radio Bursts Diffuse Dispersion Measure](https://arxiv.org/abs/2512.02357)
*Marios Kalomenopoulos,Jiaming Zhuge*

Main category: astro-ph.HE

TL;DR: The paper presents an analytical approximation formula for calculating the differential dispersion measure (DM_diff) in FRB studies, offering a faster computation with minimal error compared to numerical methods.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this work is to address the computational inefficiency of integrating along the line-of-sight for DM_diff calculations, which is crucial for using FRBs to study cosmic ionization structures and cosmological parameters.

Method: The authors derived an analytical approximation formula for DM_diff applicable to flat ΛCDM and wCDM cosmological models, validating it over redshift ranges 0.01–2, and cosmological parameter ranges Ω_m 0.2–1.0 and w -3.0–-0.5.

Result: The approximation achieves a relative error under 3.5% (typically <0.5%) compared to numerical calculations, with computational speed up to 15x (for ΛCDM) and 2x (for wCDM) faster than numerical solutions.

Conclusion: The proposed analytical formula provides a practical and efficient tool for the FRB community to enhance studies on cosmic ionization and cosmological parameter estimation without significant loss of accuracy.
...
### [59] [The first extragalactic ultra-compact X-ray binary : a candidate black hole-white dwarf system](https://arxiv.org/abs/2512.02360)
*Qian-Qi Ma,Jiachang Zhang,Wei-Min Gu,Zhiyuan Li,Shan-Shan Weng,Tong Bao*

Main category: astro-ph.HE

TL;DR: M31 UCXB-1 is a high-luminosity X-ray binary in M31's bulge, identified as a BH-WD ultra-compact system with a 465-second orbital period. It exhibits the shortest orbital period, strongest gravitational wave emission potential, and a massive white dwarf companion among known UCXBs.


<details>
  <summary>Details</summary>
Motivation: The discovery of M31 UCXB-1's eclipsing signal during high-luminosity states and its luminosity-orbital period alignment with BH/NS-WD UCXB systems motivated this study to characterize its nature and place it within evolutionary models.

Method: XMM-Newton/Chandra observational data analyzed for periodicity and spectral properties. Theoretical L-X-Porb relations were used to model system parameters, and spectral fitting determined the compact object type (BH vs NS).

Result: M31 UCXB-1's parameters align with BH-WD UCXB systems. It has the shortest known orbital period (465s), emits potentially the strongest gravitational waves, and hosts a massive white dwarf companion.

Conclusion: The source is confirmed as a BH-WD UCXB with unique extremes in orbital period and component properties, offering insights into compact binary evolution and gravitational wave astronomy.
...
### [60] [The exotic black hole-neutron star binaries in our Galaxy](https://arxiv.org/abs/2512.02434)
*Man Ho Chan*

Main category: astro-ph.HE

TL;DR: The paper explores the existence of exotic BH-NS binaries containing dark matter density spikes around primordial black holes, which could maintain high neutron star surface temperatures and aid in detecting these elusive binaries while shedding light on dark matter properties.


<details>
  <summary>Details</summary>
Motivation: Despite the predicted abundance of BH-NS binaries in our galaxy, none have been discovered through radio searches. These systems are crucial for advancing understanding of relativistic compact objects and fundamental physics, hence the need for new detection strategies.

Method: Proposes that dark matter density spikes around primordial black holes in BH-NS binaries cause neutron stars to retain extremely high surface temperatures (~10^6 K) due to dark matter capture. This effect could be used as a detection signature.

Result: Suggests BH-NS binaries with dark matter-induced heating could be identifiable via their neutron stars' unusual temperatures, potentially improving dark matter scattering cross-section limits below 10^-47 cm².

Conclusion: The proposed mechanism offers a novel pathway to locate missing BH-NS binaries and may advance knowledge of dark matter interaction cross-sections and compact object dynamics.
...
### [61] [Modeling Particle Acceleration and MWL Emission of a PeVatron Microquasar V4641 Sgr](https://arxiv.org/abs/2512.02574)
*Anton Dmytriiev,Frans van der Merwe,Markus Böttcher*

Main category: astro-ph.HE

TL;DR: The study proposes a detailed model explaining how the microquasar V4641 Sgr accelerates particles to PeV energies and emits UHE γ-rays via inverse Compton scattering, reconciling key observations but identifying gaps needing further study.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanisms behind PeV particle acceleration in V4641 Sgr and resolve contradictions in multi-wavelength data.

Method: Combined first-principles simulations of stochastic acceleration with MWL emission modeling, using the Monte Carlo framework STRIPE to model electron acceleration via second-order Fermi process driven by relativistic turbulence. The resulting electrons produce γ-rays via inverse Compton scattering off CMB and ISRF.

Result: Model reproduces observed UHE γ-ray spectrum (up to ~0.8 PeV), hard spectral index, and PeV particle energies, but unresolved issues remain, emphasizing needs for more observations and theory refinement.

Conclusion: The model provides a plausible explanation for V4641 Sgr's extreme emission but highlights the uniqueness of the source and the challenges in astrophysical acceleration mechanisms at such high energies.
...
### [62] [A Statistical Analysis of Fluence and Energy Distributions of Non-repeating Fast Radio Bursts Detected by CHIME](https://arxiv.org/abs/2512.02588)
...
TL;DR: The study analyzes 415 non-repeating FRBs from CHIME data, revealing distinct power-law fluence distributions and a broken power-law DM distribution. The energy release shows a dominant cluster around 2.3×10^40 erg with a secondary lower-energy component, suggesting different progenitor mechanisms for FRBs.


<details>
  <summary>Details</summary>
Motivation: To understand FRB progenitors, trigger mechanisms, and radiation processes by analyzing their observational properties, including fluence, dispersion measure (DM), redshift, and isotropic energy release.

Method: Manual filtering of 415 non-repeating CHIME FRBs to ensure sample completeness. Fitted fluence with a three-segment power-law, DM with smoothly broken power-laws, and evaluated isotropic energy (E_iso) distributions using Macquart relation for redshift estimation.

Result: Fluence follows three power-laws with indices -3.76, 0.20, 2.06. Total/extragalactic DM breaks at ~703/639 pc cm^-3. Redshifts peak at z~0.6. E_iso has two Gaussian populations: one dominant cluster at ~2.3×10^40 erg and a secondary at ~1.6×10^39 erg.

Conclusion: Dominant FRB population's uniform energy suggests catastrophic progenitors, while lower-energy group's diversity hints varied origins/emission mechanisms. This supports hypotheses where most FRBs come from single events, but some (repeaters?) involve different mechanisms or evolutionary phases.
...
### [63] [Search for persistent radio emission towards selected localised Fast Radio Burst positions using the MeerKAT Telescope](https://arxiv.org/abs/2512.02693)
*Thulo Letsele,Lebogang Mfulwane,Christo Venter,James O. Chibueze,Mechiel Christiaan Bezuidenhout*

Main category: astro-ph.HE

TL;DR: The paper analyzes two candidate Persistent Radio Sources (PRS) associated with Fast Radio Bursts (FRBs) using MeerKAT data and reports a non-detection for another FRB, highlighting the need for high-resolution imaging to confirm PRS origins.


<details>
  <summary>Details</summary>
Motivation: To understand FRB progenitors, environments, and evolution by characterizing PRS associations, as only a few FRBs with confirmed PRS exist.

Method: Used MeerKAT radio telescope data to observe 25 FRB positions, identifying two candidate PRSs (FRB20221106 and FRB20181112) and one non-detection (FRB20220190102). Proposed follow-up with e-MERLIN for high-resolution imaging to distinguish host galaxy emission from PRS.

Result: Detected potential PRS candidates for two FRBs but could not confirm if emission originates from the host galaxy or PRS. Found no radio continuum for FRB20220190102, providing flux upper limits.

Conclusion: High-resolution observations are crucial to resolve whether detected radio emission is from PRS or host galaxies, emphasizing the need for telescopes like e-MERLIN to study FRB-PRS associations further.
...
### [64] [Insights into Extragalactic Background Light constraints with MAGIC archival data](https://arxiv.org/abs/2512.02880)
*R. Grau,A. Moralejo*

Main category: astro-ph.HE

TL;DR: The study investigates the discrepancy between observed and predicted extragalactic background light (EBL) in the optical band by analyzing the impact of assumptions about the intrinsic spectra of very high energy (VHE) sources on EBL density estimates. Using Monte Carlo simulations and MAGIC telescope data, they show EBL constraints depend heavily on these assumptions and propose methods to reduce them for more reliable results, crucial for future VHE observatories.


<details>
  <summary>Details</summary>
Motivation: To address the controversy where direct EBL measurements exceed expectations from known galaxies, and to improve the robustness of EBL density estimates by minimizing assumptions about source spectra, especially critical for next-generation VHE facilities.

Method: Monte Carlo simulations and archival MAGIC telescope data were used to study how assumptions about intrinsic VHE source spectra affect EBL density estimates. Two methods to reduce these assumptions and improve result reliability were explored.

Result: EBL density constraints are highly dependent on the assumed spectral shape of the sources. The proposed methods to minimize spectral assumptions yield more robust results, which is vital for future observations with reduced statistical uncertainties.

Conclusion: Assumptions about source spectra significantly affect EBL estimates. Adopting less restrictive spectral models is essential for accurate EBL measurements, particularly as next-generation VHE facilities reduce statistical uncertainties, making systematic ones more impactful.
