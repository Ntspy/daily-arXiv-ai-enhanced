...
### [5] [Particle Physics Driven by Quantum Technology - Quantum Simulations and Quantum Sensing](https://arxiv.org/abs/2609.20500)
...
### [6] [SHiP as a (post-)discovery machine: identifying the diphoton signals' origin](https://arxiv.org/abs/2609.19269)
...
### [7] [Lukewarm inflation, primordial black holes and gravitational waves](https://arxiv.org/abs/2609.19270)
...
### [8] [Probing Scalar-Induced First-Order Phase Transitions with the Diffuse Supernova Neutrino Background](https://arxiv.org/abs/2609.19271)
...
### [9] [Lukewarm inflation and the QCD axion](https://arxiv.org/abs/2609.19284)
*Paulo B. Ferraz,António Torres Manso,João G. Rosa*
...
### [11] [Generalized parton distributions: Theory meets experiment](https://arxiv.org/abs/2609.19544)
...
### [12] [T-odd Effect from Two-Photon Exchange in SIDIS at Low Transverse Momentum](https://arxiv.org/abs/2609.19574)
*J. P. Ma,G. P. Zhang*
...
### [13] [Higher twists in QCD](https://arxiv.org/abs/2609.19620)
*W. Melnitchouk*
...
### [14] [Strange Two-Photon Exchange in Time-Like Electromagnetic Form Factors](https://arxiv.org/abs/2609.19652)
...
### [15] [Clarifying the puzzling mass shift of the $ψ(4160)$ via a reanalysis of $R$-value data with unquenched charmonium spectroscopy](https://arxiv.org/abs/2609.19673)
...
### [16] [Neutralino Dark Matter in SU(5) after H.E.S.S. and Direct-Detection Searches](https://arxiv.org/abs/2609.19675)
...
### [17] [Hidden charm pentaquarks and the nature of $P_{c}$ states observed at LHCb](https://arxiv.org/abs/2609.19749)
...
### [19] [Measure of the kaon structure: generalized valence quark distribution functions and form factors](https://arxiv.org/abs/2609.19861)
...
### [20] [Colour sextet baryons in composite Higgs models](https://arxiv.org/abs/2609.19918)
*Manuel Kunkel*
...
### [21] [New massive resonances at the LHC](https://arxiv.org/abs/2609.19919)
*Rosy Caliri*
...
### [22] [Study of the $e^+e^- \to φK^+K^-$ reaction within triangle dynamics and its implications for the $φ(2170)$](https://arxiv.org/abs/2609.19951)
...
### [23] [Stasis Combs: Gravitational-Wave Signatures of Recurrent Cosmological Stasis](https://arxiv.org/abs/2609.20280)
...
### [24] [Paired charmonium and bottomonium production in rare exclusive decays of Z boson](https://arxiv.org/abs/2609.19952)
...
### [25] [On the Maximal CP Violation in Leptogenesis with Two Right Handed Neutrinos](https://arxiv.org/abs/2609.20033)
*Swapnil Dutta*
...
### [26] [Comparing theoretical descriptions of Drell-Yan angular coefficients](https://arxiv.org/abs/2609.20362)
...
### [27] [Investigation of low-lying $Ω_b(1P)$ states in an unquenched coupled-channel framework](https://arxiv.org/abs/2609.20392)
...
### [34] [Schwarzschild solution from a Raychaudhuri-Huygens relation](https://arxiv.org/abs/2609.19171)
...
### [35] [An Operative Viability Boundary for Relaxed Single-Particle Penrose Extraction in Kerr-Vaidya Spacetimes](https://arxiv.org/abs/2609.19175)
*Fabio Buffoli*
...
### [36] [Bosonic stars with dark electroweak fields](https://arxiv.org/abs/2609.19273)
...
### [37] [Deep Learning Detection of Beyond-General-Relativity Deviations in Gravitational-Wave Signals: A Detection-Threshold Study with Real LIGO Noise](https://arxiv.org/abs/2609.19416)
...
### [38] [On Stochastic Memory Backgrounds In LISA](https://arxiv.org/abs/2609.19462)
...
### [39] [Classical Noise in Transient USR Inflation](https://arxiv.org/abs/2609.19478)
...
### [40] [Relativistic Stellar Oscillations from Ultralight Dark Matter](https://arxiv.org/abs/2609.19500)
...
### [41] [Extending the Love-Q Relation to Rapidly Rotating Neutron Stars for Gravitational-Waveform Modelling](https://arxiv.org/abs/2609.19975)
...
### [42] [Extremal Scalarization of Charged Black Holes: Miransky Scaling across Reissner-Nordström Extremality](https://arxiv.org/abs/2609.20040)
...
### [43] [Higher-order generalized uncertainty principle corrections to Casimir-supported traversable wormholes](https://arxiv.org/abs/2609.20168)
...
### [44] [Radiative losses from unbound orbits at quadratic order in spin from MPM formalism](https://arxiv.org/abs/2609.20185)
...
### [45] [Jordan-like invariant representations of scalar-tensor gravity and the return of imperfect-fluid thermodynamics](https://arxiv.org/abs/2609.20189)
...
### [46] [Entropy production during reheating after inflation and General Relativistic Entropic Acceleration](https://arxiv.org/abs/2609.20242)
*Juan Garcia-Bellido*
...
### [47] [Quasinormal modes of Schwarzschild--AdS black holes with a near-horizon reflective surface](https://arxiv.org/abs/2609.20382)
...
### [48] [Gravity from Invariant Weyl-Integrable space-time (IWIST)](https://arxiv.org/abs/2609.20619)
...
### [49] [The return of Palatini inflationary attractors: Universal mapping of observables](https://arxiv.org/abs/2609.20622)
...
### [50] [On the Extended Kerr-Newman-Bertotti-Robinson Spacetime: Two Black Holes and a Naked Singularity in Bertotti-Robinson Universe](https://arxiv.org/abs/2609.20626)
...
### [51] [Entropy, area, and the choice of regulator during gravitational collapse](https://arxiv.org/abs/2609.20663)
...
### [52] [Spin-network states for the Bianchi I and IX cosmological models from quantum constrained symmetries](https://arxiv.org/abs/2609.20703)
...
### [53] [Gravitas: A Browser-Based Astrophysics Laboratory for Prediction, Measurement, and Discovery](https://arxiv.org/abs/2609.19327)
*Carl Ziegler*
...
### [54] [Investigation of magnetic-field effects on photomultiplier tubes for the first Large-Sized Telescope of the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2609.19633)
...
### [55] [Semi-automated single-mode fiber coupling for AO-fed spectrographs](https://arxiv.org/abs/2609.19978)
...
### [56] [The SHARPEx space-to-space VLBI experiment](https://arxiv.org/abs/2609.20102)
...
### [57] [Offline vs Real-Time Validation and Performance Assessment of Heimdall Detection Pipeline for Fast Radio Bursts](https://arxiv.org/abs/2609.20635)
...
### [58] [All-Fiber Broadband Wavelength-Division Multiplexing using Heterogeneous Photonic Lanterns](https://arxiv.org/abs/2609.20642)
...
### [59] [A Significant Dust Reservoir Uncovered with JWST in the Type Ic SN 1983V More Than 40 Years Post-Explosion](https://arxiv.org/abs/2609.19263)
...
### [60] [Hydrodynamic Simulations of Eccentric Black Hole Encounters in AGN Discs](https://arxiv.org/abs/2609.19281)
...
### [61] [Lepto-hadronic modeling of blazars associated with well-reconstructed high-energy neutrino events](https://arxiv.org/abs/2609.19477)
...
### [62] [Polarization of Synchrotron Emission from Rotation Powered Pulsars](https://arxiv.org/abs/2609.19741)
...
### [63] [The rise and decline of a transient obscuration event in a moderately distant type-I quasar](https://arxiv.org/abs/2609.19910)
...
### [64] [Investigating the influence of the full-kinematics treatment for charged-current processes in binary neutron star mergers](https://arxiv.org/abs/2609.19922)
...
### [65] [Systematic Effects of Hydrogen and Helium Atmosphere Mismatch on Radius Inference in PSR~J0740+6620-like Synthetic NICER Data](https://arxiv.org/abs/2609.20795)
...
### [66] [A 32-day Quasi-periodic Modulation in the Post-peak Light Curve of the Superluminous Supernova SN 2018bsz](https://arxiv.org/abs/2609.19984)
...
### [67] [The 2025.6 X-ray Minimum of Eta Carinae](https://arxiv.org/abs/2609.20046)
...
### [68] [Evolution and mergers of eccentric white dwarf binaries encountering intermediate-mass black holes](https://arxiv.org/abs/2609.20338)
...
### [69] [Low Frequency Radio Imaging Study of PSR J1818-1607](https://arxiv.org/abs/2609.20745)
...
### [70] [A systematic search for long GRBs without supernovae: global properties and rate of events](https://arxiv.org/abs/2609.20787)
