...
### [2] [Optimization of lenslet arrays for PRIMA Kinetic Inductance Detectors](https://arxiv.org/abs/2511.10773)
...
### [3] [Mock Observations for the CSST Mission: Main Surveys -- the Mock Catalogue](https://arxiv.org/abs/2511.10805)
...
TL;DR: The study presents a mock catalogue of stars and galaxies for the Chinese Space Station Survey Telescope (CSST) mission, designed to simulate data for dark matter and dark energy research. The catalogue uses simulations and deep learning to generate realistic galaxy and stellar properties, validated against observations and models.


<details>
  <summary>Details</summary>
Motivation: The CSST mission requires comprehensive simulations to prepare for its large-area sky survey, which will study dark matter and dark energy. The mock catalogue addresses the need for realistic data to test image processing and enable cosmological analyses.

Method: Stars were simulated using Galaxia or TRILEGAL, while galaxies were generated from N-body simulations, semi-analytical models, and weak lensing ray-tracing. A deep-learning model predicted galaxy spectral energy distributions (SEDs) to compute multi-band magnitudes. Properties like redshifts, stellar masses, and lensing shears were included.

Result: A validated mock catalogue with stellar and galaxy properties aligned with observational data and theoretical predictions. It supports CSST's image simulation needs and cosmological studies.

Conclusion: The mock catalogue is a flexible, reliable resource for CSST mission preparation, enabling robust image processing development and advanced cosmological research on dark matter/energy.
...
### [4] [Evolutionary Map of the Universe: A pilot survey to detect high Galactic latitude pulsars in variance images with ASKAP](https://arxiv.org/abs/2511.10886)
...
### [5] [PRIMA General Observer Science Book Volume 2](https://arxiv.org/abs/2511.10927)
*A. Moullet,D. Burgarella,T. Kataria,H. Beuther,C. Battersby,M. Cheng,T. Essinger-Hileman,H. Inami,E. Mills,T. Nagao,S. Unwin*

Main category: astro-ph.IM

TL;DR: The PRIMA mission concept, proposed to NASA's APEX program, features a cryogenic 1.8m telescope with imaging polarimeter and spectrometer instruments to cover 24-264μm wavelengths. The 75% open community observation time and public data will enable diverse astrophysics research, as detailed in the second volume of the PRIMA Science Book, aligning with over 90% of Astro2020 decadal survey priorities.


<details>
  <summary>Details</summary>
Motivation: PRIMA aims to expand astrophysical understanding by addressing key questions from the Astro2020 survey through community-driven observations, building on the success of its first science book and fostering broad scientific engagement.

Method: Utilizes a cryogenically cooled telescope with two instruments (PRIMAger for imaging polarimetry and FIRESS for spectroscopy) across the far-infrared spectrum. Allocates most observing time to community proposals (GO/GI programs) and ensures open data access.

Result: Volume 2 of the PRIMA Science Book includes 120 new science cases demonstrating PRIMA's versatility for diverse astrophysical studies, validating its ability to meet decadal survey goals.

Conclusion: PRIMA's design and open-access model promise significant scientific impact across astrophysics disciplines, solidifying its alignment with community priorities outlined in Astro2020.
...
### [6] [Surface figure metrology for reflective membrane mirrors based on phase-measuring deflectometry](https://arxiv.org/abs/2511.11049)
...
### [7] [A Simulation Platform for Small Solar System Bodies using the Einstein-Elevator](https://arxiv.org/abs/2511.11121)
...
### [8] [Spectropolarimetric Evolution Reveals Dual-Axis Ejecta in the Atypical Magnetar-Powered SN 2012au](https://arxiv.org/abs/2511.10700)
...
### [9] [Widening of Binaries via Non-conservative Mass Transfer as a Formation Channel for Gaia Black Hole System](https://arxiv.org/abs/2511.10728)
...
TL;DR: The study proposes that non-conservative mass transfer with mass loss carrying the donor's angular momentum can explain the wide orbital periods of Gaia black hole systems, challenging conventional binary evolution models.


<details>
  <summary>Details</summary>
Motivation: To resolve the discrepancy between observed Gaia BH systems' orbital periods and predictions of standard models, which either lead to mergers or tighter orbits.

Method: Detailed binary evolution calculations testing a non-conservative mass transfer model where mass loss carries the donor's specific angular momentum, contrasting with standard isotropic re-emission.

Result: The model reproduces observed orbital periods without fine-tuning, applicable across initial conditions and suggesting orbital widening via Roche-lobe dynamics and eruptive mass loss.

Conclusion: This mechanism provides a plausible pathway for Gaia BH systems and may be relevant for other post-mass-transfer binaries like neutron star, white dwarf, and stripped-envelope systems.
...
### [10] [Intra-night optical polarization monitoring of blazars](https://arxiv.org/abs/2511.10736)
...
TL;DR: The study reveals intra-night optical polarization variability in blazars over minute timescales, indicating turbulent magnetic fields with a preferred orientation.


<details>
  <summary>Details</summary>
Motivation: To discern between competing models of blazar emission by studying short-timescale polarization changes, which offer critical insights into particle acceleration and high-energy emission mechanisms.

Method: Pilot study using RoboPol at Skinakas Observatory and supplementary data from Calar Alto, Perkins, and Sierra Nevada observatories for intra-night optical polarization monitoring.

Result: Detected variability as short as minutes, with small polarization degree changes (a few percent) and polarization angle shifts <20 degrees, suggesting turbulent magnetic fields alongside a stable preferred orientation.

Conclusion: Observed variability patterns support models where turbulent magnetic fields contribute to optical emission, while stable polarization angles imply a dominant magnetic field direction in blazar jets.
...
### [11] [Hybrid Simulations of Supersonic Shear Flows: I) Particle Acceleration](https://arxiv.org/abs/2511.10739)
*Naixin Liang,Damiano Caprioli*

Main category: astro-ph.HE

TL;DR: The authors use 2D hybrid simulations to study decaying shear flows across the subsonic-to-supersonic transition, showing that supersonic shears produce shocklets leading to faster dissipation, nonthermal particles, and magnetic field amplification, with implications for astrophysical environments like molecular clouds and accretion disks.


<details>
  <summary>Details</summary>
Motivation: To understand how supersonic flows dissipate energy through shocklets rather than the Kelvin-Helmholtz instability observed in subsonic flows, and their effects on particle acceleration, magnetic turbulence, and viscosity in astrophysical contexts.

Method: 2D hybrid (kinetic ions - fluid electrons) simulations of decaying shear flows varying the Mach number to observe transitions from subsonic to supersonic conditions.

Result: Supersonic shears generate shocklets causing rapid dissipation, nonthermal particle production, increased kinetic viscosity, and magnetic turbulence. Observations show a Mach number dependence in these processes.

Conclusion: Supersonic shear dynamics dominate energy dissipation mechanisms in astrophysical plasmas, influencing turbulence in the warm interstellar medium, molecular clouds, and accretion disks, with further study needed on energetic particles' role.
...
### [12] [The Quiescent Merging Nature of the Coma Cluster Revealed by ICM Velocity Structure](https://arxiv.org/abs/2511.10740)
...
### [13] [XSNAP: An X-ray Supernova Analysis Pipeline with Application to the Type II Supernova 2024ggi](https://arxiv.org/abs/2511.10744)
*Ferdinand,W. V. Jacobson-Galán,M. M. Kasliwal,Erez A. Zimmerman*

Main category: astro-ph.HE

TL;DR: The paper presents multi-epoch X-ray observations of SN II 2024ggi using Swift-XRT, Chandra, and XMM, analyzed with a new Python tool XSNAP. The results reveal a steady progenitor mass-loss rate of ~6.2e-5 Solar masses per year over the last 117 years before the explosion.


<details>
  <summary>Details</summary>
Motivation: To study SN shocks and progenitor mass-loss histories through X-ray analysis, while developing a standardized tool (XSNAP) for X-ray supernova data reduction and modeling.

Method: Collected X-ray data across 1-344 days post-explosion. Developed XSNAP for unified data reduction, spectral extraction, and modeling via PyXspec/emcee MCMC. Applied an absorbed thermal bremsstrahlung model to the spectra.

Result: Determined a steady mass-loss rate of (6.2±0.2)e-5 M☉/yr (assuming 20 km/s wind velocity) over the final 117 years before the SN. XSNAP is released publicly on GitHub and PyPI.

Conclusion: XSNAP enables efficient X-ray SN analysis, providing insights into progenitor mass loss. The steady wind rate suggests stable mass loss prior to SN 2024ggi's explosion, informing models of massive star evolution.
...
### [14] [Hydrogen-Poor Superluminous Supernovae in the Nebular Phase: Spectral Diversity Due to Ejecta Ionization as a Probe of the Power Source](https://arxiv.org/abs/2511.10747)
...
TL;DR: The study analyzes 39 optical spectra of 25 hydrogen-poor superluminous supernovae (SLSNe-I) and compares them with existing data, revealing significant spectral diversity in ionization states and identifying correlations between ionization ratios (L7300/L6300), light curve features, and progenitor magnetar properties. These findings highlight the role of magnetar spin-down energy and late-time CSM interaction in powering SLSNe.


<details>
  <summary>Details</summary>
Motivation: To understand the physical mechanisms powering superluminous supernovae (SLSNe), particularly the role of magnetars and circumstellar material (CSM) interactions, by quantifying spectral features and their evolution over time.

Method: Analyzing a large sample of SLSNe-I optical spectra (39 new + 12 existing) to measure key emission line properties ([O I] at 6300Å, [Ca II]/[O II] at 7300Å, O I at 7774Å), tracking their ratios (especially L7300/L6300) over time, and correlating these with light curve parameters.

Result: SLSNe-I show diverse ionization states: some with high L7300/L6300 (indicating [O II], [O III], and ionized oxygen) and others with weak ionized oxygen. The ratio L7300/L6300 decreases over time for most, but some outliers show sustained/increasing ratios. Ionization correlates with magnetar spin-down timescales and ejecta mass (for M_ej <12 solar masses), while outliers suggest CSM interaction.

Conclusion: The ionization ratio L7300/L6300 and its temporal evolution serve as critical diagnostics for distinguishing SLSN power sources: magnetar energy input dominates in slowly evolving events with early ionization, whereas CSM interaction may explain outlier spectral behaviors. This establishes a connection between light curve dynamics and late-phase spectral properties.
...
### [15] [EUSO-SPB2 Cherenkov Telescope: Overview and First Neutrino Constraints](https://arxiv.org/abs/2511.10944)
...
TL;DR: The paper discusses the analysis of data from the EUSO-SPB2 Cherenkov telescope's 2023 balloon flight, focusing on searches for Earth-skimming tau neutrinos via atmospheric interactions. Results provide upper limits on diffuse astrophysical neutrino fluxes and outline methods for probing transient neutrino sources.


<details>
  <summary>Details</summary>
Motivation: The goal is to detect high-energy neutrinos (≳10 PeV) which can interact in Earth's atmosphere, producing detectable Cherenkov light flashes. This helps in studying astrophysical neutrino sources and validating detection methodologies for future missions.

Method: Using the EUSO-SPB2 CT during a short balloon flight, the team analyzed data from periods when the telescope pointed below the Earth's limb. They searched for optical Cherenkov signals from tau lepton decays, set upper limits on neutrino fluxes, and developed techniques extendable to point-source searches.

Result: The flight data established upper limits on the diffuse astrophysical neutrino flux, demonstrating the CT's capability. No significant neutrino events were detected, but this provides baseline constraints. Methodological advancements enable future transient source analyses.

Conclusion: The EUSO-SPB2 CT proved viable for Earth-skimming neutrino detection through atmospheric Cherenkov signals. The results validate the technique and pave the way for more sensitive experiments, emphasizing the importance of balloon-based observatories in high-energy neutrino astronomy.
...
### [16] [Accuracy and Applicability of the Hartle-Thorne and Komatsu-Eriguchi-Hachisu Methods for Modeling Rotating Neutron Stars](https://arxiv.org/abs/2511.10996)
...
### [17] [Measurement of cosmic-ray muon flux at CJPL-II](https://arxiv.org/abs/2511.11050)
...
### [18] [Discovery of an X-ray bridge between the comma-shaped gas and the main cluster in MCXC J0157.4-0550](https://arxiv.org/abs/2511.10968)
*Chong Yang,Nobuhiro Okabe,Yasushi Fukazawa*

Main category: astro-ph.HE

TL;DR: Discovered an X-ray bridge in the merging galaxy cluster MCXC J0157.4-0550 via XMM-Newton data, analyzing its structure with topological and filtering methods, validated by weak-lensing analysis. The filamentary gas structure suggests merger dynamics involving ram pressure stripping and tidal forces, with mass estimates and merger parameters derived.


<details>
  <summary>Details</summary>
Motivation: To understand cluster mergers' dynamics and gas distribution by studying X-ray structures and their alignment with mass components using multi-wavelength observations.

Method: Used XMM-Newton X-ray imaging and Subaru/HSC weak-lensing analysis. Applied topological feature detection and Gaussian Gradient Magnitude filtering to identify filaments. Combined stellar mass priors with WL data to estimate halo masses and merger parameters.

Result: Detected a 5.5σ X-ray bridge filament, confirmed two mass components with M200 masses of 2.68e14 and 0.46e14 solar masses. Found halo axis aligns with main cluster direction. Derived infalling velocity (~1000 km/s) and impact parameter (0.9 Mpc) from combined data.

Conclusion: X-ray filamentary structures provide critical merger parameters and clarify that X-ray tails don't necessarily point opposite to merger motion. Multi-probe analysis (X-ray+weak-lensing) is essential for accurately modeling cluster mergers and their dynamics.
...
### [19] [Highly Polarized Intrinsic Emission and its Orthogonal Counterpart in Vela X-1](https://arxiv.org/abs/2511.11075)
*WanYun Wu,Fei Xie,Long Ji,Mingyu Ge,Fabio La Monaca*

Main category: astro-ph.HE

TL;DR: The study of Vela X-1 using IXPE data revealed two distinct polarized components from its accretion processes, with one showing unprecedented polarization degrees and another correlating with column density, validated via rotating vector model.


<details>
  <summary>Details</summary>
Motivation: To understand the polarimetric properties of Vela X-1, a key X-ray pulsar, by analyzing orthogonal polarization states and their physical origins.

Method: Analyzing IXPE data with a triple power-law spectral model and varying column densities to isolate two polarization components. Used rotating vector model (RVM) for fitting polarization angles.

Result: First detection of >30% polarization in neutron star accretion (peaking at 50.9%), second component shows PD vs column density correlation. Successful separate/simultaneous RVM fitting after 90° PA rotation.

Conclusion: High polarization from unobscured accretion mound emission and complex processes near the mound are confirmed, advancing X-ray pulsar emission models.
...
### [20] [A glitch in the millisecond pulsar J0900$-$3144](https://arxiv.org/abs/2511.11336)
...
TL;DR: Detection of a glitch in the millisecond pulsar PSR J0900$-$3144, the third ever observed in an MSP, highlighting the need for caution in PTA data analysis due to potential undetected glitches and their impact on noise modeling.


<details>
  <summary>Details</summary>
Motivation: To identify and characterize glitches in MSPs for improving pulsar timing array (PTA) sensitivity and reliability in gravitational wave searches, ensuring accurate noise parameter estimation.

Method: Analysis of 14 years of multi-telescope timing data (MeerKAT, Nançay, Lovell, Murriyang) to detect the glitch, coupled with simulations to assess detection feasibility and noise parameter biasing.

Result: Observed a fractional spin frequency step of 1.15(13)×10⁻¹², updated MSP glitch rate to ~2.5×10⁻³/yr/pulsar, and demonstrated small glitches can remain undetected in short datasets, affecting noise models and PTA weights.

Conclusion: Current PTAs will likely detect another MSP glitch within five years. Undetected glitches may bias noise parameters, necessitating revised data analysis strategies to avoid compromising gravitational wave background searches.
...
### [21] [Modeling the Multi-Wavelength Afterglow of Short Gamma-Ray Bursts with a Plateau Phase](https://arxiv.org/abs/2511.11396)
*Chen Deng,Yong-Feng Huang,Abdusattar Kurban,Jin-Jun Geng,Fan Xu,Xiao-Fei Dong,Hao-Xuan Gao,En-Wei Liang,Liang Li*

Main category: astro-ph.HE

TL;DR: Using broadband observations, the study finds multi-wavelength data improves constraints on magnetar parameters in short GRBs, showing lower magnetic fields and shorter spin periods compared to X-ray only studies. Differences in initial Lorentz factor and gamma-ray energy compared to long GRBs suggest diagnostic potential for progenitor studies.


<details>
  <summary>Details</summary>
Motivation: Previous X-ray-only analyses of short GRBs with plateau phases had parameter degeneracies in magnetar models. The goal is to reduce these degeneracies and better understand central engine activity by adding optical and radio data.

Method: Broadband afterglow modeling of seven short GRBs with plateau phases using X-ray, optical, and radio data under the magnetar energy injection model. Parameters were derived via Markov Chain Monte Carlo method.

Result: Energy injection significantly altered afterglow dynamics. Multi-wavelength analysis resulted in lower magnetic fields, shorter magnetar spin periods, and higher injection luminosity compared to X-ray only. Differences from long GRBs in Lorentz factor vs. gamma-ray energy plane noted.

Conclusion: Multi-wavelength data is critical for breaking parameter degeneracies in magnetar models and provides insights into progenitor differences between short and long GRBs. Larger sample studies could enhance diagnostic capabilities.
...
### [22] [Star clusters in the gamma-ray sky](https://arxiv.org/abs/2511.11432)
*Giada Peron*

Main category: astro-ph.HE

TL;DR: This paper explores the role of massive star clusters (SCs) as contributors to Galactic cosmic rays (CRs), particularly in addressing SNRs' limitations at high energies. It reviews gamma-ray data from young SCs and their potential in CR acceleration up to PeV energies, considering the impact of collective stellar winds and the need for observational validation.


<details>
  <summary>Details</summary>
Motivation: SNRs' inability to fully account for the highest energy CRs necessitates exploring alternative sources. SCs, with their fast mass loss from collective stellar winds, provide a plausible environment for particle acceleration to PeV energies and sufficient energetics to contribute significantly to Galactic CRs. Observational constraints are critical to validate these theoretical predictions.

Method: The study reviews existing gamma-ray observations of young (less than a few million years old) massive star clusters to isolate SC contributions, minimizing contamination from other sources like SNRs. It analyzes the data to assess their effectiveness as CR accelerators before stellar explosions occur within the clusters.

Result: Gamma-ray data from young SCs show detectable signals, though contamination remains an issue. The analysis suggests SCs could account for a non-negligible fraction of Galactic CRs, particularly in the PeV energy range, but definitive conclusions require more precise measurements to disentangle source contributions.

Conclusion: Young massive SCs are viable candidates for contributing to Galactic CRs, especially at the highest energies. Future observations focusing on contamination-reduced datasets and younger clusters can strengthen the case for SCs as significant CR accelerators, challenging the traditional SNR为主的 paradigm.
...
### [23] [Noncommutative black holes in extended anti-de Sitter phase space](https://arxiv.org/abs/2511.10820)
*Athanasios G. Tzikas*

Main category: gr-qc

TL;DR: The paper investigates thermodynamic properties of noncommutative black holes in various dimensions using an extended anti-de Sitter phase space, finding phase transitions akin to Van der Waals and a new 'anti-Hawking-Page' transition in 2D.


<details>
  <summary>Details</summary>
Motivation: To explore how treating the cosmological constant and noncommutative geometry parameters as thermodynamic variables affects black hole phase behavior across dimensions.

Method: Analyzing thermodynamics in extended anti-de Sitter phase space, considering negative cosmological constant as pressure and minimal cut-off length as tension, across 2D, 3D, and 4D noncommutative black hole spacetimes.

Result: 4D shows small/large black hole phase transition like Van der Waals; 3D stable thermodynamically; 2D exhibits novel anti-Hawking-Page transition.

Conclusion: Noncommutative geometry parameters significantly influence black hole phase structures, with dimensionality dictating distinct thermodynamic behaviors and new transition types.
...
### [24] [The Semiclasscical limit of $SU(3)$ Gauge Field Coherent States: Peakedness and Overlap Functions](https://arxiv.org/abs/2511.10969)
*Ye Zhang,Zichang Huang*

Main category: gr-qc

TL;DR: The paper constructs diffeomorphism-covariant coherent states for SU(3) gauge group using heat kernel method, demonstrating their semiclassical properties and providing overlap amplitude terms, essential for deriving effective dynamics of SU(3) gauge fields coupled to gravity.


<details>
  <summary>Details</summary>
Motivation: To create a foundational tool for deriving effective dynamics of SU(3) gauge fields coupled to gravity through coherent state path integrals, requiring states with proper semiclassical behavior.

Method: Uses heat kernel method to build coherent states for SU(3) gauge group. Numerically verifies peakedness of probability distribution and overlap function. Analyzes leading order term of overlap amplitude in the combined limit t→0 and g→g'.

Result: States exhibit required semiclassical properties (peakedness in probability and overlap). Leading order term of overlap amplitude derived in specified limits.

Conclusion: The constructed coherent states successfully meet semiclassical criteria, providing necessary tools for future studies on effective dynamics of SU(3) gauge fields with gravity.
...
### [25] [Quantum Electron Clouds near Black Holes: Black Atoms and Molecules](https://arxiv.org/abs/2511.11173)
*Hinako Iseki,Shin Sasaki,Kenta Shiozawa*

Main category: gr-qc

TL;DR: The paper investigates quantum wavefunctions near black holes, finding that electrons in 'black hydrogen' systems are localized near the event horizon due to strong gravitational effects, influencing quantum and chemical properties. Extensions to multi-black hole molecular systems are also explored.


<details>
  <summary>Details</summary>
Motivation: To understand how extreme gravitational fields of black holes affect quantum systems and their chemical properties, extending beyond classical physics.

Method: Using DeWitt's formalism, the Schrödinger equation is derived for electrons around Schwarzschild and Reissner-Nordström black holes. Numerical solutions analyzed the wavefunction localization.

Result: Electron wavefunctions are localized near black hole horizons, with higher probability of trapping. This quantum effect impacts chemical properties and suggests a framework for multi-black hole molecular structures.

Conclusion: Strong gravity significantly alters quantum behavior of atoms, indicating that both classical and quantum/chemical properties are influenced by black holes, opening avenues for studying gravitational effects in quantum chemistry.
...
### [26] [On Nonrelativistic Isotropic and Homogeneous Universe](https://arxiv.org/abs/2511.11268)
*R. G. G. Amorim,A. F. Santos,K. V. S. Araújo,S. C. Ulhoa*

Main category: gr-qc

TL;DR: This paper presents a nonrelativistic cosmological model using Galilean covariance in a five-dimensional manifold, deriving solutions analogous to FRW metrics without a universal speed limit. It explores vacuum and dust-dominated universes, showing how dimensional reduction introduces anisotropy aligning with observational data, and recovers Milne's cosmology under certain conditions.


<details>
  <summary>Details</summary>
Motivation: To explore cosmological dynamics outside the relativistic framework by applying Galilean covariance, providing an alternative to general relativity in nonrelativistic regimes. This aims to understand universe expansion and structure without assuming a universal speed limit, potentially explaining observed anisotropies and zero spatial curvature.

Method: Formulate a five-dimensional Galilean manifold, construct a metric similar to Friedmann–Robertson–Walker but without relativity constraints. Solve Einstein-like equations for vacuum (λ=0) and dust-dominated (λ=1) scenarios. Perform dimensional reduction to 3+1 dimensions to introduce anisotropy, then analyze consistency with Planck data on spatial curvature.

Result: Two solutions obtained: exponential-quadratic scale factor in vacuum and non-interacting dust fluid model. Dimensional reduction induces anisotropy matching near-zero curvature observations. Recovers Milne's Newtonian cosmology when spatial curvature vanishes, showing pressureless consistency.

Conclusion: Galilean covariant cosmology offers a valid nonrelativistic framework reproducing key features like Milne's model and observed anisotropies. This suggests alternative approaches to cosmological dynamics where relativity principles may not apply, expanding theoretical possibilities in low-speed universe scenarios.
...
### [27] [Molecular analogue for scalar dynamics in a tachyonic metric](https://arxiv.org/abs/2511.11379)
*Davi de Moura Esposti Moreira,Matheus Elias Pereira,Alexandre Grezzi de Miranda Schmidt*

Main category: gr-qc

TL;DR: The paper proposes using the hydrogen molecule ion as an analogue system to study tachyon-induced gravitational effects, modeling tachyonic spacetime with an AII metric and analyzing particle behavior via the Klein-Gordon equation. It shows that the ion's electron dynamics can mimic quasinormal modes and Hawking radiation of such systems through an external potential.


<details>
  <summary>Details</summary>
Motivation: To create a testable molecular model for extreme gravitational phenomena involving tachyons, which are unobservable in reality, allowing study of their spacetime effects without direct detection.

Method: Model tachyonic spacetime using an AII metric; apply the Klein-Gordon equation to analyze scalar field behavior; compute quasinormal modes and Hawking radiation spectra; compare with hydrogen molecule ion electron dynamics under external potentials.

Result: Demonstrated that radial/angular wave functions of test particles in tachyonic fields match those of electrons in hydrogen molecule ions with external potentials, successfully replicating gravitational effects at a molecular scale.

Conclusion: Hydrogen molecule ions can serve as viable molecular analogues for exploring extreme gravitational systems involving tachyons, providing a lab-based platform to study otherwise unobservable phenomena.
...
### [28] [Regularized Black Hole Solution from a New String Cloud Source](https://arxiv.org/abs/2511.11419)
...
### [29] [\textit{Euclid}: From Galaxies to Gravitational Waves -- Forecasting Stochastic Gravitational Wave Background Anisotropies and Their Cross-Correlation](https://arxiv.org/abs/2511.11509)
...
TL;DR: The paper predicts the amplitude and spatial anisotropy of the stochastic gravitational wave background (SGWB) from compact binary coalescence (CBC) events using the Flagship Simulation Galaxy Catalogue, comparing predictions with semi-analytical models and introducing a Bayesian framework for parameter inference.


<details>
  <summary>Details</summary>
Motivation: To understand the contribution of CBC events (BBH, BNS, BHNS) to the SGWB, quantify spatial anisotropy, and develop a framework linking SGWB data with galaxy observations (like Euclid) for astrophysical insights.

Method: 1. Use the Flagship Simulation Galaxy Catalogue to model star-formation histories of galaxies. 2. Calculate each galaxy's contribution to SGWB energy density via CBC mergers. 3. Aggregate contributions across all galaxies to predict SGWB frequency spectrum and anisotropy. 4. Compare with semi-analytical models, identify key parameters, and apply Bayesian inference under cosmic variance-limited conditions.

Result: First预测了CBC产生的SGWB的频谱和空间各向异性，通过贝叶斯框架确定有效参数，为结合Euclid星系数据开辟了路径。与现有模型的对比验证了方法的可行性，为未来关联SGWB和光学观测奠定基础。

Conclusion: Developed a foundational method to connect SGWB anisotropy with galaxy data, enabling future extraction of astrophysical information. This work is a critical step toward leveraging multi-messenger astronomy with upcoming surveys like Euclid.
...
### [30] [Accurate models for recoil velocity distribution in black hole mergers with comparable to extreme mass-ratios and their astrophysical implications](https://arxiv.org/abs/2511.11536)
*Tousif Islam,Digvijay Wadekar*

Main category: gr-qc

TL;DR: This paper introduces new models (gwModel_kick_q200 and gwModel_kick_prec_flow) to accurately predict remnant recoil velocities from binary black hole mergers using a combination of analytical and data-driven methods, addressing limitations of previous models and demonstrating impact on black hole retention in globular clusters.


<details>
  <summary>Details</summary>
Motivation: To address discrepancies between existing analytic models and numerical relativity data, and to extend the applicability of data-driven models to higher mass ratios (up to q=200) and precessing spins, improving predictions for hierarchical mergers in environments like AGNs or globular clusters.

Method: The authors use ~5000 numerical relativity simulations from SXS/RIT catalogs (up to q=128) and ~100 black hole perturbation theory simulations (up to q=200) to train two models: an analytic/GPR model for aligned spins (gwModel_kick_q200) and a normalizing-flow model for precessing spins (gwModel_kick_prec_flow). These combine post-Newtonian theory insights with machine learning techniques.

Result: Both models achieve high accuracy across mass ratios (from comparable to extreme) and outperform existing ones in their domains. Application to star cluster simulations shows significant variation in black hole retention probabilities when using the precessing-spin model.

Conclusion: The new models provide reliable recoil velocity predictions for a wider range of parameters, enabling better astrophysical modeling of extreme mass ratio mergers and their dynamical impacts in dense stellar environments.
...
### [31] [Keeping It Renormalizable: Minimal Baryogenesis induced Asymmetric Dark Matter](https://arxiv.org/abs/2511.10731)
...
### [32] [FeynRules and UFO model files for $ν$SMEFT: Higgs-$N_R$ operators of dimensions five and six](https://arxiv.org/abs/2511.10733)
*Arsenii Titov*

Main category: hep-ph

TL;DR: The paper introduces FeynRules and UFO model files for the νSMEFT, which extends the Standard Model with right-handed neutrinos and includes dimension-five and six Higgs-NR operators. These tools are publicly available on GitHub.


<details>
  <summary>Details</summary>
Motivation: To provide computational tools for studying the νSMEFT, enabling researchers to incorporate right-handed neutrinos and their Higgs interactions systematically through dimension-five and six operators.

Method: Development of FeynRules and UFO model files that encode the νSMEFT Lagrangian terms involving Higgs-right-handed neutrino interactions. The implementation covers up to dimension-six operators and ensures compatibility with existing collider physics simulation frameworks.

Result: Publicly available model files deposited on GitHub, allowing automation of Feynman rules and matrix element calculations for the νSMEFT. This facilitates phenomenological studies involving right-handed neutrinos in Higgs physics.

Conclusion: The release of these model files advances research in beyond-the-Standard-Model physics by standardizing the νSMEFT framework, promoting reproducibility and widespread adoption in particle physics calculations.
...
### [33] [New picture on the mesons mass relations](https://arxiv.org/abs/2511.10803)
*R. L. P. G. Amaral,V. E. R. Lemes,O. S. Ventura,L. C. Q. Vilar*

Main category: hep-ph

TL;DR: The paper presents a new approach to meson mass mixing using a second-order phase transition principle, deriving mass relations for meson nonet that align with experimental data, and developing a corresponding field theory compatible with quantum analysis.


<details>
  <summary>Details</summary>
Motivation: To address the long-standing meson mass spectra and mixing angle problems by proposing a novel theoretical framework rooted in second-order phase transitions, thereby bridging phenomenological observations with a robust field theory.

Method: 1. Review of meson pseudoscalar nonet mass spectra history. 2. Propose second-order phase transition-based approach to derive mass relations. 3. Formulate a field theory model consistent with derived phenomenological results.

Result: New mass relations for meson nonet show good agreement with experimental data; successfully resolve quark composition and mixing angle issues; demonstrate theoretical consistency via quantum field analysis.

Conclusion: The proposed method effectively unifies phenomenological observations with field theory, validating the approach's correctness and opening avenues for future theoretical explorations in meson physics.
...
### [34] [Top-quark production cross sections at higher perturbative orders](https://arxiv.org/abs/2511.10856)
*Nikolaos Kidonakis*

Main category: hep-ph

TL;DR: The paper calculates higher-order QCD and electroweak corrections for three top-quark production processes (ttsZ, ttsH, and s-channel single-top), showing that soft-gluon effects dominate. Approximate NNLO/aN3LO cross sections with these corrections are provided and compared to LHC data.


<details>
  <summary>Details</summary>
Motivation: The study aims to improve theoretical precision for top-quark production processes at the LHC by incorporating higher-order QCD and electroweak corrections, which are essential for accurate comparison with experimental measurements and testing the Standard Model.

Method: Higher-order QCD (aNNLO/aN3LO) corrections including soft-gluon resummation are combined with exact NLO results. For ttsZ and ttsH, NLO electroweak corrections are added. Calculations are performed for top-antitop+Z, s-channel single-top, and top-antitop+Higgs production.

Result: Soft-gluon corrections are numerically dominant and large across all processes. Theoretical predictions with corrected cross sections show improved agreement with experimental LHC measurements.

Conclusion: Including higher-order corrections significantly enhances theoretical precision for top-quark processes, critical for Standard Model validations and searches for new physics at the LHC.
...
### [35] [Valence quark distribution of rho meson using light-front quark model](https://arxiv.org/abs/2511.10981)
*Satyajit Puhan,Shubham Sharma,Narinder Kumar,Harleen Dahiya*

Main category: hep-ph

TL;DR: The paper examines the partonic structure of the ρ meson using a light-front quark model, emphasizing the role of tensor polarization through PDFs and TMDs.


<details>
  <summary>Details</summary>
Motivation: To understand the ρ meson's partonic structure by exploring model sensitivity, tensor polarization effects, and validating predictions through evolved PDFs and TMDs.

Method: Employed light-front helicity wave functions to derive PDFs, applied NLO DGLAP evolution, calculated Mellin moments with a neural network, and computed nine TMDs (including tensor TMDs) within two spin wave function models.

Result: Tensor polarization significantly influences the three-dimensional partonic structure of vector mesons; results align with theoretical predictions via Mellin moment comparisons.

Conclusion: Tensor polarization is essential for accurately describing vector meson partonic structures, highlighting the necessity of advanced models like LFQM with spin-1 tensor components.
...
### [36] [Spin-averaged $B_c$ Spectrum in a Cornell-type Potential Using VMC Baseline and GFMC Evolution](https://arxiv.org/abs/2511.10986)
*Tarik Akan*
...
### [37] [Exclusive semileptonic $B$ decays to the ground and excited states of light mesons](https://arxiv.org/abs/2511.11089)
*V. O. Galkin,Xian-Wei Kang*

Main category: hep-ph

TL;DR: The paper analyzes exclusive semileptonic decays of B mesons into excited light mesons using a relativistic quark model, providing form factors and branching fractions. Results align with |V_{ub}| from inclusive decays, and certain decays to excited states may be measurable at B factories.


<details>
  <summary>Details</summary>
Motivation: To determine the Cabibbo-Kobayashi-Maskawa matrix element |V_{ub|} and test the nature of excited light mesons by analyzing their interactions in B decays.

Method: Relativistic quark model with quasipotential approach, including relativistic effects (negative energy states, wave function transformations), helicity formalism, and form factor calculations across q² range.

Result: Calculated branching fractions for decays to 2S, 3S, 1P, 2P states, alignment with |V_{ub}| from inclusive decays, and identification of measurable decays with ~10⁻⁴ branching ratios.

Conclusion: Predicted decays to excited light mesons are experimentally accessible, supporting |V_{ub}| determinations and providing insights into meson structure via B factories.
...
### [38] [Thermal Leptogenesis in $SO(10)\times U(1)_A$ SUSY GUT](https://arxiv.org/abs/2511.11100)
*Nobuhiro Maekawa,Kei Shibata,Masato Yamanaka*

Main category: hep-ph

TL;DR: This paper explores thermal leptogenesis in a SUSY GUT with $SO(10) \times U(1)_A$ symmetry, addressing model challenges and baryon asymmetry generation through neutrino Yukawa couplings and masses. A moderate enhancement factor of ~5.4 for the lightest right-handed neutrino mass achieves observed asymmetry, predicting a suppressed lightest neutrino mass (~4.5e-4 eV).


<details>
  <summary>Details</summary>
Motivation: To resolve the doublet-triplet splitting problem and unrealistic neutrino Yukawa relations in SUSY GUTs, the authors use $SO(10) \times U(1)_A$ symmetry with O(1) coefficients. They aim to compute the baryon asymmetry considering flavor effects and neutrino masses.

Method: Computed baryon asymmetry using flavor effects, Higgs asymmetry, and second-lightest right-handed neutrino impacts. Tested cases with O(1) coefficients set to ±1 and analyzed required mass enhancement factors.

Result: A moderate enhancement factor ~5.4 achieves observed baryon asymmetry with suppressed lightest neutrino mass (~4.5e-4 eV). Half of ±1 coefficient cases succeeded within $r_1 ≤11$, others were close but insufficient.

Conclusion: Thermal leptogenesis is viable in this model, linking observed baryon asymmetry to lightest neutrino mass predictions, highlighting symmetry's role in both issues.
...
### [39] [Dark Matter Capture in a Core-Collapse Supernova Revives Dark Photons](https://arxiv.org/abs/2511.11219)
...
### [40] [Toward a holographic realization of the 2+1-flavor QCD phase structure](https://arxiv.org/abs/2511.11273)
*Jin-Yang Shen,Xin-Yi Liu,Jin-Rui Wu,Yue-Liang Wu,Zhen Fang*

Main category: hep-ph

TL;DR: The paper presents a comprehensive holographic model combining Einstein-Maxwell-Dilaton dynamics with light and strange quark sectors, calibrated via machine learning to lattice QCD data. It accurately maps QCD phase transitions, including a tri-critical point at light quark masses (~21 MeV), and predicts a critical endpoint in dense matter conditions (~75.4 MeV and 768 MeV) accessible to experiments.


<details>
  <summary>Details</summary>
Motivation: To unify deconfinement and chiral symmetry restoration in a single holographic framework, achieving quantitative agreement with lattice QCD results across varying quark masses and baryon densities, which previous models couldn't simultaneously describe.

Method: A machine-learning-assisted spectral method calibrates a back-reacted Einstein-Maxwell-Dilaton model with dynamical light and strange quark sectors. The model incorporates lattice QCD data to predict phase transitions and critical points.

Result: The model replicates 2+1 flavor QCD equation of state and Columbia plot with a tri-critical point at ~21 MeV strange quark mass and critical mass ~0.785 MeV. At finite density, predicts a critical endpoint at 75.4 MeV temperature and 768 MeV chemical potential within experimental reach.

Conclusion: This is the first holographic model providing a consistent and quantitative description of both deconfinement and chiral transitions across quark masses and baryon densities, offering a unified framework for QCD phase diagram studies.
...
### [41] [Weak decays of Bc meson in a QCD potential model](https://arxiv.org/abs/2511.11280)
...
### [42] [An EFT approach to the study of multi-phase criticality scenarios](https://arxiv.org/abs/2511.11367)
*Kristjan Kannike,Luca Marzola,Kristjan Müürsepp*

Main category: hep-ph

TL;DR: The paper explores a multi-phase criticality framework in an extended Standard Model with two scalar singlets, predicting a light dilaton and a dark matter candidate. It uses EFT methods to analyze coupling runs and phenomenology, showing that quantum corrections from dark matter are negligible.


<details>
  <summary>Details</summary>
Motivation: To explain the Higgs boson mass scale via multi-phase critical scenarios and investigate the model's phenomenology with effective field theory methods, addressing hierarchical mass spectra.

Method: Apply effective field theory (EFT) methods to analyze an extended Standard Model with two scalar singlets, focusing on the multi-phase criticality limit and the running of scalar couplings between mass scales.

Result: The EFT analysis shows that running couplings between scales are significant but quantum corrections from the dark matter candidate are minimal, improving on prior approximate results.

Conclusion: Multi-phase criticality with two scalar singlets is viable for explaining the Higgs mass, requiring precise EFT treatment for accurate predictions, and highlights the dilaton's role while confirming dark matter stability.
...
### [43] [Effects of Early-Universe Inhomogeneity on Bubble Formation: Primordial Black Holes as an Extreme Case](https://arxiv.org/abs/2511.11408)
*Yijie Chang,Shihang Tang,Haowen Deng,Yefeng Wang,Ran Ding,Fa Peng Huang*

Main category: hep-ph

TL;DR: The paper examines how primordial black holes and other gravitational sources near a first-order phase transition can alter bubble nucleation rates and spacetime, possibly generating new gravitational wave signals.


<details>
  <summary>Details</summary>
Motivation: To study the impact of early Universe inhomogeneities, like primordial black holes, on phase transition dynamics and nucleation rates, addressing potential deviations from homogeneous models.

Method: Investigates bubble nucleation rates around primordial black holes using effective action analysis, considering gravitational effects on bubble symmetry and phase transition dynamics.

Result: Found that primordial black holes reduce the effective action, modifying nucleation rates and leading to non-spherical bubble nucleation which could produce detectable gravitational waves.

Conclusion: Primordial black holes significantly influence early Universe phase transitions, offering a new mechanism for gravitational wave production and highlighting the importance of inhomogeneity in cosmological models.
...
### [44] [Double virtual QCD corrections to $t\bar{t}+$jet production at the LHC](https://arxiv.org/abs/2511.11424)
...
### [45] [Higher-order QCD corrections to top-quark pair production in association with a jet](https://arxiv.org/abs/2511.11431)
*Simon Badger,Matteo Bechetti,Colomba Brancaccio,Michal Czakon,Heribertus Bayu Hartanto,Rene Poncelet,Simone Zoia*

Main category: hep-ph

TL;DR: The paper presents first-ever predictions for top-quark pair production with a light jet using NNLO QCD, improving precision and reducing uncertainties through two-loop amplitudes in leading-color approximation.


<details>
  <summary>Details</summary>
Motivation: To study Standard Model properties via a key process sensitive to top-quark mass, and to enhance precision for both signal analysis and new physics background assessment.

Method: Calculations at next-to-next-to-leading order (NNLO) QCD using two-loop amplitudes in the leading-color approximation, analyzing perturbative behavior and estimating missing higher-order contributions.

Result: Substantial reduction in theoretical uncertainties from higher-order effects, validated through precision predictions of kinematic observables.

Conclusion: NNLO QCD predictions significantly improve process understanding, offering robust tools for LHC experiments in top-quark physics and beyond Standard Model searches.
...
### [46] [Exclusive photoproduction of a $π^0γ$ pair in the saturation framework](https://arxiv.org/abs/2511.11516)
*Michael Fucilla,Saad Nabeebaccus,Lech Szymanowski,Samuel Wallon,Joseph Yarwick*

Main category: hep-ph

TL;DR: The paper investigates exclusive photoproduction of a π⁰γ pair at large invariant mass to study gluon saturation effects, showing that the collinear factorization approach fails and demonstrating that a k_T-dependent factorization using the shockwave formalism predicts a dip in the cross section with back-to-back transverse momentum.


<details>
  <summary>Details</summary>
Motivation: To explore gluon saturation effects in high-energy physics, as the collinear factorization approach with GPDs at leading twist is insufficient for this process.

Method: Using the shockwave formalism to resum multiple gluon exchanges in a k_T-dependent factorization framework at small x.

Result: The polarized amplitude's sign change with |p_t| leads to a dip-like structure in the differential cross section.

Conclusion: The k_T-dependent factorization provides a valid method for processes incompatible with collinear factorization, highlighting gluon saturation signatures through observed dip features.
...
### [47] [Two-loop all-plus helicity amplitudes for self-dual Higgs boson with gluons via unitarity cut constraints](https://arxiv.org/abs/2511.11537)
