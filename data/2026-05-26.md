...
### [4] [Reassessing high-energy emission correlations in gamma-ray bursts using a large, homogeneous sample of X-ray afterglows](https://arxiv.org/abs/2605.25644)
...
### [5] [Discovery and Analysis of a Type II Supernova Candidate at z = 3.19 from JWST's COSMOS-Web Survey](https://arxiv.org/abs/2605.24088)
...
### [6] [On the maximum neutrino flux of blazars in the one-zone leptohadronic model](https://arxiv.org/abs/2605.24107)
...
### [7] [Pitch-Angle Scattering of Cosmic Rays: Confronting Theory with Observations](https://arxiv.org/abs/2605.24143)
...
### [8] [Evidence for mass-dependent spin subpopulations in GWTC-4](https://arxiv.org/abs/2605.24281)
...
### [9] [Timing and Spectral Studies of PSR J2022+3842 with NICER and NuSTAR](https://arxiv.org/abs/2605.24591)
...
### [10] [New galaxy cluster in the Zone of Avoidance SRGe CL0512.7+3712. Discovery and multi-wavelength characterization](https://arxiv.org/abs/2605.24648)
...
### [11] [The XRISM measurements of the black-hole spin in Cyg X-1 are highly model-dependent](https://arxiv.org/abs/2605.24664)
...
### [12] [SN~2018erx: A fast-evolving, dust-reddened Type Icn supernova with broad C II emission lines](https://arxiv.org/abs/2605.24811)
...
### [13] [The Evolution of Cataclysmic Variables Under Various Magnetic](https://arxiv.org/abs/2605.24820)
...
### [14] [Pulse Modulation as a Signature of the Asteroid-Neutron Star Collision Model for High-Energy Transients](https://arxiv.org/abs/2605.24886)
...
### [15] [QPEs from Warped Disk Collisions with EMRIs: Brightness-Recurrence Diagram and Gravitational-Wave Follow-up](https://arxiv.org/abs/2605.24905)
...
### [16] [Radio Study of G76.9+1.0 Pulsar Wind Nebula](https://arxiv.org/abs/2605.24936)
...
### [17] [Shear Particle Acceleration in Structured Gamma-Ray Burst Jets: IV. Thermal {\em vs.} Non-thermal Emission of the Jet Cocoon](https://arxiv.org/abs/2605.25147)
...
### [18] [Discovery of Short-Term γ-Ray Pulsed Radiation Variations Following a Glitch in PSR J0205+6449](https://arxiv.org/abs/2605.25205)
...
### [19] [Inverse Compton scattering occurring in a reverse-shock scenario involving a kilonova: A channel of TeV gamma-ray photons](https://arxiv.org/abs/2605.25209)
...
### [20] [Compact dusty starbursts at cosmic noon linked to high-energy neutrinos](https://arxiv.org/abs/2605.25412)
...
### [21] [Discovery of Molecular and Atomic Gas associated with HESS J1646-458 (Westerlund 1): Spatial TeV Gamma-Ray and Interstellar Proton Correspondence](https://arxiv.org/abs/2605.25467)
...
### [22] [Legacy analysis of Milky Way dwarf spheroidal satellite galaxies: an update](https://arxiv.org/abs/2605.25586)
...
### [23] [Superfluid fraction and effective ion mass in the crystalline crust of a neutron star: role of interband response](https://arxiv.org/abs/2605.25600)
*Nicolas Chamel*
...
### [30] [Fast and Flexible Characterisation of Astronomical Light Curves Using Multi-Time Attention](https://arxiv.org/abs/2605.24095)
...
### [31] [Hubble Astrometry for the Local Group and Beyond in the 2030s](https://arxiv.org/abs/2605.24191)
...
### [32] [Constraining the Inclination of Binary System Orbits with the Astrometric Excess Noise from Gaia DR3](https://arxiv.org/abs/2605.25482)
...
### [33] [skysurvey: a pure python package to simulate the transient sky](https://arxiv.org/abs/2605.25840)
...
### [34] [Building on SVOM : the CATCH satellite constellation for transient astronomy](https://arxiv.org/abs/2605.25959)
*Stéphane Schanne*
...
### [35] [Production of Leptophilic Bosons in Ultradegenerate Relativistic Matter](https://arxiv.org/abs/2605.24081)
...
### [36] [Oscillating Imprints of Dark Matter in Mesons Decays](https://arxiv.org/abs/2605.24090)
...
### [37] [Neutron Star Bounds on Muonic Fifth Forces from Picometer to Kilometer Scales](https://arxiv.org/abs/2605.24094)
*Damiano F. G. Fiorillo,Alessandro Lella,Georg G. Raffelt,Nudzeim Selimovic,Edoardo Vitagliano*
...
### [38] [Solar Axions from Nuclear Transitions](https://arxiv.org/abs/2605.24121)
...
### [39] [Resonant Enhancement for the transfer of baryon number from a CP-violating hidden sector](https://arxiv.org/abs/2605.24126)
...
### [40] [Associated $ZH$ production in gluon fusion process at NLO+NLL](https://arxiv.org/abs/2605.24131)
...
### [41] [Leptogenesis without on-shell right-handed neutrinos](https://arxiv.org/abs/2605.24163)
...
### [42] [Low-lying $Λ$ and $Σ$ resonances studied with the forward $K^*$ productions off the proton induced by high-momentum $π$ beam](https://arxiv.org/abs/2605.24412)
*H. Kamano,T. -S. H. Lee*
...
### [43] [Multipole structure of the nucleon tensor form factors](https://arxiv.org/abs/2605.24435)
...
### [44] [Statistical Framework for Discovery Sensitivity and Majorana Mass Estimation in \(^{136}\)Xe Neutrinoless Double Beta Decay](https://arxiv.org/abs/2605.24469)
...
### [45] [Freeze-in $SU(2)$ vector dark matter at low reheating temperature](https://arxiv.org/abs/2605.24473)
...
### [46] [Axion-like particles solve the $B\to Kν\barν$ and $B\to πK$ puzzles](https://arxiv.org/abs/2605.24713)
...
### [47] [Fermion Mass Hierarchies and the Exceptional Jordan Algebra](https://arxiv.org/abs/2605.24866)
...
### [48] [Subcritical bubble prehistory in weak first-order phase transition](https://arxiv.org/abs/2605.24891)
...
### [49] [Emerging Nonlocal Källèn-Lehmann Higgs Spectra at the LHC](https://arxiv.org/abs/2605.25015)
*Stathes Paganis*
...
### [50] [A D_5 Model of Quarks with Explicit CP Violation](https://arxiv.org/abs/2605.25300)
...
### [51] [Odderon Form Factors in Reggeized Spin-2 Pomeron and Spin-3 Odderon Exchange in $pp$ and $p\bar p$ Elastic Scattering](https://arxiv.org/abs/2605.25636)
...
### [53] [Predicted Exotic Doubly Heavy-Strange Pentaquarks](https://arxiv.org/abs/2605.25918)
...
### [54] [Spin-dependent interactions and fine structure in the negative-parity singly heavy baryons](https://arxiv.org/abs/2605.25925)
...
### [55] [Asymmetric Two-Component Scalar FIMP Dark Matter](https://arxiv.org/abs/2605.25961)
*S. Peyman Zakeri*
...
### [56] [A possible $Σ^*$ or $Λ^*$ resonance with $J^P=3/2^-$ in $K^-p\to KΞ$ scattering](https://arxiv.org/abs/2605.26015)
...
### [57] [Particle species dependence of femtoscopic source parameters in high-energy nuclear collisions](https://arxiv.org/abs/2605.26056)
...
### [58] [Geodesics and Thermodynamics of a Schwarzschild Black Hole with Hernquist Dark Matter](https://arxiv.org/abs/2605.24046)
...
### [59] [Hawking atmosphere of anti-de Sitter black holes](https://arxiv.org/abs/2605.24091)
...
### [60] [Inferring Neutron-Star Properties from Post-merger Gravitational-wave Spectra with Neural Networks](https://arxiv.org/abs/2605.24145)
...
### [62] [Probing the limits of the semiclassical Einstein equation](https://arxiv.org/abs/2605.24103)
...
### [63] [Polarized Anisotropic Stochastic Gravitational Wave Background Search with Ground-Based Detector Networks](https://arxiv.org/abs/2605.25772)
...
### [64] [Towards a causal effective thermodynamics of scalar-tensor gravity](https://arxiv.org/abs/2605.24133)
...
### [65] [Stress-Energy Tensor for Modified General Relativity with Quantum-Deformed Metric in Riemann Spacetime](https://arxiv.org/abs/2605.24282)
...
### [66] [Imprints of Black Hole Shadows and Polarization Patterns of Various Thick Disks: Bumblebee gravity](https://arxiv.org/abs/2605.24369)
...
### [67] [Non-monotonic evolution of multipartite entanglement under the Unruh effect](https://arxiv.org/abs/2605.24424)
...
### [68] [Shaping black hole resonances I. Black hole ringdown as a spectral filtering process](https://arxiv.org/abs/2605.24704)
...
### [69] [Spacetime discreteness via consistent microscopic measurement](https://arxiv.org/abs/2605.24967)
*Weihu Ma,Yu-Gang Ma*
...
### [70] [Field Sources for Dark Matter Black Holes](https://arxiv.org/abs/2605.25071)
...
### [71] [Grey-Body Factors and Thermodynamics of Asymptotically de Sitter Black Holes in Generalized Proca Theory](https://arxiv.org/abs/2605.25076)
...
### [72] [Chaotic motion of particles around a Schwarzschild black hole in a swirling electromagnetic background](https://arxiv.org/abs/2605.25094)
...
### [73] [Absorption and scattering spectra of massive scalar waves in charged regular black hole spacetimes](https://arxiv.org/abs/2605.25148)
...
### [74] [Hairy Kiselev black hole with quintessential matter: themodynamic properties, sparsity of Hawking radiation, and greybody factors](https://arxiv.org/abs/2605.25245)
...
### [75] [On the boundary cost of source-consistent warp shells](https://arxiv.org/abs/2605.25417)
*An T. Le*
...
### [76] [Gravitational Wave Propagation in K-essence Cosmology: Theory and Observational Constraints](https://arxiv.org/abs/2605.25466)
...
### [77] [A New Self-Dual Gravitational Instanton Solution on a Local Conformal Kählerian Manifold in a Brane World Model](https://arxiv.org/abs/2605.25532)
*Reinoud Jan Slagter*
...
### [78] [A pre-merger-informed spectral-level ringdown inference framework for black-hole spectroscopy](https://arxiv.org/abs/2605.25623)
...
### [79] [Periodic orbits and gravitational waveforms around a Schwarzschild black hole with a cloud of strings embedded in perfect fluid dark matter](https://arxiv.org/abs/2605.25625)
...
### [80] [Scalarization of dark matter stars](https://arxiv.org/abs/2605.25671)
*Junya Tanaka*
...
### [81] [Cesàro convergence of the high-order WKB method and its applications to black-hole overtones and long-lived modes](https://arxiv.org/abs/2605.25705)
...
### [82] [Electromagnetic emission from a black-to-white hole transition -- Photospheric emission](https://arxiv.org/abs/2605.25709)
*Mattia Villani*
...
### [83] [Teleparallel $F(T)$ electromagnetic static spherically symmetric spacetime solutions](https://arxiv.org/abs/2605.25752)
*Alexandre Landry*
...
### [84] [Generalising gravitationally induced decoherence beyond linear environmental interactions in a microscopic quantum mechanical toy model](https://arxiv.org/abs/2605.25936)
...
### [85] [Gravitational wave interactions with matter: beyond quadrupolar perturbations](https://arxiv.org/abs/2605.25950)
...
### [86] [Hyperboloidal evolution for scalar scattering in Minkowski space](https://arxiv.org/abs/2605.26028)
