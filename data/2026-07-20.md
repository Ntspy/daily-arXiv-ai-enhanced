...
### [1] [1D Luttinger Modes in Carbon Nanotubes as keV Dark Matter Detector](https://arxiv.org/abs/2607.15338)
...
### [2] [Multiboson Signatures of Doubly Charged Scalars at a Same-Sign Muon Collider](https://arxiv.org/abs/2607.15356)
...
### [3] [Muon Bremsstrahlung as a New Probe of Dark Sector at Neutrino Experiments](https://arxiv.org/abs/2607.15368)
...
### [4] [Charge-Odd Hyperon Polarization from Magnetic Spin Precession](https://arxiv.org/abs/2607.15384)
...
### [5] [Solar-System Abundances of $p$-Nuclides Probe Collective Neutrino Oscillations in Supernovae](https://arxiv.org/abs/2607.15392)
...
### [6] [PBH formation and Gravitational Waves as Multi-messenger Signals of First-order Phase Transitions](https://arxiv.org/abs/2607.15479)
...
### [7] [JetCoRD: Reliability-Aware Cross-Experiment Distillation of Jet Taggers with Adaptive Corrective Representation](https://arxiv.org/abs/2607.15531)
...
### [8] [Enhanced Rydberg-Atom Superheterodyne Detection of Hidden-Photon Dark Matter on Chips](https://arxiv.org/abs/2607.15612)
...
### [9] [Nonequilibrium approach to heavy-quark transport](https://arxiv.org/abs/2607.15618)
*Juhee Hong*
...
### [10] [Portal Matter and Scotogenic-like Dirac Neutrino Masses](https://arxiv.org/abs/2607.15965)
*Thomas G. Rizzo*
...
### [11] [Gluon Saturation](https://arxiv.org/abs/2607.15985)
*Alfred H. Mueller*
...
### [12] [$P_{c}(4312)$, $P_{c}(4440)$, and $P_{c}(4457)$ productions in $e^{+} e^{-}$ collisions](https://arxiv.org/abs/2607.16041)
...
### [13] [Minimalist Seesaw-Scotogenic Mechanism as a Source for Neutrino Physics](https://arxiv.org/abs/2607.16049)
...
### [14] [Learning Standard Model structure from LHC data with Riemannian flow matching](https://arxiv.org/abs/2607.16144)
...
### [15] [Order-reversed Kubo formulas in relativistic kinetic theory](https://arxiv.org/abs/2607.16148)
...
### [16] [Geometric scaling in elastic $pp$ collisions](https://arxiv.org/abs/2607.16182)
*Michał Praszałowicz*
...
### [17] [Assembly, integration, and verification of MITESI: an optical testbed for simulating the ELT in the laboratory](https://arxiv.org/abs/2607.15378)
...
### [18] [Star formation, stellar evolution, and planets in high-resolution X-ray imaging](https://arxiv.org/abs/2607.15474)
...
### [19] [Torsional-X Seismometer for Lunar Decihertz Gravitational-Wave Detection](https://arxiv.org/abs/2607.15683)
...
### [20] [Radial velocity and atmospheric parameter calculations for the GaiaNIR spectrograph](https://arxiv.org/abs/2607.15796)
...
### [21] [Compressing radio interferometric visibility data into a probabilistic model using sparse Gaussian processes](https://arxiv.org/abs/2607.15860)
*Takafumi Tsukui*
...
### [22] [Coherence differential imaging using gradient-boosted decision trees for the direct detection of exoplanets](https://arxiv.org/abs/2607.15973)
...
### [23] [OpenCosmo: Community Portal and Analysis Framework for Flagship Cosmological Simulations](https://arxiv.org/abs/2607.16059)
...
### [24] [Commissioning and on-sky performance of FiberPol: a fiber-fed spectropolarimetric system for the SAAO 1.9 m telescope](https://arxiv.org/abs/2607.16111)
...
### [25] [Ultraviolet to Infrared Spectroscopy of the Type Ibn SN 2023tsz Suggests a Lower-mass Progenitor](https://arxiv.org/abs/2607.15342)
...
### [26] [Observations of X-ray quasi-periodic eruptions](https://arxiv.org/abs/2607.15359)
...
### [27] [Multimessenger prospects of quasi-periodic eruptions](https://arxiv.org/abs/2607.15360)
...
### [28] [Large-scale emission from gamma-ray binaries: the case of LS 5039](https://arxiv.org/abs/2607.15402)
...
### [29] [Uncovering Hierarchical Sub-Population of Binary Black Holes](https://arxiv.org/abs/2607.15431)
...
### [30] [A Multiwavelength Study of a Long-Duration VHE Flare from BL Lacertae with VERITAS](https://arxiv.org/abs/2607.15435)
...
### [31] [Triple radio flares from tidal disruption events: jet-wind collisions and the discovery of a third radio flare from AT2020vwl](https://arxiv.org/abs/2607.15438)
...
### [32] [Assessing the waveform systematics from parameter estimation to population inference with eccentricity](https://arxiv.org/abs/2607.15453)
...
### [33] [Implications of the UV/optical Plateau of AT2018cow](https://arxiv.org/abs/2607.15464)
...
### [34] [High-Density Sound Speed and Post-Merger Dynamics](https://arxiv.org/abs/2607.15588)
...
### [35] [Stable X-ray reverberation lags in the black hole X-ray binary Swift J1727.8-1613](https://arxiv.org/abs/2607.15729)
...
### [36] [A cosmic-ray loaded nascent outflow driven by a massive star cluster](https://arxiv.org/abs/2607.15797)
...
### [37] [Non-thermal emission from the vicinity of the magnetar CXOU J171405.7-381031](https://arxiv.org/abs/2607.15955)
...
### [38] [Discovery of $γ$-Ray Pulsations from the Extreme-Spin-Down Millisecond Pulsar PSR J0435+3233](https://arxiv.org/abs/2607.16119)
...
### [39] [Impact of eccentricity and higher-modes on neutron star-black hole parameter estimation](https://arxiv.org/abs/2607.16135)
...
### [40] [Eccentricity as a Magnifying Glass: Precision Population Inference Enabled by Eccentric Neutron Star--Black Hole Mergers](https://arxiv.org/abs/2607.16136)
...
### [41] [X-ray polarization of Z-type neutron star low-mass X-ray binaries -- II. Spectropolarimetric analysis](https://arxiv.org/abs/2607.16140)
...
### [42] [Quasinormal Modes of Self-Dual Loop Quantum Gravity Corrected Kerr Black Holes](https://arxiv.org/abs/2607.15324)
...
### [43] [Schwarzschild-like Black Holes Submerged in an Exponential Density Dark Matter Profile](https://arxiv.org/abs/2607.15490)
...
### [44] [Gauge-Unfixed Hamiltonian Casimir and Static Torsionful Sector in the Katanaev-Volovich Model](https://arxiv.org/abs/2607.15496)
...
### [45] [Viscous Accretion Disks around Regular Black Holes Embedded in a Quintessence Dark Energy Field: Beyond the Novikov--Thorne Approximation](https://arxiv.org/abs/2607.15679)
*Sandip Dutta*
...
### [46] [Scalar quasinormal modes of Schwarzschild--anti-de Sitter black holes: spectral analysis and generalized boundary conditions](https://arxiv.org/abs/2607.15731)
...
### [47] [Einstein crystals in Snyder and Snyder-de Sitter noncommutative backgrounds](https://arxiv.org/abs/2607.15760)
...
### [48] [The weight of light: colliding pulses of radiation in General Relativity](https://arxiv.org/abs/2607.15761)
...
### [49] [Optical and Thermodynamic Signatures of Lorentz Symmetry Breaking in Bumblebee AdS Black Holes](https://arxiv.org/abs/2607.15827)
...
### [50] [On dark sector scalar field theories driven by cosmological $c$-fields](https://arxiv.org/abs/2607.15897)
...
### [51] [Accelerating electrically charged ModMax black hole solutions in $F(R)$ gravity](https://arxiv.org/abs/2607.15914)
...
### [52] [Massless scalar scattering by Kerr-Bertotti-Robinson black holes:transparent-end channels and superradiance](https://arxiv.org/abs/2607.16068)
...
### [53] [Comparison of $f(R,T)$ Gravity with Multiple Datasets](https://arxiv.org/abs/2607.16158)
