...
### [22] [Confronting the Higgsino Interpretation of the LZ Event with the High-Energy Sideband](https://arxiv.org/abs/2609.04175)
...
### [23] [Seasonal dark matter from the LUX-ZEPLIN high-energy event](https://arxiv.org/abs/2609.04181)
*Christopher McCabe*
...
### [24] [Quasicrystalline Inflation: From the Cosmological Dipole to Primordial Diffraction](https://arxiv.org/abs/2609.02142)
*Jiro Soda*
...
### [27] [Tidally-enhanced resonances in extreme-mass-ratio inspirals: A tertiary path to chaos](https://arxiv.org/abs/2609.03007)
...
### [28] [Excitation factors and exceptional points of Kerr-de Sitter quasinormal modes](https://arxiv.org/abs/2609.03009)
...
### [29] [DANSur_HM: Modularly incorporating higher modes in a deep learning based gravitational-wave surrogate](https://arxiv.org/abs/2609.03025)
...
### [30] [Scalar quasinormal modes of Kerr--AdS$_{\bf 7}$ via accessory parameter expansions](https://arxiv.org/abs/2609.03037)
...
### [31] [Gravitational Waves and Matter Constraints in Gravity from Entropy](https://arxiv.org/abs/2609.03082)
*David S. Pereira*
...
### [32] [Relativistic transformation of temperature for exotic cosmological fluids](https://arxiv.org/abs/2609.03124)
...
### [33] [Non-extensive entropy signatures in compact star](https://arxiv.org/abs/2609.03237)
...
### [34] [Constraint closure and gravitational-wave content of shear-free cosmologies in metric f(R) gravity](https://arxiv.org/abs/2609.03260)
...
### [35] [Tidal forces in the quantum Oppenheimer--Snyder black hole](https://arxiv.org/abs/2609.03278)
...
### [36] [Introducing SINFONIA: Symplectic, slimplectic and Magnusian (Neural) Flows for Orbital Numerical Integration and Acceleration](https://arxiv.org/abs/2609.03329)
...
### [38] [Dynamical Selection of Horizon-BMS Goldstone Modes in Evaporating Black Holes](https://arxiv.org/abs/2609.03477)
...
### [39] [Long-lived ringing of Bronnikov--Kim brane-world black holes and wormholes](https://arxiv.org/abs/2609.03683)
*Milena Skvortsova*
...
### [40] [Not All Resonances Are Created Equal: Prioritizing Tidal Resonances in EMRIs](https://arxiv.org/abs/2609.03732)
...
### [41] [On the interplay between waveform systematics and lensing signatures in gravitational-wave signals](https://arxiv.org/abs/2609.03935)
...
### [42] [Eight Local Couplings of Gravitational Waves from Unified Field Equations](https://arxiv.org/abs/2609.03979)
...
### [43] [Black holes in alternative theories of gravity](https://arxiv.org/abs/2609.03983)
...
### [44] [An off-shell conformally invariant Galilean Weyl tensor](https://arxiv.org/abs/2609.04053)
...
### [45] [Dyonic rotating cosmological black hole surrounded by quintessence](https://arxiv.org/abs/2609.04111)
...
### [46] [The influence of standard relativistic effects on Gaia-like astrometric catalogs](https://arxiv.org/abs/2609.02922)
...
### [47] [The Impact of Artificial Space Objects on Optical Astronomy as Determined from 32 Million Photometric Observations](https://arxiv.org/abs/2609.02951)
...
### [48] [A fast, wide-field, and real-time imaging prototype for large aperture arrays](https://arxiv.org/abs/2609.03027)
...
### [49] [Optimizing Field Geometry for Modular Micropore-Optics Soft X-ray Time-Domain Surveys](https://arxiv.org/abs/2609.03103)
...
### [50] [The Accretion Explorer Interferometer (AEI) Phase I NASA Innovative Advanced Concepts Final Report](https://arxiv.org/abs/2609.03159)
...
### [51] [3.5-meter Segmented-Mirror Robotic Space Telescope Mission White Paper IV. Key Scientific Mission: Solar-System Small Bodies and Planetary Defense](https://arxiv.org/abs/2609.03371)
...
### [52] [3.5-meter Segmented-Mirror Robotic Space Telescope Mission White Paper V. Key Scientific Mission: Compact-Object Time-Domain Science](https://arxiv.org/abs/2609.03373)
*Juhan Kim,Yong-Woo Kang,Sang Hyun Lee,Jeong-Yeol Han,Sungwook E. Hong,Bongkon Moon,Donguk Song,Juhyung Kang,Myeong-Gu Park,Sang Chul Kim,Chung-Uk Lee,Sangmo Tony Sohn,Arman Shafieloo,David Parkinson,Hong Soo Park,Dohyeong Kim,Chan Park,Jungjoo Sohn,Young-Beom Jeon,Jong-Hak Woo,Hyung Mok Lee,Hong Bae Ann,Myungkook James Jee,Mansoo Choi,Changbom Park*
...
### [53] [Night-sky emission correction techniques for high-resolution spectroscopy: Demonstration with NIRPS](https://arxiv.org/abs/2609.03374)
...
### [54] [Reconstruction of Shower-like Events in NEON Using Likelihood and Graph Neural Network Methods](https://arxiv.org/abs/2609.03417)
...
### [55] [Morphology of Radio Sources in Representation Space](https://arxiv.org/abs/2609.03779)
...
### [56] [nufftcf: Fast Auto- and Cross-Correlation Function Estimation for Irregularly-Sampled Time Series via the Non-Uniform FFT](https://arxiv.org/abs/2609.03866)
*Jean-Eric Campagne*
...
### [57] [Toward a realistic test of black-hole movie correlations as a probe of extreme lensing](https://arxiv.org/abs/2608.27637)
...
### [58] [Unlocking the QPE Mystery: Star-Disk Collisions in Realistic AGN Disks](https://arxiv.org/abs/2609.03011)
...
### [59] [Multi-epoch Detection of an Ultra-fast Inflow in ESP 39607: Evidence for an Accretion Cascade](https://arxiv.org/abs/2609.03019)
...
### [60] [Single-pulse reanalysis of the 2024 Vela glitch and new observations of PSR~J0437$-$4715 and PSR~J1644$-$4559](https://arxiv.org/abs/2609.03056)
...
### [61] [Thermal and non-thermal emission from supermassive black hole circumbinary disks: Disks, Coronae, Streams, and Cavities](https://arxiv.org/abs/2609.03140)
...
### [62] [Observational selection effects on radio pulsars are minimal for masses, but significant for orbits and spins](https://arxiv.org/abs/2609.03157)
...
### [63] [Radiative Efficiency Enhancement by Electromagnetic Energy Dissipation in Strongly Magnetized Supercritical Accretion Flows around Kerr Black Holes](https://arxiv.org/abs/2609.03250)
...
### [64] [The Jet Properties and Accretion Regime for the Blazar Sequence](https://arxiv.org/abs/2609.03435)
*Qingchen Long*
...
### [66] [KM3NeT/ARCA stacking search for high-energy neutrino point sources: the case of ultra-luminous infrared galaxies and blazars](https://arxiv.org/abs/2609.03609)
...
### [67] [NuSTAR View of the 2025 Mini-Outburst of the Black Hole X-ray Binary GRS 1739-278: Spectral and Timing Evolution in the Soft State](https://arxiv.org/abs/2609.03624)
...
### [68] [The Physics of the Nebular Phase in Black Hole X-ray Binaries: Modelling V404 Cygni](https://arxiv.org/abs/2609.03714)
...
### [69] [A catalogue of insights from the fourth LIGO-Virgo-KAGRA observing run](https://arxiv.org/abs/2609.03859)
...
### [70] [Ultra-compact twin stars with hybrid equations of state from bosonic dark matter](https://arxiv.org/abs/2609.03964)
...
### [71] [Sgr A* as a Galactic PeVatron: Multimessenger Signatures of the Magnetic Penrose Process](https://arxiv.org/abs/2609.04051)
...
### [72] [A targeted search for fast radio bursts from magnetars in elliptical galaxies](https://arxiv.org/abs/2609.04118)
...
### [73] [Low-angular-momentum accretion shocks can power weak-to-moderate X-ray flares from SgrA*](https://arxiv.org/abs/2609.04145)
