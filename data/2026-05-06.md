...
### [7] [PySME v1.0: improved modelling of stellar spectra for survey-scale applications](https://arxiv.org/abs/2605.04007)
...
### [8] [Weyl Cosserat Elasticity and Gravitational Memory: An Effective Microstructured Model of Spacetime](https://arxiv.org/abs/2605.02975)
*David Izabel*
...
### [9] [Orbital Nodal Phase as a Pipeline Invariant in Black Hole Timing](https://arxiv.org/abs/2605.02984)
*Mehmet Baran Ökten*
...
### [10] [Polarized Equatorial Emission around Kerr Black Holes with Synchronized Scalar Hair. I. Direct images](https://arxiv.org/abs/2605.03006)
...
### [11] [Gravitational electric-magnetic duality at the light ring and quasinormal mode isospectrality in effective field theories](https://arxiv.org/abs/2605.03018)
...
### [12] [Can wormholes have vanishing Love numbers?](https://arxiv.org/abs/2605.03025)
*Shauvik Biswas*
...
### [13] [Scattering of scalar, electromagnetic, and Dirac fields in an asymptotically flat regular black hole supported by primordial dark matter](https://arxiv.org/abs/2605.03137)
*S. V. Bolokhov*
...
### [14] [Stability of Synthetic Timelike Ricci Bounds under $C^0$-Limits and Applications to Impulsive Gravitational Waves](https://arxiv.org/abs/2605.03172)
...
### [15] [Non-radial pulsations of gravitationally coupled two-fluid neutron stars in general relativity](https://arxiv.org/abs/2605.03305)
...
### [17] [Noether charges and the first law of thermodynamics for multifractional Schwarzschild black hole in the q-derivative theory](https://arxiv.org/abs/2605.03311)
*Reggie C. Pantig*
...
### [18] [Scalar bosonic oscillator fields in LV-wormholes](https://arxiv.org/abs/2605.03366)
...
### [19] [Families of regular spacetimes and energy conditions](https://arxiv.org/abs/2605.03428)
...
### [20] [Ringdown Analysis of GW250114 with Orthonormal Modes](https://arxiv.org/abs/2605.03576)
...
### [21] [Novel Realizations of Warp Drive Spacetimes as Solutions of General Relativity](https://arxiv.org/abs/2605.03653)
...
### [22] [Long-lived massive scalar modes, grey-body factors, and absorption cross sections of the Reissner--Nordström-like brane-world black hole](https://arxiv.org/abs/2605.03659)
*Zainab Malik*
...
### [23] [Total transmission modes in draining bathtub model with vorticity](https://arxiv.org/abs/2605.03730)
*Zhe Yu,Liang-Bi Wu*
...
### [24] [Shadow of a Noncommutative Thin-Shell Gravastar](https://arxiv.org/abs/2605.03897)
...
### [25] [Minimum lifetime of a black hole](https://arxiv.org/abs/2605.03922)
...
### [26] [Spontaneous Symmetry Breaking and the Emergent Einstein-Standard Model: From Weyl x SU (2)L x U (1)Y Gauge Theory to Geometric Mass Generation](https://arxiv.org/abs/2605.02955)
...
### [27] [Calculating extremely high energy bremsstrahlung in matter](https://arxiv.org/abs/2605.03002)
...
### [28] [Metastable strings at PTAs: classical stability analysis](https://arxiv.org/abs/2605.03003)
...
### [29] [Searching for UFOs from the early universe: direct detection prospects for relativistically decoupling dark matter](https://arxiv.org/abs/2605.03014)
...
### [30] [Closing the knowledge gap in semileptonic $B\rightarrow X_c\ellν$ decays](https://arxiv.org/abs/2605.03021)
...
### [31] [From Information Geometry to Jet Substructure: A Triality of Cumulant Tensors, Energy Correlators, and Hypergraphs](https://arxiv.org/abs/2605.03063)
...
### [32] [Solution of the boundary problem for the axial-vector field in the hard-wall AdS/QCD model](https://arxiv.org/abs/2605.03070)
...
### [33] [Einstein-de Haas effect and induced rotation in QCD matter](https://arxiv.org/abs/2605.03093)
*Dushmanta Sahu*
...
### [34] [Probing anomalous quartic gauge couplings via vector boson scattering at the same-sign muon collider](https://arxiv.org/abs/2605.03116)
...
### [35] [Elastic Form Factors of Axial-Vector Mesons: A Contact Interaction Exploration](https://arxiv.org/abs/2605.03209)
...
### [36] [Constraining Tsallis Corrections to Photon Reheating from Electron-Positron Annihilation](https://arxiv.org/abs/2605.03223)
*Matias P. Gonzalez*
...
### [37] [Parton Distribution Functions from Large Momentum Expansion of Current-Current Correlators](https://arxiv.org/abs/2605.03234)
...
### [38] [Mirror Quantum Tomography Finds Unexpected Polarization Phenomena in Z Boson Production in pp Collisions at the LHC](https://arxiv.org/abs/2605.03254)
...
### [39] [Does $ψ(4660)$ exist?](https://arxiv.org/abs/2605.03320)
...
### [40] [Search for Long-Lived Dark Photons from Dark Radiation at the LHC](https://arxiv.org/abs/2605.03427)
...
### [41] [DD-pair production in the parton Reggeization approach taking into account single and double parton scattering scenarios](https://arxiv.org/abs/2605.03433)
...
### [42] [Toward a Community Roadmap for High Energy Physics and Artificial Intelligence in China and Beyond](https://arxiv.org/abs/2605.03474)
...
### [43] [Self-Interaction Bounds on Ultralight Dark Matter Couplings to Matter](https://arxiv.org/abs/2605.03477)
...
### [44] [Non-Markovian Electroweak Baryogenesis: Memory Effects on CP-Violating Transport and Gravitational Waves](https://arxiv.org/abs/2605.03580)
*Arnab Chaudhuri*
...
### [45] [Role of $a_0(1710)$ in the $J/ψ\toρ^+ρ^-ω$ and $J/ψ\toγρ^0ω$ reactions](https://arxiv.org/abs/2605.03586)
...
### [46] [Dark Matter Production from Bubble Collisions during a First-Order Phase Transition at the End of Inflation](https://arxiv.org/abs/2605.03758)
...
### [47] [Exclusive photoproduction of a di-meson pair with large invariant mass](https://arxiv.org/abs/2605.03880)
...
### [48] [Properties and implications of the four-loop non-singlet splitting functions in QCD](https://arxiv.org/abs/2605.03889)
*S. Moch,A. Vogt*
...
### [49] [QCD sum rules: Borel parameter vs. Euclidean time](https://arxiv.org/abs/2605.04001)
*A. V. Smilga*
...
### [50] [Two-loop leading-color QCD corrections for Higgs plus two-jet production in the heavy-top limit](https://arxiv.org/abs/2605.04009)
...
### [51] [Real and Complex Singlet-Scalar Benchmarks with a Vector-Like Down Quark for $B\to X_sγ$ and $B_s-\bar B_s$ Mixing](https://arxiv.org/abs/2605.04010)
*Qazi Maaz Us Salam*
...
### [52] [Predictions for the scalar partner of the LHC tetraquark $X(6600)$](https://arxiv.org/abs/2605.04014)
...
### [53] [Covariant Spinor Formalism for Multipole Expanded Form Factor](https://arxiv.org/abs/2605.04030)
...
### [54] [Wave interference as the origin of the cyclic magnetorotational dynamo in accretion disks: insights from weakly nonlinear theory and local shearing box simulations](https://arxiv.org/abs/2605.02996)
...
### [55] [The SRG/eROSITA diffuse soft X-ray background II. spectra and morphology of the eROSITA bubbles in the western Galactic hemisphere](https://arxiv.org/abs/2605.02998)
...
### [56] [Utilizing Dispersion Measure of Fast Radio Bursts to Probe the Intergalactic Medium Turbulence](https://arxiv.org/abs/2605.03253)
...
### [57] [Unveiling hidden millihertz quasi-periodic oscillations in 1A 0535+262](https://arxiv.org/abs/2605.03527)
...
### [58] [Searching For Fast Radio Transients And Radio Pulsars Using SPOTLIGHT](https://arxiv.org/abs/2605.03531)
...
### [59] [The Cocoon from a Massive Star's Death: VLA Radio Polarization Study of Possible Historical Supernova Remnant G7.7$-$3.7](https://arxiv.org/abs/2605.03540)
...
### [60] [Primordial high energy neutrinos](https://arxiv.org/abs/2605.03630)
...
### [61] [Effects of magnetically driven shocks on nucleosynthesis and kilonovae from neutron star mergers](https://arxiv.org/abs/2605.03947)
...
### [62] [The jet-shaped pipe morphology in planetary nebulae and core-collapse supernova remnants](https://arxiv.org/abs/2605.03961)
