...
### [33] [Strong Black Hole Natal Kicks in Magnetized Accretion-Powered Explosions](https://arxiv.org/abs/2609.10694)
...
### [34] [Detection of hard X-ray pulsations in non-ULX X-ray pulsar 3X J0042 in M31](https://arxiv.org/abs/2609.10699)
...
### [35] [Teglon: A Pixel-Level Pipeline for Galaxy-Informed Gravitational-Wave Follow-up Planning and Efficiency Analysis](https://arxiv.org/abs/2609.10736)
...
### [36] [Low-Mass Magnetic Monopoles in the Galaxy: Simulations and Comparison with Ultra-High-Energy Cosmic-Ray Data](https://arxiv.org/abs/2609.10784)
...
### [37] [XRISM observations of the Perseus cluster along two arms: Chaotic ICM motions probed by resonant scattering](https://arxiv.org/abs/2609.10845)
...
### [38] [IceCube neutrino point-source searches in the direction of the KM3NeT ultra-high-energy event](https://arxiv.org/abs/2609.10931)
...
### [39] [Evidence for the binary nature of the long-period radio transient ASKAP/DART J1832-0911](https://arxiv.org/abs/2609.11068)
...
### [40] [Nonbirefringent model of orthogonal polarization modes in radio pulsars - New view on S swing and mode structure in pulsar beam](https://arxiv.org/abs/2609.11220)
*J. Dyks,A. Frankowski*
...
### [41] [Spin-down of the accreting magnetar candidate 4U 0114+65: possible first evidence for a strong coupling regime](https://arxiv.org/abs/2609.11479)
...
### [42] [Cosmological Evolution of Primordial Black Holes: UV/IR Decoupling and the KM3NeT 220 PeV Neutrino Anomaly](https://arxiv.org/abs/2609.11511)
...
### [43] [Probing the details of relativistic electrons with multifrequency observations of M87 black hole](https://arxiv.org/abs/2609.11609)
...
### [44] [One Precessing Jet Pair, Diverse Core-Collapse Supernova Remnant Morphologies](https://arxiv.org/abs/2609.11629)
...
### [45] [Relativistic Magnetohydrodynamics from Myers-Pospelov Lorentz-Violating Electrodynamics](https://arxiv.org/abs/2609.11764)
...
### [46] [Spectral evolution of NS binary system GX 349+2 using AstroSat observations](https://arxiv.org/abs/2609.11787)
...
### [47] [Hierarchical Population Inference with Normalizing Flows for Binary Black Holes](https://arxiv.org/abs/2609.11885)
...
### [48] [Nonthermal Solar Stalling of an Inelastic Scalar Signal in Xenon](https://arxiv.org/abs/2609.10636)
*XinXin Qi,Hao Sun*
...
### [49] [Implications of Inelastic Dark Matter for Primordial Dark-Star Evolution: Kinematic Thresholds and Nonthermal Capture](https://arxiv.org/abs/2609.10662)
...
### [50] [The Dark Dimension and Majorana Neutrinos](https://arxiv.org/abs/2609.10668)
...
### [51] [Ultralight Axial Dark Matter](https://arxiv.org/abs/2609.10671)
...
### [52] [On the Numerical Integration of One-Loop Cosmological Collider Signals](https://arxiv.org/abs/2609.10673)
...
### [53] [Re-examining the sensitivity of JWST to decaying axion dark matter](https://arxiv.org/abs/2609.10674)
...
### [54] [Computationally Efficient Description of Medium Response to Jets in Heavy Ion Collisions](https://arxiv.org/abs/2609.10679)
...
### [55] [Opening the Topological Portal to Dark Sectors with Colliders](https://arxiv.org/abs/2609.10681)
...
### [56] [EFT Approaches to Sommerfeld Enhancement and Bound States in Singular Potentials](https://arxiv.org/abs/2609.10690)
...
### [57] [Soft functions for generalised angularity event shapes at NNLO](https://arxiv.org/abs/2609.10716)
...
### [58] [A Colour-Casimir Adjacency Matrix Approach to Fully-Heavy Tetraquarks](https://arxiv.org/abs/2609.10822)
...
### [59] [Generalized Chiral $U(1)_{B-L}$ with Inelastic Scalar Dark Matter for the LZ 248 keV Event](https://arxiv.org/abs/2609.10827)
...
### [60] [Glueball interactions from the colour Van der Waals potential](https://arxiv.org/abs/2609.10841)
...
### [61] [Unitarity dressing of the dynamical gluon mass scale](https://arxiv.org/abs/2609.10903)
...
### [62] [Axionic Wormholes in Metric-Affine Gravity](https://arxiv.org/abs/2609.11010)
...
### [63] [Qubit-Qutrit Quantum Tomography of hadronic $Λφ$ and $ΛK^{\ast 0}$ systems](https://arxiv.org/abs/2609.11151)
...
### [64] [Twist decomposition of exclusive heavy meson production cross sections](https://arxiv.org/abs/2609.11179)
*Mariusz Sadzikowski*
...
### [65] [Higgsino dark matter in the Starobinsky supergravity with the MSSM in light of the LUX-ZEPLIN event](https://arxiv.org/abs/2609.11241)
...
### [66] [Doubling down on proton structure: what double parton scattering can and cannot tell us about partonic separation](https://arxiv.org/abs/2609.11196)
...
### [67] [Solar Neutrino Constraints on Inelastic Dark Matter Scattering in Light of Recent LUX-ZEPLIN Observations](https://arxiv.org/abs/2609.11833)
...
### [68] [Might the radiation era extend back to the Big Bang? On dark matter production and the relic graviton background in quadratic gravity](https://arxiv.org/abs/2609.11750)
...
### [69] [Relocating the SIMP Miracle in the Axion Portal](https://arxiv.org/abs/2609.11254)
...
### [70] [Broad p-Wave Sommerfeld Resonances From Dimensional Deconstruction](https://arxiv.org/abs/2609.11305)
*Nobuki Yoshimatsu*
...
### [71] [Connecting Vector-like Muons, pNGB Dark Matter and Electroweak Phase Transition through Collider and Gravitational Wave](https://arxiv.org/abs/2609.11386)
...
### [72] [Net-baryon number distributions and the QCD phase diagram](https://arxiv.org/abs/2609.11483)
...
### [73] [Cosmic ray boosted dark matter with momentum dependent interactions can explain the LZ 248 keV event](https://arxiv.org/abs/2609.11600)
...
### [74] [Collinear fragmentation of pseudoscalar quarkonia from NLO NRQCD](https://arxiv.org/abs/2609.11604)
...
### [75] [Distinguishing a pseudoscalar from a vector $t\bar t$ resonance with top-quark spin correlations at the HL-LHC](https://arxiv.org/abs/2609.11641)
...
### [76] [An event generator for $h\to b\bar{b}$ decays at NLO in SMEFT matched to a parton shower](https://arxiv.org/abs/2609.11681)
...
### [77] [Hunting the Unseen: Deep Learning Analysis for Semi-Visible Jet Tagging](https://arxiv.org/abs/2609.11692)
...
### [78] [NLO corrections to the NEik DIS structure functions](https://arxiv.org/abs/2609.11700)
...
### [79] [Precise bubble wall velocity in a specific phase transition pattern in the CxSM and beyond](https://arxiv.org/abs/2609.11747)
...
### [80] [Massless-Massive Amplitude Correspondence III: Massive Amplitude Bases in the SMEFT](https://arxiv.org/abs/2609.11767)
...
### [82] [Mathematical inverse problem for the world data inference of the parton distribution functions of the proton](https://arxiv.org/abs/2609.11896)
*Henri Hänninen*
...
### [83] [Anomalous Dimensions, Matching, and Phenomenology of Dirac Fermionic Dark Matter Effective Interactions](https://arxiv.org/abs/2609.11914)
