...
### [13] [Detecting Axion-Like Particles With Coiled Optical Fibers I: Silica Fibers](https://arxiv.org/abs/2608.27551)
...
### [14] [Imperfect axions with no domain wall problem](https://arxiv.org/abs/2608.27553)
...
### [15] [KOFFEE: Kaon Observables at Future Fermilab Experimental Extensions](https://arxiv.org/abs/2608.27558)
...
### [16] [Next-to-Leading-Order Electroweak Corrections to Quantum Observables in Lepton-Lepton Collisions](https://arxiv.org/abs/2608.27559)
...
### [17] [A doubly critical point in the color-superconducting regime of the RG-consistent NJL model](https://arxiv.org/abs/2608.27677)
...
### [18] [Constraining Light and Strange Flavor Equilibration in Relativistic Heavy-Ion Collisions](https://arxiv.org/abs/2608.27687)
*Andrew Gordeev*
...
### [19] [Future of Artificial Intelligence for Science in Japan 2024 Community Report](https://arxiv.org/abs/2608.27807)
...
### [23] [Magnetic Moments and Radiative Transitions of the $T_{cc}(3875)^+$ and its partner states](https://arxiv.org/abs/2608.27961)
...
### [28] [System-size dependence of strangeness production from p+p to Pb+Pb: quantitative tests of the $K^+/π^+$ horn](https://arxiv.org/abs/2608.28189)
*Neeraj,Amal Sarkar*
...
### [29] [Minimal-Length Deformations of Chiral Quark Matter in a 2+1-Flavor NJL Model](https://arxiv.org/abs/2608.28201)
*Sameer Ahmad Mir*
...
### [30] [HEPToolBench 1.2: Testing How Reliably Language Models Can Drive Particle Physics Software](https://arxiv.org/abs/2608.28232)
...
### [31] [HEPLocalAgent 1.0: Running Collider Simulations from Plain-Language Requests on Your Own Computer](https://arxiv.org/abs/2608.28244)
*Aadarsh Singh,Sudhir K. Vempati*
...
### [32] [Color screening versus thermal decay as the mechanism of $Υ$ suppression in high energy nuclear collisions](https://arxiv.org/abs/2608.28277)
...
### [33] [Investigation of S-wave tetraquark bound and resonant states with all Jacobi coordinates](https://arxiv.org/abs/2608.28284)
...
### [39] [Multimessenger Constraints on the Central Engine in SN 2023ixf: Neutron Star or Black Hole?](https://arxiv.org/abs/2608.27468)
...
### [40] [A first-principles binary neutron star merger model of GW170817, GRB170817A, and AT2017gfo](https://arxiv.org/abs/2608.27555)
...
### [41] [Exploring the capabilities of combined modelling strategies for supernova with relativistic jets using Redback](https://arxiv.org/abs/2608.27567)
...
### [42] [Dynamical formation of high-eccentricity compact binaries through BH--BH*/TZO collisions](https://arxiv.org/abs/2608.27595)
...
### [43] [Formation of black hole stars via star--black hole collisions](https://arxiv.org/abs/2608.27596)
...
### [44] [Spin-disc misalignment drives periodic accretion and pulse profile asymmetry in X-ray pulsars](https://arxiv.org/abs/2608.27691)
...
### [45] [Magnetospheric birefringence breaks the rotating-vector model and depolarises X-ray pulsars](https://arxiv.org/abs/2608.27699)
...
### [46] [Hyperon bulk viscosity effects in neutron-star inspirals](https://arxiv.org/abs/2608.28000)
...
### [47] [The Impact of Errors in the Shape Function of Rotating Neutron Stars in the Oblate Schwarzschild Approximation](https://arxiv.org/abs/2608.27744)
...
### [48] [Spherical Accretion onto Konoplya Zhidenko Black Holes: Sonic Point Analysis and Fluid Dynamics](https://arxiv.org/abs/2608.28049)
...
### [49] [Low-energy antinuclei measurements for background-free indirect dark matter searches and PBH signatures](https://arxiv.org/abs/2608.27787)
...
### [50] [Rapid Variability and Broadband Spectral Modeling in the Flaring Activity of BL Lacertae](https://arxiv.org/abs/2608.27955)
...
### [51] [From Inspiral to Expansion: The Wake-Driven Torque on Binary Black Holes in Gaseous Medium](https://arxiv.org/abs/2608.27970)
...
### [52] [The Geometry of Ultra-Fast Outflows Probed by Soft X-ray Variability in PDS 456](https://arxiv.org/abs/2608.28034)
...
### [53] [Exploring the sensitivity of in-ice radio detectors to cosmic ray mass composition](https://arxiv.org/abs/2608.28536)
...
### [54] [Three-dimensional Core-Collapse Supernova Simulations: From shell burning to shock revival](https://arxiv.org/abs/2608.28358)
...
### [55] [Astrophysical Sensitivity Projections for the IceCube Upgrade](https://arxiv.org/abs/2608.28395)
...
### [56] [Reassessing the contribution of long-GRB high-energy afterglows to the isotropic gamma-ray background after GRB 221009A](https://arxiv.org/abs/2608.28448)
*S. V. Troitsky*
...
### [57] [Relativistic outflows power a quasi-periodic eruption: constraints on energetics, mass loss, and emission mechanisms](https://arxiv.org/abs/2608.28507)
...
### [58] [Distinct Modes of Pulsar Glitch Activity Revealed by the Waiting-Time--Amplitude Morphology](https://arxiv.org/abs/2608.28523)
...
### [59] [A Similarity Theorem and Its Breakdown in Atomic Black Hole Accretion](https://arxiv.org/abs/2608.28587)
*Marcus DuPont*
...
### [60] [Quantum speed limit time of a uniformly accelerated Unruh-DeWitt detector](https://arxiv.org/abs/2608.27478)
...
### [61] [Creation of an inflationary epoch from an Emergent Universe through quantum tunneling](https://arxiv.org/abs/2608.27597)
...
### [62] [Thermodynamic Criticality in FLRW Cosmology with Non-extensive Loop Quantum Gravity Entropy](https://arxiv.org/abs/2608.27721)
...
### [63] [Compact Core--Shell Equilibria in Gravitational Vlasov--Poisson Systems with Positive and Negative Mass](https://arxiv.org/abs/2608.27900)
*Naoki Sato*
...
### [64] [Dynamical friction on black holes in scalar field environment](https://arxiv.org/abs/2608.28029)
...
### [65] [Devoured by a Hairy Gargantua: Probing Massive Scalar Charges with Non-minimal Curvature Coupling with Extreme-Mass-Ratio Inspirals](https://arxiv.org/abs/2608.28037)
...
### [66] [Photon Spheres and Shadows of Covariant Loop Quantum Black Holes in the general $μ$-scheme](https://arxiv.org/abs/2608.28186)
...
### [67] [Global structure of Kerr-Newman-BR spacetime](https://arxiv.org/abs/2608.28265)
*Hryhorii Ovcharenko*
