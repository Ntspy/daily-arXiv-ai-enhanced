...
### [30] [Dynamical Baryogenesis in Rainbow Cosmology](https://arxiv.org/abs/2607.22252)
...
### [31] [Static vacuum metrics in (4 + 1) dimensions with Λ < 0 and squashed conformal infinity](https://arxiv.org/abs/2607.22237)
...
### [36] [Scattering Amplitudes as Programs: Self-Evolving Search for Theory and Event Generation](https://arxiv.org/abs/2607.21629)
...
### [37] [Higher-order chiral Lagrangians with vector meson nonet in different representations](https://arxiv.org/abs/2607.21678)
...
### [38] [Formation and scaling of $\mathbb{Z}_N$ strings for global $\mathrm{SU}(N)/\mathbb{Z}_N$ symmetry](https://arxiv.org/abs/2607.21701)
*Masaki Yamada*
...
### [39] [Direct constraints on the agnostic $ν$SMEFT from heavy-neutrino searches at the LHC](https://arxiv.org/abs/2607.21711)
...
### [40] [ALP pair production at the LHC](https://arxiv.org/abs/2607.21712)
...
### [41] [Probing Lorentz invariance via diphoton decays of the Higgs boson](https://arxiv.org/abs/2607.21766)
...
### [42] [Revisiting Quark Confinement in the Proton through the Force on Quarks](https://arxiv.org/abs/2607.21952)
...
### [43] [Polarization fractions and helicity-dependent CP asymmetries in $B_{(s)} \to ρρ, ρK^\ast$ and $K^\ast K^\ast$ decays](https://arxiv.org/abs/2607.22093)
...
### [44] [Updated E141 constraints on a long-lived $X_{17}$ vector boson](https://arxiv.org/abs/2607.22102)
...
### [45] [Resolving Lorentz-Violating New Physics at ESSnuSB Using High-Statistics Complementarity with T2HK](https://arxiv.org/abs/2607.22163)
...
### [46] [Statistical validation of template-based parameter extraction from toy thrust distributions for future FCC-ee studies](https://arxiv.org/abs/2607.22282)
*Fatih ilgin*
...
### [47] [SMEFT-Pheno-Agent: a natural-language-driven AI agent for machine-learning-assisted Standard Model Effective Field Theory phenomenology](https://arxiv.org/abs/2607.22331)
...
### [48] [Simultaneous extraction of top quark mass, strong coupling, effective mixing angle, and proton PDFs using inclusive DIS and proton-proton collision data](https://arxiv.org/abs/2607.22390)
...
### [49] [Non-Markovian heavy-quark equilibration and equilibrium correlation function in a thermal medium](https://arxiv.org/abs/2607.22403)
...
### [50] [Hot and Dense Medium Effects on the $B_s^*$ and $B^*$ Multiplets](https://arxiv.org/abs/2607.22419)
...
### [51] [Baryon-number-violating nucleon decays into a dark photon particle](https://arxiv.org/abs/2607.22452)
...
### [52] [Nambu-Goldstone emissions from the cosmological evolution of global monopoles](https://arxiv.org/abs/2607.22481)
...
### [53] [Finite Formation Time Antenna Radiation: Color Spectators Break Single-Emitter BDMPS-Z](https://arxiv.org/abs/2607.22502)
...
### [54] [Light Antinuclei Coalescence: Femtoscopic Constraints via Neural-Flow Surrogates](https://arxiv.org/abs/2607.21689)
...
### [55] [On the astrophysical origin of cosmic rays: Constraining the Ultra-High-Energy Cosmic Ray Horizon through Nearby Galaxy Distributions](https://arxiv.org/abs/2607.21747)
...
### [56] [A GRMHD-Calibrated Semi-Analytical Model for Hot Sub-Keplerian Accretion Flows in Kerr Spacetime](https://arxiv.org/abs/2607.21852)
...
### [57] [The Distinctive Evolution and Spectral Energy Distribution of Binary Massive Black Hole Accretion](https://arxiv.org/abs/2607.21956)
...
### [58] [Radio Core Size of Low-luminosity Active Galactic Nuclei under the MAD-jet model](https://arxiv.org/abs/2607.21966)
*Yue Xu,Fu-Guo Xie*
...
### [59] [A post-hypercritical accretion small-scale dynamo in newborn neutron stars](https://arxiv.org/abs/2607.21990)
...
### [60] [Revealing Four Subpopulations of Binary Black-Hole Mergers with the Fifth Gravitational-Wave Transient Catalog](https://arxiv.org/abs/2607.22011)
...
### [61] [Observation of Wobbling and Precessing Jet Signatures in Gamma-Ray Emission from Blazar PKS 1424-41](https://arxiv.org/abs/2607.22175)
...
### [62] [Exploring the optical properties of redback pulsars: The case of J1717+4308A in the globular cluster M92](https://arxiv.org/abs/2607.22289)
...
### [63] [4th TDAMM Workshop White Paper](https://arxiv.org/abs/2607.22404)
...
### [64] [Winds Versus Jets in Active Galactic Nuclei](https://arxiv.org/abs/2607.22418)
