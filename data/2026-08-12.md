...
### [16] [All You Need is not $Ω_\mathrm{gw}$: Beyond the Mean of the Cross-Correlation Estimator when Searching for an Astrophysical Gravitational-Wave Background](https://arxiv.org/abs/2608.11119)
...
### [17] [The generalized second law as a thermodynamic selection criterion for dynamical dark energy](https://arxiv.org/abs/2608.10495)
...
### [18] [Two-Fluid Schwarzschild Solution](https://arxiv.org/abs/2608.10552)
...
### [19] [Octupolar Gravitational Radiation in de Sitter Spacetime](https://arxiv.org/abs/2608.10593)
...
### [20] [Radiative Signatures from Warp Drives Traveling Through the Earth's Atmosphere](https://arxiv.org/abs/2608.10800)
...
### [21] [Conductors and superconductors in stationary spacetimes: generalized Schiff-Barnhill and Meissner effects](https://arxiv.org/abs/2608.10814)
...
### [22] [Constraining ModMax Black Holes with EHT and GRAVITY Observations: Optical Signatures and Accretion Disk Properties](https://arxiv.org/abs/2608.10859)
...
### [27] [Mysterious Transients in the Palomar Observatory Sky Survey (POSS-1) as profound manifestation of the Dark Matter physics](https://arxiv.org/abs/2608.10061)
*Ariel Zhitnitsky*
...
### [28] [Archimedean Seesaw: Small Neutrino Masses and Large Lepton-number Violation](https://arxiv.org/abs/2608.10062)
...
### [29] [Electroweak precision observables at NLL order in the SMEFT](https://arxiv.org/abs/2608.10064)
...
### [31] [A $U(1)_{(B-L)_3}$ model for dark matter and the $B^+\to K^+ν\barν$ excess reported by Belle II](https://arxiv.org/abs/2608.10086)
...
### [32] [Precision Tests of SM and new physics with the COHERENT Ge-mini and TEXONO data](https://arxiv.org/abs/2608.10104)
...
### [33] [Calibrated correlation between heavy-quark masses and Hadronic Vacuum Polarization observables at the precision frontier](https://arxiv.org/abs/2608.10112)
...
### [34] [Heavy neutral leptons beyond the BBN bound: probing the lepton asymmetry of the Universe](https://arxiv.org/abs/2608.10123)
...
### [35] [Scalar baryons in neutron stars](https://arxiv.org/abs/2608.10141)
*Julian Heeck,Yu Zhi*
...
### [36] [Connecting Heavy-Quarkonium Born-Oppenheimer EFT to the Peskin OPE](https://arxiv.org/abs/2608.10201)
*Arkadiy I. Syamtomov*
...
### [37] [Extraction of baryon number susceptibilities at finite density from heavy-ion collisions](https://arxiv.org/abs/2608.10238)
...
### [38] [The near-threshold cross section of $e^+e^- \to Ω^-\barΩ^+$: Heavy-flavor rescattering and physics-informed deep learning](https://arxiv.org/abs/2608.10301)
*Sara Rahmani*
...
### [39] [Commensurate Structure of Quark and Lepton Mixing: Eighteenth Powers of One Parameter and a Digital-Clock Quantization of the Unitarity Triangles](https://arxiv.org/abs/2608.10312)
*Vernon Barger*
...
### [40] [Event-by-event analysis of chiral charge separation in $p^{\uparrow}+$Au collisions within an improved AMPT model](https://arxiv.org/abs/2608.10496)
...
### [41] [Nucleon electromagnetic form factors in nonlocal chiral effective theory](https://arxiv.org/abs/2608.10543)
*Y. Salamu,Alim Ablat*
...
### [42] [Probing vorticity and fluctuations in a rotating hadron resonance gas at LHC energy](https://arxiv.org/abs/2608.10561)
...
### [43] [Probing Gluon Linear Polarization with Dihadron Fragmentation in $χ_b$ Decays](https://arxiv.org/abs/2608.10570)
...
### [44] [Scaling of soft QGP signatures in relativistic lead, xenon and oxygen collisions in EPOS4](https://arxiv.org/abs/2608.10578)
...
### [45] [Baryogenesis and CMB spectral distortion from Axions](https://arxiv.org/abs/2608.10633)
...
### [46] [Evolution of the underlying event and non-extensive thermodynamics in pp collisions from RHIC to LHC energies](https://arxiv.org/abs/2608.10717)
...
### [47] [Superfluid He-4 as Dark Matter Detectors](https://arxiv.org/abs/2608.10761)
...
### [48] [Monsters and neutron stars](https://arxiv.org/abs/2608.10904)
*Sourendu Gupta*
...
### [49] [Gluonic nucleon energy correlators and fracture functions for Color Glass Condensate](https://arxiv.org/abs/2608.10955)
...
### [50] [TauPolaris: reconstructing tau lepton polarimetric vectors with conditional normalizing flows](https://arxiv.org/abs/2608.10961)
...
### [51] [Multi-Channel Di-Higgs Production in the scNMSSM: From Exotic 8b to Boosted 8tau Signatures at the HL-LHC](https://arxiv.org/abs/2608.11040)
*Marwa Telba*
...
### [52] [Tricritical dynamics in $\mathrm{^3He}$-$\mathrm{^4He}$ mixtures and QCD](https://arxiv.org/abs/2608.11065)
...
### [53] [Hilbert Series of Pseudoscalar Mesons: Operators and Sum Rules](https://arxiv.org/abs/2608.11118)
...
### [54] [QCD Vacuum in an Inhomogeneous Magnetic Field](https://arxiv.org/abs/2608.11144)
...
### [55] [$|ΔI|=3/2$ non-leptonic hyperon decays in covariant baryon chiral perturbation theory](https://arxiv.org/abs/2608.11176)
...
### [56] [Radiative Transfer Modeling of Stripped-envelope Supernovae II: Neural Network Emulation of Light Curves](https://arxiv.org/abs/2608.10058)
...
### [57] [Explaining the X-ray Precursor, Ultra-long Prompt Emission, and Week-long Decay of GRB250702B with a Jetted Micro-TDE](https://arxiv.org/abs/2608.10065)
...
### [58] [Decoding the jet of BL Lacertae using relativistic magneto-hydrodynamics](https://arxiv.org/abs/2608.10067)
...
### [59] [3D Binary Neutron Star Merger Ejecta Evolution up to Seconds Timescale: Dynamics, Element Distribution, and Light Curves](https://arxiv.org/abs/2608.10100)
...
### [60] [Astrophysical Constraints on Hadron--Quark Crossover in Hybrid Neutron Stars](https://arxiv.org/abs/2608.10259)
...
### [61] [An Optically Motivated Gamma-ray Study of Fermi-LAT Novae](https://arxiv.org/abs/2608.10388)
...
### [62] [JWST Spectroscopy of Type Ia Supernova 2025rbs from Maximum Light to the Nebular Phase](https://arxiv.org/abs/2608.10451)
...
### [63] [Two new highly scattered fast radio bursts: evidence for scatter broadening by the circumsource medium](https://arxiv.org/abs/2608.10452)
...
### [64] [Electromagnetic responses driven by gravitational-wave memory in magnetar-flare outflows](https://arxiv.org/abs/2608.10511)
*Wen-Biao Han*
...
### [65] [Transmutation Timescales for Dark Matter Induced Collapse of Compact Stars into Black Holes](https://arxiv.org/abs/2608.10594)
...
### [66] [Real-time observations of the transition to the quiescent state in an accreting magnetised neutron star: No propeller required?](https://arxiv.org/abs/2608.10733)
...
### [67] [Synchrotron-Regulated Relativistic Magnetohydrodynamic Turbulence: Emission, Polarization, and Faraday Rotation](https://arxiv.org/abs/2608.10748)
...
### [68] [Wind-confined jet collimation revealed by the acceleration-phase photosphere of GRB 220426A](https://arxiv.org/abs/2608.10841)
...
### [69] [Multi-night photometric repeatability of STDWeb: an empirical error budget from a 14-night campaign on a single field](https://arxiv.org/abs/2608.10017)
...
### [70] [The Carruthers Mission Concept and Performance](https://arxiv.org/abs/2608.10130)
...
### [71] [Freezing the speckles: focal plane wavefront sensing with the spatially-clipped self-coherent camera](https://arxiv.org/abs/2608.10151)
...
### [72] [The eXtreme Wavefront Control Toolkit: High-Contrast Imaging Instrument Control for Ground and Space-Based Coronagraphs](https://arxiv.org/abs/2608.10156)
...
### [73] [CCD Rotation Rates From Regular Dispersion Solution Monitoring](https://arxiv.org/abs/2608.10167)
...
### [74] [Wavelength Calibration Accuracy Across the STIS CCD: Pipeline Update and User Guidance](https://arxiv.org/abs/2608.10199)
...
### [75] [Sensor fusion on MagAO-X: real time vibration control using accelerometers](https://arxiv.org/abs/2608.10205)
...
### [76] [The final design of GMagAO-X: high-contrast imaging at first-light of the GMT](https://arxiv.org/abs/2608.10212)
...
### [78] [Lunar Reflective Interferometry](https://arxiv.org/abs/2608.10284)
...
### [79] [windsoCC: reconstructing the wind-driven halo in MagAO-X images using wavefront sensor telemetry](https://arxiv.org/abs/2608.10302)
...
### [80] [Closed-loop Atmospheric Dispersion Correction for High-Contrast Imaging with MagAO-X](https://arxiv.org/abs/2608.10307)
...
### [81] [Comparing realtime optical gain measurement and methods on MagAO-X](https://arxiv.org/abs/2608.10539)
...
### [82] [Application of continuous corrections in widefield imaging obtained with the IDGCAL calibration method](https://arxiv.org/abs/2608.10762)
...
### [83] [Wavefront Profiling via correlation of GLAO open loop telemetry](https://arxiv.org/abs/2608.10786)
...
### [84] [High-temperature photovoltaics for solar-electric Oberth maneuvers: ton-class payload feasibility for interstellar-precursor missions](https://arxiv.org/abs/2608.11113)
...
### [85] [Eclipses by Artificial Satellites to Measure the Angular Sizes of Stars](https://arxiv.org/abs/2608.11161)
