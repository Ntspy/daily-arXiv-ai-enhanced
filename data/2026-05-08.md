...
### [4] [Muon Track Reconstruction Procedures at the Baikal-GVD Neutrino Telescope](https://arxiv.org/abs/2605.06428)
*Grigory Safronov*
...
### [5] [Atmospheric turbulence profiling with the Multistar Turbulence Monitor](https://arxiv.org/abs/2605.06449)
...
### [6] [A preliminary exploration of the effects of baseline length for the LIFE space mission](https://arxiv.org/abs/2605.06648)
...
### [7] [What You Don't Know Won't Hurt You: Self-Consistent Hierarchical Inference with Unknown Follow-up Selection Strategies](https://arxiv.org/abs/2605.06636)
...
### [8] [Inflation driven by repulsive-like primordial black holes](https://arxiv.org/abs/2605.05232)
...
### [9] [Light Deflection and Greybody Bound Around a BTZ-ModMax Black Hole in Plasma Medium](https://arxiv.org/abs/2605.05264)
...
### [10] [Generic Peculiar Motions in FLRW spacetimes](https://arxiv.org/abs/2605.05265)
*Bahram Mashhoon*
...
### [11] [Extended thermodynamics and $P-v$ Criticality of Kalb-Ramond black hole coupled with nonlinear electrodynamics](https://arxiv.org/abs/2605.05281)
...
### [12] [Canonical quantization of all minisuperspaces with consistent symmetry reductions](https://arxiv.org/abs/2605.05311)
...
### [13] [Constraining Lorentz symmetry breaking in bumblebee gravity with extreme mass-ratio inspirals](https://arxiv.org/abs/2605.05362)
...
### [14] [Exact solution and Classical tests of New General Relativity](https://arxiv.org/abs/2605.05500)
...
### [15] [Testing General Relativity with Individual Supermassive Black Hole Binaries](https://arxiv.org/abs/2605.05512)
...
### [16] [Implications of the LISA stochastic signal from eccentric stellar mass black hole binaries in vacuum](https://arxiv.org/abs/2605.05537)
...
### [17] [Adaptive ray tracing and photon ring signatures of rotating dark-matter-dressed black holes](https://arxiv.org/abs/2605.05635)
*Mohsen Fathi*
...
### [20] [Quasi-normal modes of a multi-dimensional rotating Kerr black hole](https://arxiv.org/abs/2605.05821)
*Mattia Villani*
...
### [21] [Singularity Resolution in Quantum Cosmology via Page-Wootters Formalism](https://arxiv.org/abs/2605.06093)
...
### [22] [Spin and Quadrupole Sectors in Nonrelativistic Gravity](https://arxiv.org/abs/2605.06410)
*Utku Zorba*
...
### [23] [On the non-radial oscillations of realistic anisotropic neutron stars: Axial modes](https://arxiv.org/abs/2605.06418)
...
### [24] [Quasi-homogeneous black hole geometrothermodynamics in Einstein-Maxwell theory](https://arxiv.org/abs/2605.06602)
*Hernando Quevedo*
...
### [25] [Perturbations in the parametrized wormhole spacetime and their related quasinormal modes](https://arxiv.org/abs/2605.05352)
...
### [26] [On the Origin of Mass Ejection in Failed Supernovae](https://arxiv.org/abs/2605.05289)
...
### [27] [No model-independent evidence for a peak in binary black hole spin (mis)alignments](https://arxiv.org/abs/2605.05300)
...
### [28] [Multi-wavelength outburst activity from EP J174942.2-384834: a very faint X-ray transient discovered by Einstein Probe](https://arxiv.org/abs/2605.05303)
...
### [29] [Moving-mesh simulations of spreading dynamics and local electron cooling in structured gamma-ray burst afterglow jets](https://arxiv.org/abs/2605.05320)
...
### [30] [Astrophysical X-Ray Polarization](https://arxiv.org/abs/2605.05355)
...
### [31] [Searches for Binary Mergers with Sub-solar Mass Components in Data from the First Part of LIGO--Virgo--KAGRA's Fourth Observing Run](https://arxiv.org/abs/2605.05444)
...
### [32] [A Multiwavelength Assessment Disfavoring the X-ray Binary Origin of He III Regions in Metal-Poor Star-Forming Dwarf Galaxies](https://arxiv.org/abs/2605.05548)
...
### [33] [How do the LIGO-Virgo-KAGRA's Heavy Black Holes Form? No evidence for core-collapse Intermediate-mass black holes in GWTC-4](https://arxiv.org/abs/2605.05563)
...
### [34] [An Insight-HXMT View of the Evolution of the Type-C Quasiperiodic Oscillation during the Flaring State of Swift J1727.8-1613](https://arxiv.org/abs/2605.05735)
...
### [35] [A comparative study of occurrence rates and nature of Ultraluminous X-ray sources in spiral and elliptical galaxies](https://arxiv.org/abs/2605.06133)
...
### [36] [Vacuum polarization and cyclotron resonance effects on radiative transfer and plasma deceleration in subcritical X-ray pulsars](https://arxiv.org/abs/2605.06162)
...
### [37] [Early interaction signatures and an extended plateau phase in Type II SN 2020aze](https://arxiv.org/abs/2605.06313)
...
### [38] [Gravitational Lensing of Gravitational Waves from Astrophysical Sources: Theory, Detection, and Applications](https://arxiv.org/abs/2605.06321)
...
### [39] [Fifteen new millisecond pulsars in 47 Tucanae](https://arxiv.org/abs/2605.06492)
...
### [40] [Nonthermal leptogenesis via cosmological gravitational particle production is tested by inflationary gravitational waves](https://arxiv.org/abs/2605.05304)
...
### [41] [On the equivalence of unitarization prescriptions for the Sommerfeld enhancement](https://arxiv.org/abs/2605.05309)
...
### [42] [Monochromatic neutrinos from scotogenic dark matter](https://arxiv.org/abs/2605.05312)
...
### [43] [First next-to-next-to-leading-order extraction of fragmentation functions for Lambda hyperons](https://arxiv.org/abs/2605.05314)
...
### [44] [All-loop four-quark Bethe-Salpeter kernel](https://arxiv.org/abs/2605.05349)
*Piotr Bargiela*
...
### [45] [Evidence for Q-Dependent Nuclear Transverse-Momentum Redistribution Beyond Broadening from AI-driven analysis of p-Cu Drell-Yan](https://arxiv.org/abs/2605.05425)
...
### [46] [Squeezed spectra and back-to-back correlations of protons and antiprotons at RHIC energies](https://arxiv.org/abs/2605.05565)
*Yong Zhang*
...
### [47] [$T^a_{c\bar{s}0}(2900)$, $T_{cs0}^*(2870)^0$, and other singly-heavy tetraquark states](https://arxiv.org/abs/2605.05799)
...
### [48] [Massive hybrid stars within the extended three-flavor quark-meson diquark model](https://arxiv.org/abs/2605.05816)
...
### [49] [Top-associated Higgs-boson production using perturbative fragmentation functions at next-to-leading-order](https://arxiv.org/abs/2605.05880)
...
### [50] [Interaction and correlation functions for $πf_1(1285)$, $ηf_1(1285)$](https://arxiv.org/abs/2605.05946)
...
### [51] [Kaon Portal to Freeze-in Dark Matter](https://arxiv.org/abs/2605.05947)
...
### [52] [A Comparative Study of Mass Extraction Schemes and $π^\pm-ρ^\pm$ Mixing](https://arxiv.org/abs/2605.06271)
*Ziyue Wang*
...
### [53] [The temporal distribution of SN1987A neutrino events](https://arxiv.org/abs/2605.06401)
...
### [54] [GTMDs, orbital angular momentum, and pretzelosity](https://arxiv.org/abs/2605.06412)
...
### [55] [Quantum spin dynamics of heavy quarks and polarization observables in relativistic heavy-ion collisions](https://arxiv.org/abs/2605.06461)
...
### [56] [Probing unknown nonperturbative effects in $b \to s \ell\ell$ with inclusive and exclusive observables](https://arxiv.org/abs/2605.06567)
...
### [57] [TMDs in the Lens of Generative AI: A Pixel-Based Approach to Partonic Imaging](https://arxiv.org/abs/2605.06606)
