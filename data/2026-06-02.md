...
### [12] [Improving the resolution of double white dwarf systems with spaceborne gravitational wave observatories using a robust astrophysical prior](https://arxiv.org/abs/2606.01236)
...
### [13] [Planckian Gravitons from an Imaginary-Time Clock](https://arxiv.org/abs/2606.01052)
...
### [14] [Gravitational-wave astronomy with a space-based optical clock network](https://arxiv.org/abs/2606.01516)
...
### [15] [Revisiting Schwarzschild's constant density star in isotropic coordinates](https://arxiv.org/abs/2606.01061)
...
### [16] [The Heuristic Approach to General Relativity in the Laplace-Beltrami Formalism](https://arxiv.org/abs/2606.01129)
*Noah M. MacKay*
...
### [17] [Rotating traversable wormholes and particle dynamics in $f(R,T)$ gravity](https://arxiv.org/abs/2606.01141)
...
### [19] [Pitching Cosmic Curveballs: Environmental Effects on Extreme-Mass-Ratio Inspirals with Spinning Secondaries](https://arxiv.org/abs/2606.01569)
...
### [20] [Ellis-Bronnikov Wormhole Shadows with Spherically Symmetric Accretion Flow](https://arxiv.org/abs/2606.01699)
...
### [33] [Black Bounce via Gravitational Tension Screening Acting as an Analogue of Schwinger Corrections](https://arxiv.org/abs/2606.02393)
*Milko Estrada*
...
### [35] [Isosinglet-isotriplet mixing and the $X(3872)$ lineshape](https://arxiv.org/abs/2606.00215)
...
### [36] [Matter-Wave Interferometers as Open-System Dark Matter Detectors](https://arxiv.org/abs/2606.00237)
...
### [37] [Weight-Based Representation Learning for Parameter Inference in Monte Carlo Simulations](https://arxiv.org/abs/2606.00238)
...
### [38] [Impact of Future Dihadron Production Measurements on the Transversity Distributions and Tensor Charges of the Nucleon](https://arxiv.org/abs/2606.00362)
...
### [39] [Explaining the $B \to Kμ^+μ^-$ Anomaly in the Left-Right Inverse Seesaw Model](https://arxiv.org/abs/2606.00513)
...
### [40] [Machine Learning Enhanced Detection of Higgs Chain Decays in Vector Boson Fusion](https://arxiv.org/abs/2606.00695)
...
### [41] [Multiplicity-dependent Hadron Enhancement in High-Energy pp and p-Pb Collisions within an Effective Mass-Scale Framework](https://arxiv.org/abs/2606.00763)
*R. C. Baral,B. Mohanty*
...
### [43] [A quarkyonic matter model](https://arxiv.org/abs/2606.00943)
*Toru Kojo*
...
### [44] [Rephasing invariant CP phases and sum rules in TM$_{1,2}$ mixing](https://arxiv.org/abs/2606.00980)
*Masaki J. S. Yang*
...
### [45] [Systematic Study of Coupled-Channel Dynamics in Doubly Heavy Hadronic Molecules](https://arxiv.org/abs/2606.01177)
...
### [46] [Probing the imaginary parts and their $q^2$ dependences for the tau $g-2$ and EDM](https://arxiv.org/abs/2606.01178)
...
### [47] [Probing pair production of long-lived scalars via an off-shell Standard-Model-like Higgs boson at the LHC](https://arxiv.org/abs/2606.01681)
...
### [48] [Prediction of doubly-charm hadronic molecules with double strange quarks](https://arxiv.org/abs/2606.01758)
...
### [49] [Semileptonic Decays of $Λ\to p \ell^{-} \barν_{\ell}$ in the Light-Front Dynamics](https://arxiv.org/abs/2606.01768)
...
### [50] [Probing the dark axion portal via $J/ψ$ decays at BESIII and STCF](https://arxiv.org/abs/2606.01791)
...
### [51] [Anomaly flow and anomaly cancellation](https://arxiv.org/abs/2606.01829)
*Yutaka Hosotani*
...
### [52] [Reinterpreting the ATLAS HHH$\to 6b$ Search with CheckMATE and Rivet: Validation, TRSM Benchmarks, and HL-LHC Prospects](https://arxiv.org/abs/2606.01966)
...
### [53] [The $μ-τ$ Counter Reflection Symmetry](https://arxiv.org/abs/2606.02034)
...
### [54] [Tachyonic particle production: quantum 2PI formalism with momentum exchanging collisions](https://arxiv.org/abs/2606.02039)
...
### [55] [Interpreting Light Scalar Excesses and Heavy Scalar Cascades in the $μ$-Term Extended NMSSM](https://arxiv.org/abs/2606.02069)
*Jingwei Lian*
...
### [56] [Semi-analytical two-loop QCD corrections to $e^+e^-\to J/ψ+χ_{cJ}$ at B factories](https://arxiv.org/abs/2606.02182)
...
### [57] [Azimuthal decorrelation in diffractive dijet production](https://arxiv.org/abs/2606.02230)
...
### [58] [Probing Pair Correlations in QCD Matter with Photon Spectra](https://arxiv.org/abs/2606.02414)
...
### [59] [On the spanning cuts consistency problem in the IBP reductions of Feynman integrals](https://arxiv.org/abs/2606.02485)
...
### [60] [Comment on "QCD-factorization amplitudes from flavour symmetries: beyond the $SU(3)$ symmetric case''](https://arxiv.org/abs/2606.02538)
...
### [61] [New Windows on Heavy Dark Matter: Mineral Melt Modelling and X-Ray Readout for Muscovite Mica](https://arxiv.org/abs/2606.02579)
...
### [62] [On the Faint Early-time Radio and X-ray Emissions in TDE2025aarm](https://arxiv.org/abs/2606.00209)
...
### [63] [Far-infrared synchrotron properties of the inner lobes of the radio galaxy Centaurus A revealed with the Herschel observatory](https://arxiv.org/abs/2606.00213)
...
### [64] [Comparative properties of X-Ray Flashes and Gamma-Ray Bursts from BeppoSAX observations of Fast X-ray Transients](https://arxiv.org/abs/2606.00225)
...
### [65] [BBH-Genesis: Disentangling Binary Black Hole Formation Channels with GWTC-4](https://arxiv.org/abs/2606.00234)
...
### [66] [The Delta Resonance in the Neutrino Sky](https://arxiv.org/abs/2606.00249)
...
### [67] [Hard X-ray Sources in Fermi UFOs](https://arxiv.org/abs/2606.00331)
...
### [68] [Suppression of boosted relic neutrinos by photon backgrounds during ultra-high-energy cosmic ray propagation](https://arxiv.org/abs/2606.00498)
...
### [69] [The Radio--X-ray Correlation of High-Redshift AGN: A Numerical Study of Inverse-Compton Scattering of the CMB Photons in Relativistic Jets](https://arxiv.org/abs/2606.00721)
...
### [70] [TeV gamma-ray spectral spikes produced by magnetic reconnection in blazar jets: the case of the 2014 high state of Markarian 501](https://arxiv.org/abs/2606.00790)
...
### [71] [Enhancing the Angular Resolution of Large Array of imaging atmospheric Cherenkov Telescope (LACT) at Ultra-High Energies](https://arxiv.org/abs/2606.01059)
...
### [72] [High-Synchrotron-Peaked BL Lacs as Multi-Messenger Sources: Connecting Ultra-High-Energy Cosmic Rays and Neutrinos](https://arxiv.org/abs/2606.00816)
...
### [73] [Hunting for Compact Object Binaries from eRASS1 Optical Counterparts through ZTF Time-domain Photometry and Multi-wavelength Census](https://arxiv.org/abs/2606.01085)
...
### [74] [Photon Escape from Slab Thomson Media: A Scattering-order-resolved Recursive Formalism for Comptonization Applications](https://arxiv.org/abs/2606.01087)
*Haichao Xu*
...
### [75] [Deep Optical Follow-up Observations to IceCube Cosmic Neutrinos: a case for IC230724A with Subaru/HSC and prospects with Rubin/LSST](https://arxiv.org/abs/2606.01158)
...
### [76] [Rapid quasi-periodic reconfiguration of the accretion column in pulsar 1A 0535+262](https://arxiv.org/abs/2606.01625)
...
### [77] [Reconnection-Driven Injection and Stochastic Reacceleration during Cosmological Magnetogenesis](https://arxiv.org/abs/2606.01775)
*Ji-Hoon Ha*
...
### [78] [A new Chandra look at the globular cluster NGC 6540 and its peculiar X-ray flaring source](https://arxiv.org/abs/2606.01792)
...
### [79] [A 0.03 Hz Radio Quasi-periodic Oscillation During the 2025 Flare of GRS 1915+105](https://arxiv.org/abs/2606.01823)
...
### [80] [Possible High-Energy Neutrino Emission from Dark Matter Annihilation in the Disrupting Dwarf Galaxy Boötes~III](https://arxiv.org/abs/2606.01853)
...
### [81] [Fast radio bursts, magnetars and earthquakes: their "family feud"?](https://arxiv.org/abs/2606.01855)
...
### [82] [Mass and Spin Growth of Very Massive Stars in Star Clusters Potentially Associated with Little Red Dots](https://arxiv.org/abs/2606.01870)
...
### [83] [Locating the Production Sites of High-Energy Neutrinos in Blazar Jets](https://arxiv.org/abs/2606.02024)
...
### [84] [Revealing the high redshift host galaxy of the short GRB 061201 with JWST](https://arxiv.org/abs/2606.02032)
...
### [85] [Statistical properties of type-II bursts in Rapid Burster observed with Insight-HXMT](https://arxiv.org/abs/2606.02190)
...
### [86] [The First Detection of Sub-Populations in the Delay-Time Distribution of Binary Black Holes in GWTC-4 of LIGO-Virgo-KAGRA](https://arxiv.org/abs/2606.02318)
*Shaunak Padhyegurjar,Suvodip Mukherjee*
...
### [87] [Regression on Regression: Mapping Data-Driven Binary Black Hole Merger Rate Fits to Progenitor Histories](https://arxiv.org/abs/2606.02431)
...
### [88] [Prospects for Astrobiology and Technosignature Searches with the Vera C. Rubin Observatory Legacy Survey of Space and Time](https://arxiv.org/abs/2606.00574)
...
### [89] [Bayesian estimation of spectral parameters of the 6.7-GHz methanol maser G339.884-1.259 from GRAO observations](https://arxiv.org/abs/2606.00768)
...
### [90] [PSF-like Alpha-Particle Events in LSST Images](https://arxiv.org/abs/2606.01295)
...
### [91] [JAXtronomy: A JAX port of lenstronomy](https://arxiv.org/abs/2606.01547)
...
### [92] [The Murchison Widefield Array Phase III upgrade: Sensitivity Doubled, Number of Baselines Quadrupled, Flexibility Enhanced, and EoR Observations Optimised](https://arxiv.org/abs/2606.01644)
...
### [93] [Design and development of Fabry-Perot based wavelength calibration system for PARAS-2 spectrograph](https://arxiv.org/abs/2606.01769)
...
### [94] [Polarized lines of the second solar spectrum (SrI, SrII, CaI, BaII) observed at the Pic du Midi Turret Dome spectropolarimeter with the slit orthogonal to the limb](https://arxiv.org/abs/2606.01989)
*Jean-Marie Malherbe*
...
### [95] [AstroSkyFlow: an astronomical sky image flow simulator for time domain survey validation and machine learning](https://arxiv.org/abs/2606.02140)
