...
### [9] [Collective neutrino-antineutrino pair oscillations](https://arxiv.org/abs/2604.25687)
...
### [10] [On the Role of Prompt Photons in the Anisotropic Emission of Direct Photons -- Direct Photons from Au+Au collisions at $\sqrt{s_{NN}}=200$ GeV with IP-Glasma Initial Condition](https://arxiv.org/abs/2604.25165)
*Fu-Ming Liu*
...
### [11] [Big Dipper, Help Me Find A Way -- Dip-hunting at hadron colliders](https://arxiv.org/abs/2604.25407)
...
### [12] [A study of $J/ψ$ mass shift and bound states: Impact of $D D$ and $DD^*$ meson loops](https://arxiv.org/abs/2604.25449)
...
### [14] [The EDM inverse problem: Identifying the sources of CP violation and PQ breaking with electric dipole moments](https://arxiv.org/abs/2604.25516)
...
### [15] [A Speculative Benchmark for the AMS-02 Electron and Positron Spectra from a Time-Symmetric Transport Hypothesis](https://arxiv.org/abs/2604.25542)
*Yi Yang*
...
### [16] [Jarvis-HEP: A lightweight Python framework for workflow composition and parameter scans in high-energy physics](https://arxiv.org/abs/2604.25557)
...
### [17] [Determination of the $Z_c(3900)$ and the $Z_{cs}(3985)$ states from joint analysis of experimental and lattice data](https://arxiv.org/abs/2604.25607)
...
### [18] [Probing the hadronic molecular nature of the $Ω(2012)$, $Ω(2380)$, and $Ω_c(3120)$ via femtoscopy correlation functions](https://arxiv.org/abs/2604.25630)
...
### [19] [Axion-like particle-meson production in semileptonic $τ$ decays](https://arxiv.org/abs/2604.25673)
...
### [20] [Coherent deeply virtual Compton scattering on helium-4 beyond leading power](https://arxiv.org/abs/2604.25677)
...
### [30] [The effects of image augmentations when training machine learning models in astronomy](https://arxiv.org/abs/2604.24862)
...
### [31] [Seismic background mitigation with the Lunar Gravitational-wave Antenna](https://arxiv.org/abs/2604.24866)
*Han Yan,Jan Harms*
...
### [32] [Joint Multiband Photometry with crowdsource](https://arxiv.org/abs/2604.24875)
...
### [33] [Enabling real-time multi-messenger follow-up of transient events with Astro-COLIBRI](https://arxiv.org/abs/2604.25529)
...
### [34] [Impact of segmented deformable mirrors on high-contrast testbeds for exoplanet imaging with future large space telescopes: contrast stability assessment on the HiCAT bench](https://arxiv.org/abs/2604.25675)
...
### [35] [Ultra-thick warm absorbers: Enlarging the parameter space of AGN ionised outflows](https://arxiv.org/abs/2604.24899)
...
### [36] [A Physics Informed Bayesian Neural Network for the Neutron Star Equation of State](https://arxiv.org/abs/2604.24949)
...
### [37] [Pair-Rich Corona of an Accreting Kerr Black Hole](https://arxiv.org/abs/2604.24961)
...
### [38] [Moving-Mesh Simulations of Mini-Common Envelope Ejection in Classical Novae](https://arxiv.org/abs/2604.24963)
...
### [39] [Core Collapse Supernova Modeling: The Next Ten Years](https://arxiv.org/abs/2604.24970)
*Anthony Mezzacappa*
...
### [40] [Non-Monotonic Rotation Imprint on Time-Integrated Neutrino Spectral Moments in a 15\,$M_\odot$ Core-Collapse Supernova Sequence](https://arxiv.org/abs/2604.25084)
*Nicolas Viaux*
...
### [41] [The GMRT High-Resolution Southern Sky Survey for pulsars and transients -- VIII: Orbital Variability and the Evolution of a 1-Day He-WD Millisecond Pulsar J2101-4208](https://arxiv.org/abs/2604.25278)
...
### [42] [Rotation Measure Substructures Induced by the Ponderomotive Force of Inertial \alfven Waves](https://arxiv.org/abs/2604.25469)
...
### [43] [Intergalactic Magnetic Field constraints from detected very high-energy Gamma-Ray Bursts using the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2604.25647)
...
### [44] [The Szekeres metrics with $M < 0$](https://arxiv.org/abs/2604.24786)
*Andrzej Krasiński*
...
### [45] [Renormalization-group improved Schwarzschild black hole: shadow, ringdown, and strong cosmic censorship](https://arxiv.org/abs/2604.24798)
...
### [46] [Link-based causal set propagators in $1+1$ dimensions](https://arxiv.org/abs/2604.24812)
...
### [47] [Quasinormal Modes, Greybody Factors and Rigorous Bounds for Quantum Oppenheimer-Snyder Black Hole with Quintessential Dark Energy and a String Clouds](https://arxiv.org/abs/2604.24813)
...
### [48] [Bouncing cosmologies from Born-Infeld-type gravity](https://arxiv.org/abs/2604.24860)
...
### [49] [Hawking radiation with dispersion: reconciling the Bogoliubov and tunneling approaches](https://arxiv.org/abs/2604.24861)
...
### [50] [Underlying mechanisms of phase transitions in scalar-tensor theories](https://arxiv.org/abs/2604.24867)
...
### [51] [Gauge Theoretic Signal Processing II: Zero-Latency Whitening for Early Warning Pipelines](https://arxiv.org/abs/2604.25116)
...
### [52] [Sensitivity of black hole spectral instability against perturbations of the effective potential](https://arxiv.org/abs/2604.24926)
...
### [53] [Wellposedness of the initial boundary value problem for the conformal field equations](https://arxiv.org/abs/2604.24931)
...
### [54] [A general formalism for coupling scalar fields to the Einstein equations without a variational principle](https://arxiv.org/abs/2604.24944)
*Joshua Ritchie*
...
### [55] [Toller matrices and the Feynman $i\varepsilon$ in spinfoams](https://arxiv.org/abs/2604.24945)
...
### [56] [Peculiar velocities in the $Λ$CDM universe](https://arxiv.org/abs/2604.24974)
...
### [57] [Covariant quantization of the Einstein-Hilbert theory in first-order form](https://arxiv.org/abs/2604.25117)
*S. Martins-Filho*
...
### [58] [Early-Time Nonlinear Growth in an Unstable Q-Ball Hairy Black Hole](https://arxiv.org/abs/2604.25223)
...
### [59] [The properties and predictions of quasi-periodic oscillations around a black hole in nonlocal gravity](https://arxiv.org/abs/2604.25254)
...
### [60] [Dynamical analysis of the covariant $f(Q)$ gravity models](https://arxiv.org/abs/2604.25412)
...
### [61] [Massive scalar quasinormal modes of an asymptotically flat regular black hole supported by a phantom Dirac--Born--Infeld field](https://arxiv.org/abs/2604.25471)
*Milena Skvortsova*
...
### [62] [Large-Eccentricity Asymptotics and Fast Analytic Approximation for Fourier modes of Post-Newtonian Eccentric Waveforms](https://arxiv.org/abs/2604.25536)
...
### [63] [Lessons from binary dynamics of inspiralling equal-mass boson-star mergers](https://arxiv.org/abs/2604.25582)
...
### [64] [Thermodynamic and Radiative Properties of Euler-Heisenberg AdS Black Holes Surrounded by Quintessence and Dark Matter with a Cloud of Strings](https://arxiv.org/abs/2604.25629)
...
### [65] [Mean first passage time and the Kramers escape rate of phase transitions for the Bardeen-AdS-class black hole](https://arxiv.org/abs/2604.25791)
...
### [66] [The Equivalence Principle and Kinematical Structure in the ADM Framework](https://arxiv.org/abs/2604.25793)
*L. G. Pereira*
