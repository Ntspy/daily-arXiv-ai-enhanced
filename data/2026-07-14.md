...
### [19] [Two Earliest Optical-UV Tidal Disruption Events Hidden in the SDSS DR7 Catalog Unveiled by the Transformer-Based Spectrum Classifier](https://arxiv.org/abs/2607.11539)
...
### [20] [Discovering Millisecond Pulsars in Globular Clusters with the GMRT (GCGPS)](https://arxiv.org/abs/2607.11461)
...
### [21] [Superdiffusion of cosmic rays in the vicinity of their accelerators and the resulting $γ$-ray emission](https://arxiv.org/abs/2607.11485)
...
### [24] [Extending the infrastructure of the BAM code towards resistive general-relativistic magnetohydrodynamics: tests and first applications](https://arxiv.org/abs/2607.11670)
...
### [25] [Tidal deformation and strain accumulation of solid compact stars](https://arxiv.org/abs/2607.11780)
...
### [26] [HAMCOR: A physics-driven Hamiltonian framework for inferring AGN coronal geometry from X-ray reverberation lags](https://arxiv.org/abs/2607.11805)
*Buffoli Fabio*
...
### [27] [Robust Photometry for Roman High-Latitude Imaging Survey Cosmology Using Roman and Rubin Imaging](https://arxiv.org/abs/2607.09849)
...
### [28] [Efficient Optimal Image Reconstruction for the Nancy Grace Roman Space Telescope and Beyond: II. Implementation of {\sc Effortless}](https://arxiv.org/abs/2607.09862)
*Kaili Cao*
...
### [29] [Neural Posterior Estimation for Inferring Weak Lensing Shear](https://arxiv.org/abs/2607.09867)
...
### [30] [LISA 10 -- Library and Information Services in Astronomy. Report on the ESO workshop](https://arxiv.org/abs/2607.09870)
...
### [31] [SAXO+, the second-stage adaptive optics for SPHERE: NCPA compensation and dark-hole loop with a pyramid wavefront sensor](https://arxiv.org/abs/2607.10124)
...
### [32] [Exoplanetary Tour Design with Solar Sails: TheAntipodes Results in the GTOC13 Problem](https://arxiv.org/abs/2607.10150)
...
### [33] [Detector-level simulation closure of radio air-shower reconstruction with fixed equal-prior geomagnetic templates](https://arxiv.org/abs/2607.10637)
...
### [34] [GroundBIRD: First On-Sky Responsivity Calibration at the Teide Observatory](https://arxiv.org/abs/2607.10845)
...
### [35] [Fast(er)PM and Moving Mesh: JAX-native Geometric Multigrid Methods](https://arxiv.org/abs/2607.10983)
*Benjamin Horowitz*
...
### [36] [Synthesis imaging with a lunar orbit array: III. Augmented lagrangian Multiplier Imaging using Gradient descent Optimization (AMIGO)](https://arxiv.org/abs/2607.11006)
...
### [37] [Low-Noise SiPM Light Readout and ASIC-Based Charge Readout of a Liquid Argon Time Projection Chamber for MeV Gamma-Ray Measurements](https://arxiv.org/abs/2607.11336)
...
### [38] [WALOP-South: a four camera one shot imaging polarimeter for the PASIPHAE survey. Paper III -- PSF modelling](https://arxiv.org/abs/2607.11825)
...
### [39] [Ardua: Unveiling the Baryon Cycle from Stars to the Cosmic Web](https://arxiv.org/abs/2607.11865)
...
### [40] [Compact stars in a large-tension braneworld: mildly negative Weyl coupling consistent with NICER and gravitational-wave data](https://arxiv.org/abs/2607.09836)
...
### [41] [Black-bounce spacetime and galactic rotation curves: from singularity resolution to observable gravitational effects](https://arxiv.org/abs/2607.09840)
...
### [42] [Perturbative aspects of analogue FLRW spacetime Jellium models](https://arxiv.org/abs/2607.09843)
...
### [43] [GRACE: An Open-Source Framework for GPU-Accelerated Numerical Relativity](https://arxiv.org/abs/2607.09854)
...
### [44] [Hawking Radiation in $f(\mathcal{R})$ Gravity: Survival of lighter black holes](https://arxiv.org/abs/2607.09863)
...
### [45] [Exceptional lines in the Kerr-Newman black hole spectrum](https://arxiv.org/abs/2607.09878)
...
### [46] [Entropy and Non-Collapse in Lorentzian Geometry](https://arxiv.org/abs/2607.09940)
*Rohit Dhormare*
...
### [47] [Scalar and vector bosons in a Bonnor-Melvin-$Λ$ spacetime: an exact Duffin-Kemmer-Petiau analysis](https://arxiv.org/abs/2607.09997)
...
### [48] [Quasinormal modes of Bonanno-Reuter black holes via the Spectral Method](https://arxiv.org/abs/2607.10199)
...
### [49] [Magnetising de Sitter and Anti-de Sitter spacetimes](https://arxiv.org/abs/2607.10213)
...
### [50] [Probing the Strong Equivalence Principle through the External Field Effect. How Do Two Masses Fall?](https://arxiv.org/abs/2607.10247)
...
### [51] [Circular orbits and particle collisions close to charged black holes surrounded by scalar clouds](https://arxiv.org/abs/2607.10325)
...
### [52] [Geodesics and shadows of the spindle-deformed Kerr black hole](https://arxiv.org/abs/2607.10533)
...
### [53] [A winding number analysis of Schwarzschild black hole stability in light of Planck-scale modified kinematics](https://arxiv.org/abs/2607.10600)
...
### [54] [Einstein Frame Regularization of the JNW Spacetime: From Brans-Dicke Singularity to Ellis Wormhole](https://arxiv.org/abs/2607.10603)
...
### [55] [Scalarization of Einstein-Euler-Heisenberg black hole with multiple horizons](https://arxiv.org/abs/2607.10614)
...
### [56] [Polarization-dependent observational signatures of Weyl-coupled photons around a black hole](https://arxiv.org/abs/2607.10658)
...
### [57] [Corrections to inflationary models induced by non-minimal coupling between scalar field and curvature](https://arxiv.org/abs/2607.10679)
...
### [58] [Regular black holes with Minkowskian cores: causal structure and observational degeneracy](https://arxiv.org/abs/2607.10713)
...
### [59] [Nonlinear electrodynamics and stability of spherically symmetric space-times in scalar-tensor gravity](https://arxiv.org/abs/2607.10718)
...
### [60] [Scalar-induced gravitational waves from a box-shaped curvature power spectrum](https://arxiv.org/abs/2607.10730)
...
### [61] [On correlated noise in the LIGO-Virgo network: a test of the stochastic gravitational-wave background hypothesis](https://arxiv.org/abs/2607.10816)
...
### [62] [Comparing twist-free axisymmetric gravitational waves near the black hole threshold](https://arxiv.org/abs/2607.10843)
...
### [63] [Post-Newtonian N-Body Dynamics in Extended Theories of Gravity](https://arxiv.org/abs/2607.10889)
*Antonio Tedesco*
...
### [64] [How a minimal length scale modifies thermodynamics of RN AdS Black Holes?](https://arxiv.org/abs/2607.10964)
...
### [65] [A Space Mission to Earth's Nearest Black Hole: Reality or Science Fiction?](https://arxiv.org/abs/2607.10982)
*Cosimo Bambi*
...
### [66] [Spinoptics in the presence of axion-like particles in curved spacetime](https://arxiv.org/abs/2607.11134)
...
### [67] [Formation of Trapped Surfaces from Spacelike Initial Data](https://arxiv.org/abs/2607.11236)
...
### [68] [Turbulence, Norm Inflation, and the Rendall Instability for the Einstein-Euler System with Positive Cosmological Constant](https://arxiv.org/abs/2607.11375)
*Elliot Marshall*
...
### [69] [Sonic black holes with thick horizons in BECs](https://arxiv.org/abs/2607.11396)
...
### [70] [Dynamics and observational signatures of warm Dirac-Born-Infeld inflation with nonminimal derivative coupling](https://arxiv.org/abs/2607.11519)
...
### [71] [Black-hole evaporation from the semiclassical Einstein equations in 3+1 dimensions](https://arxiv.org/abs/2607.11737)
...
### [72] [A way to constrain a graviton mass from astronomical observations](https://arxiv.org/abs/2607.11764)
...
### [73] [Is there ghost and tachyon free bounce in UV complete gravity theory?](https://arxiv.org/abs/2607.11765)
...
### [74] [Universal Bounds on Black Hole Observables Imposed by Energy Conditions](https://arxiv.org/abs/2607.11840)
...
### [75] [Corrected thermodynamics and radiation predictions of modified black bounce compact objects](https://arxiv.org/abs/2607.11851)
...
### [76] [Higher-derivative gravitational effective field theories are generically weakly hyperbolic](https://arxiv.org/abs/2607.11879)
...
### [77] [ACT stands for Awkward Cosmology Theories](https://arxiv.org/abs/2607.09808)
...
### [78] [Searching for heavy charged relics in the Earth](https://arxiv.org/abs/2607.09845)
...
### [79] [Darkly Charged ALPs](https://arxiv.org/abs/2607.09852)
...
### [96] [Multipole structure of the $N \to Δ$ Transition Generalized Parton Distributions](https://arxiv.org/abs/2607.10901)
...
### [97] [Conversion-Driven Baryogenesis in Flavored Dark Matter Models](https://arxiv.org/abs/2607.11147)
...
### [98] [Soft photon approximation in a laser field: applications](https://arxiv.org/abs/2607.11160)
...
### [99] [Neutron tagging of heavy lepton pair production at RHIC and LHC energies](https://arxiv.org/abs/2607.11224)
...
### [100] [Determination of the Odderon amplitude in elastic cross-sections at high energies from scaling and analyticity](https://arxiv.org/abs/2607.11286)
...
### [101] [Coulomb Effects in Momentum-Space Femtoscopy: A Case Study of the $\bar{K}Ω$ System](https://arxiv.org/abs/2607.11321)
...
### [102] [Unitarization Schemes for High-Energy Elastic Scattering](https://arxiv.org/abs/2607.11504)
*E. G. S. Luna*
...
### [103] [An improved moment QCD sum rule](https://arxiv.org/abs/2607.11536)
...
### [104] [TRSMScans](https://arxiv.org/abs/2607.11571)
...
### [105] [Linearity, Nonlinearity and Universality of Regge Trajectories in Light Mesons: a Statistical Approach](https://arxiv.org/abs/2607.11583)
*S. S. Afonin*
...
### [106] [Thermal Dilepton Polarization under Rotation or Magnetic Field in Heavy-ion Collisions](https://arxiv.org/abs/2607.11634)
...
### [107] [Multi-scale improved predictions for $\boldsymbol{pp \to t\bar{t}W^+ +X}$](https://arxiv.org/abs/2607.11652)
...
### [108] [Antenna subtraction at NNLO for heavy quark pair production at hadron colliders: the non-diagonal channels](https://arxiv.org/abs/2607.11741)
...
### [109] [A Standard Model analysis of $D^0 \to π^- π^+, K^- K^+, K_{\rm S}^0 K_{\rm S}^0$](https://arxiv.org/abs/2607.11845)
