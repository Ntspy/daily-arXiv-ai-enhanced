...
### [12] [A story about a tipsy kangaroo: Reversible jump MCMC for model selection in the analysis of gravitational-wave signals from the coalescence of compact objects](https://arxiv.org/abs/2607.21484)
...
### [13] [Static spheres in black hole spacetimes: pairing, energy conditions, and an upper bound on the innermost radius](https://arxiv.org/abs/2607.20850)
*Yong Song*
...
### [22] [Structural, thermal and optical tolerance analysis of SHARP, a near infrared spectrograph for next generation telescope](https://arxiv.org/abs/2607.20610)
...
### [23] [STORM: RDMA-based Monte Carlo Transport Scheme for Distributed-Memory Particle Simulations](https://arxiv.org/abs/2607.20639)
...
### [24] [A multi-band radio flux density catalog of ICRF3 sources using the Onsala Twin Telescopes](https://arxiv.org/abs/2607.20671)
...
### [25] [RAMSES-GPU: Cell-by-Cell Adaptive Mesh Refinement with Magneto-Hydrodynamics and Self-Gravity on Graphics Processing Units](https://arxiv.org/abs/2607.20704)
...
### [26] [The High-Energy Light Isotope eXperiment (HELIX) Instrument](https://arxiv.org/abs/2607.20774)
...
### [27] [How to Craft the Right Language AI Policy For Your Research Group (Some Assembly Required)](https://arxiv.org/abs/2607.20836)
...
### [28] [GCR Spectra Reconstructed with Neutron Monitor Yield Function and Artificial Neural Networks: Comparison of Two Methods](https://arxiv.org/abs/2607.21009)
...
### [29] [Fast Inference on Astronomical Time Series with Trans-Dimensional Flow Matching Posterior Estimation](https://arxiv.org/abs/2607.21134)
...
### [30] [Infrasound Newtonian Noise Estimation at the Einstein Telescope Candidate Site Sos Enattos](https://arxiv.org/abs/2607.21154)
...
### [31] [HARMONI at ELT: optical design of the spectrograph sub-system](https://arxiv.org/abs/2607.21264)
...
### [32] [PROVIDENCE: a ground station for space observation](https://arxiv.org/abs/2607.21304)
...
### [33] [Modeling Dependence Structures in Astronomical Multi-Band Time Series Data via Multi-Output Gaussian Processes](https://arxiv.org/abs/2607.21431)
...
### [34] [Atmosphere mitigation in CMB observations using multi-frequency time-domain component separation](https://arxiv.org/abs/2607.21432)
...
### [35] [Unveiling the Vanishing Higgsino-Nucleon Scattering in the MSSM at Next-to-Leading Order](https://arxiv.org/abs/2607.20588)
...
### [36] [Accidentally Stable Dark Matter in a Parity Solution to the Strong CP Problem](https://arxiv.org/abs/2607.20600)
...
### [37] [Earth rotation turns event timing into a geometric probe of UHE neutrino origin](https://arxiv.org/abs/2607.20608)
...
### [38] [Dark Matter Weather: Probing Sub-GeV Interactions with Earth-Shielding Modulation](https://arxiv.org/abs/2607.20620)
...
### [39] [Reheating the FCC: Probing Early Matter Domination with Long-Lived Particles](https://arxiv.org/abs/2607.20625)
...
### [40] [Hyperasymptotic Expansions in QCD: The Lightest Gluelump Mass Case](https://arxiv.org/abs/2607.20648)
*Antonio Pineda*
...
### [41] [Spin Structure of the Nucleon: Overview](https://arxiv.org/abs/2607.20761)
*Yoshitaka Hatta*
...
### [43] [The supernumerary $K(1690)$ signal from COMPASS as a strange hybrid state](https://arxiv.org/abs/2607.20825)
...
### [44] [Dark Monopoles, Bounds on Hidden Sectors, and Cosmological Implications](https://arxiv.org/abs/2607.20843)
...
### [45] [Charged Higgs Search at Future Neutrino Telescope and Higgs Factory](https://arxiv.org/abs/2607.20963)
...
### [46] [Advanced Statistical Analysis of Linear and Nonlinear Regge Trajectories for Light Non-strange Mesons](https://arxiv.org/abs/2607.21035)
*S. S. Afonin*
...
### [47] [MeV Electrophilic Axion-like Particles from Sun](https://arxiv.org/abs/2607.21168)
...
### [48] [Thermal Resummation for Very Strong First-order Phase Transitions](https://arxiv.org/abs/2607.21252)
*Philipp Klose*
...
### [49] [Transverse-momentum resummation effects on angular coefficients in Z and W boson hadroproduction](https://arxiv.org/abs/2607.21395)
...
### [50] [Heavy neutral leptons from light scalar in fixed target and forward search experiments](https://arxiv.org/abs/2607.21537)
...
### [51] [Neural solutions of coupled ghost and gluon Dyson--Schwinger equations in Landau gauge](https://arxiv.org/abs/2607.21548)
*Rodrigo Carmo Terin*
...
### [52] [Gauge coupling beta functions and gauge field anomalous dimensions at four loops in the Standard Model](https://arxiv.org/abs/2607.21586)
...
### [53] [Semi-analytical Light Curve Model for Transients Preceding Binary Mergers. I: Supernova Precursor Emission from Compact Object Companions](https://arxiv.org/abs/2607.20599)
...
### [54] [Revealing the Structure and Magnetization of GRB Jets with ALMA Polarization Observations](https://arxiv.org/abs/2607.20604)
...
### [55] [The Origin of the Magnetic Flux Driving TDE Jets](https://arxiv.org/abs/2607.20615)
...
### [56] [Polarization of impulsive relativistic jets propagating in a stratified medium](https://arxiv.org/abs/2607.20618)
...
### [57] [Time-evolving Diagnostic of the Ionized Absorbers in NGC 4051. II. High-throughput Time-resolved Spectroscopy](https://arxiv.org/abs/2607.20621)
...
### [58] [Reaction-constrained composition \(g\)-modes in neutron stars with antikaon condensates, hyperons, and \(Δ(1232)\) resonances](https://arxiv.org/abs/2607.20693)
...
### [59] [Exploring Physics beyond the Standard Model from kHz-Gravitational-Wave Signals of Core-Collapse Supernovae](https://arxiv.org/abs/2607.20921)
...
### [60] [Relativistic Oblique Shocks at Finite Temperature: Detachment Angle, Shock Polars, and the Turning Parameter](https://arxiv.org/abs/2607.20978)
...
### [61] [The Extended Ultrahigh-energy Gamma-Ray Emission in the Vicinity of PSR J2238+5903](https://arxiv.org/abs/2607.21026)
...
### [62] [Spirited Away: Advective Loss of Cosmic Rays into the Milky Way's Circumgalactic Medium Explains the Large Magellanic Cloud's Low Gamma-ray Luminosity](https://arxiv.org/abs/2607.21316)
...
### [63] [Rapid Orbital Decay of Supersoft X-Ray Source WX Cen: a Surrounding Circumbinary Disk](https://arxiv.org/abs/2607.21364)
...
### [64] [Importance and Science Outcomes from the first XSPECT/XPoSat Workshop](https://arxiv.org/abs/2607.21365)
...
### [65] [Ultra-High-Energy Particle Production in Binary Mergers Endowed with Magnetic Fields](https://arxiv.org/abs/2607.21385)
...
### [66] [XMM-Newton and Swift Unveil Another X-Ray Transient in NGC 4945, XMM J130514.64-493311.27](https://arxiv.org/abs/2607.21587)
