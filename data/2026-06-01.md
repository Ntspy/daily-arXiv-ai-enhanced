...
### [11] [Leptonic CP Phase Determination from Fisher Information in NO$ν$A and T2K](https://arxiv.org/abs/2605.30404)
...
### [12] [Quark-Lepton Color-Flavor Unification](https://arxiv.org/abs/2605.30413)
...
### [13] [A Bandpass Axion Or: How I Learned To Stop Worrying About Stars And Love The Lab](https://arxiv.org/abs/2605.30416)
...
### [15] [Millicharged Particle Constraints from Asymptotic Giant Branch Stars](https://arxiv.org/abs/2605.30422)
...
### [16] [Factorizing quarkonium production matrix elements using effective field theory](https://arxiv.org/abs/2605.30441)
...
### [17] [Impact of Primordial Black Holes Induced Neutrinos on the Cosmic 21-cm Brightness Temperature](https://arxiv.org/abs/2605.30449)
...
### [18] [Generative Models and Statistical Validation](https://arxiv.org/abs/2605.30453)
...
### [19] [Canonical statistical hadronization with local baryon conservation for higher-order cumulants](https://arxiv.org/abs/2605.30710)
...
### [21] [Functional renormalization group study of the jet quenching parameter near the QCD critical end point](https://arxiv.org/abs/2605.30816)
...
### [22] [Moderate-to-Large-$x$ Gluon Helicity from $J/ψ$ Production at $\sqrt{s}=27~\mathrm{GeV}$](https://arxiv.org/abs/2605.30945)
...
### [23] [Searching for Lepton Flavor Violating decays of the Higgs Boson into $μτ$, $eτ$, and $eμ$ final states at FCC-ee](https://arxiv.org/abs/2605.30971)
...
### [24] [Geometric Phases as Probes of Dark Sectors](https://arxiv.org/abs/2605.30975)
...
### [25] [Nuclear matter and proton parton distributions in a light-front Hamiltonian framework](https://arxiv.org/abs/2605.31030)
...
### [26] [Radiative Corrections to Elastic Lepton-Proton Scattering with Focus on Two-Photon-Exchange Diagrams](https://arxiv.org/abs/2605.31123)
...
### [27] [A unified study of the \(B_c\) meson: from spectrum and form factors to weak and radiative decays](https://arxiv.org/abs/2605.31208)
...
### [28] [CoLoRFulNNLO for color-singlet processes: An update on NNLOCAL](https://arxiv.org/abs/2605.31221)
...
### [29] [Thermodynamics of the Isospectral family of holographic vector mesons](https://arxiv.org/abs/2605.31280)
...
### [31] [Signals of New Resonances from Di-Lepton Non-Universality in the Bottomonium Mass Region at the Large Hadron Collider](https://arxiv.org/abs/2605.31357)
...
### [33] [Dirac-Phase CP-Violation in the Low-Scale Type-I Seesaw with Three Right-Handed Neutrinos](https://arxiv.org/abs/2605.31454)
...
### [34] [Hyperoptimisation algorithm for the next generation of PDF determinations: ensemble regression with an unbiased selection model](https://arxiv.org/abs/2605.31482)
...
### [35] [Deeply bound dibaryon $d^*(2380)$ from meson-exchange saturation $ΔΔ$ effective field theory](https://arxiv.org/abs/2605.31578)
...
### [36] [Dark Energy Stars in Finch-Skea Spacetime with a Schwarzschild-(Anti)-de Sitter Exterior](https://arxiv.org/abs/2605.30398)
...
### [37] [Toward a Phenomenologically Acceptable Quantum Cyclic Universe](https://arxiv.org/abs/2605.30405)
...
### [38] [Exact Mass Conservation in Binary Neutron Star Merger Simulations](https://arxiv.org/abs/2605.30430)
...
### [39] [Cosmological accretion onto braneworld black holes: a relativistic treatment](https://arxiv.org/abs/2605.30446)
...
### [40] [Black hole evolutions: Lessons from bifurcation theory](https://arxiv.org/abs/2605.30458)
...
### [41] [Quantification of the parameter estimation error from Rotating Core Collapse supernovae](https://arxiv.org/abs/2605.30665)
...
### [42] [Dirac-Field Black Hole Entropy in \(f(Q)\) Gravity from the RVB Residue Method](https://arxiv.org/abs/2605.31012)
*Wen-Xiang Chen*
...
### [43] [Classical Corrections to Black Hole Entropy II](https://arxiv.org/abs/2605.31211)
...
### [44] [Stability and instability of torus-symmetric Einstein spacetimes with square-integrable connection](https://arxiv.org/abs/2605.31585)
...
### [45] [The EPS Research Astro-RAG Platform: A Unified Open-Science Infrastructure for Cross-Epoch Astrophysical Kinematic Analysis, LLM-Assisted Research Workflows, and Educational Outreach](https://arxiv.org/abs/2605.30384)
*David C. Flynn*
...
### [46] [Experiments on Settling of Granular and Cohesive Material in Low Gravity](https://arxiv.org/abs/2605.30395)
...
### [47] [Choosing the right MCMC sampler: a systematic benchmark of gradient-free methods](https://arxiv.org/abs/2605.30412)
...
### [48] [Transformer-Based Source Detection and Morphological Classification in LOFAR Deep-Field Continuum Images](https://arxiv.org/abs/2605.30500)
...
### [49] [Gratis Mitigation of Polarization Aberration Effects in Coronagraphic Dark Holes](https://arxiv.org/abs/2605.30565)
*Richard A. Frazin*
...
### [50] [Characterising and mitigating Bluetooth and WiFi radio frequency interference at the Parkes Observatory](https://arxiv.org/abs/2605.30761)
...
### [51] [An Automated Photometric Pipeline for the 80cm Xizang University Telescope](https://arxiv.org/abs/2605.31301)
...
### [52] [Refining the Gaia DR3 Parallax Zero-point: A Hybrid Approach Combining Global Parametric Correction with Local Refinement](https://arxiv.org/abs/2605.31402)
