...
### [31] [Observationally Reconstructed Spacetime of NGC 5907: Dark-Matter-Corrected Black Hole Thermodynamics and Galactic Shadow](https://arxiv.org/abs/2609.17570)
...
### [32] [Exceptional points and the breaking of Schwarzschild isospectrality under local potential perturbations](https://arxiv.org/abs/2609.17580)
...
### [33] [Noether and Mei symmetries in static spherically symmetric quadratic gravity: variational consistency, constraints, and conserved curvature flux](https://arxiv.org/abs/2609.17582)
...
### [34] [Non-equilibrium thermodynamics of an expanding Swiss-Cheese braneworld cosmology with a matter bounce](https://arxiv.org/abs/2609.17583)
*Nasr Ahmed*
...
### [35] [Horizon Structure and Geodesic Properties of Simpson-Visser Black Holes in Einstein-Euler-Heisenberg Theory](https://arxiv.org/abs/2609.17585)
*Ahmad Al-Badawi*
...
### [36] [Fold-Point Scaling and Phenomenological Cascade Closures in Regular Black Hole Spacetimes](https://arxiv.org/abs/2609.17587)
*Hoang Van Quyet*
...
### [37] [First-Law Entropy and a Degenerate Extremal Remnant in a Minimal-Length Simpson--Visser-Type Regular Black Hole: Geometrothermodynamics, Phase Structure, and Observational Discriminants](https://arxiv.org/abs/2609.17588)
...
### [38] [From Geometry to Gravity: A Friendly Introduction to the Schwarzschild Metric](https://arxiv.org/abs/2609.17591)
*Jorge Pinochet*
...
### [39] [Traversable Hyperbolic Wormholes with a Casimir-Memory Source: Complexity and Shell-Free Matching](https://arxiv.org/abs/2609.17597)
...
### [40] [Gravitating sources with zero energy density in cosmology](https://arxiv.org/abs/2609.17604)
...
### [41] [Prescription Dependence in Nonextensive Bose--Fermi State Counting near Black-Hole Horizons](https://arxiv.org/abs/2609.17615)
...
### [42] [Quasinormal modes of Kerr-Newman-de Sitter black holes from Heun connection formulae](https://arxiv.org/abs/2609.17471)
...
### [43] [A closer look at Viaggiu Holographic Dark Energy with Statefinder Hierarchy and Fractional Growth Diagnostics](https://arxiv.org/abs/2609.17616)
*Somnath Saha*
...
### [47] [Scalar quasinormal and quasibound states of weakly magnetized Ernst--Schwarzschild spacetime: a confluent-Heun Wronskian approach](https://arxiv.org/abs/2609.17727)
...
### [48] [Shadow and Polarized Images of Schwarzschild-MOG Black Hole Illuminated by Thick Accretion Disk](https://arxiv.org/abs/2609.18606)
...
### [49] [Extremal curves of Perlick's proper time in Weyl geometry](https://arxiv.org/abs/2609.17774)
...
### [50] [Searching for gravitational wave echo with group equivariant neural posterior estimation](https://arxiv.org/abs/2609.18337)
...
### [51] [Stochastic Thermodynamics of Dynamical Thin-Shell Wormholes: Effective Temperatures, Fluctuations and Conditional Quasi-Horizon Unification](https://arxiv.org/abs/2609.17912)
...
### [52] [Symmetry preservation in black hole quasinormal mode spectra](https://arxiv.org/abs/2609.18105)
...
### [53] [Horizon--orbit scale competition in chaos bound violation for spinning particles in the black-bounce--Kerr--Newman spacetime](https://arxiv.org/abs/2609.18143)
...
### [54] [Causal structure and optical signatures of rotating power law Kalb-Ramond geometry](https://arxiv.org/abs/2609.18377)
...
### [55] [Second-order slow rotation of wormholes in Einstein-scalar-Gauss-Bonnet gravity](https://arxiv.org/abs/2609.18475)
...
### [56] [Black Hole Shadow and Light Deflection in Generalized Heisenberg-Euler Nonlinear Electrodynamics](https://arxiv.org/abs/2609.18615)
...
### [57] [Symmetry-Driven $k$-Essence Cosmological Dynamics](https://arxiv.org/abs/2609.18790)
...
### [59] [1D PIC Simulations of Resonant Scattering-Driven Pair Cascades in Magnetar Magnetospheres](https://arxiv.org/abs/2609.17661)
...
### [60] [Unifying spatial correlation with hierarchical population inference to constrain the AGN channel for binary black hole mergers](https://arxiv.org/abs/2609.17665)
...
### [61] [Uncovering New Ionized Winds and Relativistic Hot Outflows in MCG-6-30-15 with \emph{Chandra} HETG and a Bayesian Framework](https://arxiv.org/abs/2609.17723)
...
### [62] [The Hidden Evolution of Gamma-Ray Burst Jets Revealed by Gravitational Waves](https://arxiv.org/abs/2609.17776)
...
### [63] [Radiation Magneto-hydrodynamic Simulations of MRI with Zero-Net-Vertical-Flux: Necessity of Resolving the Thermal Scale For Strongly Magnetized Initial Conditions](https://arxiv.org/abs/2609.17813)
...
### [64] [Updated estimates of post-merger gravitational wave energy released in GW170817 and the maximum neutron star mass](https://arxiv.org/abs/2609.17936)
...
### [65] [FRB 20250607A: Weirder Than Fiction](https://arxiv.org/abs/2609.18086)
...
### [66] [RadioAstron space-VLBI imaging of the jet in M87: II. The parsec-scale structure at 4.8 GHz](https://arxiv.org/abs/2609.18192)
...
### [67] [Detectability of 100 TeV Gamma Rays from PeV Cosmic Rays Accelerated in the Early Phase of a Supernova Shock Wave](https://arxiv.org/abs/2609.18226)
...
### [68] [Toward Autonomous Radio Follow-up of Multi-messenger Transients with RADAR: From Alert Parsing to Inference and Observation Scheduling](https://arxiv.org/abs/2609.18233)
...
### [69] [The unidentified PeV source LHAASO J2108+5157: A microquasar remnant?](https://arxiv.org/abs/2609.18353)
...
### [70] [WFST Follow-up of S251112cm: Searching for an Optical Counterpart to a Subsolar-mass Compact-binary Merger Candidate](https://arxiv.org/abs/2609.18523)
...
### [71] [Studying the Intermittency of Magnetized Interstellar Medium by Synchrotron Polarization Intensity and its Gradient](https://arxiv.org/abs/2609.18699)
...
### [72] [Radiation-Driven Magnetic Fields in Sub-Keplerian Accretion Flows: An Alternative to MRI](https://arxiv.org/abs/2609.19108)
...
### [73] [IViS: Interferometric Visibility-domain inversion Software - A GPU-accelerated Python framework for joint deconvolution with ASKAP](https://arxiv.org/abs/2609.17636)
...
### [74] [Rethinking Domain Specialization for Open-Ended Scientific Reasoning in Astronomy Language Models](https://arxiv.org/abs/2609.17644)
...
### [75] [The OpenGadget3 Code for Cosmological Simulations](https://arxiv.org/abs/2609.17658)
...
### [76] [Optimising instrument concepts with Machine Learning: Application to CMB spectral distortion experiments](https://arxiv.org/abs/2609.17829)
...
### [77] [Pulsed ion deflection to overcome detector saturation in cryogenic ice sampling](https://arxiv.org/abs/2609.17873)
...
### [78] [Quantifying the temperature-dependent yields of N$_2$ and N$_2$H$_4$ formation in vacuum-ultraviolet-irradiated NH$_3$ ice](https://arxiv.org/abs/2609.17878)
...
### [79] [Graph neural networks for exoplanet atmospheres](https://arxiv.org/abs/2609.17894)
...
### [80] [Progress in quantum telescopes](https://arxiv.org/abs/2609.18079)
...
### [81] [Transitioning from ADS to SciX to Serve 21st Century Astronomy](https://arxiv.org/abs/2609.18091)
...
### [82] [cosmokdtree: a flexible OpenMP-parallelized k-d tree for computational astrophysics applications](https://arxiv.org/abs/2609.18316)
...
### [83] [The GOTO Telescope Control System](https://arxiv.org/abs/2609.18443)
