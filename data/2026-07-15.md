...
### [21] [Naturally quality-safe GeV axion with charm coupling](https://arxiv.org/abs/2607.12956)
*Bo-Qiang Lu*
...
### [22] [Thermo-electric transport in non-extensive QCD matter in presence of magnetic field](https://arxiv.org/abs/2607.12589)
...
### [23] [Signatures of $X_{17}$ through Coherent Elastic Solar Neutrino-Nucleus Scattering in Direct Detection Searches](https://arxiv.org/abs/2607.12691)
...
### [24] [Interpreting the Newly Observed $Ξ(1720)$ State in the Spin-$\frac{3}{2}$ $Ξ$ Spectrum](https://arxiv.org/abs/2607.12712)
...
### [25] [Physically Consistent Parameter Inference: Transparent Machine Learning Emulation in High Energy Physics and Cosmology](https://arxiv.org/abs/2607.12726)
...
### [28] [Quantifying Foreground Contamination in the Dark Ages 21 cm Power Spectrum Using an Electromagnetically Simulated Dipole Antenna Atop a Dielectric Surface](https://arxiv.org/abs/2607.11929)
...
### [29] [The Interstellar Laser Beacons Hypothesis and the Cosmic Lighthouses Project](https://arxiv.org/abs/2607.12106)
...
### [30] [Demystifying image-recovery from radio interferometers: toward a multiscale predictive model](https://arxiv.org/abs/2607.12396)
...
### [31] [The Lightspeed project: high-speed, ultra-low read noise imaging and polarimetry for the Magellan telescopes](https://arxiv.org/abs/2607.12426)
...
### [32] [Scaling laws for multi-object spectrographs: empirical relationships and the photonic advantage of CAWSMOS](https://arxiv.org/abs/2607.12492)
...
### [33] [Estimation of the laser guide star uplink tip-tilt using aperture size diversity](https://arxiv.org/abs/2607.12494)
...
### [34] [PSRDISP: A novel approach to modeling dispersive processes in single-pulsar noise analysis using epoch-wise dispersion measures](https://arxiv.org/abs/2607.12609)
...
### [35] [ngVLTI: Cost and Feasibility of a Four-Telescope VLTI Expansion for Milliarcsecond-Scale Imaging](https://arxiv.org/abs/2607.12692)
...
### [36] [Status and future development of the COSMOCal Project for absolute CMB polarization calibration](https://arxiv.org/abs/2607.12698)
...
### [37] [A genetic algorithm for peer-review panel composition](https://arxiv.org/abs/2607.12757)
*Ferdinando Patat*
...
### [38] [Enhanced wavefront sensing for the Roman Coronagraph Instrument: Gaussian probes and compact model validation](https://arxiv.org/abs/2607.12805)
...
### [39] [The MICADO first-light imager for the ELT: first steps of the SCAO system MAIT](https://arxiv.org/abs/2607.12814)
...
### [40] [The MICADO first light imager for the ELT: an overview of the RAM analysis and consequent design and maintenance strategy](https://arxiv.org/abs/2607.12827)
...
### [41] [The MICADO first light imager for the ELT: the SCAO module AIT in France, from the beta flat configuration towards the flat and final configurations](https://arxiv.org/abs/2607.12854)
...
### [42] [Astra: an open-source fully autonomous robotic observatory control software](https://arxiv.org/abs/2607.12898)
...
### [43] [Establishing baseline model performances for optical turbulence forecasting](https://arxiv.org/abs/2607.12900)
...
### [44] [Updates to the WFC3/IR Photometric Stability Stellar Cluster Study](https://arxiv.org/abs/2607.12908)
...
### [45] [Fast and accurate bandpass integration of complex SEDs with neural networks](https://arxiv.org/abs/2607.12953)
*L. A. Bianchi*
...
### [46] [picoMUX: microcontroller based time-domain multiplexing readout for kilopixel TES arrays](https://arxiv.org/abs/2607.13004)
...
### [47] [Mitigating the Timing Impact of Anomalous Pulse Profile Shape Variability in PSR J1713+0747 with Gaussian Component Modeling](https://arxiv.org/abs/2607.12038)
...
### [48] [Superlinear Type II Superluminous Supernovae 2017fck and 2019cmv: A Possible Origin from Interacting Thermonuclear Supernovae](https://arxiv.org/abs/2607.12040)
...
### [49] [Pulsar anti-glitches: starquakes driven by magnetism?](https://arxiv.org/abs/2607.12285)
...
### [50] [Astrophysical Population Coordinates for Supermassive Black Hole Binaries in Pulsar Timing Array Inference](https://arxiv.org/abs/2607.12427)
...
### [51] [Photometric and Spectroscopic Studies of Type Ic Supernovae SN 2020akf and SN 2021mxx](https://arxiv.org/abs/2607.12525)
...
### [52] [Machine Learning Detection of Non-Axisymmetric Fast Flavor Instabilities in Compact Objects](https://arxiv.org/abs/2607.12558)
...
### [53] [Coupled Shock Cooling and Radioactive Heating in the Type IIb Supernova SN 2024aecx: An Extended Envelope and Rapid Optical Decline](https://arxiv.org/abs/2607.12700)
...
### [54] [Constraining the High-Density Equation of State with Present and Future NICER Observations Using Physics-Informed Regularized Machine Learning](https://arxiv.org/abs/2607.12722)
...
### [55] [An internal shock model calibrated with real gamma-ray burst light curves using a genetic algorithm](https://arxiv.org/abs/2607.12731)
...
### [56] [Identifying potentially missed extended sources in the Fermi-LAT 4FGL Catalog using clustering analysis](https://arxiv.org/abs/2607.12776)
...
### [57] [Supernova Neutrinos and the Origin of Biomolecular Homochirality](https://arxiv.org/abs/2607.12813)
...
### [58] [EP-FXT Observations of Abell 1795: X-ray Properties and Structure out to $R_{200}$](https://arxiv.org/abs/2607.12816)
...
### [59] [Momentum Space Resolution Dependence in Boltzmann Neutrino Radiation Hydrodynamics Simulations of Core-collapse Supernovae](https://arxiv.org/abs/2607.12891)
*Ryuichiro Akaho*
...
### [60] [Investigating the Periodic X-ray Behaviour in the Eclipsing AGN NGC 6814](https://arxiv.org/abs/2607.12904)
...
### [61] [High-Resolution Numerical Calculations of GRB Afterglow Plateaus arising from Stratified Ejecta](https://arxiv.org/abs/2607.12967)
...
### [62] [A new model for the continuum spectra of AM CVn binaries and multi-messenger inference with normalizing flows](https://arxiv.org/abs/2607.12971)
...
### [63] [Gamma-ray Modes in a Transitional Pulsar](https://arxiv.org/abs/2607.13019)
...
### [64] [Beyond ΛCDM with the SKA Observatory -- I: Probing Gravity on Cosmological Scales](https://arxiv.org/abs/2607.11917)
...
### [65] [Optical and thermodynamic properties of Kerr-Bertotti-Robinson black holes](https://arxiv.org/abs/2607.11979)
...
### [66] [Geometric effects of torsion on black hole ringdown and shadows in Poincaré gauge gravity](https://arxiv.org/abs/2607.11989)
...
### [67] [A new non-commutative correction to the thermodynamics and evaporation of the Schwarzschild black hole in non-commutative gauge theory](https://arxiv.org/abs/2607.11991)
...
### [68] [Spinning particle dynamics, epicyclic frequencies, and transient QPO signatures in Schwarzschild spacetime](https://arxiv.org/abs/2607.11993)
...
### [69] [Thin-shell wormholes in cosmic voids](https://arxiv.org/abs/2607.11995)
...
### [70] [No persuasive evidence yet of gravitational-wave tails from perturbers along the line of sight in LVK observations](https://arxiv.org/abs/2607.12043)
...
### [71] [High-order gravitational late-time tails in Kerr spacetime](https://arxiv.org/abs/2607.12151)
...
### [72] [Dynamics of potential-free warm $\mathbf{k}$-inflation with nonminimal derivative coupling](https://arxiv.org/abs/2607.12280)
...
### [73] [Particle decay and energy conservation in the Kerr-Newman black hole](https://arxiv.org/abs/2607.12475)
...
### [74] [Role of spin-curvature and magnetic interactions on circular orbits of particles with magnetic monopole around Bardeen black holes](https://arxiv.org/abs/2607.12486)
...
### [75] [High-Frequency Gravitational Wave Constraints from Precision Spectroscopy](https://arxiv.org/abs/2607.12617)
...
### [76] [Two-fluid $f$-mode oscillations of dark-matter-admixed neutron stars](https://arxiv.org/abs/2607.12661)
...
### [77] [Evaluating KAGRA upgrade scenarios for multimessenger observations of binary neutron stars](https://arxiv.org/abs/2607.12769)
...
### [78] [Qualitative Analysis of Cosmological Models Using Dynamical System Perspective](https://arxiv.org/abs/2607.12791)
*Sayantan Ghosh*
...
### [79] [The entropy of dynamical black holes deviating from electrovacuum in second order](https://arxiv.org/abs/2607.12794)
...
### [81] [Prism Effect in Quantum Gravity](https://arxiv.org/abs/2607.13012)
