...
### [1] [Constraining Ultralight Scalars with Black Hole Binary Mergers in Galactic Nuclei](https://arxiv.org/abs/2609.12052)
...
### [2] [\texttt{cWB-space}: A time-frequency transient-search pipeline for LISA](https://arxiv.org/abs/2609.12986)
...
### [3] [Hidden structures in the UHE sky: unveiling potential sources via spectral signatures](https://arxiv.org/abs/2609.12174)
...
### [4] [Spin-polarization of the neutron ocean in magnetar crusts](https://arxiv.org/abs/2609.12539)
...
### [5] [Muon decay across scales: from LEFT to SMEFT](https://arxiv.org/abs/2609.12051)
...
### [6] [Leptogenesis Determined By Low Energy Parameters](https://arxiv.org/abs/2609.12542)
...
### [7] [Comparision of modeling of prompt photon production in proton-proton collisions at energies NICA $\sqrt{s}$ =10 GeV in PYTHIA and calculations using FeynCalc](https://arxiv.org/abs/2609.12751)
...
### [8] [Reconstructing the Dark Matter Equation of State with Compact Object Inspirals](https://arxiv.org/abs/2609.12806)
...
### [9] [Supernova cooling from neutrinophilic dark matter](https://arxiv.org/abs/2609.12821)
*Yugen Lin*
