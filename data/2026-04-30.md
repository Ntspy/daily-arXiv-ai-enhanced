...
### [6] [Normalizing flows for density estimation in multi-detector gravitational-wave searches](https://arxiv.org/abs/2604.26581)
...
### [7] [Effects of nucleon-nucleon short-range correlation and symmetry energy on the evolution of newly born magnetars](https://arxiv.org/abs/2604.26395)
...
### [8] [Status of the KM3NeT real-time analysis framework](https://arxiv.org/abs/2604.26780)
*Martina Marconi*
...
### [9] [Point-like Off-pulse GeV Emission from the Millisecond Pulsar PSR J0437-4715](https://arxiv.org/abs/2604.26442)
*Ziwei Ou*
...
### [14] [Charge diffusion and modulation transfer function in a Nancy Grace Roman Space Telescope detector](https://arxiv.org/abs/2604.26114)
...
### [15] [Analytical Modeling of Far-Field Wavefront Error with Beam-Waist and Lateral-Shift Effects in Spaceborne Laser Interferometry](https://arxiv.org/abs/2604.26371)
...
### [16] [IQUEYE at Gemini South: instrument, science commission, and first results](https://arxiv.org/abs/2604.26777)
...
### [17] [Bayesian component separation and power spectrum estimation for 21 cm intensity mapping data cubes](https://arxiv.org/abs/2604.26890)
...
### [18] [EFT Pathways to $|ΔB| =2$: Chiral Constructions and Phenomenology](https://arxiv.org/abs/2604.25989)
...
### [19] [Collisional energy loss distribution of a fast parton in a hot or dense QCD medium](https://arxiv.org/abs/2604.25997)
*G. Jackson,S. Peigné*
...
### [20] [New insights into the $b\rightarrow c \bar{u}q$ puzzle through Top-Bottom synergies](https://arxiv.org/abs/2604.25998)
...
### [21] [Revisiting Turner Window Axions: The Untapped Potential of NaI Dark Matter Detectors](https://arxiv.org/abs/2604.26004)
...
### [22] [Asteroid-mass Primordial Black Holes as Dark Matter from Supersymmetry](https://arxiv.org/abs/2604.26005)
...
### [23] [Dissipative Losses In Black Hole-Induced Vacuum Decay](https://arxiv.org/abs/2604.26009)
...
### [24] [Specially Embedding a Composite Axion Model](https://arxiv.org/abs/2604.26010)
...
### [25] [Time-of-Flight Constraints on Neutrino Millicharge from Supernova Neutrinos in Galactic Magnetic Fields](https://arxiv.org/abs/2604.26013)
...
### [26] [When JIMWLK evolution really matters: the example of incoherent diffraction](https://arxiv.org/abs/2604.26123)
...
### [27] [Recent Developments in IR-Improved Amplitude-Based Resummation in Precision High Energy Collider Physics](https://arxiv.org/abs/2604.26124)
...
### [28] [Radiative charmonium decays in a contact-interaction model with dynamical quark anomalous magnetic moment](https://arxiv.org/abs/2604.26185)
...
### [29] [Gravitational Properties of the Monopole Bag](https://arxiv.org/abs/2604.26191)
...
### [30] [Exponentially improved quantum simulation of scalar QFT](https://arxiv.org/abs/2604.26226)
...
### [31] [Light sea-quark flavor asymmetry and angular momentum of the nucleon in a scalar-vector spectator model](https://arxiv.org/abs/2604.26306)
...
### [33] [Particle seismology: mechanical and gravitational properties from parton-hadron duality](https://arxiv.org/abs/2604.26537)
...
### [34] [Hybrid hadrons at rest and on the light front](https://arxiv.org/abs/2604.26708)
...
### [35] [Probing Sub-GeV Dark Matter via Migdal Effect-Induced Electron Excitations](https://arxiv.org/abs/2604.26773)
...
### [36] [Effect of sub-nucleon fluctuations on the DVCS process in proton and nuclear targets at the EIC](https://arxiv.org/abs/2604.26789)
...
### [37] [GLoop: A Monte Carlo program to construct higher-loop integrals from lower-loop structures](https://arxiv.org/abs/2604.26798)
*Roberto Pittau*
...
### [38] [Continuum contribution to charged-current absorption of low-energy $ν_e$ on $^{40}$Ar](https://arxiv.org/abs/2604.26801)
...
### [39] [When Two Loops Matter: Electroweak Precision in the SMEFT](https://arxiv.org/abs/2604.26817)
...
### [40] [Null Tests and Lepton Universality in $Ξ_{cc}$ Baryon Decays](https://arxiv.org/abs/2604.26842)
*Hindi Zouhair*
...
### [41] [Nanohertz gravitational waves from the baryon-dark matter coincidence](https://arxiv.org/abs/2604.26860)
...
### [42] [Strong-field signatures of a regular black hole in an Einasto dark matter halo](https://arxiv.org/abs/2604.25961)
...
### [43] [Parameter-estimation bias induced by transient orbital resonances in extreme-mass-ratio inspirals](https://arxiv.org/abs/2604.26011)
...
### [44] [Inflationary Scenarios in $f(Q,φ)$ Gravity with Scalar Field Coupling](https://arxiv.org/abs/2604.26156)
...
### [45] [Scattering of electromagnetic field in quasi-topological gravity](https://arxiv.org/abs/2604.26166)
*Juan Pablo Arbelaez*
...
### [46] [Trapping, Irregular Waveforms, and Efficient Radiation in Ultra-relativistic Black Hole Encounters](https://arxiv.org/abs/2604.26253)
...
### [47] [Quantum Probe to the Higher Dimensional Yang-Mills Singularity](https://arxiv.org/abs/2604.26350)
...
### [48] [Thermodynamic properties of the Kerr Black-hole in non-linear electrodynamics with cosmological constant](https://arxiv.org/abs/2604.26586)
...
### [49] [Causal structure of black holes immersed in a Chaplygin-like dark fluid environment: Horizons and singularities](https://arxiv.org/abs/2604.26681)
...
### [50] [Finite-Window Centered Organization of Neighboring Poles](https://arxiv.org/abs/2604.26725)
*Yuye Wu,Hong-Bo Jin*
...
### [51] [Power-Law Approach of the Stress-Energy Tensor to the Unruh State after Gravitational Collapse](https://arxiv.org/abs/2604.26840)
*Michael Wilson*
